...
int Cyc__IO_vfscanf(int (* _IO_getc)(void *),int (* _IO_ungetc)(int,void *),
  ...
  int _T173;
  int _T174;
  struct Cyc_Core_Impossible_exn_struct * _T175;
  void * _T176;
  int * _T177;
  unsigned int _T178;
  int * _T179;
  ...
  char ccltab[256U];
  char buf[351U];
  { unsigned int _T17F = 350U;
    unsigned int i;
    i = 0;
    _TLB: if (i < _T17F) { goto _TL9;
    }else { goto _TLA;
    }
    _TL9: _T0 = buf;
    _T1 = i;
    ...
    case 110: 
      ...
      _T27 = ap;
      _T28 = _check_fat_subscript(_T27,sizeof(void *),0U);
      _T29 = (void * *)_T28;
      _T2A = *_T29;
      ...
      *_T2B = (short)_T2C;
      ...
      _T2D = ap;
      _T2E = _check_fat_subscript(_T2D,sizeof(void *),0U);
      _T2F = (void * *)_T2E;
      _T30 = *_T2F;
      ...
      *_T31 = nread;
      goto _TL33;
      _TL32: _T32 = ap;
      _T33 = _check_fat_subscript(_T32,sizeof(void *),0U);
      _T34 = (void * *)_T33;
      _T35 = *_T34;
	...
	_T46 = ap;
	_T47 = _check_fat_subscript(_T46,sizeof(void *),0U);
	_T48 = (void * *)_T47;
	_T49 = *_T48;
	{ struct _fat_ptr z = Cyc_va_arg_char_ptr(_T49);
	  ...
	  goto _TL4E;
	  _TL52: _T4F = z;
	  _T50 = _check_fat_subscript(_T4F,sizeof(char),0U);
	  _T51 = (char *)_T50;
	  _T52 = n;
	  *_T51 = (char)_T52;
	  _T53 = &z;
	...
	_T57 = (char)_T56;
	_T58 = (int)_T57;
	_T59 = _check_known_subscript_notnull(_T55,256U,sizeof(char),_T58);
	_T5A = (char *)_T59;
	_T5B = *_T5A;
	_T5C = (int)_T5B;
	if (_T5C) { goto _TL59;
	...
	width = width + -1;
	_T5D = width;
	if (_T5D != 0) { goto _TL5B;
	}
	goto _TL5A;
	_TL5B: c = _IO_peekc(fp);
	_T5E = c;
	_T5F = - 1;
	if (_T5E != _T5F) { goto _TL5D;
	}
	if (n != 0) { goto _TL5F;
	}
	goto eof_failure;
	...
	_TL61: ;
      ...
      _TL56: _T60 = ap;
      _T61 = _check_fat_subscript(_T60,sizeof(void *),0U);
      _T62 = (void * *)_T61;
      _T63 = *_T62;
      _T64 = Cyc_va_arg_string_ptr(_T63);
      { struct _fat_ptr p4 = _T64;
	_T65 = &ap;
	...
	{ struct _fat_ptr p5 = p4;
	  ...
	  _T68 = (char)_T67;
	  _T69 = (int)_T68;
	  _T6A = _check_known_subscript_notnull(_T66,256U,sizeof(char),_T69);
	  _T6B = (char *)_T6A;
	  _T6C = *_T6B;
	  _T6D = (int)_T6C;
	  if (_T6D) { goto _TL64;
	  ...
	  _TL64: _T6E = p5;
	  _T6F = _get_fat_size(_T6E,sizeof(char));
	  if (_T6F != 0U) { goto _TL66;
	  }
	  goto eof_failure;
	  _TL66: _T70 = p5;
	  _T71 = _T70.curr;
	  _T72 = (char *)_T71;
	  _T73 = _check_null(_T72);
	  _T74 = c;
	  *_T73 = (char)_T74;
	  _T75 = &p5;
	  ...
	  width = width + -1;
	  _T76 = width;
	  if (_T76 != 0) { goto _TL68;
	  }
	  goto _TL65;
	  _TL68: c = _IO_peekc(fp);
	  _T77 = c;
	  _T78 = - 1;
	  if (_T77 != _T78) { goto _TL6A;
	  }
	  _T79 = p5;
	  _T7A = _T79.curr;
	  _T7B = (char *)_T7A;
	  ...
	  goto match_failure;
	  _TL6E: _T84 = p5;
	  _T85 = _get_fat_size(_T84,sizeof(char));
	  if (_T85 != 0U) { goto _TL70;
	  }
	  goto eof_failure;
	  _TL70: _T86 = p5;
	  _T87 = _T86.curr;
	...
	width = width + -1;
	_T8F = width;
	if (_T8F != 0) { goto _TL79;
	}
	goto _TL78;
	_TL79: c = _IO_peekc(fp);
	_T90 = c;
	_T91 = - 1;
	if (_T90 != _T91) { goto _TL7B;
	}
	seen_eof = seen_eof + 1;
	goto _TL78;
	_TL7B: goto _TL76;
	...
	nread = nread + _T92;
      ...
      _TL74: _T93 = ap;
      _T94 = _check_fat_subscript(_T93,sizeof(void *),0U);
      _T95 = (void * *)_T94;
      _T96 = *_T95;
      { struct _fat_ptr p2 = Cyc_va_arg_string_ptr(_T96);
	_T97 = &ap;
	_fat_ptr_inplace_plus(_T97,sizeof(void *),1);
	{ struct _fat_ptr p3 = p2;
	  int c = _IO_peekc(fp);
	  _TL7D: _T98 = c;
	  _T99 = (unsigned char)_T98;
	  _T9A = (int)_T99;
	  _T9B = isspace(_T9A);
	  if (_T9B) { goto _TL7F;
	  }else { goto _TL7E;
	  ...
	  _TL7E: c = _IO_getc(fp);
	  _T9C = p3;
	  _T9D = _get_fat_size(_T9C,sizeof(char));
	  if (_T9D != 0U) { goto _TL80;
	  }
	  goto eof_failure;
	  _TL80: _T9E = p3;
	  _T9F = _T9E.curr;
	  _TA0 = (char *)_T9F;
	  _TA1 = _check_null(_TA0);
	  _TA2 = c;
	  *_TA1 = (char)_TA2;
	  _TA3 = &p3;
	  ...
	  width = width + -1;
	  _TA4 = width;
	  if (_TA4 != 0) { goto _TL82;
	  }
	  goto _TL7F;
	  _TL82: c = _IO_peekc(fp);
	  _TA5 = c;
	  _TA6 = - 1;
	  if (_TA5 != _TA6) { goto _TL84;
	  }
	  seen_eof = seen_eof + 1;
	  goto _TL7F;
	  _TL84: goto _TL7D;
	  _TL7F: _TA7 = p3;
	  _TA8 = _get_fat_size(_TA7,sizeof(char));
	  if (_TA8 != 0U) { goto _TL86;
	  }
	  goto eof_failure;
	  _TL86: _TA9 = p3;
	  _TAA = _TA9.curr;
	  _TAB = (char *)_TAA;
	  _TAC = _check_null(_TAB);
	  *_TAC = '\000';
	  _TAD = p3;
	  _TAE = _TAD.curr;
	  _TAF = p2;
    ...
    case 3: 
      ...
      _TB5 = _TB4 - 1U;
      _TB6 = (long long)_TB5;
      if (_TB3 > _TB6) { goto _TL8A;
      }else { goto _TL88;
      }
      _TL8A: _TB7 = sizeof(buf);
      _TB8 = _TB7 - 1U;
      width = (long long)_TB8;
      goto _TL89;
      _TL88: _TL89: _TB9 = 64 | 128;
      _TBA = _TB9 | 512;
      flags = flags | _TBA;
      _TBB = buf;
      p = _tag_fat(_TBB,sizeof(char),351U);
      _TL8F: if (width != 0) { goto _TL8D;
      }else { goto _TL8E;
      }
      _TL8D: _TBC = _IO_peekc(fp);
      _TBD = (unsigned char)_TBC;
      c = (int)_TBD;
      _TBE = c;
      _TBF = (int)_TBE;
      switch (_TBF) {
	...
	_LL64: _TC6 = basefix;
	_TC7 = base;
	_TC8 = _check_known_subscript_notnull(_TC6,17U,sizeof(short),_TC7);
	_TC9 = (short *)_TC8;
	_TCA = *_TC9;
	base = (int)_TCA;
	_TCB = 64 | 256;
	...
	_LL68: _TCE = basefix;
	_TCF = base;
	_TD0 = _check_known_subscript_notnull(_TCE,17U,sizeof(short),_TCF);
	_TD1 = (short *)_TD0;
	_TD2 = *_TD1;
	base = (int)_TD2;
	...
	_TDA = p;
	_TDB = - 1;
	_TDC = _fat_ptr_plus(_TDA,sizeof(char),_TDB);
	_TDD = _TDC.curr;
	_TDE = (char *)_TDD;
	_TDF = buf;
	if (_TDE != _TDF) { goto _TL9B;
	}
	base = 16;
	_TE0 = ~ 256;
	flags = flags & _TE0;
	...
	goto _LL54;
      ...
      _LL54: goto _TL8E;
      ok: _TE1 = &p;
      { struct _fat_ptr _T17F = _fat_ptr_inplace_plus_post(_TE1,sizeof(char),
							   1);
	_TE2 = _check_fat_subscript(_T17F,sizeof(char),0U);
	_TE3 = (char *)_TE2;
	{ char _T180 = *_TE3;
	  _TE4 = c;
	  { char _T181 = (char)_TE4;
	    _TE5 = _get_fat_size(_T17F,sizeof(char));
	    if (_TE5 != 1U) { goto _TL9D;
	    }
      ...
      _TEC = (char *)_TEB;
      _TED = buf;
      if (_TEC <= _TED) { goto _TLA3;
      }
      _TEE = &p;
      _fat_ptr_inplace_plus(_TEE,sizeof(char),-1);
      _TEF = p;
      _TF0 = _check_fat_subscript(_TEF,sizeof(char),0U);
      _TF1 = (char *)_TF0;
      _TF2 = *_TF1;
      _TF3 = (int)_TF2;
      _TF4 = fp;
      _IO_ungetc(_TF3,_TF4);
      goto _TLA4;
      _TLA3: _TLA4: goto match_failure;
      _TLA1: _TF5 = p;
      _TF6 = - 1;
      _TF7 = _check_fat_subscript(_TF5,sizeof(char),_TF6);
      _TF8 = (char *)_TF7;
      _TF9 = *_TF8;
      c = (int)_TF9;
      if (c == 120) { goto _TLA7;
      ...
      _TLA7: _TFA = &p;
      _fat_ptr_inplace_plus(_TFA,sizeof(char),-1);
      _IO_ungetc(c,fp);
      goto _TLA6;
      _TLA5: _TLA6: _TFB = flags & 8;
      if (_TFB != 0) { goto _TLA9;
      }
      { unsigned long res;
	{ struct _fat_ptr _T17F = p;
	  _TFC = _T17F.curr;
	  _TFD = (char *)_TFC;
	  { char _T180 = *_TFD;
	    char _T181 = '\000';
	    _TFE = _get_fat_size(_T17F,sizeof(char));
	    if (_TFE != 1U) { goto _TLAB;
	    }
	    if (_T180 != 0) { goto _TLAB;
	    }
	    if (_T181 == 0) { goto _TLAB;
	    }
	    _throw_arraybounds();
	    goto _TLAC;
	    _TLAB: _TLAC: _TFF = _T17F.curr;
	    _T100 = (char *)_TFF;
	    *_T100 = _T181;
	  }
	}_T101 = use_strtoul;
	...
	goto _TLAE;
	_TLAD: _T102 = strtol(buf,0,base);
	res = (unsigned long)_T102;
	...
	*_T107 = (int)_T108;
	...
	_T10B = (void * *)_T10A;
	_T10C = *_T10B;
	_T10D = Cyc_va_arg_short_ptr(_T10C);
	_T10E = res;
	*_T10D = (short)_T10E;
	goto _TLB2;
	...
	_T111 = (void * *)_T110;
	_T112 = *_T111;
	_T113 = Cyc_va_arg_int_ptr(_T112);
	_T114 = res;
	*_T113 = (int)_T114;
	goto _TLB4;
	_TLB3: _T115 = ap;
	...
	_T117 = (void * *)_T116;
	_T118 = *_T117;
	_T119 = Cyc_va_arg_int_ptr(_T118);
	_T11A = res;
	*_T119 = (int)_T11A;
	_TLB4: _TLB2: _TLB0: _T11B = &ap;
	...
	nassigned = nassigned + 1;
      ...
      _T11D = _T11C.curr;
      _T11E = buf;
      _T11F = _tag_fat(_T11E,sizeof(char),351U);
      _T120 = _T11F.curr;
      _T121 = _T11D - _T120;
      _T122 = _T121 / sizeof(char);
      nread = nread + _T122;
      goto _LL47;
    case 4: 
      ...
      _T124 = sizeof(buf);
      _T125 = _T124 - 1U;
      _T126 = (long long)_T125;
      if (_T123 > _T126) { goto _TLB7;
      }else { goto _TLB5;
      }
      _TLB7: _T127 = sizeof(buf);
      _T128 = _T127 - 1U;
      width = (long long)_T128;
      goto _TLB6;
      _TLB5: _TLB6: _T129 = 64 | 128;
      _T12A = _T129 | 256;
      _T12B = _T12A | 512;
      flags = flags | _T12B;
      _T12C = buf;
      p = _tag_fat(_T12C,sizeof(char),351U);
	...
	goto _LL8B;
      ...
      _LL8B: goto _TLBB;
      fok: _T13C = &p;
      { struct _fat_ptr _T17F = _fat_ptr_inplace_plus_post(_T13C,sizeof(char),
							   1);
	_T13D = _check_fat_subscript(_T17F,sizeof(char),0U);
	_T13E = (char *)_T13D;
	{ char _T180 = *_T13E;
	  _T13F = c;
	  { char _T181 = (char)_T13F;
	    _T140 = _get_fat_size(_T17F,sizeof(char));
	    if (_T140 != 1U) { goto _TLC4;
	    }
	    if (_T180 != 0) { goto _TLC4;
	    }
	    if (_T181 == 0) { goto _TLC4;
	    }
	    _throw_arraybounds();
	    goto _TLC5;
	    _TLC4: _TLC5: _T141 = _T17F.curr;
	    _T142 = (char *)_T141;
	    *_T142 = _T181;
	  }
	}
      ...
      _T147 = (char *)_T146;
      _T148 = buf;
      if (_T147 > _T148) { goto _TLCD;
      }else { goto _TLCE;
      }
      _TLCD: _T149 = &p;
      _fat_ptr_inplace_plus(_T149,sizeof(char),-1);
      _T14A = p;
      _T14B = _check_fat_subscript(_T14A,sizeof(char),0U);
      _T14C = (char *)_T14B;
      _T14D = *_T14C;
      _T14E = (int)_T14D;
      _T14F = fp;
      _IO_ungetc(_T14E,_T14F);
      goto _TLCC;
      _TLCE: goto match_failure;
      _TLCA: _T150 = &p;
      _fat_ptr_inplace_plus(_T150,sizeof(char),-1);
      _T151 = p;
      _T152 = _check_fat_subscript(_T151,sizeof(char),0U);
      _T153 = (char *)_T152;
      _T154 = *_T153;
      c = (int)_T154;
      if (c == 101) { goto _TLCF;
      ...
      _IO_ungetc(c,fp);
      _T155 = &p;
      _fat_ptr_inplace_plus(_T155,sizeof(char),-1);
      _T156 = p;
      _T157 = _check_fat_subscript(_T156,sizeof(char),0U);
      _T158 = (char *)_T157;
      _T159 = *_T158;
      c = (int)_T159;
      goto _TLD0;
      ...
      goto _TLC9;
      _TLC8: _TLC9: _T15A = flags & 8;
      if (_T15A != 0) { goto _TLD1;
      }
      { double res;
	{ struct _fat_ptr _T17F = p;
	  _T15B = _check_fat_subscript(_T17F,sizeof(char),0U);
	  _T15C = (char *)_T15B;
	  { char _T180 = *_T15C;
	    char _T181 = '\000';
	    _T15D = _get_fat_size(_T17F,sizeof(char));
	    if (_T15D != 1U) { goto _TLD3;
	    }
	    if (_T180 != 0) { goto _TLD3;
	    }
	    if (_T181 == 0) { goto _TLD3;
	    }
	    _throw_arraybounds();
	    goto _TLD4;
	    _TLD3: _TLD4: _T15E = _T17F.curr;
	    _T15F = (char *)_T15E;
	    *_T15F = _T181;
	  }
	}_T160 = buf;
	_T161 = (const char *)_T160;
	res = atof(_T161);
	if (! (flags & 1)) { goto _TLD5;
	}
	_T162 = ap;
	_T163 = _check_fat_subscript(_T162,sizeof(void *),0U);
	_T164 = (void * *)_T163;
	_T165 = *_T164;
	_T166 = Cyc_va_arg_double_ptr(_T165);
	*_T166 = res;
	goto _TLD6;
	_TLD5: _T167 = ap;
	_T168 = _check_fat_subscript(_T167,sizeof(void *),0U);
	_T169 = (void * *)_T168;
	_T16A = *_T169;
	_T16B = Cyc_va_arg_float_ptr(_T16A);
	_T16C = res;
	*_T16B = (float)_T16C;
	_TLD6: _T16D = &ap;
	...
	nassigned = nassigned + 1;
      ...
      _T16F = _T16E.curr;
      _T170 = buf;
      _T171 = _tag_fat(_T170,sizeof(char),351U);
      _T172 = _T171.curr;
      _T173 = _T16F - _T172;
      _T174 = _T173 / sizeof(char);
      nread = nread + _T174;
      goto _LL47;
    default: 
      { struct Cyc_Core_Impossible_exn_struct * _T17F = _cycalloc(sizeof(struct Cyc_Core_Impossible_exn_struct));
	_T17F->tag = Cyc_Core_Impossible;
	_T17F->f1 = _tag_fat("scanf3",sizeof(char),7U);
	_T175 = (struct Cyc_Core_Impossible_exn_struct *)_T17F;
      }_T176 = (void *)_T175;
      _throw(_T176);
    }
    ...
    nassigned = - 1;
    goto _TLD8;
    _TLD7: _TLD8: control_failure: match_failure: _T177 = errp;
    ...
    *_T179 = *_T179 | 2;
    goto _TLDA;
    _TLD9: _TLDA: done: _T17A = errp;
    _T17B = (unsigned int)_T17A;
    if (! _T17B) { goto _TLDB;
    }
    _T17C = seen_eof;
    if (! _T17C) { goto _TLDB;
