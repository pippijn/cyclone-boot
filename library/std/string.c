...
int Cyc_strcmp(struct _fat_ptr s1,struct _fat_ptr s2) {
  ...
  _TLB: { int i = 0;
	...
	_TL1C: _T2A = s1;
	_T2B = _T2A.curr;
	_T2C = (const char *)_T2B;
	_T2D = _check_null(_T2C);
	_T2E = i;
	_T2F = _T2D[_T2E];
	_T30 = (int)_T2F;
	if (_T30 != 0) { goto _TL20;
	}
	_T29 = 0;
	goto _TL21;
	_TL20: _T29 = 1;
...
struct _fat_ptr Cyc_rexpand(struct _RegionHandle * r,struct _fat_ptr s,unsigned long sz) {
  ...
  _T9 = slen;
  _TA = (int)_T9;
  { struct _fat_ptr _T11 = _fat_ptr_plus(_T8,sizeof(char),_TA);
    _TB = _check_fat_subscript(_T11,sizeof(char),0U);
    _TC = (char *)_TB;
    { char _T12 = *_TC;
      char _T13 = '\000';
      _TD = _get_fat_size(_T11,sizeof(char));
      if (_TD != 1U) { goto _TL9D;
      }
      ...
      _throw_arraybounds();
      goto _TL9E;
      _TL9D: _TL9E: _TE = _T11.curr;
      _TF = (char *)_TE;
      *_TF = _T13;
    }
  }goto _TL9C;
  _TL9B: _TL9C: _T10 = temp;
  return _T10;
}
...
struct _fat_ptr Cyc_strtok(struct _fat_ptr s,struct _fat_ptr delim) {
  ...
  _TL11B: _TL11C: { unsigned long inc = Cyc_strspn(s,delim);
    ...
    _TL123: { struct _fat_ptr _T20 = s;
      _T19 = _check_fat_subscript(_T20,sizeof(char),0U);
      _T1A = (char *)_T19;
      { char _T21 = *_T1A;
	char _T22 = '\000';
