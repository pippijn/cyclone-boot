...
_TL157:{struct Cyc_Core_Invalid_argument_exn_struct*_T16=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T16->tag=Cyc_Core_Invalid_argument;_T16->f1=_tag_fat("memchr",sizeof(char),7U);_T4=(struct Cyc_Core_Invalid_argument_exn_struct*)_T16;}_T5=(void*)_T4;_throw(_T5);goto _TL156;_TL155: _TL156: _T6=s;_T7=_untag_fat_ptr_check_bound(_T6,sizeof(char),1U);_T8=(const char*)_T7;_T9=c;_TA=(int)_T9;_TB=n;{
char*p=memchr(_T8,_TA,_TB);
if(p!=0)goto _TL159;_TC=_tag_fat(0,0,0);return _TC;_TL159: _TD=s;_TE=_untag_fat_ptr(_TD,sizeof(char),1U);_TF=(const char*)_TE;{
...
_TL15D:{struct Cyc_Core_Invalid_argument_exn_struct*_T15=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_T15->tag=Cyc_Core_Invalid_argument;_T15->f1=_tag_fat("mmemchr",sizeof(char),8U);_T4=(struct Cyc_Core_Invalid_argument_exn_struct*)_T15;}_T5=(void*)_T4;_throw(_T5);goto _TL15C;_TL15B: _TL15C: _T6=s;_T7=_untag_fat_ptr_check_bound(_T6,sizeof(char),1U);_T8=(const char*)_T7;_T9=c;_TA=(int)_T9;_TB=n;{
char*p=memchr(_T8,_TA,_TB);
if(p!=0)goto _TL15F;_TC=_tag_fat(0,0,0);return _TC;_TL15F: _TD=s;_TE=_untag_fat_ptr(_TD,sizeof(char),1U);_TF=(const char*)_TE;{
