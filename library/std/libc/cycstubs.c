...
int Cyc_pthread_create(unsigned long * thread,const union Cyc_pthread_attr_t * attr,
 ...
 union _tuple14 {
  ...
  struct _tuple11 _sigfault;
  struct _tuple12 _sigpoll;
  struct _tuple13 _sigsys;
};
 struct _tuple15 {
  int si_signo;
  int si_errno;
  int si_code;
  union _tuple14 _sifields;
};
 union _tuple16 {
  void (* sa_handler)(int);
  void (* sa_sigaction)(int,struct _tuple15 *,void *);
};
 struct Cyc_sigaction {
  union _tuple16 __sigaction_handler;
...
int  __attribute__((cdecl))Cyc_sigaction(int sig,const struct Cyc_sigaction * act,
					 struct Cyc_sigaction * oact) {
  int _T0;
  if (act == 0) { goto _TL17;
  }
 ...
 struct _tuple19 {
  int __count;
  union _tuple18 __value;
};
 struct _tuple20 {
  long __pos;
  struct _tuple19 __state;
};
...
int Cyc_fgetpos(struct Cyc___cycFILE * f,struct _tuple20 * x) {
  struct Cyc___cycFILE * _T0;
  struct __abstractFILE * _T1;
  struct __abstractFILE * _T2;
  struct _tuple20 * _T3;
...
extern unsigned int fread(char *,unsigned int,unsigned int,struct __abstractFILE *);
...
unsigned int Cyc_fread(struct _fat_ptr ptr,unsigned int size,unsigned int nmemb,
...
int Cyc_fsetpos(struct Cyc___cycFILE * f,const struct _tuple20 * b) {
  struct Cyc___cycFILE * _T0;
  struct __abstractFILE * _T1;
  struct __abstractFILE * _T2;
  const struct _tuple20 * _T3;
  int _T4;
  _T0 = f;
  _T1 = _T0->file;
  _T2 = _check_null(_T1);
...
extern unsigned int fwrite(const char *,unsigned int,unsigned int,struct __abstractFILE *);
...
unsigned int Cyc_fwrite(struct _fat_ptr ptr,unsigned int size,unsigned int nmemb,
			struct Cyc___cycFILE * f) {
  struct _fat_ptr _T0;
  unsigned char * _T1;
  unsigned int _T2;
...
extern int __CYCLONE_GETCHAR_UNLOCKED();
int Cyc_getchar_unlocked() {
  int _T0;
  _T0 = __CYCLONE_GETCHAR_UNLOCKED();
  return _T0;
}
...
extern int setvbuf(struct __abstractFILE *,char *,int,unsigned int);
...
int Cyc_setvbuf(struct Cyc___cycFILE * f,struct _fat_ptr buf,int type,unsigned int size) {
  struct _fat_ptr _T0;
  unsigned char * _T1;
  unsigned int _T2;
  struct Cyc_Core_Failure_exn_struct * _T3;
  ...
  _TF = _check_null(_TE);
  _T10 = buf;
  _T11 = _untag_fat_ptr_check_bound(_T10,sizeof(char),1U);
  _T12 = (char *)_T11;
  _T13 = type;
  _T14 = size;
  _T15 = setvbuf(_TF,_T12,_T13,_T14);
  return _T15;
}
...
void Cyc_qsort(struct _fat_ptr tab,unsigned int nmemb,unsigned int szmemb,
...
extern int munmap(const char *,unsigned int);
...
struct _fat_ptr Cyc_mmap(struct _fat_ptr ignored,unsigned int length,int prot,
...
int Cyc_munmap(struct _fat_ptr start,unsigned int length) {
  struct _fat_ptr _T0;
  unsigned char * _T1;
  const char * _T2;
  unsigned int _T3;
...
extern int pselect(int,struct _tuple23 *,struct _tuple23 *,struct _tuple23 *,
		   const struct Cyc_timespec *,const struct _tuple6 *);
extern int * __CYCLONE_ERRNO();
extern int Cyc_pselect(int a,struct _tuple23 * b,struct _tuple23 * c,struct _tuple23 * d,
...
extern int select(int,struct _tuple23 *,struct _tuple23 *,struct _tuple23 *,
		  struct Cyc_timeval *);
extern int Cyc_select(int a,struct _tuple23 * b,struct _tuple23 * c,struct _tuple23 * d,
...
int Cyc_FD_ISSET(int a,struct _tuple23 * b) {
  int _T0;
  if (a < 0) { goto _TL67;
  }else { goto _TL68;
  }
...
int Cyc_accept(int fd,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL6E;
  _TL6D: _TL6E: { struct _tuple25 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_bind(int fd,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL74;
  _TL73: _TL74: { struct _tuple25 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_connect(int fd,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL7A;
  _TL79: _TL7A: { struct _tuple25 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_getpeername(int fd,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL80;
  _TL7F: _TL80: { struct _tuple25 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_getsockname(int fd,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL86;
  _TL85: _TL86: { struct _tuple25 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_getsockopt(int fd,int level,int optname,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL8C;
  _TL8B: _TL8C: { struct _tuple25 _T2F;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
extern int recv_wrapped(int,struct _fat_ptr,unsigned int,int);
int Cyc_recv(int fd,struct _fat_ptr buf,unsigned int n,int flags) {
  int _T0;
  _T0 = recv_wrapped(fd,buf,n,flags);
  return _T0;
}
extern int recvfrom_in(int,struct _fat_ptr,unsigned int,int,const struct Cyc_sockaddr_in *,
		       unsigned int *);
int Cyc_recvfrom(int fd,struct _fat_ptr buf,unsigned int n,int flags,struct _fat_ptr ap) {
  struct _fat_ptr _T0;
  unsigned int _T1;
  struct Cyc_SocketError_exn_struct * _T2;
  struct Cyc_SocketError_exn_struct * _T3;
  ...
  _throw(_T3);
  goto _TL91;
  _TL90: _TL91: { struct _tuple25 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
extern int send_wrapped(int,struct _fat_ptr,unsigned int,int);
int Cyc_send(int fd,struct _fat_ptr buf,unsigned int n,int flags) {
  int _T0;
  _T0 = send_wrapped(fd,buf,n,flags);
  return _T0;
}
extern int sendto_in(int,struct _fat_ptr,unsigned int,int,const struct Cyc_sockaddr_in *,
		     unsigned int);
int Cyc_sendto(int fd,struct _fat_ptr buf,unsigned int n,int flags,struct _fat_ptr ap) {
  struct _fat_ptr _T0;
  unsigned int _T1;
  struct Cyc_SocketError_exn_struct * _T2;
  struct Cyc_SocketError_exn_struct * _T3;
  ...
  _throw(_T3);
  goto _TL97;
  _TL96: _TL97: { struct _tuple25 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_setsockopt(int fd,int level,int optname,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL9D;
  _TL9C: _TL9D: { struct _tuple25 _T23;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
extern unsigned int strftime(char *,unsigned int,const char *,const struct Cyc_tm *);
...
unsigned int Cyc_strftime(struct _fat_ptr s,unsigned int maxsize,struct _fat_ptr fmt,
...
struct _fat_ptr Cyc_getcwd(struct _fat_ptr buf,unsigned int size) {
  struct _fat_ptr _T0;
  unsigned int _T1;
  unsigned int _T2;
  struct Cyc_Core_Failure_exn_struct * _T3;
...
int Cyc_gethostname(struct _fat_ptr buf,unsigned int count) {
  struct _fat_ptr _T0;
  unsigned char * _T1;
  unsigned int _T2;
  struct Cyc_Core_Failure_exn_struct * _T3;
...
int Cyc_read(int fd,struct _fat_ptr buf,unsigned int count) {
  unsigned int _T0;
  struct _fat_ptr _T1;
  unsigned int _T2;
  struct Cyc_Core_Failure_exn_struct * _T3;
...
int Cyc_write(int fd,struct _fat_ptr buf,unsigned int count) {
  unsigned int _T0;
  struct _fat_ptr _T1;
  unsigned int _T2;
  struct Cyc_Core_Failure_exn_struct * _T3;
