...
# 183
if(_T1!=0)goto _TL11;_T2=tbl;_T3=cmp;_T4=hash;
*_T2=Cyc_Hashtable_create(101,_T3,_T4);goto _TL12;_TL11: _TL12: _T5=tbl;_T6=*_T5;
return _T6;}
# 189
...
# 195
if(i >= 0)goto _TL13;{struct Cyc_Core_Failure_exn_struct*_T59=_cycalloc(sizeof(struct Cyc_Core_Failure_exn_struct));_T59->tag=Cyc_Core_Failure;
_T59->f1=_tag_fat("nlblanks",sizeof(char),9U);_T5=(struct Cyc_Core_Failure_exn_struct*)_T59;}_T6=(void*)_T5;_throw(_T6);goto _TL14;_TL13: _TL14: {struct _handler_cons _T59;_T7=& _T59;_push_handler(_T7);{int _T5A=0;_T8=setjmp(_T59.handler);if(!_T8)goto _TL15;_T5A=1;goto _TL16;_TL15: _TL16: if(_T5A)goto _TL17;else{goto _TL19;}_TL19: _TA=Cyc_Hashtable_lookup;{
# 198
struct _fat_ptr*(*_T5B)(struct Cyc_Hashtable_Table*,int)=(struct _fat_ptr*(*)(struct Cyc_Hashtable_Table*,int))_TA;_T9=_T5B;}_TB=_T9(t,i);{struct _fat_ptr _T5B=*_TB;_npop_handler(0);return _T5B;}_pop_handler();goto _TL18;_TL17: _TC=Cyc_Core_get_exn_thrown();{void*_T5B=(void*)_TC;void*_T5C;_TD=(struct Cyc_Core_Not_found_exn_struct*)_T5B;_TE=_TD->tag;_TF=Cyc_Core_Not_found;if(_TE!=_TF)goto _TL1A;_T10=Cyc_PP_tex_output;
# 202
if(_T10)goto _TL1C;else{goto _TL1E;}
# 204
...
struct _fat_ptr nlb=Cyc_Core_new_string(_T14);_T15=nlb;{struct _fat_ptr _T5D=_fat_ptr_plus(_T15,sizeof(char),0);_T16=_check_fat_subscript(_T5D,sizeof(char),0U);_T17=(char*)_T16;{char _T5E=*_T17;char _T5F='\n';_T18=_get_fat_size(_T5D,sizeof(char));if(_T18!=1U)goto _TL1F;if(_T5E!=0)goto _TL1F;if(_T5F==0)goto _TL1F;_throw_arraybounds();goto _TL20;_TL1F: _TL20: _T19=_T5D.curr;_T1A=(char*)_T19;*_T1A=_T5F;}}{
# 209
int j=0;_TL24: if(j < num_tabs)goto _TL22;else{goto _TL23;}
_TL22: _T1B=nlb;_T1C=j + 1;{struct _fat_ptr _T5D=_fat_ptr_plus(_T1B,sizeof(char),_T1C);_T1D=_check_fat_subscript(_T5D,sizeof(char),0U);_T1E=(char*)_T1D;{char _T5E=*_T1E;char _T5F='\t';_T1F=_get_fat_size(_T5D,sizeof(char));if(_T1F!=1U)goto _TL25;if(_T5E!=0)goto _TL25;if(_T5F==0)goto _TL25;_throw_arraybounds();goto _TL26;_TL25: _TL26: _T20=_T5D.curr;_T21=(char*)_T20;*_T21=_T5F;}}
# 209
j=j + 1;goto _TL24;_TL23:;}{
# 211
int j=0;_TL2A: if(j < num_spaces)goto _TL28;else{goto _TL29;}
_TL28: _T22=nlb;_T23=j + 1;_T24=num_tabs;_T25=_T23 + _T24;{struct _fat_ptr _T5D=_fat_ptr_plus(_T22,sizeof(char),_T25);_T26=_check_fat_subscript(_T5D,sizeof(char),0U);_T27=(char*)_T26;{char _T5E=*_T27;char _T5F=' ';_T28=_get_fat_size(_T5D,sizeof(char));if(_T28!=1U)goto _TL2B;if(_T5E!=0)goto _TL2B;if(_T5F==0)goto _TL2B;_throw_arraybounds();goto _TL2C;_TL2B: _TL2C: _T29=_T5D.curr;_T2A=(char*)_T29;*_T2A=_T5F;}}
# 211
j=j + 1;goto _TL2A;_TL29:;}_T2C=Cyc_Hashtable_insert;{
# 213
...
return _T33;}}}
# 220
_TL1C:{int total=3 + i;_T34=total + 1;_T35=(unsigned)_T34;{
struct _fat_ptr nlb=Cyc_Core_new_string(_T35);_T36=nlb;{struct _fat_ptr _T5D=_fat_ptr_plus(_T36,sizeof(char),0);_T37=_T5D.curr;_T38=(char*)_T37;_T39=_check_null(_T38);{char _T5E=*_T39;char _T5F='\\';_T3A=_get_fat_size(_T5D,sizeof(char));if(_T3A!=1U)goto _TL2D;if(_T5E!=0)goto _TL2D;if(_T5F==0)goto _TL2D;_throw_arraybounds();goto _TL2E;_TL2D: _TL2E: _T3B=_T5D.curr;_T3C=(char*)_T3B;*_T3C=_T5F;}}_T3D=nlb;{struct _fat_ptr _T5D=_fat_ptr_plus(_T3D,sizeof(char),1);_T3E=_T5D.curr;_T3F=(char*)_T3E;{char _T5E=*_T3F;char _T5F='\\';_T40=_get_fat_size(_T5D,sizeof(char));if(_T40!=1U)goto _TL2F;if(_T5E!=0)goto _TL2F;if(_T5F==0)goto _TL2F;_throw_arraybounds();goto _TL30;_TL2F: _TL30: _T41=_T5D.curr;_T42=(char*)_T41;*_T42=_T5F;}}_T43=nlb;{struct _fat_ptr _T5D=_fat_ptr_plus(_T43,sizeof(char),2);_T44=_T5D.curr;_T45=(char*)_T44;{char _T5E=*_T45;char _T5F='\n';_T46=_get_fat_size(_T5D,sizeof(char));if(_T46!=1U)goto _TL31;if(_T5E!=0)goto _TL31;if(_T5F==0)goto _TL31;_throw_arraybounds();goto _TL32;_TL31: _TL32: _T47=_T5D.curr;_T48=(char*)_T47;*_T48=_T5F;}}{
# 225
int j=3;_TL36: if(j < total)goto _TL34;else{goto _TL35;}
_TL34: _T49=nlb;_T4A=j;{struct _fat_ptr _T5D=_fat_ptr_plus(_T49,sizeof(char),_T4A);_T4B=_T5D.curr;_T4C=(char*)_T4B;{char _T5E=*_T4C;char _T5F='~';_T4D=_get_fat_size(_T5D,sizeof(char));if(_T4D!=1U)goto _TL37;if(_T5E!=0)goto _TL37;if(_T5F==0)goto _TL37;_throw_arraybounds();goto _TL38;_TL37: _TL38: _T4E=_T5D.curr;_T4F=(char*)_T4E;*_T4F=_T5F;}}
# 225
j=j + 1;goto _TL36;_TL35:;}_T51=Cyc_Hashtable_insert;{
# 227
...
return _T58;}}_TL1A: _T5C=_T5B;{void*exn=_T5C;_rethrow(exn);};}_TL18:;}}}}
# 233
...
# 265
struct _fat_ptr*p;p=_cycalloc(sizeof(struct _fat_ptr));_T4=p;*_T4=s;{struct _handler_cons _T10;_T5=& _T10;_push_handler(_T5);{int _T11=0;_T6=setjmp(_T10.handler);if(!_T6)goto _TL39;_T11=1;goto _TL3A;_TL39: _TL3A: if(_T11)goto _TL3B;else{goto _TL3D;}_TL3D: _T8=Cyc_Hashtable_lookup;{
# 268
struct Cyc_PP_Doc*(*_T12)(struct Cyc_Hashtable_Table*,struct _fat_ptr*)=(struct Cyc_PP_Doc*(*)(struct Cyc_Hashtable_Table*,struct _fat_ptr*))_T8;_T7=_T12;}{struct Cyc_PP_Doc*_T12=_T7(t,p);_npop_handler(0);return _T12;}_pop_handler();goto _TL3C;_TL3B: _T9=Cyc_Core_get_exn_thrown();{void*_T12=(void*)_T9;void*_T13;_TA=(struct Cyc_Core_Not_found_exn_struct*)_T12;_TB=_TA->tag;_TC=Cyc_Core_Not_found;if(_TB!=_TC)goto _TL3E;{
# 272
...
return _TF;}_TL3E: _T13=_T12;{void*exn=_T13;_rethrow(exn);};}_TL3C:;}}}}
# 278
...
# 323
if(Cyc_PP_nil_doc_opt!=0)goto _TL47;_T0=
_tag_fat("",sizeof(char),1U);Cyc_PP_nil_doc_opt=Cyc_PP_text(_T0);goto _TL48;_TL47: _TL48: _T1=Cyc_PP_nil_doc_opt;
return _T1;}
# 329
...
if(blank_doc_opt!=0)goto _TL49;_T0=
_tag_fat(" ",sizeof(char),2U);blank_doc_opt=Cyc_PP_text(_T0);goto _TL4A;_TL49: _TL4A: _T1=blank_doc_opt;
...
if(line_doc_opt!=0)goto _TL4B;{struct Cyc_PP_Doc*_T4=_cycalloc(sizeof(struct Cyc_PP_Doc));
_T4->mwo=0;_T4->mw=0;_T2=Cyc_Fn_fp2fn;{struct Cyc_Fn_Function*(*_T5)(struct Cyc_PP_Out*(*)(struct Cyc_PP_Ppstate*))=(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct Cyc_PP_Ppstate*)))_T2;_T1=_T5;}_T4->f=_T1(Cyc_PP_line_f);_T0=(struct Cyc_PP_Doc*)_T4;}line_doc_opt=_T0;goto _TL4C;_TL4B: _TL4C: _T3=line_doc_opt;
...
# 383
if(k < 0)goto _TL4D;goto _TL4E;_TL4D: _throw_assert();_TL4E: {
...
# 406
if(x > y)goto _TL4F;_T0=x;
return _T0;
# 409
_TL4F: _T1=y;return _T1;}
# 412
int Cyc_PP_max(int x,int y){int _T0;int _T1;
# 415
if(x < y)goto _TL51;_T0=x;
return _T0;
# 418
_TL51: _T1=y;return _T1;}struct _tuple6{struct Cyc_PP_Doc*f0;struct Cyc_PP_Doc*f1;};
# 421
...
# 425
if(d1==Cyc_PP_nil_doc_opt)goto _TL53;goto _TL54;_TL53: _throw_assert();_TL54:
 if(d2==Cyc_PP_nil_doc_opt)goto _TL55;goto _TL56;_TL55: _throw_assert();_TL56: _T1=st;_T2=_T1->pw;_T3=d2;_T4=_T3->mw;_T5=_T2 - _T4;_T6=st;_T7=_T6->epw;_T8=d1;_T9=_T8->mwo;_TA=_T7 - _T9;{
# 428
...
# 443
if(d1!=Cyc_PP_nil_doc_opt)goto _TL57;_T0=d2;
return _T0;_TL57:
 if(d2!=Cyc_PP_nil_doc_opt)goto _TL59;_T1=d1;
return _T1;_TL59:{struct Cyc_PP_Doc*_T14=_cycalloc(sizeof(struct Cyc_PP_Doc));_T3=d1;_T4=_T3->mw;_T5=d1;_T6=_T5->mwo;_T7=d2;_T8=_T7->mwo;_T9=_T6 + _T8;
...
# 457
_get_fat_size(_T0,sizeof(struct Cyc_PP_Doc*));_T2=_T1 - 1U;{int i=(int)_T2;_TL5E: if(i >= 0)goto _TL5C;else{goto _TL5D;}
_TL5C: _T3=l;_T4=_T3.curr;_T5=(struct Cyc_PP_Doc**)_T4;_T6=_check_null(_T5);_T7=i;_T8=_T6[_T7];_T9=d;d=Cyc_PP_concat(_T8,_T9);
# 457
i=i + -1;goto _TL5E;_TL5D:;}_TA=d;
# 459
return _TA;}
# 464
...
struct Cyc_List_List*ds=ds0;_TL62: if(ds!=0)goto _TL60;else{goto _TL61;}
# 470
_TL60: _T0=ds;_T1=_T0->hd;{struct Cyc_PP_Doc*d=(struct Cyc_PP_Doc*)_T1;
if(d!=Cyc_PP_nil_doc_opt)goto _TL63;goto _TL5F;_TL63: _T3=Cyc_Fn_apply;{
# 474
...
_T28->hd=o;_T28->tl=os;_T10=(struct Cyc_List_List*)_T28;}os=_T10;}}_TL5F: _T11=ds;
# 468
ds=_T11->tl;goto _TL62;_TL61:;}_T12=
# 479
...
# 485
_TL68: if(os!=0)goto _TL66;else{goto _TL67;}
# 487
_TL66: _T1C=os;_T1D=_T1C->hd;_T1E=(struct Cyc_PP_Out*)_T1D;_T1F=_T1E->ppout;_T20=s;s=Cyc_PP_append(_T1F,_T20);_T21=os;_T22=_T21->hd;_T23=(struct Cyc_PP_Out*)_T22;_T24=_T23->links;_T25=links;
links=Cyc_PP_append(_T24,_T25);_T26=os;
# 485
os=_T26->tl;goto _TL68;_TL67:{struct Cyc_PP_Out*_T28=_cycalloc(sizeof(struct Cyc_PP_Out));
# 491
...
int mwo=_T4->mw;{
# 506
struct Cyc_List_List*ds=doclist;_TL6C: if(ds!=0)goto _TL6A;else{goto _TL6B;}
# 508
_TL6A: _T5=mw;_T6=mwo;_T7=ds;_T8=_T7->hd;_T9=(struct Cyc_PP_Doc*)_T8;_TA=_T9->mwo;_TB=_T6 + _TA;{int mw2=Cyc_PP_min(_T5,_TB);_TC=mw;_TD=mwo;_TE=ds;_TF=_TE->hd;_T10=(struct Cyc_PP_Doc*)_TF;_T11=_T10->mw;_T12=_TD + _T11;{
int mwo2=Cyc_PP_min(_TC,_T12);
mw=mw2;
mwo=mwo2;}}_T13=ds;
# 506
ds=_T13->tl;goto _TL6C;_TL6B:;}{struct Cyc_PP_Doc*_T18=_cycalloc(sizeof(struct Cyc_PP_Doc));
# 514
...
# 520
if(doclist!=0)goto _TL6D;_T0=
Cyc_PP_nil_doc();return _T0;
_TL6D: _T1=doclist;_T2=_T1->tl;if(_T2!=0)goto _TL6F;_T3=doclist;_T4=_T3->hd;_T5=(struct Cyc_PP_Doc*)_T4;
return _T5;
# 525
_TL6F: _T6=Cyc_List_length(doclist);if(_T6 <= 30)goto _TL71;_T7=
Cyc_PP_long_cats(doclist);return _T7;
# 528
_TL71: _T8=doclist;_T9=_T8->hd;_TA=(struct Cyc_PP_Doc*)_T9;_TB=doclist;_TC=_TB->tl;_TD=Cyc_PP_cats(_TC);_TE=Cyc_PP_concat(_TA,_TD);return _TE;}
# 531
...
int i=0;_TL76: if(i < sz)goto _TL74;else{goto _TL75;}
# 540
_TL74: _T3=docs;_T4=_T3.curr;_T5=(struct Cyc_PP_Doc**)_T4;_T6=_check_null(_T5);_T7=i;{struct Cyc_PP_Doc*d=_T6[_T7];
if(d==Cyc_PP_nil_doc_opt)goto _TL77;goto _TL78;_TL77: _throw_assert();_TL78: _T9=Cyc_Fn_apply;{
...
# 553
_TL7C: if(os!=0)goto _TL7A;else{goto _TL7B;}
# 555
_TL7A: _T21=os;_T22=_T21->hd;_T23=(struct Cyc_PP_Out*)_T22;_T24=_T23->ppout;_T25=s;s=Cyc_PP_append(_T24,_T25);_T26=os;_T27=_T26->hd;_T28=(struct Cyc_PP_Out*)_T27;_T29=_T28->links;_T2A=links;
links=Cyc_PP_append(_T29,_T2A);_T2B=os;
# 553
os=_T2B->tl;goto _TL7C;_TL7B:{struct Cyc_PP_Out*_T2D=_cycalloc(sizeof(struct Cyc_PP_Out));
# 559
...
# 568
if(sz!=0U)goto _TL7D;{struct Cyc_Core_Failure_exn_struct*_T23=_cycalloc(sizeof(struct Cyc_Core_Failure_exn_struct));_T23->tag=Cyc_Core_Failure;
_T23->f1=_tag_fat("cats_arr -- size zero array",sizeof(char),28U);_T1=(struct Cyc_Core_Failure_exn_struct*)_T23;}_T2=(void*)_T1;_throw(_T2);goto _TL7E;_TL7D: _TL7E: _T3=docs;_T4=_T3.curr;_T5=(struct Cyc_PP_Doc**)_T4;_T6=
_check_null(_T5);{struct Cyc_PP_Doc*d=_T6[0];_T7=d;{
int mw=_T7->mw;_T8=d;{
int mwo=_T8->mw;{
unsigned long i=1U;_TL82: if(i < sz)goto _TL80;else{goto _TL81;}
# 575
_TL80: _T9=mw;_TA=mwo;_TB=docs;_TC=_TB.curr;_TD=(struct Cyc_PP_Doc**)_TC;_TE=i;_TF=(int)_TE;_T10=_TD[_TF];_T11=_T10->mwo;_T12=_TA + _T11;{int mw2=Cyc_PP_min(_T9,_T12);_T13=mw;_T14=mwo;_T15=docs;_T16=_T15.curr;_T17=(struct Cyc_PP_Doc**)_T16;_T18=i;_T19=(int)_T18;_T1A=_T17[_T19];_T1B=_T1A->mw;_T1C=_T14 + _T1B;{
int mwo2=Cyc_PP_min(_T13,_T1C);
mw=mw2;
mwo=mwo2;}}
# 573
i=i + 1;goto _TL82;_TL81:;}{struct Cyc_PP_Doc*_T23=_cycalloc(sizeof(struct Cyc_PP_Doc));
# 580
...
# 588
if(_T6 > _T8)goto _TL83;_T1=1;goto _TL84;_TL83: _T9=st;_TA=_T9->cc;_TB=d;_TC=_TB->mw;_TD=_TA + _TC;_TE=st;_TF=_TE->pw;_T1=_TD <= _TF;_TL84: {int dfits=_T1;_T10=dfits;
# 590
if(!_T10)goto _TL85;_T12=Cyc_Fn_apply;{
...
# 593
_TL85: _T18=Cyc_Fn_apply;{struct Cyc_PP_Out*(*_T1F)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*)=(struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*))_T18;_T17=_T1F;}_T19=d2;_T1A=_T19->f;_T1B=st;_T1C=_T17(_T1A,_T1B);return _T1C;}}}
# 596
...
# 636
if(l!=0)goto _TL87;_T0=
Cyc_PP_nil_doc();return _T0;
_TL87: _T1=l;_T2=_T1->tl;if(_T2!=0)goto _TL89;_T3=l;_T4=_T3->hd;_T5=
pp(_T4);return _T5;
# 641
_TL89:{struct Cyc_PP_Doc*_TE[4];_T7=l;_T8=_T7->hd;_TE[0]=pp(_T8);_TE[1]=Cyc_PP_text(sep);_TE[2]=Cyc_PP_oline_doc();_T9=pp;_TA=sep;_TB=l;_TC=_TB->tl;_TE[3]=Cyc_PP_ppseq_f(_T9,_TA,_TC);_TD=_tag_fat(_TE,sizeof(struct Cyc_PP_Doc*),4);_T6=Cyc_PP_cat(_TD);}return _T6;}
# 644
...
Cyc_PP_nil_doc();return _T0;
_TL8B: _T1=l;_T2=_T1->tl;if(_T2!=0)goto _TL8D;_T3=l;_T4=_T3->hd;_T5=(struct Cyc_PP_Doc*)_T4;
return _T5;
# 660
_TL8D: {struct Cyc_PP_Doc*sep2=Cyc_PP_text(sep);
struct Cyc_PP_Doc*oline=Cyc_PP_oline_doc();
struct Cyc_List_List*x=l;
_TL8F: _T6=_check_null(x);_T7=_T6->tl;if(_T7!=0)goto _TL90;else{goto _TL91;}
# 665
_TL90: _T8=x;{struct Cyc_List_List*temp=_T8->tl;_T9=x;{struct Cyc_List_List*_TD=_cycalloc(sizeof(struct Cyc_List_List));
...
# 690
if(l!=0)goto _TL92;_T0=
Cyc_PP_nil_doc();return _T0;
_TL92: _T1=l;_T2=_T1->tl;if(_T2!=0)goto _TL94;_T3=l;_T4=_T3->hd;_T5=
pp(_T4);return _T5;
# 695
_TL94:{struct Cyc_PP_Doc*_TE[4];_T7=l;_T8=_T7->hd;_TE[0]=pp(_T8);_TE[1]=Cyc_PP_text(sep);_TE[2]=Cyc_PP_line_doc();_T9=pp;_TA=sep;_TB=l;_TC=_TB->tl;_TE[3]=Cyc_PP_ppseql_f(_T9,_TA,_TC);_TD=_tag_fat(_TE,sizeof(struct Cyc_PP_Doc*),4);_T6=Cyc_PP_cat(_TD);}return _T6;}
# 698
...
Cyc_PP_nil_doc();return _T0;
_TL96: _T1=l;_T2=_T1->tl;if(_T2!=0)goto _TL98;_T3=l;_T4=_T3->hd;_T5=(struct Cyc_PP_Doc*)_T4;
return _T5;
# 713
_TL98:{struct Cyc_PP_Doc*_TD[4];_T7=l;_T8=_T7->hd;_TD[0]=(struct Cyc_PP_Doc*)_T8;_TD[1]=Cyc_PP_text(sep);_TD[2]=Cyc_PP_line_doc();_T9=sep;_TA=l;_TB=_TA->tl;_TD[3]=Cyc_PP_seql_f(_T9,_TB);_TC=_tag_fat(_TD,sizeof(struct Cyc_PP_Doc*),4);_T6=Cyc_PP_cat(_TC);}return _T6;}
# 716
...
# 735
if(ss!=0)goto _TL9A;_T0=
Cyc_PP_nil_doc();return _T0;
# 738
_TL9A:{struct Cyc_PP_Doc*_T3[3];_T3[0]=Cyc_PP_text(start);
