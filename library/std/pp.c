...
struct Cyc_Hashtable_Table*(*_T63)(int,int(*)(int,int),int(*)(int))=(struct Cyc_Hashtable_Table*(*)(int,int(*)(int,int),int(*)(int)))_T2;_T1=_T63;}_T3=Cyc_Core_intcmp;_T5=Cyc_Core_identity;{int(*_T63)(int)=(int(*)(int))_T5;_T4=_T63;}_T62->v=_T1(61,_T3,_T4);_T0=(struct Cyc_Core_Opt*)_T62;}Cyc_PP_bhashtbl=_T0;goto _TLC;_TLB: _TLC:
 if(i >= 0)goto _TLD;{struct Cyc_Core_Failure_exn_struct*_T62=_cycalloc(sizeof(struct Cyc_Core_Failure_exn_struct));_T62->tag=Cyc_Core_Failure;
_T62->f1=_tag_fat("nlblanks",sizeof(char),9U);_T6=(struct Cyc_Core_Failure_exn_struct*)_T62;}_T7=(void*)_T6;_throw(_T7);goto _TLE;_TLD: _TLE: {struct _handler_cons _T62;_T8=& _T62;_push_handler(_T8);{int _T63=0;_T9=setjmp(_T62.handler);if(!_T9)goto _TLF;_T63=1;goto _TL10;_TLF: _TL10: if(_T63)goto _TL11;else{goto _TL13;}_TL13: _TB=Cyc_Hashtable_lookup;{
# 185
...
_TL2E: _T50=nlb;_T51=j;{struct _fat_ptr _T66=_fat_ptr_plus(_T50,sizeof(char),_T51);_T52=_T66.curr;_T53=(char*)_T52;{char _T67=*_T53;char _T68='~';_T54=_get_fat_size(_T66,sizeof(char));if(_T54!=1U)goto _TL31;if(_T67!=0)goto _TL31;if(_T68==0)goto _TL31;_throw_arraybounds();goto _TL32;_TL31: _TL32: _T55=_T66.curr;_T56=(char*)_T55;*_T56=_T68;}}
# 212
...
# 249
static struct Cyc_Core_Opt*str_hashtbl=0;
# 251
struct Cyc_Hashtable_Table*t;
if(str_hashtbl!=0)goto _TL33;_T1=Cyc_Hashtable_create;{
# 254
...
_T17->v=t;_T4=(struct Cyc_Core_Opt*)_T17;}str_hashtbl=_T4;goto _TL34;
# 258
_TL33: _T5=str_hashtbl;_T6=_T5->v;t=(struct Cyc_Hashtable_Table*)_T6;_TL34: {struct _handler_cons _T17;_T7=& _T17;_push_handler(_T7);{int _T18=0;_T8=setjmp(_T17.handler);if(!_T8)goto _TL35;_T18=1;goto _TL36;_TL35: _TL36: if(_T18)goto _TL37;else{goto _TL39;}_TL39: _TA=Cyc_Hashtable_lookup;{
# 260
...
# 291
static struct Cyc_Core_Opt*str_hashtbl2=0;
# 293
struct Cyc_Hashtable_Table*t;
if(str_hashtbl2!=0)goto _TL3C;_T1=Cyc_Hashtable_create;{
# 296
struct Cyc_Hashtable_Table*(*_T17)(int,int(*)(struct _fat_ptr*,struct _fat_ptr*),int(*)(struct _fat_ptr*))=(struct Cyc_Hashtable_Table*(*)(int,int(*)(struct _fat_ptr*,struct _fat_ptr*),int(*)(struct _fat_ptr*)))_T1;_T0=_T17;}_T2=Cyc_zstrptrcmp;_T3=Cyc_Hashtable_hash_stringptr;t=_T0(101,_T2,_T3);{struct Cyc_Core_Opt*_T17=_cycalloc(sizeof(struct Cyc_Core_Opt));
_T17->v=t;_T4=(struct Cyc_Core_Opt*)_T17;}str_hashtbl2=_T4;goto _TL3D;
# 300
_TL3C: _T5=str_hashtbl2;_T6=_T5->v;t=(struct Cyc_Hashtable_Table*)_T6;_TL3D: {struct _handler_cons _T17;_T7=& _T17;_push_handler(_T7);{int _T18=0;_T8=setjmp(_T17.handler);if(!_T8)goto _TL3E;_T18=1;goto _TL3F;_TL3E: _TL3F: if(_T18)goto _TL40;else{goto _TL42;}_TL42: _TA=Cyc_Hashtable_lookup;{
# 302
...
# 317
static struct Cyc_Core_Opt*nil_doc_opt=0;
if(nil_doc_opt!=0)goto _TL45;{struct Cyc_Core_Opt*_T5=_cycalloc(sizeof(struct Cyc_Core_Opt));_T1=
_tag_fat("",sizeof(char),1U);_T5->v=Cyc_PP_text(_T1);_T0=(struct Cyc_Core_Opt*)_T5;}nil_doc_opt=_T0;goto _TL46;_TL45: _TL46: _T2=nil_doc_opt;_T3=_T2->v;_T4=(struct Cyc_PP_Doc*)_T3;
return _T4;}
# 324
...
# 327
static struct Cyc_Core_Opt*blank_doc_opt=0;
if(blank_doc_opt!=0)goto _TL47;{struct Cyc_Core_Opt*_T5=_cycalloc(sizeof(struct Cyc_Core_Opt));_T1=
_tag_fat(" ",sizeof(char),2U);_T5->v=Cyc_PP_text(_T1);_T0=(struct Cyc_Core_Opt*)_T5;}blank_doc_opt=_T0;goto _TL48;_TL47: _TL48: _T2=blank_doc_opt;_T3=_T2->v;_T4=(struct Cyc_PP_Doc*)_T3;
...
# 366
static struct Cyc_Core_Opt*line_doc_opt=0;
if(line_doc_opt!=0)goto _TL49;{struct Cyc_Core_Opt*_T7=_cycalloc(sizeof(struct Cyc_Core_Opt));{struct Cyc_PP_Doc*_T8=_cycalloc(sizeof(struct Cyc_PP_Doc));
_T8->mwo=0;_T8->mw=0;_T3=Cyc_Fn_fp2fn;{struct Cyc_Fn_Function*(*_T9)(struct Cyc_PP_Out*(*)(struct Cyc_PP_Ppstate*))=(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct Cyc_PP_Ppstate*)))_T3;_T2=_T9;}_T8->f=_T2(Cyc_PP_line_f);_T1=(struct Cyc_PP_Doc*)_T8;}_T7->v=_T1;_T0=(struct Cyc_Core_Opt*)_T7;}line_doc_opt=_T0;goto _TL4A;_TL49: _TL4A: _T4=line_doc_opt;_T5=_T4->v;_T6=(struct Cyc_PP_Doc*)_T5;
...
_TL50: _T3=l;_T4=_T3.curr;_T5=(struct Cyc_PP_Doc**)_T4;_T6=_check_null(_T5);_T7=i;_T8=_T6[_T7];_T9=d;d=Cyc_PP_concat(_T8,_T9);
# 442
i=i + -1;goto _TL52;_TL51:;}_TA=d;
# 444
return _TA;}
# 449
...
# 497
if(doclist!=0)goto _TL5F;_T0=
Cyc_PP_nil_doc();return _T0;
_TL5F: _T1=doclist;_T2=_T1->tl;if(_T2!=0)goto _TL61;_T3=doclist;_T4=_T3->hd;_T5=(struct Cyc_PP_Doc*)_T4;
return _T5;
# 502
_TL61: _T6=Cyc_List_length(doclist);if(_T6 <= 30)goto _TL63;_T7=
...
# 516
_TL66: _T3=docs;_T4=_T3.curr;_T5=(struct Cyc_PP_Doc**)_T4;_T6=_check_null(_T5);_T7=i;{struct Cyc_PP_Doc*d=_T6[_T7];_T9=Cyc_Fn_apply;{
...
# 527
_TL6A: _T21=os;_T22=_T21->hd;_T23=(struct Cyc_PP_Out*)_T22;_T24=_T23->ppout;_T25=s;s=Cyc_PP_append(_T24,_T25);_T26=os;_T27=_T26->hd;_T28=(struct Cyc_PP_Out*)_T27;_T29=_T28->links;_T2A=links;
links=Cyc_PP_append(_T29,_T2A);_T2B=os;
# 525
os=_T2B->tl;goto _TL6C;_TL6B:{struct Cyc_PP_Out*_T2D=_cycalloc(sizeof(struct Cyc_PP_Out));
# 530
_T2D->newcc=newcc;_T2D->newcl=newcl;_T2D->ppout=s;_T2D->links=links;_T2C=(struct Cyc_PP_Out*)_T2D;}return _T2C;}}}}}}}
# 534
struct Cyc_PP_Doc*Cyc_PP_cats_arr(struct _fat_ptr docs){struct _fat_ptr _T0;unsigned _T1;struct Cyc_Core_Failure_exn_struct*_T2;void*_T3;struct _fat_ptr _T4;unsigned char*_T5;struct Cyc_PP_Doc**_T6;struct Cyc_PP_Doc**_T7;struct Cyc_PP_Doc*_T8;struct Cyc_PP_Doc*_T9;int _TA;int _TB;struct _fat_ptr _TC;unsigned char*_TD;struct Cyc_PP_Doc**_TE;int _TF;struct Cyc_PP_Doc*_T10;int _T11;int _T12;int _T13;int _T14;struct _fat_ptr _T15;unsigned char*_T16;struct Cyc_PP_Doc**_T17;int _T18;struct Cyc_PP_Doc*_T19;int _T1A;int _T1B;struct Cyc_PP_Doc*_T1C;struct Cyc_Fn_Function*(*_T1D)(struct Cyc_PP_Out*(*)(struct _fat_ptr*,struct Cyc_PP_Ppstate*),struct _fat_ptr*);struct Cyc_Fn_Function*(*_T1E)(void*(*)(void*,void*),void*);struct _fat_ptr*_T1F;struct _fat_ptr*_T20;unsigned _T21;_T0=docs;_T1=
# 537
...
# 546
_TL70: _TA=mw;_TB=mwo;_TC=docs;_TD=_TC.curr;_TE=(struct Cyc_PP_Doc**)_TD;_TF=i;_T10=_TE[_TF];_T11=_T10->mwo;_T12=_TB + _T11;{int mw2=Cyc_PP_min(_TA,_T12);_T13=mw;_T14=mwo;_T15=docs;_T16=_T15.curr;_T17=(struct Cyc_PP_Doc**)_T16;_T18=i;_T19=_T17[_T18];_T1A=_T19->mw;_T1B=_T14 + _T1A;{
...
# 561
if(!_T10)goto _TL75;_T12=Cyc_Fn_apply;{
...
# 607
if(l!=0)goto _TL77;_T0=
Cyc_PP_nil_doc();return _T0;
_TL77: _T1=l;_T2=_T1->tl;if(_T2!=0)goto _TL79;_T3=l;_T4=_T3->hd;_T5=
pp(_T4);return _T5;
# 612
...
# 625
if(l!=0)goto _TL7B;_T0=
Cyc_PP_nil_doc();return _T0;
_TL7B: _T1=l;_T2=_T1->tl;if(_T2!=0)goto _TL7D;_T3=l;_T4=_T3->hd;_T5=(struct Cyc_PP_Doc*)_T4;
return _T5;
# 631
...
# 661
if(l!=0)goto _TL82;_T0=
Cyc_PP_nil_doc();return _T0;
_TL82: _T1=l;_T2=_T1->tl;if(_T2!=0)goto _TL84;_T3=l;_T4=_T3->hd;_T5=
pp(_T4);return _T5;
# 666
...
# 679
if(l!=0)goto _TL86;_T0=
Cyc_PP_nil_doc();return _T0;
_TL86: _T1=l;_T2=_T1->tl;if(_T2!=0)goto _TL88;_T3=l;_T4=_T3->hd;_T5=(struct Cyc_PP_Doc*)_T4;
return _T5;
# 684
