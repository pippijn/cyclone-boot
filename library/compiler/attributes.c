...
# 253
int Cyc_Tcutil_force_type2bool(int,void*);struct Cyc_String_pa_PrintArg_struct{int tag;struct _fat_ptr f1;};struct Cyc_Int_pa_PrintArg_struct{int tag;unsigned long f1;};
# 48 "warn.h"
...
# 91
int i=0;_TL5: _T23=i;_T24=(unsigned)_T23;if(_T24 < 20U)goto _TL3;else{goto _TL4;}
...
return 0;_TL71:
# 258
 return 1;}struct _tuple15{struct Cyc_List_List*f0;struct _fat_ptr f1;};
# 261
static void Cyc_Atts_fnTypeAttsOverlap(unsigned loc,int i,struct _tuple15 lst1,struct _tuple15 lst2){int(*_T0)(struct Cyc_List_List*,int);int(*_T1)(struct Cyc_List_List*,void*);struct _tuple15 _T2;struct Cyc_List_List*_T3;int _T4;int _T5;struct Cyc_String_pa_PrintArg_struct _T6;struct _tuple15 _T7;struct Cyc_String_pa_PrintArg_struct _T8;struct _tuple15 _T9;struct Cyc_Int_pa_PrintArg_struct _TA;int _TB;unsigned _TC;struct _fat_ptr _TD;struct _fat_ptr _TE;_T1=Cyc_List_memq;{
# 266
...
# 271
void Cyc_Atts_fnTypeAttsOK(unsigned loc,void*t){struct _tuple15 _T0;struct _tuple15 _T1;struct _tuple15 _T2;int*_T3;int _T4;struct Cyc_Absyn_FnInfo _T5;struct Cyc_Absyn_FnInfo _T6;struct Cyc_Absyn_FnInfo _T7;struct Cyc_List_List*_T8;int*_T9;unsigned _TA;unsigned _TB;int _TC;int _TD;struct Cyc_List_List*_TE;void*_TF;int _T10;struct _tuple8*(*_T11)(struct Cyc_List_List*,int);void*(*_T12)(struct Cyc_List_List*,int);struct Cyc_List_List*_T13;int _T14;struct _tuple8*_T15;struct _tuple8 _T16;void*_T17;int*_T18;int _T19;struct Cyc_Absyn_PtrInfo _T1A;struct Cyc_Absyn_PtrAtts _T1B;struct Cyc_Absyn_PtrInfo _T1C;struct Cyc_Absyn_PtrAtts _T1D;struct Cyc_Absyn_PtrInfo _T1E;struct Cyc_Absyn_PtrAtts _T1F;int _T20;struct Cyc_Warn_String_Warn_Warg_struct _T21;struct Cyc_Warn_String_Warn_Warg_struct _T22;unsigned _T23;struct _fat_ptr _T24;int _T25;struct Cyc_Warn_String_Warn_Warg_struct _T26;struct Cyc_Warn_String_Warn_Warg_struct _T27;unsigned _T28;struct _fat_ptr _T29;int _T2A;struct Cyc_Warn_String_Warn_Warg_struct _T2B;struct Cyc_Warn_String_Warn_Warg_struct _T2C;unsigned _T2D;struct _fat_ptr _T2E;struct Cyc_Warn_String_Warn_Warg_struct _T2F;struct Cyc_Warn_String_Warn_Warg_struct _T30;unsigned _T31;struct _fat_ptr _T32;struct Cyc_List_List*_T33;int _T34;struct _tuple15 _T35;unsigned _T36;int _T37;int _T38;struct Cyc_List_List*_T39;void*_T3A;int _T3B;struct _tuple8*(*_T3C)(struct Cyc_List_List*,int);void*(*_T3D)(struct Cyc_List_List*,int);struct Cyc_List_List*_T3E;int _T3F;int _T40;struct Cyc_Warn_String_Warn_Warg_struct _T41;unsigned _T42;struct _fat_ptr _T43;struct Cyc_List_List*_T44;int _T45;struct _tuple15 _T46;unsigned _T47;int _T48;int _T49;struct Cyc_List_List*_T4A;void*_T4B;int _T4C;struct _tuple8*(*_T4D)(struct Cyc_List_List*,int);void*(*_T4E)(struct Cyc_List_List*,int);struct Cyc_List_List*_T4F;int _T50;int _T51;struct Cyc_Warn_String_Warn_Warg_struct _T52;unsigned _T53;struct _fat_ptr _T54;struct Cyc_List_List*_T55;int _T56;struct _tuple15 _T57;struct Cyc_List_List*_T58;struct Cyc_Warn_String_Warn_Warg_struct _T59;int(*_T5A)(struct _fat_ptr);void*(*_T5B)(struct _fat_ptr);struct _fat_ptr _T5C;{struct _tuple15 _T5D;
# 274
_T5D.f0=0;_T5D.f1=_tag_fat("initializes",sizeof(char),12U);_T0=_T5D;}{struct _tuple15 init_params=_T0;{struct _tuple15 _T5D;
_T5D.f0=0;_T5D.f1=_tag_fat("noliveunique",sizeof(char),13U);_T1=_T5D;}{struct _tuple15 nolive_unique_params=_T1;{struct _tuple15 _T5D;
_T5D.f0=0;_T5D.f1=_tag_fat("consume",sizeof(char),8U);_T2=_T5D;}{struct _tuple15 consume_params=_T2;
# 278
...
# 308
Cyc_Atts_fnTypeAttsRangeOK(_T36,_T37,_T38,_T3A);if(_T3B)goto _TL8A;else{goto _TL8C;}
_TL8C: goto _LL5;_TL8A:
...
# 318
Cyc_Atts_fnTypeAttsRangeOK(_T47,_T48,_T49,_T4B);if(_T4C)goto _TL90;else{goto _TL92;}
_TL92: goto _LL5;_TL90:
...
# 350
Cyc_List_exists_c(_T3,_T5,_T6);if(_T7)goto _TL9B;else{goto _TL9D;}
_TL9D: return 0;_TL9B:;};}_TL96: _T8=t;
# 342
...
if(ftc==0)goto _TLB9;_T27=ftc;
return _T27;_TLB9: {
int ic=Cyc_Core_intcmp(i1,i2);
if(ic==0)goto _TLBB;_T28=ic;
return _T28;_TLBB: _T29=
