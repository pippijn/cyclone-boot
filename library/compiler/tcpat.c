...
# 80
struct _fat_ptr Cyc_Absynpp_pat2string(struct Cyc_Absyn_Pat*);struct Cyc___cycFILE;
...
return;_TL22: {
# 119
struct _tuple18 _T8F=Cyc_Evexp_eval_const_uint_exp(e);int _T90;unsigned _T91;_T91=_T8F.f0;_T90=_T8F.f1;{unsigned i=_T91;int known=_T90;_T74=known;
...
_T3->loc=loc;_T3->topt=0;_T1=& Cyc_Absyn_Wild_p_val;_T2=(struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*)_T1;_T3->r=(void*)_T2;_T0=(struct Cyc_Absyn_Pat*)_T3;}return _T0;}struct _tuple19{struct Cyc_List_List*f0;struct Cyc_Absyn_Pat*f1;};
# 138
static struct _tuple19*Cyc_Tcpat_wild_dlp(unsigned loc){struct _tuple19*_T0;{struct _tuple19*_T1=_cycalloc(sizeof(struct _tuple19));
_T1->f0=0;_T1->f1=Cyc_Tcpat_wild_pat(loc);_T0=(struct _tuple19*)_T1;}return _T0;}
# 142
...
return _TE;_TL35:;}}struct _tuple20{struct Cyc_Absyn_Vardecl**f0;struct Cyc_Absyn_Exp*f1;};
# 172
static void Cyc_Tcpat_set_vd(struct Cyc_Absyn_Vardecl**vd,struct Cyc_Absyn_Exp*e,struct Cyc_List_List**v_result_ptr,void*t){struct Cyc_Absyn_Vardecl**_T0;struct Cyc_Absyn_Vardecl*_T1;struct Cyc_Absyn_Vardecl**_T2;struct Cyc_Absyn_Vardecl*_T3;struct Cyc_List_List**_T4;struct Cyc_List_List*_T5;struct _tuple20*_T6;struct Cyc_List_List**_T7;
# 174
if(vd==0)goto _TL37;_T0=vd;_T1=*_T0;
_T1->type=t;_T2=vd;_T3=*_T2;
_T3->tq=Cyc_Absyn_empty_tqual(0U);goto _TL38;_TL37: _TL38: _T4=v_result_ptr;{struct Cyc_List_List*_T8=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple20*_T9=_cycalloc(sizeof(struct _tuple20));
# 178
_T9->f0=vd;_T9->f1=e;_T6=(struct _tuple20*)_T9;}_T8->hd=_T6;_T7=v_result_ptr;_T8->tl=*_T7;_T5=(struct Cyc_List_List*)_T8;}*_T4=_T5;}
# 180
...
_T27A->f0=0;_T27A->f1=0;_T30=(struct _tuple1*)_T27A;}res.tvars_and_effconstr_opt=_T30;goto _TL52;_TL51: _TL52: _T31=res;_T32=_T31.tvars_and_effconstr_opt;_T33=res;_T34=_T33.tvars_and_effconstr_opt;_T35=*_T34;_T36=_T35.f0;{struct Cyc_List_List*_T27A=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple21*_T27B=_cycalloc(sizeof(struct _tuple21));
# 249
_T27B->f0=tv;_T27B->f1=1;_T38=(struct _tuple21*)_T27B;}_T27A->hd=_T38;_T27A->tl=0;_T37=(struct Cyc_List_List*)_T27A;}
# 248
(*_T32).f0=
...
_T27A->f0=0;_T27A->f1=0;_T87=(struct _tuple1*)_T27A;}res.tvars_and_effconstr_opt=_T87;goto _TL6A;_TL69: _TL6A: _T88=res;_T89=_T88.tvars_and_effconstr_opt;{struct Cyc_List_List*_T27A=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple21*_T27B=_cycalloc(sizeof(struct _tuple21));
# 308
_T27B->f0=tv;_T27B->f1=0;_T8B=(struct _tuple21*)_T27B;}_T27A->hd=_T8B;_T8C=res;_T8D=_T8C.tvars_and_effconstr_opt;_T8E=*_T8D;_T27A->tl=_T8E.f0;_T8A=(struct Cyc_List_List*)_T27A;}
# 307
(*_T89).f0=_T8A;
# 309
...
# 458
_T281.f0=Cyc_Tcenv_lookup_type_vars(te2);_T281.f1=rgn;_T139=_T281;}{struct _tuple16 env=_T139;_T13B=Cyc_List_rmap_c;{
...
# 469
struct Cyc_List_List*(*_T281)(struct _tuple21*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple21*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*))_T160;_T15F=_T281;}_T161=exist_ts;_T162=_T15F(Cyc_Tcpat_add_false,_T161);
# 468
(*_T15A).f0=
...
struct Cyc_List_List*(*_T281)(struct Cyc_List_List*,int,int,struct _tuple19*(*)(unsigned),unsigned,struct _fat_ptr)=(struct Cyc_List_List*(*)(struct Cyc_List_List*,int,int,struct _tuple19*(*)(unsigned),unsigned,struct _fat_ptr))Cyc_Tcpat_remove_dots;_T192=_T281;}_T193=dps;_T194=Cyc_List_length(dps);_T195=ad;_T196=_T195->impl;_T197=_check_null(_T196);_T198=_T197->fields;_T199=Cyc_List_length(_T198);_T19A=p;_T19B=_T19A->loc;_T19C=
...
_TLB0: _T1A8=fields;_T1A9=_T1A8->hd;{struct _tuple22*_T281=(struct _tuple22*)_T1A9;struct Cyc_Absyn_Pat*_T282;struct Cyc_Absyn_Aggrfield*_T283;{struct _tuple22 _T284=*_T281;_T283=_T284.f0;_T282=_T284.f1;}{struct Cyc_Absyn_Aggrfield*field=_T283;struct Cyc_Absyn_Pat*pat=_T282;_T1AA=rgn;_T1AB=inst;_T1AC=field;_T1AD=_T1AC->type;{
...
struct Cyc_List_List*(*_T280)(struct Cyc_List_List*,int,int,struct _tuple19*(*)(unsigned),unsigned,struct _fat_ptr)=(struct Cyc_List_List*(*)(struct Cyc_List_List*,int,int,struct _tuple19*(*)(unsigned),unsigned,struct _fat_ptr))Cyc_Tcpat_remove_dots;_T1E3=_T280;}_T1E4=dps;_T1E5=Cyc_List_length(dps);_T1E6=Cyc_List_length(afs);_T1E7=p;_T1E8=_T1E7->loc;_T1EA=is_tuple;
...
_TLC3: _T1F2=fields;_T1F3=_T1F2->hd;{struct _tuple22*_T281=(struct _tuple22*)_T1F3;struct Cyc_Absyn_Pat*_T282;struct Cyc_Absyn_Aggrfield*_T283;{struct _tuple22 _T284=*_T281;_T283=_T284.f0;_T282=_T284.f1;}{struct Cyc_Absyn_Aggrfield*field=_T283;struct Cyc_Absyn_Pat*pat=_T282;_T1F4=field;{
...
# 558
_T27A.f0=Cyc_Tcenv_lookup_type_vars(te);_T27A.f1=Cyc_Core_heap_region;_T223=_T27A;}{struct _tuple16 env=_T223;_T225=Cyc_List_map_c;{
...
_TLD0: _T23B=ps;_T23C=_T23B->hd;{struct Cyc_Absyn_Pat*p2=(struct Cyc_Absyn_Pat*)_T23C;_T23D=inst;_T23E=tqts;_T23F=_T23E->hd;_T240=(struct _tuple23*)_T23F;_T241=*_T240;_T242=_T241.f1;{
# 571
...
_TLE4: _T12=x;_T13=_T12->hd;{struct _tuple20*_T21=(struct _tuple20*)_T13;void*_T22;struct Cyc_Absyn_Vardecl**_T23;{struct _tuple20 _T24=*_T21;_T23=_T24.f0;_T14=& _T21->f1;_T22=(struct Cyc_Absyn_Exp**)_T14;}{struct Cyc_Absyn_Vardecl**vdopt=_T23;struct Cyc_Absyn_Exp**expopt=(struct Cyc_Absyn_Exp**)_T22;_T15=expopt;_T16=*_T15;
...
_TL105: _T18=te;_T19=dps;_T1A=_T19->hd;_T1B=(struct _tuple19*)_T1A;_T1C=*_T1B;_T1D=_T1C.f1;_T1E=did_noalias_deref;_T1F=patvars;Cyc_Tcpat_check_pat_regions_rec(_T18,_T1D,_T1E,_T1F);_T20=dps;
# 706
...
_TL10D: _T28=x;_T29=_T28->hd;{struct _tuple20*_T6A=(struct _tuple20*)_T29;struct Cyc_Absyn_Exp*_T6B;struct Cyc_Absyn_Vardecl**_T6C;{struct _tuple20 _T6D=*_T6A;_T6C=_T6D.f0;_T6B=_T6D.f1;}{struct Cyc_Absyn_Vardecl**vdopt=_T6C;struct Cyc_Absyn_Exp*eopt=_T6B;
# 722
...
_TL11E: _T46=x;_T47=_T46->hd;{struct _tuple20*_T6A=(struct _tuple20*)_T47;struct Cyc_Absyn_Exp*_T6B;struct Cyc_Absyn_Vardecl**_T6C;{struct _tuple20 _T6D=*_T6A;_T6C=_T6D.f0;_T6B=_T6D.f1;}{struct Cyc_Absyn_Vardecl**vdopt=_T6C;struct Cyc_Absyn_Exp*eopt=_T6B;
# 751
...
_TL12E: _TB=x;_TC=_TB->hd;{struct _tuple20*_T24=(struct _tuple20*)_TC;struct Cyc_Absyn_Exp*_T25;struct Cyc_Absyn_Vardecl**_T26;{struct _tuple20 _T27=*_T24;_T26=_T27.f0;_T25=_T27.f1;}{struct Cyc_Absyn_Vardecl**vdopt=_T26;struct Cyc_Absyn_Exp*eopt=_T25;
...
_check_null(dlps);_T49=_T48->hd;_T4A=(struct _tuple19*)_T49;_T4B=*_T4A;_T4C=_T4B.f0;_T4D=_check_null(_T4C);{void*_T6B=_T4D->hd;struct _fat_ptr*_T6C;_T4E=(int*)_T6B;_T4F=*_T4E;if(_T4F!=1)goto _TL159;{struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_T6D=(struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_T6B;_T6C=_T6D->f1;}{struct _fat_ptr*f=_T6C;{struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*_T6D=_cycalloc(sizeof(struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct));_T6D->tag=8;
...
_TL16F: _T51=dlps0;_T52=_T51->hd;{struct _tuple19*_TAE=(struct _tuple19*)_T52;struct Cyc_Absyn_Pat*_TAF;struct Cyc_List_List*_TB0;{struct _tuple19 _TB1=*_TAE;_TB0=_TB1.f0;_TAF=_TB1.f1;}{struct Cyc_List_List*dl=_TB0;struct Cyc_Absyn_Pat*p=_TAF;struct _fat_ptr*_TB1;if(dl==0)goto _TL173;_T53=dl;_T54=(struct Cyc_List_List*)_T53;_T55=_T54->hd;_T56=(int*)_T55;_T57=*_T56;if(_T57!=1)goto _TL175;_T58=dl;_T59=(struct Cyc_List_List*)_T58;_T5A=_T59->tl;if(_T5A!=0)goto _TL177;_T5B=dl;{struct Cyc_List_List _TB2=*_T5B;_T5C=_TB2.hd;{struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_TB3=(struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_T5C;_TB1=_TB3->f1;}}{struct _fat_ptr*f=_TB1;_T5D=f;_T5E=fields;_T5F=_T5E->hd;_T60=(struct Cyc_Absyn_Aggrfield*)_T5F;_T61=_T60->name;_T62=
# 1088
...
int*span;span=_cycalloc_atomic(sizeof(int));_T76=span;*_T76=Cyc_List_length(fields);{struct Cyc_Absyn_Pat*_TAE;struct _fat_ptr*_TAF;if(dlps==0)goto _TL181;_T77=dlps;_T78=(struct Cyc_List_List*)_T77;_T79=_T78->hd;_T7A=(struct _tuple19*)_T79;_T7B=_T7A->f0;if(_T7B==0)goto _TL183;_T7C=dlps;_T7D=(struct Cyc_List_List*)_T7C;_T7E=_T7D->hd;_T7F=(struct _tuple19*)_T7E;_T80=_T7F->f0;_T81=(struct Cyc_List_List*)_T80;_T82=_T81->hd;_T83=(int*)_T82;_T84=*_T83;if(_T84!=1)goto _TL185;_T85=dlps;_T86=(struct Cyc_List_List*)_T85;_T87=_T86->hd;_T88=(struct _tuple19*)_T87;_T89=_T88->f0;_T8A=(struct Cyc_List_List*)_T89;_T8B=_T8A->tl;if(_T8B!=0)goto _TL187;_T8C=dlps;_T8D=(struct Cyc_List_List*)_T8C;_T8E=_T8D->tl;if(_T8E!=0)goto _TL189;_T8F=dlps;{struct Cyc_List_List _TB0=*_T8F;_T90=_TB0.hd;_T91=(struct _tuple19*)_T90;{struct _tuple19 _TB1=*_T91;_T92=_TB1.f0;{struct Cyc_List_List _TB2=*_T92;_T93=_TB2.hd;{struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_TB3=(struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_T93;_TAF=_TB3->f1;}}_TAE=_TB1.f1;}}{struct _fat_ptr*f=_TAF;struct Cyc_Absyn_Pat*p2=_TAE;_T94=f;_T95=*_T94;_T96=span;{struct Cyc_List_List*_TB0=_cycalloc(sizeof(struct Cyc_List_List));
# 1107
...
# 1317
static struct Cyc_List_List*Cyc_Tcpat_augment(struct Cyc_List_List*ctxt,void*dsc){struct Cyc_List_List*_T0;void*_T1;struct _tuple25*_T2;struct Cyc_List_List*_T3;struct _tuple25*_T4;struct Cyc_List_List*_T5;struct Cyc_List_List*_T6;struct Cyc_List_List*_T7;struct Cyc_Tcpat_Con_s*_T8;if(ctxt!=0)goto _TL1C7;
# 1319
return 0;_TL1C7: _T0=ctxt;{struct Cyc_List_List _T9=*_T0;_T1=_T9.hd;_T2=(struct _tuple25*)_T1;{struct _tuple25 _TA=*_T2;_T8=_TA.f0;_T7=_TA.f1;}_T6=_T9.tl;}{struct Cyc_Tcpat_Con_s*c=_T8;struct Cyc_List_List*args=_T7;struct Cyc_List_List*tl=_T6;{struct Cyc_List_List*_T9=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple25*_TA=_cycalloc(sizeof(struct _tuple25));
_TA->f0=c;{struct Cyc_List_List*_TB=_cycalloc(sizeof(struct Cyc_List_List));_TB->hd=dsc;_TB->tl=args;_T5=(struct Cyc_List_List*)_TB;}_TA->f1=_T5;_T4=(struct _tuple25*)_TA;}_T9->hd=_T4;_T9->tl=tl;_T3=(struct Cyc_List_List*)_T9;}return _T3;};}
# 1327
static struct Cyc_List_List*Cyc_Tcpat_norm_context(struct Cyc_List_List*ctxt){struct Cyc_Warn_String_Warn_Warg_struct _T0;int(*_T1)(struct _fat_ptr);void*(*_T2)(struct _fat_ptr);struct _fat_ptr _T3;struct Cyc_List_List*_T4;void*_T5;struct _tuple25*_T6;struct Cyc_List_List*_T7;struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_T8;void*_T9;struct Cyc_List_List*_TA;struct Cyc_List_List*_TB;struct Cyc_List_List*_TC;struct Cyc_Tcpat_Con_s*_TD;if(ctxt!=0)goto _TL1C9;{struct Cyc_Warn_String_Warn_Warg_struct _TE;_TE.tag=0;
# 1329
_TE.f1=_tag_fat("norm_context: empty context",sizeof(char),28U);_T0=_TE;}{struct Cyc_Warn_String_Warn_Warg_struct _TE=_T0;void*_TF[1];_TF[0]=& _TE;_T2=Cyc_Warn_impos2;{int(*_T10)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T2;_T1=_T10;}_T3=_tag_fat(_TF,sizeof(void*),1);_T1(_T3);}goto _TL1CA;_TL1C9: _T4=ctxt;{struct Cyc_List_List _TE=*_T4;_T5=_TE.hd;_T6=(struct _tuple25*)_T5;{struct _tuple25 _TF=*_T6;_TD=_TF.f0;_TC=_TF.f1;}_TB=_TE.tl;}{struct Cyc_Tcpat_Con_s*c=_TD;struct Cyc_List_List*args=_TC;struct Cyc_List_List*tl=_TB;_T7=tl;{struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_TE=_cycalloc(sizeof(struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct));_TE->tag=0;
...
# 1339
static void*Cyc_Tcpat_build_desc(struct Cyc_List_List*ctxt,void*dsc,struct Cyc_List_List*work){struct _tuple1 _T0;struct Cyc_List_List*_T1;struct Cyc_List_List*_T2;void*_T3;struct Cyc_List_List*_T4;struct Cyc_Warn_String_Warn_Warg_struct _T5;int(*_T6)(struct _fat_ptr);void*(*_T7)(struct _fat_ptr);struct _fat_ptr _T8;struct Cyc_List_List*_T9;void*_TA;struct _tuple25*_TB;struct Cyc_List_List*_TC;void*_TD;struct _tuple24*_TE;struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_TF;struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_T10;struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_T11;struct Cyc_List_List*_T12;struct Cyc_List_List*_T13;struct Cyc_List_List*_T14;struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_T15;void*_T16;struct Cyc_List_List*_T17;void*_T18;{struct _tuple1 _T19;
# 1341
...
# 1344
_T1F.f1=_tag_fat("build_desc: ctxt and work don't match",sizeof(char),38U);_T5=_T1F;}{struct Cyc_Warn_String_Warn_Warg_struct _T1F=_T5;void*_T20[1];_T20[0]=& _T1F;_T7=Cyc_Warn_impos2;{int(*_T21)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T7;_T6=_T21;}_T8=_tag_fat(_T20,sizeof(void*),1);_T6(_T8);}goto _TL1D0;_TL1CF: _T9=_T19.f0;{struct Cyc_List_List _T1F=*_T9;_TA=_T1F.hd;_TB=(struct _tuple25*)_TA;{struct _tuple25 _T20=*_TB;_T1E=_T20.f0;_T1D=_T20.f1;}_T1C=_T1F.tl;}_TC=_T19.f1;{struct Cyc_List_List _T1F=*_TC;_TD=_T1F.hd;_TE=(struct _tuple24*)_TD;{struct _tuple24 _T20=*_TE;_T1B=_T20.f2;}_T1A=_T1F.tl;}{struct Cyc_Tcpat_Con_s*c=_T1E;struct Cyc_List_List*args=_T1D;struct Cyc_List_List*rest=_T1C;struct Cyc_List_List*dargs=_T1B;struct Cyc_List_List*work2=_T1A;
# 1346
...
# 1372
static void*Cyc_Tcpat_and_match(struct Cyc_List_List*ctx,struct Cyc_List_List*work,struct Cyc_Tcpat_Rhs*right_hand_side,struct Cyc_List_List*rules){struct Cyc_Tcpat_Success_Tcpat_Decision_struct*_T0;void*_T1;struct Cyc_List_List*_T2;struct Cyc_List_List*_T3;struct _tuple24*_T4;struct _tuple24*_T5;struct Cyc_List_List*_T6;struct Cyc_List_List*_T7;struct Cyc_List_List*_T8;struct _tuple24*_T9;struct _tuple24*_TA;struct Cyc_List_List*_TB;struct Cyc_List_List*_TC;struct Cyc_List_List*_TD;struct _tuple24*_TE;struct _tuple24*_TF;struct Cyc_List_List*_T10;struct Cyc_List_List*_T11;struct Cyc_List_List*_T12;struct Cyc_List_List*_T13;struct Cyc_Tcpat_Rhs*_T14;struct Cyc_List_List*_T15;void*_T16;struct Cyc_List_List*_T17;void*_T18;struct _tuple24*_T19;struct Cyc_Warn_String_Warn_Warg_struct _T1A;int(*_T1B)(struct _fat_ptr);void*(*_T1C)(struct _fat_ptr);struct _fat_ptr _T1D;void*_T1E;void*_T1F;void*_T20;struct _tuple24*_T21;struct _tuple24*_T22;struct _tuple24*_T23;void*_T24;struct Cyc_List_List*_T25;void*_T26;struct Cyc_List_List*_T27;struct Cyc_List_List*_T28;struct Cyc_Tcpat_Rhs*_T29;struct Cyc_List_List*_T2A;void*_T2B;struct Cyc_List_List*_T2C;struct Cyc_List_List*_T2D;struct Cyc_List_List*_T2E;struct Cyc_List_List*_T2F;if(work!=0)goto _TL1D3;{struct Cyc_Tcpat_Success_Tcpat_Decision_struct*_T30=_cycalloc(sizeof(struct Cyc_Tcpat_Success_Tcpat_Decision_struct));_T30->tag=1;
# 1376
_T30->f1=right_hand_side;_T0=(struct Cyc_Tcpat_Success_Tcpat_Decision_struct*)_T30;}_T1=(void*)_T0;return _T1;_TL1D3: _T2=work;_T3=(struct Cyc_List_List*)_T2;_T4=_T3->hd;_T5=(struct _tuple24*)_T4;_T6=_T5->f0;if(_T6!=0)goto _TL1D5;_T7=work;_T8=(struct Cyc_List_List*)_T7;_T9=_T8->hd;_TA=(struct _tuple24*)_T9;_TB=_TA->f1;if(_TB!=0)goto _TL1D7;_TC=work;_TD=(struct Cyc_List_List*)_TC;_TE=_TD->hd;_TF=(struct _tuple24*)_TE;_T10=_TF->f2;if(_T10!=0)goto _TL1D9;_T11=work;{struct Cyc_List_List _T30=*_T11;_T2F=_T30.tl;}{struct Cyc_List_List*workr=_T2F;_T12=
# 1378
Cyc_Tcpat_norm_context(ctx);_T13=workr;_T14=right_hand_side;_T15=rules;_T16=Cyc_Tcpat_and_match(_T12,_T13,_T14,_T15);return _T16;}_TL1D9: goto _LL5;_TL1D7: goto _LL5;_TL1D5: _LL5: _T17=work;{struct Cyc_List_List _T30=*_T17;_T18=_T30.hd;_T19=(struct _tuple24*)_T18;{struct _tuple24 _T31=*_T19;_T2F=_T31.f0;_T2E=_T31.f1;_T2D=_T31.f2;}_T2C=_T30.tl;}{struct Cyc_List_List*pats=_T2F;struct Cyc_List_List*objs=_T2E;struct Cyc_List_List*dscs=_T2D;struct Cyc_List_List*workr=_T2C;
# 1380
...
struct _tuple24*wf;wf=_cycalloc(sizeof(struct _tuple24));_T21=wf;_T21->f0=patr;_T22=wf;_T22->f1=objr;_T23=wf;_T23->f2=dscr;_T24=pat1;_T25=obj1;_T26=dsc1;_T27=ctx;{struct Cyc_List_List*_T39=_cycalloc(sizeof(struct Cyc_List_List));
...
_T75.f1=Cyc_Absynpp_pat2string(p);_T6B=_T75;}{struct Cyc_String_pa_PrintArg_struct _T75=_T6B;void*_T76[1];_T76[0]=& _T75;_T6D=Cyc_Warn_impos;{int(*_T77)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T6D;_T6C=_T77;}_T6E=_tag_fat("get_access on bad pattern: %s",sizeof(char),30U);_T6F=_tag_fat(_T76,sizeof(void*),1);_T6C(_T6E,_T6F);}};}};}struct _tuple27{struct Cyc_List_List*f0;struct Cyc_Tcpat_Con_s*f1;};
# 1464
static struct Cyc_List_List*Cyc_Tcpat_getoarg(struct _tuple27*env,int i){struct _tuple27*_T0;struct Cyc_Tcpat_Con_s*_T1;union Cyc_Tcpat_PatOrWhere _T2;int _T3;struct Cyc_List_List*_T4;struct Cyc_Tcpat_PathNode*_T5;struct Cyc_Tcpat_Con_s*_T6;struct Cyc_Tcpat_Con_s*_T7;struct Cyc_List_List*_T8;_T0=env;{struct _tuple27 _T9=*_T0;_T8=_T9.f0;_T7=_T9.f1;}{struct Cyc_List_List*obj=_T8;struct Cyc_Tcpat_Con_s*pcon=_T7;_T1=pcon;_T2=_T1->orig_pat;_T3=i;{
# 1466
...
# 1469
static struct Cyc_List_List*Cyc_Tcpat_getoargs(struct Cyc_Tcpat_Con_s*pcon,struct Cyc_List_List*obj){struct _tuple27 _T0;struct Cyc_List_List*(*_T1)(int,struct Cyc_List_List*(*)(struct _tuple27*,int),struct _tuple27*);struct Cyc_List_List*(*_T2)(int,void*(*)(void*,int),void*);struct Cyc_Tcpat_Con_s*_T3;int _T4;struct _tuple27*_T5;struct Cyc_List_List*_T6;{struct _tuple27 _T7;
_T7.f0=obj;_T7.f1=pcon;_T0=_T7;}{struct _tuple27 env=_T0;_T2=Cyc_List_tabulate_c;{
struct Cyc_List_List*(*_T7)(int,struct Cyc_List_List*(*)(struct _tuple27*,int),struct _tuple27*)=(struct Cyc_List_List*(*)(int,struct Cyc_List_List*(*)(struct _tuple27*,int),struct _tuple27*))_T2;_T1=_T7;}_T3=pcon;_T4=_T3->arity;_T5=& env;_T6=_T1(_T4,Cyc_Tcpat_getoarg,_T5);return _T6;}}
# 1477
static void*Cyc_Tcpat_match(void*p,struct Cyc_List_List*obj,void*dsc,struct Cyc_List_List*ctx,struct Cyc_List_List*work,struct Cyc_Tcpat_Rhs*right_hand_side,struct Cyc_List_List*rules){void*_T0;int*_T1;int _T2;struct Cyc_List_List*_T3;struct Cyc_List_List*_T4;struct Cyc_Tcpat_Rhs*_T5;struct Cyc_List_List*_T6;void*_T7;void*_T8;int _T9;struct Cyc_List_List*_TA;struct _tuple25*_TB;struct Cyc_List_List*_TC;struct _tuple24*_TD;struct _tuple24*_TE;struct _tuple24*_TF;struct Cyc_List_List*_T10;struct Cyc_List_List*_T11;void*_T12;void*_T13;struct Cyc_List_List*_T14;void*_T15;struct Cyc_List_List*_T16;struct _tuple25*_T17;struct Cyc_List_List*_T18;struct _tuple24*_T19;struct _tuple24*_T1A;struct _tuple24*_T1B;struct Cyc_List_List*_T1C;struct Cyc_List_List*_T1D;struct Cyc_List_List*_T1E;void*_T1F;struct Cyc_List_List*_T20;void*_T21;struct Cyc_List_List*_T22;void*_T23;struct Cyc_List_List*_T24;struct Cyc_Tcpat_Con_s*_T25;_T0=p;_T1=(int*)_T0;_T2=*_T1;if(_T2!=0)goto _TL20C;_T3=
# 1481
...
# 1485
struct Cyc_List_List*ctx2;ctx2=_cycalloc(sizeof(struct Cyc_List_List));_TA=ctx2;{struct _tuple25*_T27=_cycalloc(sizeof(struct _tuple25));_T27->f0=pcon;_T27->f1=0;_TB=(struct _tuple25*)_T27;}_TA->hd=_TB;_TC=ctx2;_TC->tl=ctx;{
struct _tuple24*work_frame;work_frame=_cycalloc(sizeof(struct _tuple24));_TD=work_frame;_TD->f0=pargs;_TE=work_frame;_TE->f1=Cyc_Tcpat_getoargs(pcon,obj);_TF=work_frame;
...
# 1493
struct Cyc_List_List*ctx2;ctx2=_cycalloc(sizeof(struct Cyc_List_List));_T16=ctx2;{struct _tuple25*_T27=_cycalloc(sizeof(struct _tuple25));_T27->f0=pcon;_T27->f1=0;_T17=(struct _tuple25*)_T27;}_T16->hd=_T17;_T18=ctx2;_T18->tl=ctx;{
struct _tuple24*work_frame;work_frame=_cycalloc(sizeof(struct _tuple24));_T19=work_frame;_T19->f0=pargs;_T1A=work_frame;_T1A->f1=Cyc_Tcpat_getoargs(pcon,obj);_T1B=work_frame;
...
# 1535
static struct _tuple26*Cyc_Tcpat_get_match(int*ctr,struct Cyc_Absyn_Switch_clause*swc){struct Cyc_Absyn_Switch_clause*_T0;struct Cyc_Absyn_Pat*_T1;struct Cyc_Tcpat_Rhs*_T2;struct Cyc_Tcpat_Rhs*_T3;struct Cyc_Absyn_Switch_clause*_T4;struct Cyc_Absyn_Pat*_T5;struct Cyc_Tcpat_Rhs*_T6;struct Cyc_Absyn_Switch_clause*_T7;struct Cyc_Absyn_Switch_clause*_T8;struct Cyc_Absyn_Exp*_T9;union Cyc_Tcpat_PatOrWhere _TA;struct Cyc_Absyn_Switch_clause*_TB;struct Cyc_List_List*_TC;int*_TD;int _TE;union Cyc_Tcpat_PatOrWhere _TF;struct _fat_ptr _T10;union Cyc_Tcpat_PatOrWhere _T11;int*_T12;int*_T13;int _T14;struct Cyc_List_List*_T15;struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_T16;struct _fat_ptr _T17;union Cyc_Tcpat_PatOrWhere _T18;struct _tuple26*_T19;_T0=swc;_T1=_T0->pattern;{
...
# 1544
_TL217:{void*_T1A[2];_T1A[0]=sp0;{struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_T1B=_cycalloc(sizeof(struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct));_T1B->tag=0;_T16=(struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*)_T1B;}_T1A[1]=(void*)_T16;_T17=_tag_fat(_T1A,sizeof(void*),2);_T15=Cyc_List_list(_T17);}{union Cyc_Tcpat_PatOrWhere _T1A;_T1A.where_clause.tag=2U;_T1A.where_clause.val=0;_T18=_T1A;}sp=Cyc_Tcpat_tuple_pat(_T15,_T18);_TL218:{struct _tuple26*_T1A=_cycalloc(sizeof(struct _tuple26));
_T1A->f0=sp;_T1A->f1=rhs;_T19=(struct _tuple26*)_T1A;}return _T19;}}}char Cyc_Tcpat_Desc2string[12U]="Desc2string";struct Cyc_Tcpat_Desc2string_exn_struct{char*tag;};
# 1550
...
if(_T31!=1)goto _TL221;{struct _fat_ptr*_T128;if(dlps==0)goto _TL223;_T32=dlps;_T33=(struct Cyc_List_List*)_T32;_T34=_T33->hd;_T35=(struct _tuple19*)_T34;_T36=_T35->f0;if(_T36==0)goto _TL225;_T37=dlps;_T38=(struct Cyc_List_List*)_T37;_T39=_T38->hd;_T3A=(struct _tuple19*)_T39;_T3B=_T3A->f0;_T3C=(struct Cyc_List_List*)_T3B;_T3D=_T3C->hd;_T3E=(int*)_T3D;_T3F=*_T3E;if(_T3F!=1)goto _TL227;_T40=dlps;{struct Cyc_List_List _T129=*_T40;_T41=_T129.hd;_T42=(struct _tuple19*)_T41;{struct _tuple19 _T12A=*_T42;_T43=_T12A.f0;{struct Cyc_List_List _T12B=*_T43;_T44=_T12B.hd;{struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_T12C=(struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_T44;_T128=_T12C->f1;}}}}{struct _fat_ptr*f=_T128;{struct Cyc_String_pa_PrintArg_struct _T129;_T129.tag=0;_T47=ad;_T48=_T47->name;
# 1576
...
_T0->used=1;}
# 1678
void Cyc_Tcpat_check_switch_exhaustive(unsigned loc,struct Cyc_Tcenv_Tenv*te,struct Cyc_List_List*swcs,void**dopt){struct Cyc_List_List*(*_T0)(struct _tuple26*(*)(int*,struct Cyc_Absyn_Switch_clause*),int*,struct Cyc_List_List*);struct Cyc_List_List*(*_T1)(void*(*)(void*,void*),void*,struct Cyc_List_List*);int*_T2;struct Cyc_List_List*_T3;void**_T4;void(*_T5)(void*,void(*)(unsigned,void*),unsigned,void(*)(int,struct Cyc_Tcpat_Rhs*),int,int*);void*_T6;unsigned _T7;int*_T8;struct Cyc_List_List*_T9;void*_TA;struct Cyc_Tcpat_Rhs*_TB;int _TC;struct Cyc_Warn_String_Warn_Warg_struct _TD;unsigned _TE;struct _fat_ptr _TF;struct Cyc_List_List*_T10;
# 1684
int where_ctr=0;
int*env=& where_ctr;_T1=Cyc_List_map_c;{
struct Cyc_List_List*(*_T11)(struct _tuple26*(*)(int*,struct Cyc_Absyn_Switch_clause*),int*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple26*(*)(int*,struct Cyc_Absyn_Switch_clause*),int*,struct Cyc_List_List*))_T1;_T0=_T11;}_T2=env;_T3=swcs;{struct Cyc_List_List*match_rules=_T0(Cyc_Tcpat_get_match,_T2,_T3);
...
_TL26C: _T9=match_rules;_TA=_T9->hd;{struct _tuple26*_T11=(struct _tuple26*)_TA;unsigned _T12;int _T13;{struct _tuple26 _T14=*_T11;_TB=_T14.f1;{struct Cyc_Tcpat_Rhs _T15=*_TB;_T13=_T15.used;_T12=_T15.pat_loc;}}{int b=_T13;unsigned loc2=_T12;_TC=b;
...
# 1707
static void Cyc_Tcpat_not_exhaust_warn(struct _tuple18*pr,void*desc){struct _tuple18*_T0;struct _handler_cons*_T1;int _T2;struct Cyc_Warn_String_Warn_Warg_struct _T3;struct Cyc_Warn_String_Warn_Warg_struct _T4;struct _tuple18*_T5;struct _tuple18 _T6;unsigned _T7;struct _fat_ptr _T8;void*_T9;struct Cyc_Tcpat_Desc2string_exn_struct*_TA;char*_TB;char*_TC;struct Cyc_Warn_String_Warn_Warg_struct _TD;struct _tuple18*_TE;struct _tuple18 _TF;unsigned _T10;struct _fat_ptr _T11;_T0=pr;
...
return;}
# 1721
int Cyc_Tcpat_check_let_pat_exhaustive(unsigned loc,struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Pat*p,void**dopt){struct Cyc_Tcpat_Rhs*_T0;struct Cyc_Tcpat_Rhs*_T1;struct Cyc_Absyn_Pat*_T2;struct Cyc_Tcpat_Rhs*_T3;struct Cyc_List_List*_T4;struct _tuple26*_T5;struct Cyc_List_List*_T6;struct _tuple18 _T7;void(*_T8)(void*,void(*)(struct _tuple18*,void*),struct _tuple18*,void(*)(int,struct Cyc_Tcpat_Rhs*),int,int*);void*_T9;struct _tuple18*_TA;int*_TB;void**_TC;struct _tuple18 _TD;int _TE;
...
struct Cyc_List_List*match_rules;match_rules=_cycalloc(sizeof(struct Cyc_List_List));_T4=match_rules;{struct _tuple26*_TF=_cycalloc(sizeof(struct _tuple26));_TF->f0=Cyc_Tcpat_compile_pat(p);_TF->f1=rhs;_T5=(struct _tuple26*)_TF;}_T4->hd=_T5;_T6=match_rules;_T6->tl=0;{
void*dec_tree=Cyc_Tcpat_match_compile(match_rules);{struct _tuple18 _TF;
_TF.f0=loc;_TF.f1=1;_T7=_TF;}{struct _tuple18 exhaust_env=_T7;
int ex_done=0;{
void(*_TF)(void*,void(*)(struct _tuple18*,void*),struct _tuple18*,void(*)(int,struct Cyc_Tcpat_Rhs*),int,int*)=(void(*)(void*,void(*)(struct _tuple18*,void*),struct _tuple18*,void(*)(int,struct Cyc_Tcpat_Rhs*),int,int*))Cyc_Tcpat_check_exhaust_overlap;_T8=_TF;}_T9=dec_tree;_TA=& exhaust_env;_TB=& ex_done;_T8(_T9,Cyc_Tcpat_not_exhaust_warn,_TA,Cyc_Tcpat_dummy_fn,0,_TB);_TC=dopt;
# 1729
*_TC=dec_tree;_TD=exhaust_env;_TE=_TD.f1;
return _TE;}}}}
# 1737
static struct _tuple26*Cyc_Tcpat_get_match2(struct Cyc_Absyn_Switch_clause*swc){struct Cyc_Absyn_Switch_clause*_T0;struct Cyc_Absyn_Pat*_T1;struct Cyc_Absyn_Switch_clause*_T2;struct Cyc_Absyn_Exp*_T3;struct Cyc_Warn_String_Warn_Warg_struct _T4;struct Cyc_Absyn_Switch_clause*_T5;struct Cyc_Absyn_Exp*_T6;unsigned _T7;struct _fat_ptr _T8;struct Cyc_Tcpat_Rhs*_T9;struct Cyc_Tcpat_Rhs*_TA;struct Cyc_Absyn_Switch_clause*_TB;struct Cyc_Absyn_Pat*_TC;struct Cyc_Tcpat_Rhs*_TD;struct Cyc_Absyn_Switch_clause*_TE;struct _tuple26*_TF;_T0=swc;_T1=_T0->pattern;{
...
# 1744
struct Cyc_Tcpat_Rhs*rhs;rhs=_cycalloc(sizeof(struct Cyc_Tcpat_Rhs));_T9=rhs;_T9->used=0;_TA=rhs;_TB=swc;_TC=_TB->pattern;_TA->pat_loc=_TC->loc;_TD=rhs;_TE=swc;_TD->rhs=_TE->body;{struct _tuple26*_T10=_cycalloc(sizeof(struct _tuple26));
_T10->f0=sp0;_T10->f1=rhs;_TF=(struct _tuple26*)_T10;}return _TF;}}}
# 1747
static void Cyc_Tcpat_not_exhaust_err2(unsigned loc,void*d){;}
# 1750
void Cyc_Tcpat_check_catch_overlap(unsigned loc,struct Cyc_Tcenv_Tenv*te,struct Cyc_List_List*swcs,void**dopt){struct Cyc_List_List*(*_T0)(struct _tuple26*(*)(struct Cyc_Absyn_Switch_clause*),struct Cyc_List_List*);struct Cyc_List_List*(*_T1)(void*(*)(void*),struct Cyc_List_List*);struct Cyc_List_List*_T2;void**_T3;void(*_T4)(void*,void(*)(unsigned,void*),unsigned,void(*)(int,struct Cyc_Tcpat_Rhs*),int,int*);void*_T5;unsigned _T6;int*_T7;struct Cyc_List_List*_T8;struct Cyc_List_List*_T9;struct Cyc_List_List*_TA;void*_TB;struct Cyc_Tcpat_Rhs*_TC;int _TD;struct Cyc_Warn_String_Warn_Warg_struct _TE;unsigned _TF;struct _fat_ptr _T10;struct Cyc_List_List*_T11;_T1=Cyc_List_map;{
# 1754
struct Cyc_List_List*(*_T12)(struct _tuple26*(*)(struct Cyc_Absyn_Switch_clause*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple26*(*)(struct Cyc_Absyn_Switch_clause*),struct Cyc_List_List*))_T1;_T0=_T12;}_T2=swcs;{struct Cyc_List_List*match_rules=_T0(Cyc_Tcpat_get_match2,_T2);
...
struct _tuple26*_T12=(struct _tuple26*)_TB;unsigned _T13;int _T14;{struct _tuple26 _T15=*_T12;_TC=_T15.f1;{struct Cyc_Tcpat_Rhs _T16=*_TC;_T14=_T16.used;_T13=_T16.pat_loc;}}{int b=_T14;unsigned loc2=_T13;_TD=b;
...
# 1771
int Cyc_Tcpat_has_vars(struct Cyc_Core_Opt*pat_vars){struct Cyc_Core_Opt*_T0;void*_T1;struct Cyc_List_List*_T2;void*_T3;struct _tuple20*_T4;struct _tuple20 _T5;struct Cyc_Absyn_Vardecl**_T6;struct Cyc_List_List*_T7;_T0=
...
_TL285: _T2=l;_T3=_T2->hd;_T4=(struct _tuple20*)_T3;_T5=*_T4;_T6=_T5.f0;if(_T6==0)goto _TL288;
