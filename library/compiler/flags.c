...
void Cyc_Flags_set_cfonly() {
  ...
  goto _TL9;
  _TL8: _T0 = 6U;
  _TL9: Cyc_Flags_stop_after_pass = _T0;
}
void Cyc_Flags_set_toconly() {
  ...
  goto _TLB;
  _TLA: _T0 = 14U;
  _TLB: Cyc_Flags_stop_after_pass = _T0;
}
