...
void Cyc_Cifc_merge_sys_user_decl(unsigned int loc,struct Cyc_Tcenv_Tenv * te,
  ...
  { struct _tuple14 _T137;
    _T1 = c_decl;
    _T137.f0 = _T1->r;
    _T2 = user_decl;
    _T137.f1 = _T2->r;
    _T0 = _T137;
  }{ struct _tuple14 _T137 = _T0;
	...
	_T7E->r = _T7F->r;
	return;
	_TL73: { struct _tuple15 _T141;
	  _T81 = cd;
	  _T141.f0 = _T81->impl;
	  _T82 = ud;
	  _T141.f1 = _T82->impl;
	  _T80 = _T141;
	}{ struct _tuple15 _T141 = _T80;
...
static struct _tuple16 * Cyc_Cifc_update_tvars(struct Cyc_Tcenv_Tenv * te,
		  ...
		  { void * _T92 = _T15->r;
			...
			{ struct Cyc_List_List * tvs = _T21->tvs;
			  ...
			  *_T41 = Cyc_List_imp_rev(_T43);
			  ...
			  _TL11F: _T44 = 0;
			  goto _TL11E;
			  _TL11D: { struct _tuple16 * _T94 = _cycalloc(sizeof(struct _tuple16));
			    _T94->f0 = added_tvars;
			    _T94->f1 = removed_tvars;
			    _T47 = (struct _tuple16 *)_T94;
			  }_T44 = _T47;
			  _TL11E: return _T44;
			}
		      }
	...
	{ struct Cyc_List_List * argit = _T61.args;
	  ...
	  { struct _tuple8 * _T8C = (struct _tuple8 *)_T65;
	    ...
	    { struct _tuple8 _T8E = *_T8C;
	      ...
	      struct _tuple16 * ar_tup = Cyc_Cifc_update_tvars(te,tv_ovrs,
							       at,enclosing_decl,
							       instantiate);
	      _T66 = ar_tup;
	  ...
	  _TL12F: { struct _tuple16 * _T8C = _cycalloc(sizeof(struct _tuple16));
	    _T8C->f0 = added_tvars;
	    _T8C->f1 = removed_tvars;
	    _T7D = (struct _tuple16 *)_T8C;
	  }return _T7D;
	  _TL12D: return 0;
	}
      }
...
static long Cyc_Cifc_update_fninfo_usage(unsigned int loc,struct Cyc_Tcenv_Tenv * te,
  ...
  _T3 = _T2->ret_type;
  _T4 = enclosing_decl;
  { struct _tuple16 * ad = Cyc_Cifc_update_tvars(_T0,_T1,_T3,_T4,0);
    _T5 = fi;
	...
	_TL134: { struct Cyc_List_List * removed_tvars = _TB;
	  ...
	  { struct _tuple8 * _T42 = (struct _tuple8 *)_T13;
	    ...
	    { struct _tuple8 _T44 = *_T42;
	      ...
	      _T18 = *_T17;
	      _T19 = enclosing_decl;
	      { struct _tuple16 * ad = Cyc_Cifc_update_tvars(_T15,_T16,_T18,
							     _T19,0);
		_T1A = ad;
...
static struct _tuple16 * Cyc_Cifc_add_tvars_to_type(struct Cyc_Tcenv_Tenv * te,
  ...
  { struct Cyc_Absyn_Typedefdecl * _T22;
	...
	{ struct Cyc_List_List * old_tvars = Cyc_List_copy(_T15);
	  ...
	  { long changed = Cyc_Cifc_update_fninfo_usage(_T17,_T18,_T19,_T1A,
	    ...
	    { struct _tuple16 * _T28 = _cycalloc(sizeof(struct _tuple16));
	      _T1E = fi;
	      _T28->f0 = _T1E->tvars;
	      _T28->f1 = old_tvars;
	      _T1D = (struct _tuple16 *)_T28;
	    }return _T1D;
	    _TL15C: goto _LL0;
	  }
	}
...
static long Cyc_Cifc_update_typedef_decl(struct Cyc_Tcenv_Tenv * te,struct Cyc_Absyn_Decl * encloser,
  ...
  { long changed = 0;
	...
	_T7 = _check_null(_T6);
	_T8 = tv_ovrs;
	{ struct _tuple16 * new_old_tvars = Cyc_Cifc_add_tvars_to_type(_T3,
								       _T4,
								       _T7,
								       _T8);
...
static struct Cyc_List_List * Cyc_Cifc_update_usages(unsigned int loc,struct Cyc_Tcenv_Tenv * te,
  ...
  struct Cyc_List_List * _T2F;
  unsigned int _T30;
  struct _tuple16 * _T31;
  struct _tuple16 _T32;
	...
	{ void * _T89 = _T4->r;
	  ...
	  case 5: 
		...
		{ struct Cyc_Absyn_Aggrfield * fld = (struct Cyc_Absyn_Aggrfield *)_T25;
		  ...
		  _T29 = _T28->type;
		  _T2A = d;
		  { struct _tuple16 * tvtup = Cyc_Cifc_update_tvars(_T26,
								    _T27,
								    _T29,
								    _T2A,
								    0);
