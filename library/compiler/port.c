...
static void * Cyc_Port_known_aggr_ct(struct _tuple14 * p) {
...
static void Cyc_Port_unify_ct(void * t1,void * t2) {
  ...
  return;
  _TL61: { struct _tuple15 _T7C;
    _T7C.f0 = t1;
    _T7C.f1 = t2;
    _T0 = _T7C;
  }{ struct _tuple15 _T7C = _T0;
	...
	*_T8C = t2;
	...
	{ struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct * _T8C = (struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct *)_T58;
	  _T8A = _T8C->f1;
	}{ struct _tuple14 * p1 = _T8B;
	  struct _tuple14 * p2 = _T8A;
	  if (p1 != p2) { goto _TL84;
	  }
	  return;
...
static struct Cyc_List_List * Cyc_Port_insert_upper(void * v,void * t,struct Cyc_List_List * * uppers) {
  ...
  { struct Cyc_List_List * us = *_T8;
    ...
    { void * t2 = Cyc_Port_compress_ct(_TC);
      ...
      _TE = *_TD;
      return _TE;
      _TLB8: { struct _tuple15 _T36;
	_T36.f0 = t;
	_T36.f1 = t2;
	_TF = _T36;
      }{ struct _tuple15 _T36 = _TF;
	void * _T37;
	void * _T38;
	void * _T39;
	void * _T3A;
...
static struct Cyc_List_List * Cyc_Port_insert_lower(void * v,void * t,struct Cyc_List_List * * lowers) {
  ...
  { struct Cyc_List_List * ls = *_T8;
    ...
    { void * t2 = Cyc_Port_compress_ct(_TC);
      ...
      _TE = *_TD;
      return _TE;
      _TLC3: { struct _tuple15 _T3C;
	_T3C.f0 = t;
	_T3C.f1 = t2;
	_TF = _T3C;
      }{ struct _tuple15 _T3C = _TF;
	void * _T3D;
	void * _T3E;
	void * _T3F;
	void * _T40;
...
static long Cyc_Port_leq(void * t1,void * t2) {
  ...
  t2 = Cyc_Port_compress_ct(t2);
  { struct _tuple15 _T80;
    _T80.f0 = t1;
    _T80.f1 = t2;
    _T0 = _T80;
  }{ struct _tuple15 _T80 = _T0;
...
static void * Cyc_Port_lookup_typedef(struct Cyc_Port_Cenv * env,struct _tuple0 * n) {
  struct _handler_cons * _T0;
  int _T1;
  struct _tuple15 * (* _T2)(struct Cyc_Dict_Dict,struct _tuple0 *);
  ...
  { int _TF = 0;
    ...
    { struct _tuple15 * (* _T10)(struct Cyc_Dict_Dict,struct _tuple0 *) = (struct _tuple15 * (*)(struct Cyc_Dict_Dict,
												 struct _tuple0 *))_T3;
      _T2 = _T10;
    }_T4 = env;
    _T5 = _T4->gcenv;
...
static struct _tuple14 * Cyc_Port_lookup_struct_decl(struct Cyc_Port_Cenv * env,
						     struct _tuple0 * n) {
  ...
  struct Cyc_Port_GlobalCenv * _T14;
  struct Cyc_Dict_Dict (* _T15)(struct Cyc_Dict_Dict,struct _tuple0 *,struct _tuple14 *);
  ...
  { struct _tuple14 * * (* _T1D)(struct Cyc_Dict_Dict,struct _tuple0 *) = (struct _tuple14 * * (*)(struct Cyc_Dict_Dict,
												   struct _tuple0 *))_T1;
    _T0 = _T1D;
  }_T2 = env;
  _T3 = _T2->gcenv;
  _T4 = _T3->struct_dict;
  _T5 = n;
  { struct _tuple14 * * popt = _T0(_T4,_T5);
    _T6 = popt;
    ...
    _TLEE: { struct Cyc_Absyn_Aggrdecl * ad;
      ...
      { struct _tuple14 * p;
	p = _cycalloc(sizeof(struct _tuple14));
	_T11 = p;
	_T11->f0 = ad;
	_T12 = p;
	_T12->f1 = 0;
	...
	{ struct Cyc_Dict_Dict (* _T1D)(struct Cyc_Dict_Dict,struct _tuple0 *,
					struct _tuple14 *) = (struct Cyc_Dict_Dict (*)(struct Cyc_Dict_Dict,
										       struct _tuple0 *,
...
static struct _tuple14 * Cyc_Port_lookup_union_decl(struct Cyc_Port_Cenv * env,
						    struct _tuple0 * n) {
  struct _tuple14 * * (* _T0)(struct Cyc_Dict_Dict,struct _tuple0 *);
  void * * (* _T1)(struct Cyc_Dict_Dict,void *);
  struct Cyc_Port_Cenv * _T2;
...
static struct _tuple17 Cyc_Port_lookup_var(struct Cyc_Port_Cenv * env,struct _tuple0 * x) {
  struct _handler_cons * _T0;
  int _T1;
  struct _tuple18 * (* _T2)(struct Cyc_Dict_Dict,struct _tuple0 *);
  void * (* _T3)(struct Cyc_Dict_Dict,void *);
  struct Cyc_Port_Cenv * _T4;
  struct Cyc_Dict_Dict _T5;
  struct _tuple0 * _T6;
  ...
  { int _T10 = 0;
    ...
    { struct _tuple18 * (* _T11)(struct Cyc_Dict_Dict,struct _tuple0 *) = (struct _tuple18 * (*)(struct Cyc_Dict_Dict,
												 struct _tuple0 *))_T3;
      _T2 = _T11;
    }_T4 = env;
    _T5 = _T4->var_dict;
    _T6 = x;
    _T7 = _T2(_T5,_T6);
    { struct _tuple18 _T11 = *_T7;
      unsigned int _T12;
      struct _tuple15 * _T13;
      _T13 = _T11.f1;
      _T12 = _T11.f2;
      { struct _tuple15 * p = _T13;
...
static struct _tuple18 * Cyc_Port_lookup_full_var(struct Cyc_Port_Cenv * env,
						  struct _tuple0 * x) {
  struct _tuple18 * (* _T0)(struct Cyc_Dict_Dict,struct _tuple0 *);
  void * (* _T1)(struct Cyc_Dict_Dict,void *);
  struct Cyc_Port_Cenv * _T2;
  ...
  struct _tuple18 * _T5;
  _T1 = Cyc_Dict_lookup;
  { struct _tuple18 * (* _T6)(struct Cyc_Dict_Dict,struct _tuple0 *) = (struct _tuple18 * (*)(struct Cyc_Dict_Dict,
											      struct _tuple0 *))_T1;
    _T0 = _T6;
  }_T2 = env;
  _T3 = _T2->var_dict;
...
static long Cyc_Port_isfn(struct Cyc_Port_Cenv * env,struct _tuple0 * x) {
  ...
  { int _T11 = 0;
    ...
    { struct _tuple18 * (* _T12)(struct Cyc_Dict_Dict,struct _tuple0 *) = (struct _tuple18 * (*)(struct Cyc_Dict_Dict,
												 struct _tuple0 *))_T3;
      _T2 = _T12;
    }_T4 = env;
    _T5 = _T4->var_dict;
...
static struct Cyc_Port_Cenv * Cyc_Port_add_var(struct Cyc_Port_Cenv * env,
  ...
  struct Cyc_Port_Cenv * _T0;
  struct Cyc_Port_Cenv * _T1;
  struct Cyc_Dict_Dict (* _T2)(struct Cyc_Dict_Dict,struct _tuple0 *,struct _tuple18 *);
  ...
  { struct Cyc_Port_Cenv * _TA = _cycalloc(sizeof(struct Cyc_Port_Cenv));
    ...
    { struct Cyc_Dict_Dict (* _TB)(struct Cyc_Dict_Dict,struct _tuple0 *,
				   struct _tuple18 *) = (struct Cyc_Dict_Dict (*)(struct Cyc_Dict_Dict,
										  struct _tuple0 *,
										  struct _tuple18 *))_T3;
      _T2 = _TB;
    }_T4 = env;
    _T5 = _T4->var_dict;
    _T6 = x;
    { struct _tuple18 * _TB = _cycalloc(sizeof(struct _tuple18));
      _TB->f0 = t;
      { struct _tuple15 * _TC = _cycalloc(sizeof(struct _tuple15));
	_TC->f0 = qual;
	_TC->f1 = ctype;
	_T8 = (struct _tuple15 *)_TC;
      }_TB->f1 = _T8;
      _TB->f2 = loc;
      _T7 = (struct _tuple18 *)_TB;
...
static void Cyc_Port_add_typedef(struct Cyc_Port_Cenv * env,struct _tuple0 * n,
  ...
  struct Cyc_Port_Cenv * _T0;
  struct Cyc_Port_GlobalCenv * _T1;
  struct Cyc_Dict_Dict (* _T2)(struct Cyc_Dict_Dict,struct _tuple0 *,struct _tuple15 *);
  struct Cyc_Dict_Dict (* _T3)(struct Cyc_Dict_Dict,void *,void *);
  struct Cyc_Port_Cenv * _T4;
  struct Cyc_Port_GlobalCenv * _T5;
  struct Cyc_Dict_Dict _T6;
  ...
  _T1 = _T0->gcenv;
  _T3 = Cyc_Dict_insert;
  { struct Cyc_Dict_Dict (* _T9)(struct Cyc_Dict_Dict,struct _tuple0 *,struct _tuple15 *) = (struct Cyc_Dict_Dict (*)(struct Cyc_Dict_Dict,
														      struct _tuple0 *,
														      struct _tuple15 *))_T3;
    _T2 = _T9;
  }_T4 = env;
  ...
  _T6 = _T5->typedef_dict;
  _T7 = n;
  { struct _tuple15 * _T9 = _cycalloc(sizeof(struct _tuple15));
    _T9->f0 = t;
    _T9->f1 = ct;
    _T8 = (struct _tuple15 *)_T9;
...
static void Cyc_Port_register_localvar_decl(struct Cyc_Port_Cenv * env,struct _tuple0 * x,
  ...
  { struct Cyc_List_List * _TD = _cycalloc(sizeof(struct Cyc_List_List));
    { struct _tuple19 * _TE = _cycalloc(sizeof(struct _tuple19));
      _TE->f0 = x;
      _TE->f1 = loc;
      _TE->f2 = type;
      _T3 = (struct _tuple19 *)_TE;
    }_TD->hd = _T3;
    _T4 = env;
    _T5 = _T4->gcenv;
...
static void * Cyc_Port_type_to_ctype(struct Cyc_Port_Cenv * env,void * t) {
  ...
  case 0: 
	...
	{ struct _tuple0 * n = _TD0;
	  ...
	  { struct _tuple14 * p = Cyc_Port_lookup_struct_decl(env,n);
	...
	{ struct _tuple0 * n = _TD0;
	  ...
	  { struct _tuple14 * p = Cyc_Port_lookup_union_decl(env,n);
	...
	{ struct Cyc_Absyn_Aggrdecl * * adp = _TCF;
	  ...
	  { struct Cyc_Absyn_Aggrdecl * ad = *_T22;
	    ...
	    { enum Cyc_Absyn_AggrKind _TD1 = _T23->kind;
	      ...
	      _T25 = ad;
	      _T26 = _T25->name;
	      { struct _tuple14 * p = Cyc_Port_lookup_struct_decl(_T24,_T26);
		_T27 = Cyc_Port_known_aggr_ct(p);
		return _T27;
	      }_TL12E: _T28 = env;
	      _T29 = ad;
	      _T2A = _T29->name;
	      { struct _tuple14 * p = Cyc_Port_lookup_union_decl(_T28,_T2A);
...
static struct _tuple15 Cyc_Port_gen_lhs(struct Cyc_Port_Cenv * env,struct Cyc_Absyn_Exp * e,
					long takeaddress) {
  ...
  { void * _T33 = _T0->r;
	...
	_T4 = x;
	(*_T4).f0 = Cyc_Absyn_Loc_n();
	{ struct _tuple17 _T38 = Cyc_Port_lookup_var(env,x);
	  unsigned int _T39;
	  struct _tuple15 _T3A;
	  _T3A = _T38.f0;
	  _T39 = _T38.f1;
	  { struct _tuple15 p = _T3A;
...
static void * Cyc_Port_gen_exp(long takeaddress,struct Cyc_Port_Cenv * env,
  ...
  void * _T61;
  void * _T62;
  struct Cyc_List_List * (* _T63)(void * (*)(struct Cyc_Port_Cenv *,struct Cyc_Absyn_Exp *),
				  struct Cyc_Port_Cenv *,struct Cyc_List_List *);
  struct Cyc_List_List * (* _T64)(void * (*)(void *,void *),void *,struct Cyc_List_List *);
  struct Cyc_Port_Cenv * _T65;
  ...
  struct Cyc_Port_Cfield * _T94;
  struct _fat_ptr _T95;
  void * _T96;
  void * _T97;
  void * _T98;
  struct Cyc_List_List * _T99;
  struct Cyc_Port_Cfield * _T9A;
  ...
  struct Cyc_Absyn_MallocInfo _TA4;
  void * _TA5;
  void * _TA6;
  void * _TA7;
  void * * _TA8;
  ...
  void * _TB1;
  void * _TB2;
  int (* _TB3)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TB4)(struct _fat_ptr,struct _fat_ptr);
  struct _fat_ptr _TB5;
  struct _fat_ptr _TB6;
  int (* _TB7)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TB8)(struct _fat_ptr,struct _fat_ptr);
  struct _fat_ptr _TB9;
  struct _fat_ptr _TBA;
  int (* _TBB)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TBC)(struct _fat_ptr,struct _fat_ptr);
  struct _fat_ptr _TBD;
  struct _fat_ptr _TBE;
  int (* _TBF)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TC0)(struct _fat_ptr,struct _fat_ptr);
  struct _fat_ptr _TC1;
  struct _fat_ptr _TC2;
  int (* _TC3)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TC4)(struct _fat_ptr,struct _fat_ptr);
  struct _fat_ptr _TC5;
  struct _fat_ptr _TC6;
  int (* _TC7)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TC8)(struct _fat_ptr,struct _fat_ptr);
  struct _fat_ptr _TC9;
  struct _fat_ptr _TCA;
  int (* _TCB)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TCC)(struct _fat_ptr,struct _fat_ptr);
  ...
  int (* _TE3)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TE4)(struct _fat_ptr,struct _fat_ptr);
  struct _fat_ptr _TE5;
  struct _fat_ptr _TE6;
  int (* _TE7)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TE8)(struct _fat_ptr,struct _fat_ptr);
  ...
  int (* _TF3)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TF4)(struct _fat_ptr,struct _fat_ptr);
  struct _fat_ptr _TF5;
  struct _fat_ptr _TF6;
  int (* _TF7)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TF8)(struct _fat_ptr,struct _fat_ptr);
  struct _fat_ptr _TF9;
  struct _fat_ptr _TFA;
  int (* _TFB)(struct _fat_ptr,struct _fat_ptr);
  void * (* _TFC)(struct _fat_ptr,struct _fat_ptr);
  struct _fat_ptr _TFD;
  struct _fat_ptr _TFE;
  _T0 = e;
  { void * _TFF = _T0->r;
    struct Cyc_Absyn_Stmt * _T100;
    void * * _T101;
    struct _fat_ptr * _T102;
    struct Cyc_List_List * _T103;
    struct Cyc_Absyn_Exp * _T104;
    enum Cyc_Absyn_Incrementor _T105;
    struct Cyc_Absyn_Exp * _T106;
    struct Cyc_Core_Opt * _T107;
    enum Cyc_Absyn_Primop _T108;
    void * _T109;
    _T1 = (int *)_TFF;
    _T2 = *_T1;
    switch (_T2) {
    case 0: 
      _T3 = (struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct *)_TFF;
      _T4 = _T3->f1;
      _T5 = _T4.Wstring_c;
      _T6 = _T5.tag;
      switch (_T6) {
	...
	_LL8: goto _LLA;
      case 7: 
	_LL14: _T7 = Cyc_Port_arith_ct();
	return _T7;
      case 5: 
	_T8 = (struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct *)_TFF;
	_T9 = _T8->f1;
	_TA = _T9.Int_c;
	_TB = _TA.val;
	_TC = _TB.f1;
    ...
    case 32: 
      _LL12: goto _LL14;
    case 1: 
      { struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct *)_TFF;
	_T1C = _T10A->f1;
	_T109 = (void *)_T1C;
      }{ void * b = _T109;
	struct _tuple0 * x = Cyc_Absyn_binding2qvar(b);
	...
	{ struct _tuple17 _T10A = Cyc_Port_lookup_var(env,x);
	  unsigned int _T10B;
	  struct _tuple15 _T10C;
	  _T10C = _T10A.f0;
	  _T10B = _T10A.f1;
	  { struct _tuple15 p = _T10C;
	    unsigned int loc = _T10B;
	    void * _T10D;
	    _T1E = p;
	    _T10D = _T1E.f1;
	    { void * t = _T10D;
    ...
    case 3: 
      { struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct *)_TFF;
	_T108 = _T10A->f1;
	_T109 = _T10A->f2;
      }{ enum Cyc_Absyn_Primop p = _T108;
	struct Cyc_List_List * es = _T109;
	_T33 = env;
	_T34 = p;
	_T36 = Cyc_List_map_c;
	{ struct Cyc_List_List * (* _T10A)(void * (*)(struct Cyc_Port_Cenv *,
						      struct Cyc_Absyn_Exp *),
    ...
    case 4: 
      { struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct *)_TFF;
	_T109 = _T10A->f1;
	_T107 = _T10A->f2;
	_T106 = _T10A->f3;
      }{ struct Cyc_Absyn_Exp * e1 = _T109;
	struct Cyc_Core_Opt * popt = _T107;
	struct Cyc_Absyn_Exp * e2 = _T106;
	struct _tuple15 _T10A = Cyc_Port_gen_lhs(env,e1,0);
	void * _T10B;
	void * _T10C;
	_T10C = _T10A.f0;
	_T10B = _T10A.f1;
	{ void * q = _T10C;
	  ...
	  { void * t2 = Cyc_Port_gen_exp(0,env,e2);
		...
		_T10D.hd = t1;
		_T41 = &x2;
		_T10D.tl = (struct Cyc_List_List *)_T41;
		_T40 = _T10D;
	      }{ struct Cyc_List_List x1 = _T40;
		_T42 = env;
		_T43 = popt;
		_T44 = _T43->v;
		_T45 = (enum Cyc_Absyn_Primop)_T44;
		_T46 = &x1;
    ...
    case 5: 
      { struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct *)_TFF;
	_T109 = _T10A->f1;
	_T105 = _T10A->f2;
      }{ struct Cyc_Absyn_Exp * e1 = _T109;
	enum Cyc_Absyn_Incrementor inc = _T105;
	struct _tuple15 _T10A = Cyc_Port_gen_lhs(env,e1,0);
	void * _T10B;
	void * _T10C;
	_T10C = _T10A.f0;
	...
	{ void * q = _T10C;
	  void * t = _T10B;
	  _T4A = q;
	  _T4B = Cyc_Port_notconst_ct();
	  Cyc_Port_unifies(_T4A,_T4B);
	  _T4C = t;
	  _T4D = Cyc_Port_var();
	  _T4E = Cyc_Port_var();
	  _T4F = Cyc_Port_fat_ct();
	  _T50 = Cyc_Port_var();
	  _T51 = Cyc_Port_var();
	  _T52 = Cyc_Port_ptr_ct(_T4D,_T4E,_T4F,_T50,_T51);
	  Cyc_Port_leq(_T4C,_T52);
	  _T53 = t;
	  _T54 = Cyc_Port_arith_ct();
	  Cyc_Port_leq(_T53,_T54);
	  _T55 = t;
	  return _T55;
	}
      }
    case 6: 
      { struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct *)_TFF;
	_T109 = _T10A->f1;
	_T106 = _T10A->f2;
	_T104 = _T10A->f3;
      }{ struct Cyc_Absyn_Exp * e1 = _T109;
	struct Cyc_Absyn_Exp * e2 = _T106;
	struct Cyc_Absyn_Exp * e3 = _T104;
	void * v = Cyc_Port_var();
	_T56 = Cyc_Port_gen_exp(0,env,e1);
	_T57 = Cyc_Port_arith_ct();
	Cyc_Port_leq(_T56,_T57);
	_T58 = Cyc_Port_gen_exp(0,env,e2);
	_T59 = v;
	Cyc_Port_leq(_T58,_T59);
	_T5A = Cyc_Port_gen_exp(0,env,e3);
	_T5B = v;
	Cyc_Port_leq(_T5A,_T5B);
	_T5C = v;
	return _T5C;
      }
    case 7: 
      { struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct *)_TFF;
	_T109 = _T10A->f1;
	_T106 = _T10A->f2;
      }{ struct Cyc_Absyn_Exp * e1 = _T109;
	struct Cyc_Absyn_Exp * e2 = _T106;
    ...
    case 8: 
      { struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct *)_TFF;
	_T109 = _T10A->f1;
	_T106 = _T10A->f2;
      }_LL2C: { struct Cyc_Absyn_Exp * e1 = _T109;
	struct Cyc_Absyn_Exp * e2 = _T106;
	_T5D = Cyc_Port_gen_exp(0,env,e1);
	_T5E = Cyc_Port_arith_ct();
	Cyc_Port_leq(_T5D,_T5E);
	_T5F = Cyc_Port_gen_exp(0,env,e2);
	_T60 = Cyc_Port_arith_ct();
	Cyc_Port_leq(_T5F,_T60);
	_T61 = Cyc_Port_arith_ct();
	return _T61;
      }
    case 9: 
      { struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct *)_TFF;
	_T109 = _T10A->f1;
	_T106 = _T10A->f2;
      }{ struct Cyc_Absyn_Exp * e1 = _T109;
	struct Cyc_Absyn_Exp * e2 = _T106;
	Cyc_Port_gen_exp(0,env,e1);
	_T62 = Cyc_Port_gen_exp(0,env,e2);
	return _T62;
      }
    case 10: 
      { struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct *)_TFF;
	_T109 = _T10A->f1;
	_T103 = _T10A->f2;
      }{ struct Cyc_Absyn_Exp * e1 = _T109;
	struct Cyc_List_List * es = _T103;
	void * v = Cyc_Port_var();
	void * t1 = Cyc_Port_gen_exp(0,env,e1);
	_T64 = Cyc_List_map_c;
	{ struct Cyc_List_List * (* _T10A)(void * (*)(struct Cyc_Port_Cenv *,
	...
	_T66 = es;
	{ struct Cyc_List_List * ts = _T63(Cyc_Port_gen_exp_false,_T65,_T66);
	  _T67 = ts;
	  { struct Cyc_List_List * vs = Cyc_List_map(Cyc_Port_new_var,_T67);
	    _T68 = t1;
	    _T69 = Cyc_Port_fn_ct(v,vs);
	    _T6A = Cyc_Port_var();
	    _T6B = Cyc_Port_var();
	    _T6C = Cyc_Port_var();
	    _T6D = Cyc_Port_nozterm_ct();
	    _T6E = Cyc_Port_ptr_ct(_T69,_T6A,_T6B,_T6C,_T6D);
	    Cyc_Port_unifies(_T68,_T6E);
    ...
    case 40: 
      { struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct *)_TFF;
	_T109 = _T10A->f1;
      }{ struct Cyc_Absyn_Exp * e1 = _T109;
    ...
    case 12: 
      { struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct *)_TFF;
	_T109 = _T10A->f1;
      }{ struct Cyc_Absyn_Exp * e1 = _T109;
	_T77 = Cyc_Port_gen_exp(0,env,e1);
	return _T77;
      }
    case 14: 
      { struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct *)_TFF;
	_T78 = _T10A->f1;
	_T109 = (void *)_T78;
	_T106 = _T10A->f2;
      }{ void * t = _T109;
	struct Cyc_Absyn_Exp * e1 = _T106;
    ...
    case 15: 
      { struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct *)_TFF;
	_T106 = _T10A->f1;
      }{ struct Cyc_Absyn_Exp * e1 = _T106;
	struct _tuple15 _T10A = Cyc_Port_gen_lhs(env,e1,1);
	void * _T10B;
	void * _T10C;
	_T10C = _T10A.f0;
	_T10B = _T10A.f1;
	{ void * q = _T10C;
	  ...
	  _T7D = Cyc_Port_var();
	  _T7E = Cyc_Port_var();
	  _T7F = Cyc_Port_ptr_ct(_T7A,_T7B,_T7C,_T7D,_T7E);
	  return _T7F;
	}
      }
    case 23: 
      { struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct *)_TFF;
	_T106 = _T10A->f1;
	_T104 = _T10A->f2;
      }{ struct Cyc_Absyn_Exp * e1 = _T106;
	struct Cyc_Absyn_Exp * e2 = _T104;
	void * v = Cyc_Port_var();
	_T80 = Cyc_Port_gen_exp(0,env,e2);
	_T81 = Cyc_Port_arith_ct();
	Cyc_Port_leq(_T80,_T81);
	{ void * t = Cyc_Port_gen_exp(0,env,e1);
	  _T82 = t;
	  _T83 = v;
	  _T84 = Cyc_Port_var();
	  _T85 = Cyc_Port_fat_ct();
	  _T86 = Cyc_Port_var();
	  _T87 = Cyc_Port_var();
	  _T88 = Cyc_Port_ptr_ct(_T83,_T84,_T85,_T86,_T87);
	  Cyc_Port_leq(_T82,_T88);
	  _T89 = v;
	  return _T89;
	}
      }
    case 20: 
      { struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct *)_TFF;
	_T106 = _T10A->f1;
      }{ struct Cyc_Absyn_Exp * e1 = _T106;
	void * v = Cyc_Port_var();
	_T8A = Cyc_Port_gen_exp(0,env,e1);
	_T8B = v;
	_T8C = Cyc_Port_var();
	_T8D = Cyc_Port_var();
	_T8E = Cyc_Port_var();
	_T8F = Cyc_Port_var();
	_T90 = Cyc_Port_ptr_ct(_T8B,_T8C,_T8D,_T8E,_T8F);
	Cyc_Port_leq(_T8A,_T90);
	_T91 = v;
	return _T91;
      }
    case 21: 
      { struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct *)_TFF;
	_T106 = _T10A->f1;
	_T102 = _T10A->f2;
      }{ struct Cyc_Absyn_Exp * e1 = _T106;
	struct _fat_ptr * f = _T102;
	void * v = Cyc_Port_var();
	void * t = Cyc_Port_gen_exp(takeaddress,env,e1);
	_T92 = t;
	{ struct Cyc_Port_Cfield * _T10A[1];
	  { struct Cyc_Port_Cfield * _T10B = _cycalloc(sizeof(struct Cyc_Port_Cfield));
	    _T10B->qual = Cyc_Port_var();
	    _T10B->f = f;
	    _T10B->type = v;
	    _T94 = (struct Cyc_Port_Cfield *)_T10B;
	  }_T10A[0] = _T94;
	  _T95 = _tag_fat(_T10A,sizeof(struct Cyc_Port_Cfield *),1);
	  _T93 = Cyc_List_list(_T95);
	}_T96 = Cyc_Port_unknown_aggr_ct(_T93);
	Cyc_Port_leq(_T92,_T96);
	_T97 = v;
	return _T97;
      }
    case 22: 
      { struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct *)_TFF;
	_T106 = _T10A->f1;
	_T102 = _T10A->f2;
      }{ struct Cyc_Absyn_Exp * e1 = _T106;
	struct _fat_ptr * f = _T102;
	void * v = Cyc_Port_var();
	void * t = Cyc_Port_gen_exp(0,env,e1);
	_T98 = Cyc_Port_gen_exp(0,env,e1);
	{ struct Cyc_Port_Cfield * _T10A[1];
	  { struct Cyc_Port_Cfield * _T10B = _cycalloc(sizeof(struct Cyc_Port_Cfield));
	    _T10B->qual = Cyc_Port_var();
	    _T10B->f = f;
	    _T10B->type = v;
	    _T9A = (struct Cyc_Port_Cfield *)_T10B;
	  }_T10A[0] = _T9A;
	  _T9B = _tag_fat(_T10A,sizeof(struct Cyc_Port_Cfield *),1);
	  _T99 = Cyc_List_list(_T9B);
	}_T9C = Cyc_Port_unknown_aggr_ct(_T99);
	_T9D = Cyc_Port_var();
	_T9E = Cyc_Port_var();
	_T9F = Cyc_Port_var();
	_TA0 = Cyc_Port_var();
	_TA1 = Cyc_Port_ptr_ct(_T9C,_T9D,_T9E,_T9F,_TA0);
	Cyc_Port_leq(_T98,_TA1);
	_TA2 = v;
	return _TA2;
      }
    case 33: 
      { struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct *)_TFF;
	_TA3 = _T10A->f1;
	_T101 = _TA3.elt_type;
	_TA4 = _T10A->f1;
	_T106 = _TA4.num_elts;
	...
	struct Cyc_Absyn_Exp * e1 = _T106;
	_TA5 = Cyc_Port_gen_exp(0,env,e1);
	_TA6 = Cyc_Port_arith_ct();
	Cyc_Port_leq(_TA5,_TA6);
	_TA8 = topt;
	...
	_TAB = topt;
	_TAC = *_TAB;
	_TA7 = Cyc_Port_type_to_ctype(_TAA,_TAC);
	goto _TL18A;
	_TL189: _TA7 = Cyc_Port_var();
	_TL18A: { void * t = _TA7;
	  _TAD = t;
	  _TAE = Cyc_Port_var();
	  _TAF = Cyc_Port_fat_ct();
	  _TB0 = Cyc_Port_heap_ct();
	  _TB1 = Cyc_Port_var();
	  _TB2 = Cyc_Port_ptr_ct(_TAD,_TAE,_TAF,_TB0,_TB1);
	  return _TB2;
	}
      }
    case 41: 
      _TB4 = Cyc_Warn_impos;
      { int (* _T10A)(struct _fat_ptr,struct _fat_ptr) = (int (*)(struct _fat_ptr,
								  struct _fat_ptr))_TB4;
	_TB3 = _T10A;
      }_TB5 = _tag_fat("@assert",sizeof(char),8U);
      _TB6 = _tag_fat(0U,sizeof(void *),0);
      _TB3(_TB5,_TB6);
    case 42: 
      _TB8 = Cyc_Warn_impos;
      { int (* _T10A)(struct _fat_ptr,struct _fat_ptr) = (int (*)(struct _fat_ptr,
	...
	_TB7 = _T10A;
      }_TB9 = _tag_fat("@assert_false",sizeof(char),14U);
      _TBA = _tag_fat(0U,sizeof(void *),0);
      _TB7(_TB9,_TBA);
    case 11: 
      _TBC = Cyc_Warn_impos;
      { int (* _T10A)(struct _fat_ptr,struct _fat_ptr) = (int (*)(struct _fat_ptr,
	...
	_TBB = _T10A;
      }_TBD = _tag_fat("throw",sizeof(char),6U);
      _TBE = _tag_fat(0U,sizeof(void *),0);
      _TBB(_TBD,_TBE);
    case 13: 
      _TC0 = Cyc_Warn_impos;
      { int (* _T10A)(struct _fat_ptr,struct _fat_ptr) = (int (*)(struct _fat_ptr,
	...
	_TBF = _T10A;
      }_TC1 = _tag_fat("instantiate",sizeof(char),12U);
	...
	_TC3 = _T10A;
      }_TC5 = _tag_fat("Pragma_e",sizeof(char),9U);
      _TC6 = _tag_fat(0U,sizeof(void *),0);
      _TC3(_TC5,_TC6);
    case 34: 
      { struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct *)_TFF;
	_T106 = _T10A->f1;
	_T104 = _T10A->f2;
      }{ struct Cyc_Absyn_Exp * e1 = _T106;
	struct Cyc_Absyn_Exp * e2 = _T104;
	...
	{ int (* _T10A)(struct _fat_ptr,struct _fat_ptr) = (int (*)(struct _fat_ptr,
	  ...
	  _TC7 = _T10A;
	}_TC9 = _tag_fat("Swap_e",sizeof(char),7U);
	_TCA = _tag_fat(0U,sizeof(void *),0);
	_TC7(_TC9,_TCA);
      }
    case 16: 
      _TCC = Cyc_Warn_impos;
	...
	_TCB = _T10A;
      }_TCD = _tag_fat("New_e",sizeof(char),6U);
	...
	_TCF = _T10A;
      }_TD1 = _tag_fat("CompoundLit_e",sizeof(char),14U);
      _TD2 = _tag_fat(0U,sizeof(void *),0);
      _TCF(_TD1,_TD2);
    case 25: 
      _TD4 = Cyc_Warn_impos;
      { int (* _T10A)(struct _fat_ptr,struct _fat_ptr) = (int (*)(struct _fat_ptr,
	...
	_TD3 = _T10A;
      }_TD5 = _tag_fat("Array_e",sizeof(char),8U);
	...
	_TD7 = _T10A;
      }_TD9 = _tag_fat("Comprehension_e",sizeof(char),16U);
	...
	_TDB = _T10A;
      }_TDD = _tag_fat("ComprehensionNoinit_e",sizeof(char),22U);
	...
	_TDF = _T10A;
      }_TE1 = _tag_fat("Aggregate_e",sizeof(char),12U);
	...
	_TE3 = _T10A;
      }_TE5 = _tag_fat("AnonStruct_e",sizeof(char),13U);
      _TE6 = _tag_fat(0U,sizeof(void *),0);
      _TE3(_TE5,_TE6);
    case 30: 
      _TE8 = Cyc_Warn_impos;
      { int (* _T10A)(struct _fat_ptr,struct _fat_ptr) = (int (*)(struct _fat_ptr,
	...
	_TE7 = _T10A;
      }_TE9 = _tag_fat("Datatype_e",sizeof(char),11U);
	...
	_TEB = _T10A;
      }_TED = _tag_fat("UnresolvedMem_e",sizeof(char),16U);
      _TEE = _tag_fat(0U,sizeof(void *),0);
      _TEB(_TED,_TEE);
    case 36: 
      { struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct * _T10A = (struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct *)_TFF;
	_T100 = _T10A->f1;
      }{ struct Cyc_Absyn_Stmt * s = _T100;
	_TF0 = Cyc_Warn_impos;
	{ int (* _T10A)(struct _fat_ptr,struct _fat_ptr) = (int (*)(struct _fat_ptr,
								    struct _fat_ptr))_TF0;
	  _TEF = _T10A;
	}_TF1 = _tag_fat("StmtExp_e",sizeof(char),10U);
	...
	_TF3 = _T10A;
      }_TF5 = _tag_fat("Valueof_e",sizeof(char),10U);
      _TF6 = _tag_fat(0U,sizeof(void *),0);
      _TF3(_TF5,_TF6);
    case 39: 
      _TF8 = Cyc_Warn_impos;
      { int (* _T10A)(struct _fat_ptr,struct _fat_ptr) = (int (*)(struct _fat_ptr,
	...
	_TF7 = _T10A;
      }_TF9 = _tag_fat("Asm_e",sizeof(char),6U);
      _TFA = _tag_fat(0U,sizeof(void *),0);
      _TF7(_TF9,_TFA);
    default: 
      _TFC = Cyc_Warn_impos;
      { int (* _T10A)(struct _fat_ptr,struct _fat_ptr) = (int (*)(struct _fat_ptr,
	...
	_TFB = _T10A;
      }_TFD = _tag_fat("Tagcheck_e",sizeof(char),11U);
      _TFE = _tag_fat(0U,sizeof(void *),0);
      _TFB(_TFD,_TFE);
    }
    ;
  }
	...
	LOOP: { struct Cyc_Absyn_Aggrdecl * _T65;
	  ...
	  case 5: 
	    ...
	    { struct Cyc_Absyn_ArrayType_Absyn_Type_struct * _T6A = (struct Cyc_Absyn_ArrayType_Absyn_Type_struct *)_T8;
	      ...
	      _TL195: _TC = dles;
	      _TD = _TC->hd;
	      _TE = (struct _tuple21 *)_TD;
	      { struct _tuple21 _T6A = *_TE;
	  ...
	  case 0: 
		...
		_TL1A3: _T3E = dles;
		_T3F = _T3E->hd;
		_T40 = (struct _tuple21 *)_T3F;
		{ struct _tuple21 _T6A = *_T40;
		  struct Cyc_Absyn_Exp * _T6B;
		  struct Cyc_List_List * _T6C;
		  _T6C = _T6A.f0;
		  _T6B = _T6A.f1;
...
static struct Cyc_Port_Cenv * Cyc_Port_gen_topdecl(struct Cyc_Port_Cenv * env,
  ...
  unsigned int _TB6;
  struct _tuple14 * _TB7;
  struct _tuple14 _TB8;
  ...
  struct _tuple14 _TDB;
  struct Cyc_List_List * _TDC;
  struct _tuple14 * _TDD;
  ...
  { void * _T101 = _T0->r;
	...
	_T10 = vd;
	_T11 = _T10->name;
	{ struct _tuple17 _T107 = Cyc_Port_lookup_var(_TF,_T11);
	  unsigned int _T108;
	  struct _tuple15 _T109;
	  _T109 = _T107.f0;
	  _T108 = _T107.f1;
	  { struct _tuple15 p = _T109;
		...
		{ struct Cyc_Port_Cenv * fn_env = Cyc_Port_set_cpos(env,2U);
		  ...
		  { struct Cyc_List_List * xs = args;
			...
			_TL1CA: { struct Cyc_List_List * _T10B = _cycalloc(sizeof(struct Cyc_List_List));
			  { struct _tuple22 * _T10C = _cycalloc(sizeof(struct _tuple22));
			    _T10C->f0 = x;
			    _T10C->f1 = t;
			    _T10C->f2 = tqv;
			    _T10C->f3 = ct;
			    _T71 = (struct _tuple22 *)_T10C;
			  }_T10B->hd = _T71;
			  _T10B->tl = c_args;
		  ...
		  { void * ctype = Cyc_Port_fn_ct(c_rettype,c_arg_types);
		    ...
		    { struct Cyc_List_List * xs = c_args;
		      ...
		      _TL1D0: _T7F = xs;
		      _T80 = _T7F->hd;
		      _T81 = (struct _tuple22 *)_T80;
		      { struct _tuple22 _T107 = *_T81;
			void * _T108;
			void * _T109;
			void * _T10A;
		    ...
		    { struct Cyc_Dict_Dict counts = _T8B(_T8D);
		      ...
		      _T9F = predeclared;
		      { struct _tuple18 _T107 = *_T9F;
			void * _T108;
			void * _T109;
			void * _T10A;
			_T10A = _T107.f0;
			_TA0 = _T107.f1;
			{ struct _tuple15 _T10B = *_TA0;
			  _T109 = _T10B.f0;
			  _T108 = _T10B.f1;
  ...
  { struct Cyc_Port_Cenv * env = Cyc_Port_gen_topdecls(_T0,_T1);
	...
	{ struct Cyc_List_List * zts = _T7->zeroterm_edits;
	  ...
	  { struct Cyc_List_List * edits = _T9->edits;
		...
		_TL1F4: _TE = ps;
		_TF = _TE->hd;
		_T10 = (struct _tuple20 *)_TF;
		{ struct _tuple20 _T56 = *_T10;
		  unsigned int _T57;
		  void * _T58;
		  void * _T59;
		  _T59 = _T56.f0;
		...
		_TL1F8: _T14 = cs;
		_T15 = _T14->hd;
		_T16 = (struct _tuple20 *)_T15;
		{ struct _tuple20 _T56 = *_T16;
		  unsigned int _T57;
		  void * _T58;
		  void * _T59;
		  _T59 = _T56.f0;
		...
		_TL1FC: _T1A = zs;
		_T1B = _T1A->hd;
		_T1C = (struct _tuple20 *)_T1B;
		{ struct _tuple20 _T56 = *_T1C;
		  unsigned int _T57;
		  void * _T58;
		  void * _T59;
		  _T59 = _T56.f0;
		...
		_TL1FD: ;
	      ...
	      _TL200: _T20 = ptrs;
	      _T21 = _T20->hd;
	      _T22 = (struct _tuple20 *)_T21;
	      { struct _tuple20 _T56 = *_T22;
		unsigned int _T57;
		void * _T58;
		void * _T59;
		_T59 = _T56.f0;
		...
		{ void * new_ctype = _T59;
	      ...
	      _TL208: _T2F = consts;
	      _T30 = _T2F->hd;
	      _T31 = (struct _tuple20 *)_T30;
	      { struct _tuple20 _T56 = *_T31;
		unsigned int _T57;
		void * _T58;
		void * _T59;
		_T59 = _T56.f0;
