...
_TL3: _T2=es2;_T3=_T2->hd;{struct _tuple17*_T12=(struct _tuple17*)_T3;void*_T13;void*_T14;{struct _tuple17 _T15=*_T12;_T14=_T15.f0;_T4=& _T12->f1;_T13=(int*)_T4;}{void*t=_T14;int*b2=(int*)_T13;
...
# 100
es2=_TC->tl;goto _TL5;_TL4:;}{struct Cyc_List_List*_T12=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple17*_T13=_cycalloc(sizeof(struct _tuple17));
# 112
_T13->f0=e;_T13->f1=b;_TE=(struct _tuple17*)_T13;}_T12->hd=_TE;_T12->tl=es;_TD=(struct Cyc_List_List*)_T12;}return _TD;}_TL0: _TF=es;
return _TF;;}
# 118
...
# 198
static int Cyc_Tctyp_cmp_fqv(struct _tuple17*te1,struct _tuple17*te2){struct _tuple17*_T0;struct _tuple17 _T1;struct _tuple17*_T2;struct _tuple17 _T3;int _T4;int _T5;_T0=te1;_T1=*_T0;{
...
return _T43;}}}}struct _tuple18{struct Cyc_Tctyp_CVTEnv f0;struct Cyc_AssnDef_AssnMap f1;};
# 344
static struct _tuple18 Cyc_Tctyp_check_clause(struct Cyc_Tctyp_CVTEnv env,struct _fat_ptr clause_name,struct Cyc_Absyn_Exp*clause){struct _tuple18 _T0;struct Cyc_Tctyp_CVTEnv _T1;struct Cyc_Tcenv_Tenv*_T2;struct Cyc_Absyn_Exp*_T3;int _T4;struct Cyc_Warn_String_Warn_Warg_struct _T5;struct Cyc_Warn_String_Warn_Warg_struct _T6;struct Cyc_Warn_TypOpt_Warn_Warg_struct _T7;struct Cyc_Absyn_Exp*_T8;struct Cyc_Warn_String_Warn_Warg_struct _T9;struct Cyc_Tctyp_CVTEnv _TA;unsigned _TB;struct _fat_ptr _TC;struct _tuple18 _TD;
# 347
if(clause!=0)goto _TL61;{struct _tuple18 _TE;
...
struct Cyc_AssnDef_AssnMap assnmap=Cyc_Vcgen_clause2assn(clause);{struct _tuple18 _TE;
...
# 506
_TLA3: _T3D=env;_T3E=& Cyc_Kinds_aqk;_T3F=(struct Cyc_Absyn_Kind*)_T3E;_T40=ts;_T41=_T40->tl;_T42=_check_null(_T41);_T43=_T42->hd;env=Cyc_Tctyp_i_check_type(_T3D,_T3F,_T43,0,0);_TLA4:{struct Cyc_List_List*_TD2=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple17*_TD3=_cycalloc(sizeof(struct _tuple17));
# 508
_TD3->f0=apptype;_TD3->f1=0;_T45=(struct _tuple17*)_TD3;}_TD2->hd=_T45;_T46=env;_TD2->tl=_T46.free_qualvars;_T44=(struct Cyc_List_List*)_TD2;}env.free_qualvars=_T44;_T47=env;
return _T47;}case 3:
# 511
...
# 585
static int Cyc_Tctyp_aqualvar_unconstrained(struct _tuple17*t){struct _tuple17*_T0;struct _tuple17 _T1;void*_T2;int*_T3;int _T4;struct Cyc_Absyn_AppType_Absyn_Type_struct*_T5;void*_T6;int*_T7;unsigned _T8;struct Cyc_Warn_String_Warn_Warg_struct _T9;struct Cyc_Warn_Typ_Warn_Warg_struct _TA;struct _tuple17*_TB;struct _tuple17 _TC;int(*_TD)(struct _fat_ptr);void*(*_TE)(struct _fat_ptr);struct _fat_ptr _TF;_T0=t;_T1=*_T0;_T2=_T1.f0;{
...
_TLE1: _T0=vars;_T1=_T0->hd;{struct _tuple17*_T9A=(struct _tuple17*)_T1;int _T9B;void*_T9C;{struct _tuple17 _T9D=*_T9A;_T9C=_T9D.f0;_T9B=_T9D.f1;}{void*v=_T9C;int existential=_T9B;_T2=make_ex_aliasable;
...
# 703
static struct _tuple17*Cyc_Tctyp_tvar2type(struct _tuple12*in){struct _tuple12*_T0;struct _tuple17*_T1;int _T2;struct Cyc_Absyn_Tvar*_T3;_T0=in;{struct _tuple12 _T4=*_T0;_T3=_T4.f0;_T2=_T4.f1;}{struct Cyc_Absyn_Tvar*tv=_T3;int b=_T2;
# 705
void*t=Cyc_Absyn_var_type(tv);{struct _tuple17*_T4=_cycalloc(sizeof(struct _tuple17));
_T4->f0=t;_T4->f1=b;_T1=(struct _tuple17*)_T4;}return _T1;}}
# 709
static int Cyc_Tctyp_evar_unconstrained(struct _tuple17*evb){struct _tuple17*_T0;struct _tuple17 _T1;void*_T2;int*_T3;int _T4;_T0=evb;_T1=*_T0;_T2=_T1.f0;{
void*_T5=Cyc_Absyn_compress(_T2);_T3=(int*)_T5;_T4=*_T3;if(_T4!=1)goto _TL122;
return 1;_TL122:
 return 0;;}}
# 716
static void Cyc_Tctyp_update_qualifier_bounds(unsigned loc,struct Cyc_Tctyp_CVTEnv env,struct Cyc_List_List*flagged_tvars,struct Cyc_List_List**qb,void*def){struct Cyc_Tctyp_CVTEnv _T0;struct Cyc_Tctyp_CVTEnv _T1;unsigned _T2;struct Cyc_Tctyp_CVTEnv _T3;struct Cyc_List_List*(*_T4)(struct _tuple17*(*)(struct _tuple12*),struct Cyc_List_List*);struct Cyc_List_List*(*_T5)(void*(*)(void*),struct Cyc_List_List*);struct Cyc_List_List*_T6;struct Cyc_List_List*_T7;struct Cyc_List_List**_T8;void*_T9;unsigned _TA;struct Cyc_Tctyp_CVTEnv _TB;struct Cyc_List_List*(*_TC)(struct _tuple17*(*)(struct _tuple12*),struct Cyc_List_List*);struct Cyc_List_List*(*_TD)(void*(*)(void*),struct Cyc_List_List*);struct Cyc_Tctyp_CVTEnv _TE;struct Cyc_List_List*_TF;struct Cyc_List_List*_T10;struct Cyc_List_List**_T11;void*_T12;unsigned _T13;struct Cyc_Tctyp_CVTEnv _T14;struct Cyc_List_List*(*_T15)(int(*)(struct _tuple17*),struct Cyc_List_List*);struct Cyc_List_List*(*_T16)(int(*)(void*),struct Cyc_List_List*);struct Cyc_List_List*_T17;struct Cyc_List_List*_T18;struct Cyc_List_List**_T19;void*_T1A;unsigned _T1B;struct Cyc_Tctyp_CVTEnv _T1C;struct Cyc_List_List*(*_T1D)(int(*)(struct _tuple17*),struct Cyc_List_List*);struct Cyc_List_List*(*_T1E)(int(*)(void*),struct Cyc_List_List*);struct Cyc_List_List*_T1F;struct Cyc_List_List*_T20;struct Cyc_List_List**_T21;void*_T22;_T0=env;{
# 720
...
struct Cyc_List_List*(*_T23)(struct _tuple17*(*)(struct _tuple12*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple17*(*)(struct _tuple12*),struct Cyc_List_List*))_T5;_T4=_T23;}_T6=flagged_tvars;_T7=_T4(Cyc_Tctyp_tvar2type,_T6);_T8=qb;_T9=def;Cyc_Tctyp_constrain_vars(_T2,_T3,_T7,_T8,_T9,1);_TA=loc;_TB=env;_TD=Cyc_List_map;{
struct Cyc_List_List*(*_T23)(struct _tuple17*(*)(struct _tuple12*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple17*(*)(struct _tuple12*),struct Cyc_List_List*))_TD;_TC=_T23;}_TE=env;_TF=_TE.free_vars;_T10=_TC(Cyc_Tctyp_tvar2type,_TF);_T11=qb;_T12=def;Cyc_Tctyp_constrain_vars(_TA,_TB,_T10,_T11,_T12,0);_T13=loc;_T14=env;_T16=Cyc_List_filter;{
struct Cyc_List_List*(*_T23)(int(*)(struct _tuple17*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(int(*)(struct _tuple17*),struct Cyc_List_List*))_T16;_T15=_T23;}_T17=freeevs;_T18=_T15(Cyc_Tctyp_evar_unconstrained,_T17);_T19=qb;_T1A=def;Cyc_Tctyp_constrain_vars(_T13,_T14,_T18,_T19,_T1A,0);_T1B=loc;_T1C=env;_T1E=Cyc_List_filter;{
struct Cyc_List_List*(*_T23)(int(*)(struct _tuple17*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(int(*)(struct _tuple17*),struct Cyc_List_List*))_T1E;_T1D=_T23;}_T1F=freeqvs;_T20=_T1D(Cyc_Tctyp_aqualvar_unconstrained,_T1F);_T21=qb;_T22=def;Cyc_Tctyp_constrain_vars(_T1B,_T1C,_T20,_T21,_T22,0);}}}
# 728
...
_tag_fat("@checks",sizeof(char),8U);_T291=chk;{struct _tuple18 _T3E4=Cyc_Tctyp_check_clause(_T28F,_T290,_T291);struct Cyc_AssnDef_AssnMap _T3E5;struct Cyc_Tctyp_CVTEnv _T3E6;_T3E6=_T3E4.f0;_T3E5=_T3E4.f1;{struct Cyc_Tctyp_CVTEnv nenv=_T3E6;struct Cyc_AssnDef_AssnMap chk_assn=_T3E5;
...
_tag_fat("@requires",sizeof(char),10U);_T295=req;{struct _tuple18 _T3E4=Cyc_Tctyp_check_clause(_T293,_T294,_T295);struct Cyc_AssnDef_AssnMap _T3E5;struct Cyc_Tctyp_CVTEnv _T3E6;_T3E6=_T3E4.f0;_T3E5=_T3E4.f1;{struct Cyc_Tctyp_CVTEnv nenv=_T3E6;struct Cyc_AssnDef_AssnMap req_assn=_T3E5;
...
_tag_fat("@ensures",sizeof(char),9U);_T29C=ens;{struct _tuple18 _T3E4=Cyc_Tctyp_check_clause(_T29A,_T29B,_T29C);struct Cyc_AssnDef_AssnMap _T3E5;struct Cyc_Tctyp_CVTEnv _T3E6;_T3E6=_T3E4.f0;_T3E5=_T3E4.f1;{struct Cyc_Tctyp_CVTEnv nenv=_T3E6;struct Cyc_AssnDef_AssnMap ens_assn=_T3E5;
...
_tag_fat("@throws",sizeof(char),8U);_T2A2=thrws;{struct _tuple18 _T3E4=Cyc_Tctyp_check_clause(_T2A0,_T2A1,_T2A2);struct Cyc_AssnDef_AssnMap _T3E5;struct Cyc_Tctyp_CVTEnv _T3E6;_T3E6=_T3E4.f0;_T3E5=_T3E4.f1;{struct Cyc_Tctyp_CVTEnv nenv=_T3E6;struct Cyc_AssnDef_AssnMap thrws_assn=_T3E5;
...
_TL216: _T2DB=ts;_T2DC=_T2DB->hd;_T2DD=(struct _tuple17*)_T2DC;{struct _tuple17 _T3E4=*_T2DD;int _T3E5;void*_T3E6;_T3E6=_T3E4.f0;_T3E5=_T3E4.f1;{void*tv=_T3E6;int put_in_eff=_T3E5;_T2DE=put_in_eff;
...
_TL22C: _T328=evs;_T329=_T328->hd;_T32A=(struct _tuple17*)_T329;{struct _tuple17 _T3E4=*_T32A;int _T3E5;void*_T3E6;_T3E6=_T3E4.f0;_T3E5=_T3E4.f1;{void*e=_T3E6;int b=_T3E5;_T32B=env;_T32C=_T32B.free_evars;_T32D=e;_T32E=b;
...
_TL232: _T335=Cyc_List_exists_c;{int(*_T3E4)(int(*)(struct _tuple17*,struct _tuple17*),struct _tuple17*,struct Cyc_List_List*)=(int(*)(int(*)(struct _tuple17*,struct _tuple17*),struct _tuple17*,struct Cyc_List_List*))_T335;_T334=_T3E4;}_T336=it;_T337=_T336->hd;_T338=(struct _tuple17*)_T337;_T339=env;_T33A=_T339.free_qualvars;_T33B=_T334(Cyc_Tctyp_cmp_fqv,_T338,_T33A);if(_T33B)goto _TL235;else{goto _TL237;}
_TL237:{struct Cyc_List_List*_T3E4=_cycalloc(sizeof(struct Cyc_List_List));_T33D=it;_T33E=_T33D->hd;_T3E4->hd=(struct _tuple17*)_T33E;_T33F=env;_T3E4->tl=_T33F.free_qualvars;_T33C=(struct Cyc_List_List*)_T3E4;}env.free_qualvars=_T33C;goto _TL236;_TL235: _TL236: _T340=it;
# 1300
...
_tag_fat("@subset",sizeof(char),8U);_T38D=e;{struct _tuple18 _T3E4=Cyc_Tctyp_check_clause(_T38B,_T38C,_T38D);struct Cyc_AssnDef_AssnMap _T3E5;struct Cyc_Tctyp_CVTEnv _T3E6;_T3E6=_T3E4.f0;_T3E5=_T3E4.f1;{struct Cyc_Tctyp_CVTEnv nenv=_T3E6;struct Cyc_AssnDef_AssnMap assn=_T3E5;
env=nenv;_T38E=a;
...
_TL254:{struct Cyc_List_List*_T3E4=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple20*_T3E5=_cycalloc(sizeof(struct _tuple20));_T3B3=tvs;_T3B4=_T3B3->hd;_T3E5->f0=(struct Cyc_Absyn_Tvar*)_T3B4;_T3B5=_check_null(ts);_T3E5->f1=_T3B5->hd;_T3B2=(struct _tuple20*)_T3E5;}_T3E4->hd=_T3B2;_T3E4->tl=inst;_T3B1=(struct Cyc_List_List*)_T3E4;}inst=_T3B1;_T3B6=tvs;
# 1371
...
return _T3C8;}}
# 1384
static struct Cyc_Tctyp_CVTEnv Cyc_Tctyp_check_valid_type(struct Cyc_Tctyp_CVTEnv cvt,struct Cyc_Absyn_Kind*expected_kind,int allow_abs_aggr,void*t){struct Cyc_Tctyp_CVTEnv _T0;struct Cyc_Tctyp_CVTEnv _T1;struct Cyc_List_List*_T2;struct Cyc_List_List*_T3;void*_T4;struct _tuple12*_T5;struct _tuple12 _T6;struct Cyc_Absyn_Tvar*_T7;struct Cyc_List_List*_T8;struct Cyc_Tctyp_CVTEnv _T9;struct Cyc_List_List*_TA;void*_TB;struct _tuple17*_TC;int*_TD;int _TE;struct Cyc_Absyn_Evar_Absyn_Type_struct*_TF;struct Cyc_Core_Opt**_T10;struct Cyc_Core_Opt**_T11;struct Cyc_Core_Opt*_T12;struct Cyc_Core_Opt**_T13;struct Cyc_Core_Opt*_T14;struct Cyc_Core_Opt**_T15;struct Cyc_Core_Opt*_T16;void*_T17;int(*_T18)(int(*)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*,struct Cyc_Absyn_Tvar*);int(*_T19)(int(*)(void*,void*),struct Cyc_List_List*,void*);int(*_T1A)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*);struct Cyc_List_List*_T1B;struct Cyc_List_List*_T1C;void*_T1D;struct Cyc_Absyn_Tvar*_T1E;int _T1F;struct Cyc_List_List*_T20;struct Cyc_List_List*_T21;void*_T22;struct Cyc_List_List*_T23;struct Cyc_Core_Opt**_T24;struct Cyc_Core_Opt*_T25;struct Cyc_List_List*_T26;struct Cyc_Tctyp_CVTEnv _T27;_T0=cvt;{
# 1386
...
_TL25F: _TA=evs;_TB=_TA->hd;_TC=(struct _tuple17*)_TB;{struct _tuple17 _T28=*_TC;void*_T29;_T29=_T28.f0;{void*e=_T29;
