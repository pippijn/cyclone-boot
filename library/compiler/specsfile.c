...
# 187
 if(j >= 4096)goto _TL4C;_T43=buf;_T44=j;
_T43[_T44]='\000';goto _TL4D;_TL4C: _TL4D:{struct Cyc_List_List*_T59=_cycalloc(sizeof(struct Cyc_List_List));{struct _fat_ptr*_T5A=_cycalloc(sizeof(struct _fat_ptr));_T47=buf;_T48=
# 190
_tag_fat(_T47,sizeof(char),4096U);_T49=Cyc_strdup(_T48);*_T5A=_T49;_T46=(struct _fat_ptr*)_T5A;}_T59->hd=_T46;_T59->tl=l;_T45=(struct Cyc_List_List*)_T59;}l=_T45;goto _TL30;_TL32:
# 192
 DONE:
 l=Cyc_List_imp_rev(l);{struct Cyc_List_List*_T59=_cycalloc(sizeof(struct Cyc_List_List));{struct _fat_ptr*_T5A=_cycalloc(sizeof(struct _fat_ptr));
*_T5A=_tag_fat("",sizeof(char),1U);_T4B=(struct _fat_ptr*)_T5A;}_T59->hd=_T4B;_T59->tl=l;_T4A=(struct Cyc_List_List*)_T59;}l=_T4A;{
struct _fat_ptr ptrarray=Cyc_List_to_array(l);_T4D=ptrarray;{unsigned _T59=
_get_fat_size(_T4D,sizeof(struct _fat_ptr*));_T4F=_check_times(_T59,sizeof(struct _fat_ptr));{struct _fat_ptr*_T5A=_cycalloc(_T4F);{unsigned _T5B=_T59;unsigned k;k=0;_TL51: if(k < _T5B)goto _TL4F;else{goto _TL50;}_TL4F: _T50=k;_T51=ptrarray;_T52=_T51.curr;_T53=(struct _fat_ptr**)_T52;_T54=_check_null(_T53);_T55=k;_T56=(int)_T55;_T57=_T54[_T56];_T5A[_T50]=*_T57;k=k + 1;goto _TL51;_TL50:;}_T4E=(struct _fat_ptr*)_T5A;}_T4C=_tag_fat(_T4E,sizeof(struct _fat_ptr),_T59);}{struct _fat_ptr result=_T4C;_T58=result;
return _T58;}}}}
# 200
...
_TL74: _T36=bindices;_T37=_T36.curr;_T38=(int*)_T37;_T39=i;_T3A=_T38[_T39];if(!_T3A)goto _TL77;_T3B=bargs;_T3C=j;j=_T3C + 1;_T3D=_T3C;_T3E=_check_fat_subscript(_T3B,sizeof(struct _fat_ptr),_T3D);_T3F=(struct _fat_ptr*)_T3E;_T40=argv;_T41=_T40.curr;_T42=(struct _fat_ptr*)_T41;_T43=i;*_T3F=_T42[_T43];goto _TL78;
