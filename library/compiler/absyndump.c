...
struct Cyc_List_List*(*_TE2)(struct _tuple16*(*)(struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple16*(*)(struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*))_TB8;_TB7=_TE2;}_TB9=fs;_TBA=_TB7(Cyc_Absyndump_aggrfield2arg,_TB9);Cyc_Absyndump_dumpargs(_TBA);goto _TL91;
# 644
...
Cyc_Absyndump_dump_nospace(_T7);goto _LL0;}_LL0:;}struct _tuple18{struct Cyc_List_List*f0;struct Cyc_Absyn_Exp*f1;};
# 981
...
return;};}struct _tuple19{struct _fat_ptr f0;struct Cyc_Absyn_Exp*f1;};
# 999
...
# 1551
int(*_T1C)(struct Cyc_Dict_Dict,struct _tuple1*)=(int(*)(struct Cyc_Dict_Dict,struct _tuple1*))_T4;_T3=_T1C;}_T5=s;_T6=vd;_T7=_T6->name;_T8=_T3(_T5,_T7);if(!_T8)goto _TL115;{struct _tuple20 _T1C;
_T1C.f0=1;_TB=Cyc_Dict_singleton;{struct Cyc_Dict_Dict(*_T1D)(int(*)(struct _tuple1*,struct _tuple1*),struct _tuple1*,struct _tuple1*)=(struct Cyc_Dict_Dict(*)(int(*)(struct _tuple1*,struct _tuple1*),struct _tuple1*,struct _tuple1*))_TB;_TA=_T1D;}_TC=Cyc_Absyn_qvar_cmp;_TD=vd;_TE=_TD->name;_TF=vd;_T10=_TF->name;_T1C.f1=_TA(_TC,_TE,_T10);_T9=_T1C;}return _T9;_TL115:{struct _tuple20 _T1C;
...
_tag_fat(");",sizeof(char),3U);Cyc_Absyndump_dump_nospace(_T5C);goto _LL0;}}_LL0:;}}struct _tuple21{struct Cyc_List_List*f0;struct Cyc_Absyn_Pat*f1;};
# 1782
...
Cyc_Absyndump_dump_char(125);goto _TL199;_TL198: _TL199:;}}struct _tuple23{unsigned f0;struct _tuple1*f1;int f2;};
# 2165
