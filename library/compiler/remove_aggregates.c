...
_T18->topt=Cyc_Absyn_char_type;{struct Cyc_List_List*_T160=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple14*_T161=_cycalloc(sizeof(struct _tuple14));
_T161->f0=0;_T161->f1=c;_T1A=(struct _tuple14*)_T161;}_T160->hd=_T1A;_T160->tl=dles;_T19=(struct Cyc_List_List*)_T160;}dles=_T19;}
# 116
...
_TL21: _T6F=dles2;_T70=_T6F->hd;{struct _tuple14*_T160=(struct _tuple14*)_T70;struct Cyc_Absyn_Exp*_T161;struct Cyc_List_List*_T162;{struct _tuple14 _T163=*_T160;_T162=_T163.f0;_T161=_T163.f1;}{struct Cyc_List_List*ds=_T162;struct Cyc_Absyn_Exp*field_exp=_T161;
...
int(*_T160)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T7B;_T7A=_T160;}_T7C=_tag_fat("zero-field aggregate",sizeof(char),21U);_T7D=_tag_fat(0U,sizeof(void*),0);_T7A(_T7C,_T7D);goto _TL25;_TL24: _TL25: _T7E=dles;_T7F=_T7E->hd;_T80=(struct _tuple14*)_T7F;_T81=*_T80;{
# 190
struct Cyc_Absyn_Exp*init_e=_T81.f1;_T82=dles;
dles=_T82->tl;_TL29: if(dles!=0)goto _TL27;else{goto _TL28;}
_TL27: _T83=dles;_T84=_T83->hd;_T85=(struct _tuple14*)_T84;_T86=*_T85;{struct Cyc_Absyn_Exp*e2=_T86.f1;_T87=e2;_T88=_T87->topt;
...
# 232
_TL35: _TB8=dles2;_TB9=_TB8->hd;{struct _tuple14*_T160=(struct _tuple14*)_TB9;struct Cyc_Absyn_Exp*_T161;{struct _tuple14 _T162=*_T160;_T161=_T162.f1;}{struct Cyc_Absyn_Exp*field_exp=_T161;_TBA=
...
# 229
dles2=_TC2->tl;i=i + 1;goto _TL37;_TL36:;}_TC3=dles;_TC4=_TC3->hd;_TC5=(struct _tuple14*)_TC4;_TC6=*_TC5;{
# 239
struct Cyc_Absyn_Exp*init_e=_TC6.f1;_TC7=dles;
dles=_TC7->tl;_TL3B: if(dles!=0)goto _TL39;else{goto _TL3A;}
_TL39: _TC8=dles;_TC9=_TC8->hd;_TCA=(struct _tuple14*)_TC9;_TCB=*_TCA;{struct Cyc_Absyn_Exp*e2=_TCB.f1;_TCC=
