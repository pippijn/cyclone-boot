...
# 1232
_TLFF: if(1)goto _TL100;else{goto _TL101;}
# 1234
_TL100: _T0=f1(env,e);if(_T0)goto _TL102;else{goto _TL104;}
_TL104: return;_TL102: _T1=e;{
# 1237
...
# 1322
_TL119: if(sl1!=0)goto _TL117;else{goto _TL118;}
_TL117: _T36=f1;_T37=f2;_T38=env;_T39=sl1;_T3A=_T39->hd;_T3B=(struct _tuple17*)_T3A;_T3C=*_T3B;_T3D=_T3C.f1;Cyc_Absyn_visit_exp(_T36,_T37,_T38,_T3D);_T3E=sl1;
# 1322
sl1=_T3E->tl;goto _TL119;_TL118:
# 1324
 _TL11D: if(sl2!=0)goto _TL11B;else{goto _TL11C;}
_TL11B: _T3F=f1;_T40=f2;_T41=env;_T42=sl2;_T43=_T42->hd;_T44=(struct _tuple17*)_T43;_T45=*_T44;_T46=_T45.f1;Cyc_Absyn_visit_exp(_T3F,_T40,_T41,_T46);_T47=sl2;
# 1324
sl2=_T47->tl;goto _TL11D;_TL11C: goto _LL0;}}_LL0:;}
# 1329
return;goto _TLFF;_TL101:;}
# 1333
...
# 1339
_TL121: if(scs!=0)goto _TL11F;else{goto _TL120;}
# 1341
_TL11F: _T0=scs;_T1=_T0->hd;_T2=(struct Cyc_Absyn_Switch_clause*)_T1;_T3=_T2->where_clause;if(_T3==0)goto _TL122;_T4=f1;_T5=f2;_T6=env;_T7=scs;_T8=_T7->hd;_T9=(struct Cyc_Absyn_Switch_clause*)_T8;_TA=_T9->where_clause;
Cyc_Absyn_visit_exp(_T4,_T5,_T6,_TA);goto _TL123;_TL122: _TL123: _TB=f1;_TC=f2;_TD=env;_TE=scs;_TF=_TE->hd;_T10=(struct Cyc_Absyn_Switch_clause*)_TF;_T11=_T10->body;
Cyc_Absyn_visit_stmt(_TB,_TC,_TD,_T11);_T12=scs;
# 1339
scs=_T12->tl;goto _TL121;_TL120:;}
# 1349
...
s=s1;goto _TL124;}case 11:{struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*_T5E=(struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_T56;_T58=_T5E->f1;}{struct Cyc_List_List*es=_T58;
# 1398
_TL12F: if(es!=0)goto _TL12D;else{goto _TL12E;}
_TL12D: _T23=f1;_T24=f2;_T25=env;_T26=es;_T27=_T26->hd;_T28=(struct Cyc_Absyn_Exp*)_T27;Cyc_Absyn_visit_exp(_T23,_T24,_T25,_T28);_T29=es;
# 1398
es=_T29->tl;goto _TL12F;_TL12E: goto _LL0;}case 12:{struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*_T5E=(struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_T56;_T57=_T5E->f1;_T5C=_T5E->f2;}{struct Cyc_Absyn_Decl*d=_T57;struct Cyc_Absyn_Stmt*s1=_T5C;_T2A=d;{
# 1403
...
# 1406
if(_T2E==0)goto _TL131;_T2F=f1;_T30=f2;_T31=env;_T32=vd;_T33=_T32->initializer;
Cyc_Absyn_visit_exp(_T2F,_T30,_T31,_T33);goto _TL132;_TL131: _TL132: goto _LL23;}case 1:{struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*_T62=(struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_T5E;_T60=_T62->f1;}{struct Cyc_Absyn_Fndecl*fd=_T60;_T34=f1;_T35=f2;_T36=env;_T37=fd;_T38=_T37->body;
# 1410
...
# 1416
if(!_T3E)goto _TL133;_T3F=f1;_T40=f2;_T41=env;_T42=eo;
Cyc_Absyn_visit_exp(_T3F,_T40,_T41,_T42);goto _TL134;_TL133: _TL134: goto _LL23;}default: goto _LL23;}_LL23:;}
# 1422
s=s1;goto _TL124;}case 13:{struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*_T5E=(struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*)_T56;_T5C=_T5E->f2;}{struct Cyc_Absyn_Stmt*s1=_T5C;
# 1426
s=s1;goto _TL124;}case 10:{struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*_T5E=(struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_T56;_T5D=_T5E->f1;_T58=_T5E->f2;}{struct Cyc_Absyn_Exp*e=_T5D;struct Cyc_List_List*scs=_T58;_T43=f1;_T44=f2;_T45=env;_T46=e;
# 1430
...
# 1493
qbl=_T51->tl;goto _TL151;_TL150: _T52=ad;_T53=_T52->impl;_T54=
# 1499
_check_null(_T53);{struct Cyc_List_List*afl=_T54->fields;
_TL155: _T55=afl;_T56=(unsigned)_T55;if(_T56)goto _TL153;else{goto _TL154;}
_TL153: _T57=f;_T58=env;_T59=afl;_T5A=_T59->hd;_T5B=(struct Cyc_Absyn_Aggrfield*)_T5A;_T5C=_T5B->type;_T5D=seen;Cyc_Absyn_i_visit_type(_T57,_T58,_T5C,_T5D);_T5E=afl;
# 1500
afl=_T5E->tl;goto _TL155;_TL154:;}}goto _TL14D;_TL14C: _TL14D: goto _LL0;}_TL14A: goto _LL7;default: _LL7: goto _LL0;}_LL0:;}
# 1510
...
# 1561
if(e==0)goto _TL162;_T5F=f;_T60=env;_T61=e;_T62=seen;
Cyc_Absyn_i_visit_type(_T5F,_T60,_T61,_T62);goto _TL163;_TL162: _TL163: _T63=f;_T64=env;_T65=r;_T66=seen;
Cyc_Absyn_i_visit_type(_T63,_T64,_T65,_T66);
_TL167: _T67=args;_T68=(unsigned)_T67;if(_T68)goto _TL165;else{goto _TL166;}
# 1566
_TL165: _T69=args;_T6A=_T69->hd;{struct _tuple8*_TFD=(struct _tuple8*)_T6A;void*_TFE;{struct _tuple8 _TFF=*_TFD;_TFE=_TFF.f2;}{void*at=_TFE;_T6B=f;_T6C=env;_T6D=at;_T6E=seen;
Cyc_Absyn_i_visit_type(_T6B,_T6C,_T6D,_T6E);}}_T6F=args;
# 1564
args=_T6F->tl;goto _TL167;_TL166: _T70=va;_T71=(unsigned)_T70;
# 1569
if(!_T71)goto _TL168;_T72=f;_T73=env;_T74=va;_T75=_T74->type;_T76=seen;
Cyc_Absyn_i_visit_type(_T72,_T73,_T75,_T76);goto _TL169;_TL168: _TL169:
 _TL16D: _T77=qb;_T78=(unsigned)_T77;if(_T78)goto _TL16B;else{goto _TL16C;}
# 1573
_TL16B: _T79=qb;_T7A=_T79->hd;{struct _tuple15*_TFD=(struct _tuple15*)_T7A;void*_TFE;void*_TFF;{struct _tuple15 _T100=*_TFD;_TFF=_T100.f0;_TFE=_T100.f1;}{void*t1=_TFF;void*t2=_TFE;_T7B=f;_T7C=env;_T7D=t1;_T7E=seen;
...
# 1571
qb=_T83->tl;goto _TL16D;_TL16C:
# 1577
 _TL171: _T84=vd;_T85=(unsigned)_T84;if(_T85)goto _TL16F;else{goto _TL170;}
# 1579
_TL16F: _T86=vd;_T87=_T86->hd;_T88=(struct Cyc_Absyn_Vardecl*)_T87;_T89=(unsigned)_T88;if(!_T89)goto _TL172;_T8A=f;_T8B=env;_T8C=vd;_T8D=_T8C->hd;_T8E=(struct Cyc_Absyn_Vardecl*)_T8D;_T8F=_T8E->type;_T90=seen;
# 1581
Cyc_Absyn_i_visit_type(_T8A,_T8B,_T8F,_T90);_T91=vd;_T92=_T91->hd;_T93=(struct Cyc_Absyn_Vardecl*)_T92;_T94=
_check_null(_T93);_T95=_T94->rgn;_T96=(unsigned)_T95;if(!_T96)goto _TL174;_T97=f;_T98=env;_T99=vd;_T9A=_T99->hd;_T9B=(struct Cyc_Absyn_Vardecl*)_T9A;_T9C=_T9B->rgn;_T9D=seen;
Cyc_Absyn_i_visit_type(_T97,_T98,_T9C,_T9D);goto _TL175;_TL174: _TL175: goto _TL173;_TL172: _TL173: _T9E=vd;
# 1577
vd=_T9E->tl;goto _TL171;_TL170:
# 1586
 _TL179: _T9F=fc;_TA0=(unsigned)_T9F;if(_TA0)goto _TL177;else{goto _TL178;}
# 1588
_TL177: _TA1=fc;{void*_TFD=_TA1->hd;void*_TFE;void*_TFF;_TA2=(int*)_TFD;_TA3=*_TA2;switch(_TA3){case 0:{struct Cyc_Absyn_SingleConstraint_Absyn_EffConstraint_struct*_T100=(struct Cyc_Absyn_SingleConstraint_Absyn_EffConstraint_struct*)_TFD;_TA4=_T100->f1;_TFF=(void*)_TA4;}{void*tc=_TFF;_TA5=f;_TA6=env;_TA7=tc;_TA8=seen;
# 1591
...
# 1586
fc=_TB5->tl;goto _TL179;_TL178: goto _LL0;}case 7: _TB6=t;{struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_TFD=(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_TB6;_TF5=_TFD->f3;}{struct Cyc_List_List*afl=_TF5;
# 1603
_TL17E: _TB7=afl;_TB8=(unsigned)_TB7;if(_TB8)goto _TL17C;else{goto _TL17D;}
_TL17C: _TB9=f;_TBA=env;_TBB=afl;_TBC=_TBB->hd;_TBD=(struct Cyc_Absyn_Aggrfield*)_TBC;_TBE=_TBD->type;_TBF=seen;Cyc_Absyn_i_visit_type(_TB9,_TBA,_TBE,_TBF);_TC0=afl;
# 1603
afl=_TC0->tl;goto _TL17E;_TL17D: goto _LL0;}case 8: _TC1=t;{struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_TFD=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_TC1;_TF5=_TFD->f2;_TF0=_TFD->f3;_TC2=_TFD->f4;_TFC=(void*)_TC2;}{struct Cyc_List_List*ts=_TF5;struct Cyc_Absyn_Typedefdecl*tdef=_TF0;void*to=_TFC;
# 1607
_TL182: _TC3=ts;_TC4=(unsigned)_TC3;if(_TC4)goto _TL180;else{goto _TL181;}
_TL180: _TC5=f;_TC6=env;_TC7=ts;_TC8=_TC7->hd;_TC9=seen;Cyc_Absyn_i_visit_type(_TC5,_TC6,_TC8,_TC9);_TCA=ts;
# 1607
ts=_TCA->tl;goto _TL182;_TL181: _TCB=tdef;_TCC=(unsigned)_TCB;
# 1609
if(!_TCC)goto _TL183;_TCD=tdef;_TCE=_TCD->defn;_TCF=(unsigned)_TCE;if(!_TCF)goto _TL183;_TD0=f;_TD1=env;_TD2=tdef;_TD3=_TD2->defn;_TD4=seen;
Cyc_Absyn_i_visit_type(_TD0,_TD1,_TD3,_TD4);goto _TL184;_TL183: _TL184: _TD5=to;_TD6=(unsigned)_TD5;
if(!_TD6)goto _TL185;_TD7=f;_TD8=env;_TD9=to;_TDA=seen;
Cyc_Absyn_i_visit_type(_TD7,_TD8,_TD9,_TDA);goto _TL186;_TL185: _TL186: goto _LL0;}case 10: _TDB=t;{struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*_TFD=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_TDB;_TEF=_TFD->f2;}{void**tptr=_TEF;_TDC=tptr;_TDD=(unsigned)_TDC;
# 1615
if(!_TDD)goto _TL187;_TDE=tptr;_TDF=*_TDE;_TE0=(unsigned)_TDF;if(!_TE0)goto _TL187;_TE1=f;_TE2=env;_TE3=tptr;_TE4=*_TE3;_TE5=seen;
Cyc_Absyn_i_visit_type(_TE1,_TE2,_TE4,_TE5);goto _TL188;_TL187: _TL188: goto _LL0;}case 12: _TE6=t;{struct Cyc_Absyn_SubsetType_Absyn_Type_struct*_TFD=(struct Cyc_Absyn_SubsetType_Absyn_Type_struct*)_TE6;_TEE=_TFD->f1;_TED=_TFD->f2;_TEC=_TFD->f3;}{struct Cyc_Absyn_Vardecl*vd=_TEE;struct Cyc_Absyn_Exp*e=_TED;struct Cyc_AssnDef_ExistAssnFn*aopt=_TEC;_TE7=f;_TE8=env;_TE9=vd;_TEA=_TE9->type;_TEB=seen;
# 1619
...
return _T3;}struct Cyc_Absyn_Env{struct _tuple0*var;int result;};
# 1701
static int Cyc_Absyn_var_may_appear_f1(struct Cyc_Absyn_Env*env,struct Cyc_Absyn_Exp*e){struct Cyc_Absyn_Exp*_T0;int*_T1;unsigned _T2;void*_T3;struct _tuple0*_T4;struct Cyc_Absyn_Env*_T5;struct _tuple0*_T6;int _T7;struct Cyc_Absyn_Env*_T8;struct Cyc_Absyn_Env*_T9;struct Cyc_Absyn_Vardecl*_TA;struct _tuple0*_TB;struct Cyc_Absyn_Env*_TC;struct _tuple0*_TD;int _TE;int _TF;_T0=e;{
# 1704
...
# 1707
Cyc_Absyn_binding2qvar(b);_T5=env;_T6=_T5->var;_T7=Cyc_Absyn_qvar_cmp(_T4,_T6);if(_T7!=0)goto _TL18B;_T8=env;
_T8->result=1;goto _TL18C;_TL18B: _TL18C:
...
# 1718
 return 1;};}}
# 1722
static int Cyc_Absyn_var_may_appear_f2(struct Cyc_Absyn_Env*env,struct Cyc_Absyn_Stmt*e){struct Cyc_Warn_String_Warn_Warg_struct _T0;int(*_T1)(struct _fat_ptr);void*(*_T2)(struct _fat_ptr);struct _fat_ptr _T3;{struct Cyc_Warn_String_Warn_Warg_struct _T4;_T4.tag=0;
# 1725
_T4.f1=_tag_fat("Absyn::no_side_effects looking at a statement",sizeof(char),46U);_T0=_T4;}{struct Cyc_Warn_String_Warn_Warg_struct _T4=_T0;void*_T5[1];_T5[0]=& _T4;_T2=Cyc_Warn_impos2;{int(*_T6)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T2;_T1=_T6;}_T3=_tag_fat(_T5,sizeof(void*),1);_T1(_T3);}}
# 1728
int Cyc_Absyn_var_may_appear_exp(struct _tuple0*v,struct Cyc_Absyn_Exp*e){struct Cyc_Absyn_Env _T0;void(*_T1)(int(*)(struct Cyc_Absyn_Env*,struct Cyc_Absyn_Exp*),int(*)(struct Cyc_Absyn_Env*,struct Cyc_Absyn_Stmt*),struct Cyc_Absyn_Env*,struct Cyc_Absyn_Exp*);struct Cyc_Absyn_Env*_T2;struct Cyc_Absyn_Env*_T3;struct Cyc_Absyn_Exp*_T4;struct Cyc_Absyn_Env _T5;int _T6;{struct Cyc_Absyn_Env _T7;
# 1731
_T7.var=v;_T7.result=0;_T0=_T7;}{struct Cyc_Absyn_Env env=_T0;{
void(*_T7)(int(*)(struct Cyc_Absyn_Env*,struct Cyc_Absyn_Exp*),int(*)(struct Cyc_Absyn_Env*,struct Cyc_Absyn_Stmt*),struct Cyc_Absyn_Env*,struct Cyc_Absyn_Exp*)=(void(*)(int(*)(struct Cyc_Absyn_Env*,struct Cyc_Absyn_Exp*),int(*)(struct Cyc_Absyn_Env*,struct Cyc_Absyn_Stmt*),struct Cyc_Absyn_Env*,struct Cyc_Absyn_Exp*))Cyc_Absyn_visit_exp;_T1=_T7;}_T2=& env;_T3=(struct Cyc_Absyn_Env*)_T2;_T4=e;_T1(Cyc_Absyn_var_may_appear_f1,Cyc_Absyn_var_may_appear_f2,_T3,_T4);_T5=env;_T6=_T5.result;
...
# 1751
void*_T5=_T0->r;_T1=(int*)_T5;_T2=*_T1;if(_T2!=18)goto _TL18D;_T3=env;_T4=_T3->szeof;
# 1754
return _T4;_TL18D:
# 1756
 return 1;;}}
