...
Cyc_Absyn_uint_exp(1U,_TB);return _TC;case 1: _TD=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_T11F;_TE=_TD->f1;_TF=(int*)_TE;_T10=*_TF;if(_T10!=2)goto _TL49;_T11=e;
return _T11;_TL49:{struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_T12F=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_T11F;_T12=_T12F->f1;_T12E=(void*)_T12;}{void*b=_T12E;
# 450
...
res=Cyc_Lower_deep_copy(v1);}_TL50: goto _LL0;}case 5:{struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_T12F=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_T11F;_T12E=_T12F->f1;_T12A=_T12F->f2;}{struct Cyc_Absyn_Exp*e1=_T12E;enum Cyc_Absyn_Incrementor incr=_T12A;
# 474
...
res=Cyc_Lower_deep_copy(v1);goto _LL59;case Cyc_Absyn_PostDec: _T3E=effect_only;if(!_T3E)goto _TL54;goto _LL61;_TL54: goto _LL64;case Cyc_Absyn_PreDec: _LL61: _T3F=env;_T40=v1;_T41=
# 483
...
# 544
if(!_T90)goto _TL5C;_T91=res;return _T91;_TL5C: goto _LL0;}case 10:{struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_T12F=(struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_T11F;_T12E=_T12F->f1;_T128=_T12F->f2;_T127=_T12F->f3;}{struct Cyc_Absyn_Exp*e1=_T12E;struct Cyc_List_List*es=_T128;struct Cyc_Absyn_VarargCallInfo*vai=_T127;
# 547
...
# 660
if(!_T117)goto _TL6B;_T118=
Cyc_Lower_might_have_effect(res);if(!_T118)goto _TL6D;_T119=env;_T11A=
Cyc_Absyn_exp_stmt(res,0U);Cyc_Lower_emit_stmt(_T119,_T11A);goto _TL6E;_TL6D: _TL6E: _T11B=res;
return _T11B;
# 667
