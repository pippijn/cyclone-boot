...
# 1009
if(id!=0)goto _TL10E;goto _TL10F;_TL10E: _T19=Cyc___assert_fail;{int(*_T30)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T19;_T18=_T30;}_T1A=_tag_fat("id == 0",sizeof(char),8U);_T1B=_tag_fat("bansheeif.cyc",sizeof(char),14U);_T18(_T1A,_T1B,1009U);_TL10F: goto _LL8;}_TL10C:
# 1012
 if(!0)goto _TL110;goto _TL111;_TL110: _T1D=Cyc___assert_fail;{int(*_T30)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T1D;_T1C=_T30;}_T1E=_tag_fat("0",sizeof(char),2U);_T1F=_tag_fat("bansheeif.cyc",sizeof(char),14U);_T1C(_T1E,_T1F,1012U);_TL111: goto _LL8;_LL8:;}_T21=Cyc_Hashtable_insert;{
# 1015
...
# 1068
_TL12C: if(cnstr!=0)goto _TL12D;goto _TL12E;_TL12D: _T22=Cyc___assert_fail;{int(*_T47)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T22;_T21=_T47;}_T23=_tag_fat("cnstr == 0",sizeof(char),11U);_T24=_tag_fat("bansheeif.cyc",sizeof(char),14U);_T21(_T23,_T24,1068U);_TL12E:
...
# 1118
if(_T8==2)goto _TL13B;goto _TL13C;_TL13B: _TA=Cyc___assert_fail;{int(*_T53)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_TA;_T9=_T53;}_TB=_tag_fat("*state != PERSIST_INPROCESS",sizeof(char),28U);_TC=_tag_fat("bansheeif.cyc",sizeof(char),14U);_T9(_TB,_TC,1118U);_TL13C: _TD=state;_TE=*_TD;_TF=(int)_TE;
...
if(Cyc_BansheeIf_cvarmap==0)goto _TL15A;goto _TL15B;_TL15A: _T1=Cyc___assert_fail;{int(*_T13)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T1;_T0=_T13;}_T2=_tag_fat("cvarmap != 0",sizeof(char),13U);_T3=_tag_fat("bansheeif.cyc",sizeof(char),14U);_T0(_T2,_T3,1197U);_TL15B: _T4=f;_T5=
...
# 1238
if(Cyc_BansheeIf_cvarmap==0)goto _TL16C;goto _TL16D;_TL16C: _T1=Cyc___assert_fail;{int(*_T19)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T1;_T0=_T19;}_T2=_tag_fat("cvarmap != 0",sizeof(char),13U);_T3=_tag_fat("bansheeif.cyc",sizeof(char),14U);_T0(_T2,_T3,1238U);_TL16D: {struct _handler_cons _T19;_T4=& _T19;_push_handler(_T4);{int _T1A=0;_T5=setjmp(_T19.handler);if(!_T5)goto _TL16E;_T1A=1;goto _TL16F;_TL16E: _TL16F: if(_T1A)goto _TL170;else{goto _TL172;}_TL172: _T7=Cyc_Hashtable_lookup;{
# 1241
...
if(!_T13)goto _TL182;goto _TL183;_TL182: _T15=Cyc___assert_fail;{int(*_T31)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T15;_T14=_T31;}_T16=_tag_fat("p",sizeof(char),2U);_T17=_tag_fat("bansheeif.cyc",sizeof(char),14U);_T14(_T16,_T17,1269U);_TL183: _T18=Cyc_Flags_resolve;
if(!_T18)goto _TL184;
# 1279
...
# 1363
if(!_T1)goto _TL1A4;goto _TL1A5;_TL1A4: _T3=Cyc___assert_fail;{int(*_T9)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T3;_T2=_T9;}_T4=_tag_fat("cvarmap",sizeof(char),8U);_T5=_tag_fat("bansheeif.cyc",sizeof(char),14U);_T2(_T4,_T5,1363U);_TL1A5: _T7=Cyc_Hashtable_print_table_map;{
