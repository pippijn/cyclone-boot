...
_TF->name=_T9->name;_TA=f;_TF->tq=_TA->tq;_TF->type=new_typ;_TB=f;_TF->width=_TB->width;_TC=f;_TF->attributes=_TC->attributes;_TF->requires_clause=new_r;_T7=(struct Cyc_Absyn_Aggrfield*)_TF;}return _T7;}}}}}struct _tuple16{struct Cyc_Absyn_Tvar*f0;void*f1;};
# 200
...
struct Cyc_Absyn_Kind*_T15=Cyc_Kinds_tvar_kind(_T3,_T5);_T6=(struct Cyc_Absyn_Kind*)_T15;_T7=_T6->kind;if(_T7!=Cyc_Absyn_EffKind)goto _TL39;goto _TL35;_TL39: goto _LL0;_LL0:;}_T9=temp;{struct Cyc_List_List*_T15=_region_malloc(_T9,0U,sizeof(struct Cyc_List_List));_TB=temp;{struct _tuple16*_T16=_region_malloc(_TB,0U,sizeof(struct _tuple16));
# 219
_T16->f0=tv;_T16->f1=t;_TA=(struct _tuple16*)_T16;}_T15->hd=_TA;_T15->tl=inst;_T8=(struct Cyc_List_List*)_T15;}inst=_T8;}}_TL35: _TC=tvs;
# 211
tvs=_TC->tl;_TD=targs;targs=_TD->tl;goto _TL38;_TL37:
# 221
 if(inst==0)goto _TL3B;{struct _tuple15 _T15;
_T15.f0=temp;_T15.f1=Cyc_List_imp_rev(inst);_TE=_T15;}{struct _tuple15 env=_TE;_T10=Cyc_List_rmap_c;{
struct Cyc_List_List*(*_T15)(struct _RegionHandle*,struct Cyc_Absyn_Aggrfield*(*)(struct _tuple15*,struct Cyc_Absyn_Aggrfield*),struct _tuple15*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_Absyn_Aggrfield*(*)(struct _tuple15*,struct Cyc_Absyn_Aggrfield*),struct _tuple15*,struct Cyc_List_List*))_T10;_TF=_T15;}_T11=temp;_T12=& env;_T13=fs;{struct Cyc_List_List*subs_fs=_TF(_T11,Cyc_CfFlowInfo_substitute_field,_T12,_T13);struct _fat_ptr _T15=
Cyc_CfFlowInfo_aggrfields_to_aggrdict(fenv,subs_fs,no_init_bits_only,leafval);_npop_handler(0);return _T15;}}
# 226
_TL3B: {struct _fat_ptr _T15=Cyc_CfFlowInfo_aggrfields_to_aggrdict(fenv,fs,no_init_bits_only,leafval);_npop_handler(0);return _T15;}}_pop_region();}struct _tuple17{struct Cyc_Absyn_Tqual f0;void*f1;};
# 230
...
_TL4A: _T25=d;_T26=_T25.curr;_T27=(void**)_T26;_T28=i;_T29=fenv;_T2A=no_init_bits_only;_T2B=_check_null(tqts);_T2C=_T2B->hd;_T2D=(struct _tuple17*)_T2C;_T2E=*_T2D;_T2F=_T2E.f1;_T30=leafval;_T27[_T28]=Cyc_CfFlowInfo_i_typ_to_absrval(_T29,0,_T2A,_T2F,_T30);_T31=tqts;
tqts=_T31->tl;
# 248
...
_TL97: _T2=Cyc_Iter_next;{int(*_T11)(struct Cyc_Iter_Iter,struct _tuple18*)=(int(*)(struct Cyc_Iter_Iter,struct _tuple18*))_T2;_T1=_T11;}_T3=iter;_T4=& elem;_T5=_T1(_T3,_T4);if(_T5)goto _TL98;else{goto _TL99;}
...
# 704
if(path!=0)goto _TL12C;_T0=Cyc_CfFlowInfo_assign_place_inner(env,oldval,newval);return _T0;_TL12C:{struct _tuple19 _T5E;
...
if(r1!=r2)goto _TL14E;_T0=r1;return _T0;_TL14E:{struct _tuple20 _T9;
_T9.f0=Cyc_CfFlowInfo_contains_local_consumed(r1);_T9.f1=Cyc_CfFlowInfo_contains_local_consumed(r2);_T1=_T9;}{struct _tuple20 _T9=_T1;_T2=_T9.f0;_T3=(int)_T2;switch(_T3){case 1: _T4=_T9.f1;if(_T4!=0)goto _TL151;_T5=r2;
...
if(r1!=r2)goto _TL155;_T0=r1;return _T0;_TL155:{struct _tuple14 _T116;
# 812
...
_T116.f0=r1;_T116.f1=r2;_TFD=_T116;}{struct _tuple14 _T116=_TFD;_TFE=_T116.f0;_TFF=(int*)_TFE;_T100=*_TFF;if(_T100!=3)goto _TL1A3;goto _LL43;_TL1A3: _T101=_T116.f1;_T102=(int*)_T101;_T103=*_T102;if(_T103!=3)goto _TL1A5;_LL43:{struct _tuple21 _T117;
# 910
_T117.f0=il1;_T117.f1=il2;_T104=_T117;}{struct _tuple21 _T117=_T104;_T105=_T117.f1;if(_T105!=Cyc_CfFlowInfo_NoneIL)goto _TL1A7;goto _LL4A;_TL1A7: _T106=_T117.f0;if(_T106!=Cyc_CfFlowInfo_NoneIL)goto _TL1A9;_LL4A: _T107=env;_T108=_T107->fenv;_T109=_T108->esc_none;
# 912
return _T109;_TL1A9: _T10A=env;_T10B=_T10A->fenv;_T10C=_T10B->esc_all;
return _T10C;;}goto _TL1A6;_TL1A5:{struct _tuple21 _T117;
# 916
_T117.f0=il1;_T117.f1=il2;_T10D=_T117;}{struct _tuple21 _T117=_T10D;_T10E=_T117.f1;if(_T10E!=Cyc_CfFlowInfo_NoneIL)goto _TL1AB;goto _LL51;_TL1AB: _T10F=_T117.f0;if(_T10F!=Cyc_CfFlowInfo_NoneIL)goto _TL1AD;_LL51: _T110=env;_T111=_T110->fenv;_T112=_T111->unknown_none;
# 918
return _T112;_TL1AD: _T113=env;_T114=_T113->fenv;_T115=_T114->unknown_all;
return _T115;;}_TL1A6:;}}}}struct _tuple22{union Cyc_CfFlowInfo_FlowInfo f0;union Cyc_CfFlowInfo_FlowInfo f1;};
# 928
...
# 930
_T24.f0=newflow;_T24.f1=oldflow;_T0=_T24;}{struct _tuple22 _T24=_T0;struct Cyc_Dict_Dict _T25;struct Cyc_Dict_Dict _T26;_T1=_T24.f0;_T2=_T1.BottomFL;_T3=_T2.tag;if(_T3!=1)goto _TL1AF;_T4=oldflow;
...
# 947
_T24.f0=f1;_T24.f1=f2;_T0=_T24;}{struct _tuple22 _T24=_T0;struct Cyc_Dict_Dict _T25;struct Cyc_Dict_Dict _T26;_T1=_T24.f0;_T2=_T1.BottomFL;_T3=_T2.tag;if(_T3!=1)goto _TL1B9;_T4=f2;
...
_T33.f0=f1;_T33.f1=f2;_T33.f2=outflow;_T4=_T33;}{struct _tuple24 _T33=_T4;struct Cyc_Dict_Dict _T34;struct Cyc_Dict_Dict _T35;struct Cyc_Dict_Dict _T36;_T5=_T33.f0;_T6=_T5.BottomFL;_T7=_T6.tag;if(_T7!=1)goto _TL1C3;{struct _tuple23 _T37;
_T37.f0=outflow;_T37.f1=r2;_T8=_T37;}return _T8;_TL1C3: _T9=_T33.f1;_TA=_T9.BottomFL;_TB=_TA.tag;if(_TB!=1)goto _TL1C5;{struct _tuple23 _T37;
...
# 975
int(*_T37)(int,void*,void*)=(int(*)(int,void*,void*))_T17;_T16=_T37;}_T18=_T16(0,r1,r2);if(!_T18)goto _TL1C9;{struct _tuple23 _T37;_T37.f0=outflow;_T37.f1=r2;_T19=_T37;}return _T19;_TL1C9: _T1B=Cyc_CfFlowInfo_absRval_lessthan_approx;{
int(*_T37)(int,void*,void*)=(int(*)(int,void*,void*))_T1B;_T1A=_T37;}_T1C=_T1A(0,r2,r1);if(!_T1C)goto _TL1CB;{struct _tuple23 _T37;_T37.f0=outflow;_T37.f1=r1;_T1D=_T37;}return _T1D;_TL1CB:{struct Cyc_CfFlowInfo_JoinEnv _T37;
...
if(r1!=r2)goto _TL1CD;return 1;_TL1CD:{struct _tuple14 _T5A;
# 988
_T5A.f0=r1;_T5A.f1=r2;_T0=_T5A;}{struct _tuple14 _T5A=_T0;struct _fat_ptr _T5B;int _T5C;int _T5D;struct _fat_ptr _T5E;int _T5F;int _T60;void*_T61;struct Cyc_Absyn_Vardecl*_T62;void*_T63;void*_T64;_T1=_T5A.f0;_T2=(int*)_T1;_T3=*_T2;if(_T3!=8)goto _TL1CF;_T4=_T5A.f1;_T5=(int*)_T4;_T6=*_T5;if(_T6!=8)goto _TL1D1;_T7=_T5A.f0;{struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_T65=(struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_T7;_T64=_T65->f1;_T8=_T65->f2;_T63=(void*)_T8;}_T9=_T5A.f1;{struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_T65=(struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_T9;_T62=_T65->f1;_TA=_T65->f2;_T61=(void*)_TA;}{struct Cyc_Absyn_Vardecl*n1=_T64;void*r1=_T63;struct Cyc_Absyn_Vardecl*n2=_T62;void*r2=_T61;
# 990
...
# 1009
 return 0;_TL1F2: _LL1D: goto _LL0;}_TL1E4: _LL0:;}{struct _tuple21 _T5A;
# 1018
_T5A.f0=Cyc_CfFlowInfo_initlevel_approx(r1);_T5A.f1=Cyc_CfFlowInfo_initlevel_approx(r2);_T57=_T5A;}{struct _tuple21 _T5A=_T57;_T58=_T5A.f0;if(_T58!=Cyc_CfFlowInfo_AllIL)goto _TL1F6;goto _LL23;_TL1F6: _T59=_T5A.f1;if(_T59!=Cyc_CfFlowInfo_NoneIL)goto _TL1F8;_LL23:
# 1020
 return 1;_TL1F8:
 return 0;;}}
# 1031
...
# 1033
_T12.f0=f1;_T12.f1=f2;_T0=_T12;}{struct _tuple22 _T12=_T0;struct Cyc_Dict_Dict _T13;struct Cyc_Dict_Dict _T14;_T1=_T12.f0;_T2=_T1.BottomFL;_T3=_T2.tag;if(_T3!=1)goto _TL1FA;
...
_T9->hd=vd;_T9->tl=names;_T5=(struct Cyc_List_List*)_T9;}names=_T5;rv=rv2;goto _LL0;}_TL203:{struct _tuple25 _T9;
