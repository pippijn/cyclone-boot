...
struct _tuple11 Cyc_Evexp_eval_const_uint_exp(struct Cyc_Absyn_Exp * e) {
  ...
  struct _tuple15 _T12 = Cyc_Evexp_eval_const_exp(e);
  long _T13;
...
static struct _tuple16 Cyc_Evexp_eval_const_bool_exp(struct Cyc_Absyn_Exp * e) {
  long _T0;
  struct _tuple16 _T1;
  ...
  struct _tuple16 _TB;
  struct _tuple16 _TC;
  struct _tuple15 _TD = Cyc_Evexp_eval_const_exp(e);
  long _TE;
...
static struct _tuple15 Cyc_Evexp_eval_const_unprimop(enum Cyc_Absyn_Primop p,
  ...
  int _T59;
  long long _T5A;
  struct _tuple15 _T5B;
  struct _tuple15 _T5C;
  struct _tuple15 _T5D = Cyc_Evexp_eval_const_exp(e);
  long _T5E;
  ...
  { union Cyc_Absyn_Cnst cn = _T5F;
    ...
    _TLD: { struct _tuple15 _T60;
      _T60.f0 = cn;
      _T60.f1 = 0;
      _T1 = _T60;
    }return _T1;
    _TLB: { struct _tuple17 _T60;
      _T60.f0 = p;
      _T60.f1 = cn;
      _T2 = _T60;
    }{ struct _tuple17 _T60 = _T2;
      long long _T61;
      char _T62;
      short _T63;
      int _T64;
...
static struct _tuple15 Cyc_Evexp_eval_const_binprimop(enum Cyc_Absyn_Primop p,
  ...
  struct _tuple15 _T63;
  long _T64;
  struct _tuple15 _T65;
  long _T66;
  struct _tuple15 _T67;
  unsigned int _T68;
  int _T69;
  long _T6A;
  ...
  struct _tuple15 _T72 = Cyc_Evexp_eval_const_exp(e1);
  long _T73;
  ...
  { union Cyc_Absyn_Cnst cn1 = _T74;
    long known1 = _T73;
    struct _tuple15 _T75 = Cyc_Evexp_eval_const_exp(e2);
    long _T76;
	...
	_TL26: { long has_u_arg = _T1E;
	  ...
	  { unsigned int u1 = (unsigned int)_T23;
	    ...
	    { unsigned int u2 = (unsigned int)_T24;
	      ...
	      long use_u3 = 0;
	      long use_b3 = 0;
	      { struct _tuple18 _T78;
		_T78.f0 = p;
		_T78.f1 = has_u_arg;
		_T25 = _T78;
	      }{ struct _tuple18 _T78 = _T25;
		_T26 = _T78.f0;
		_T27 = (int)_T26;
		switch (_T27) {
		case Cyc_Absyn_Plus: 
...
static struct _tuple15 Cyc_Evexp_eval_const_exp(struct Cyc_Absyn_Exp * e) {
  ...
  { void * _T98 = _T0->r;
	...
	struct _tuple16 _T9F = Cyc_Evexp_eval_const_bool_exp(e1);
	long _TA0;
	long _TA1;
	_TA1 = _T9F.f0;
	_TA0 = _T9F.f1;
	...
	{ struct _tuple19 _T9F;
	  ...
	  goto _TL6C;
	  _TL6B: _LL3A: { struct _tuple15 _TA7;
	    _TA7.f0 = Cyc_Absyn_Int_c(0U,0);
	    _TA7.f1 = 0;
	    _T8D = _TA7;
	  }return _T8D;
...
static int Cyc_Evexp_cmp_cnst(union Cyc_Absyn_Cnst c1,union Cyc_Absyn_Cnst c2) {
  ...
  { struct _tuple20 _T57;
    ...
    _T1B = _T1A.String_c;
    _T1C = _T1B.tag;
    if (_T1C != 8) { goto _TL9F;
    }
    _T1D = _T57.f1;
    _T1E = _T1D.String_c;
    _T1F = _T1E.tag;
    if (_T1F != 8) { goto _TLA1;
    }
    _T20 = _T57.f0;
    _T21 = _T20.String_c;
    _T5B = _T21.val;
    ...
    _T27 = _T26.String_c;
    _T28 = _T27.tag;
    if (_T28 != 8) { goto _TLA3;
    }
    return 1;
    _TLA3: _T29 = _T57.f0;
    _T2A = _T29.Wstring_c;
    _T2B = _T2A.tag;
    if (_T2B != 9) { goto _TLA5;
    }
    _T2C = _T57.f1;
    _T2D = _T2C.Wstring_c;
    _T2E = _T2D.tag;
    if (_T2E != 9) { goto _TLA7;
    }
    _T2F = _T57.f0;
    _T30 = _T2F.Wstring_c;
    _T5B = _T30.val;
    ...
    _T3D = _T3C.Float_c;
    _T3E = _T3D.tag;
    if (_T3E != 7) { goto _TLAB;
    }
    _T3F = _T57.f1;
    _T40 = _T3F.Float_c;
    _T41 = _T40.tag;
    if (_T41 != 7) { goto _TLAD;
    }
    _T42 = _T57.f0;
    _T43 = _T42.Float_c;
    _T44 = _T43.val;
...
static int Cyc_Evexp_designator_exp_cmp(struct _tuple22 * d1,struct _tuple22 * d2) {
  struct _tuple22 * _T0;
  struct _tuple22 * _T1;
  int _T2;
...
int Cyc_Evexp_exp_cmp(struct Cyc_Absyn_Exp * e1,struct Cyc_Absyn_Exp * e2) {
  ...
  void * _TD0;
  void * _TD1;
  int (* _TD2)(int (*)(struct _tuple22 *,struct _tuple22 *),struct Cyc_List_List *,
	       struct Cyc_List_List *);
  ...
  int _TE3;
  int (* _TE4)(int (*)(struct _tuple22 *,struct _tuple22 *),struct Cyc_List_List *,
	       struct Cyc_List_List *);
  ...
  struct _tuple15 _T116 = Cyc_Evexp_eval_const_exp(e1);
  long _T117;
  ...
  { union Cyc_Absyn_Cnst c1 = _T118;
    long known1 = _T117;
    struct _tuple15 _T119 = Cyc_Evexp_eval_const_exp(e2);
    long _T11A;
	...
	_T4 = (int)_T3;
	return _T4;
	_TLCA: { struct _tuple21 _T11C;
	  _T6 = e1;
	  _T11C.f0 = _T6->r;
	  _T7 = e2;
	  _T11C.f1 = _T7->r;
	  _T5 = _T11C;
	}{ struct _tuple21 _T11C = _T5;
	  ...
	  case 19: 
		...
		_TL103: { struct _tuple21 _T136;
		  _T89 = f1;
		  _T136.f0 = _T89->hd;
		  _T8A = f2;
		  _T136.f1 = _T8A->hd;
		  _T88 = _T136;
		}{ struct _tuple21 _T136 = _T88;
	  ...
	  case 25: 
	    ...
	    { struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct * _T136 = (struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct *)_TD1;
	      ...
	      { int (* _T136)(int (*)(struct _tuple22 *,struct _tuple22 *),
...
int Cyc_Evexp_uint_exp_cmp(struct Cyc_Absyn_Exp * e1,struct Cyc_Absyn_Exp * e2) {
  ...
  { struct _tuple15 _T5 = Cyc_Evexp_eval_const_exp(e1);
    long _T6;
    ...
    { union Cyc_Absyn_Cnst c1 = _T7;
      long known1 = _T6;
      struct _tuple15 _T8 = Cyc_Evexp_eval_const_exp(e2);
      long _T9;
