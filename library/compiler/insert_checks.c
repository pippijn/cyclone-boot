...
# 42 "evexp.h"
extern int Cyc_Evexp_lte_const_exp(struct Cyc_Absyn_Exp*,struct Cyc_Absyn_Exp*);struct Cyc___cycFILE;
...
# 156
 bds_ck=1;
null_ck=1;_LL0:;}{struct _tuple15 _TE;
# 159
...
# 168
if(_T1 <= 1U)goto _TLB;{
struct _tuple15 _T30=Cyc_InsertChecks_need_bound_null_check_annot(e0);int _T31;_T31=_T30.f1;{int null_ck=_T31;_T2=null_ck;
...
int(*_T152)(unsigned,struct _fat_ptr,struct _fat_ptr)=(int(*)(unsigned,struct _fat_ptr,struct _fat_ptr))_T6B;_T6A=_T152;}_T6C=e;_T6D=_T6C->loc;_T6E=_tag_fat("conversion mis-classified as null-check",sizeof(char),40U);_T6F=_tag_fat(0U,sizeof(void*),0);_T6A(_T6D,_T6E,_T6F);goto _TL50;_TL4F: _TL50: _TL4B:{struct _tuple17 _T152;
_T152.f0=b1;_T152.f1=b2;_T70=_T152;}{struct _tuple17 _T152=_T70;_T71=_T152.f0;if(_T71==0)goto _TL52;_T72=_T152.f1;if(_T72==0)goto _TL54;_T73=
# 338
...
# 361
struct _tuple15 _T153=Cyc_InsertChecks_need_bound_null_check_annot(e);int _T154;int _T155;_T155=_T153.f0;_T154=_T153.f1;{int bds_ck=_T155;int null_ck=_T154;_T99=bds_ck;
if(!_T99)goto _TL66;
...
# 393
struct _tuple15 _T156=Cyc_InsertChecks_need_bound_null_check_annot(e);int _T157;int _T158;_T158=_T156.f0;_T157=_T156.f1;{int bds_ck=_T158;int null_ck=_T157;_TCD=bds_ck;
# 396
if(!_TCD)goto _TL79;
...
_TL93: _T132=nv;_T133=dles;_T134=_T133->hd;_T135=(struct _tuple18*)_T134;_T136=*_T135;_T137=_T136.f1;Cyc_InsertChecks_do_exp(_T132,_T137);_T138=dles;
# 493
...
# 496
_T139->annot=(void*)_T13B;Cyc_InsertChecks_do_stmt(nv,s);goto _LL0;}case 38: _T13C=e;_T13D=& Cyc_InsertChecks_NoCheck_val;_T13E=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T13D;
