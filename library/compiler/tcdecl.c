...
# 81
struct _fat_ptr Cyc_Absynpp_scope2string(enum Cyc_Absyn_Scope);extern char Cyc_Tcdecl_Incompatible[13U];struct Cyc_Tcdecl_Incompatible_exn_struct{char*tag;};struct Cyc_Tcdecl_Xdatatypefielddecl{struct Cyc_Absyn_Datatypedecl*base;struct Cyc_Absyn_Datatypefield*field;};struct Cyc___cycFILE;
...
# 58
_tag_fat("%s %s is %sbut expected scope is %s",sizeof(char),36U);_TD=_tag_fat(_T12,sizeof(void*),4);Cyc_Tcdecl_merr(_TA,_TB,_TC,_TD);}}}}}}}struct _tuple14{enum Cyc_Absyn_Scope f0;int f1;};struct _tuple15{enum Cyc_Absyn_Scope f0;enum Cyc_Absyn_Scope f1;};
# 62
struct _tuple14 Cyc_Tcdecl_merge_scope(enum Cyc_Absyn_Scope s0,enum Cyc_Absyn_Scope s1,struct _fat_ptr t,struct _fat_ptr v,unsigned loc,struct _fat_ptr*msg,int externCmerge){struct _tuple15 _T0;enum Cyc_Absyn_Scope _T1;int _T2;enum Cyc_Absyn_Scope _T3;int _T4;enum Cyc_Absyn_Scope _T5;int _T6;enum Cyc_Absyn_Scope _T7;int _T8;int _T9;enum Cyc_Absyn_Scope _TA;int _TB;struct _tuple14 _TC;enum Cyc_Absyn_Scope _TD;int _TE;enum Cyc_Absyn_Scope _TF;enum Cyc_Absyn_Scope _T10;enum Cyc_Absyn_Scope _T11;struct _tuple14 _T12;struct _tuple14 _T13;{struct _tuple15 _T14;
# 64
_T14.f0=s0;_T14.f1=s1;_T0=_T14;}{struct _tuple15 _T14=_T0;_T1=_T14.f0;_T2=(int)_T1;switch(_T2){case Cyc_Absyn_ExternC: _T3=_T14.f1;_T4=(int)_T3;switch(_T4){case Cyc_Absyn_ExternC: goto _LL0;case Cyc_Absyn_Public: goto _LL6;case Cyc_Absyn_Extern: _LL6: goto _LL8;default: _LLC: goto _LLE;};case Cyc_Absyn_Public: _T5=_T14.f1;_T6=(int)_T5;switch(_T6){case Cyc_Absyn_ExternC: _LL8: goto _LLA;case Cyc_Absyn_Extern: goto _LLF;case Cyc_Absyn_Public: _LL16: goto _LL18;default: goto _LL1B;};case Cyc_Absyn_Extern: _T7=_T14.f1;_T8=(int)_T7;switch(_T8){case Cyc_Absyn_ExternC: _LLA: _T9=externCmerge;
# 71
...
# 73
 Cyc_Tcdecl_merge_scope_err(s0,s1,t,v,loc,msg);{struct _tuple14 _T15;_T15.f0=s1;_T15.f1=0;_TC=_T15;}return _TC;case Cyc_Absyn_Extern: _LLF:
# 75
...
# 82
 Cyc_Tcdecl_merge_scope_err(s0,s1,t,v,loc,msg);{struct _tuple14 _T15;_T15.f0=s1;_T15.f1=0;_T12=_T15;}return _T12;};};}_LL0:;}{struct _tuple14 _T14;
# 84
...
_T10->f1=_tag_fat("Tcdecl::get_uint_const_value",sizeof(char),29U);_TC=(struct Cyc_Core_Invalid_argument_exn_struct*)_T10;}_TD=(void*)_TC;_throw(_TD);;}}struct _tuple16{struct Cyc_Absyn_Tvar*f0;void*f1;};
# 100
static struct Cyc_List_List*Cyc_Tcdecl_build_tvs_map(struct Cyc_List_List*tvs0,struct Cyc_List_List*tvs1){struct Cyc_List_List*_T0;struct _tuple16*_T1;struct Cyc_List_List*_T2;void*_T3;struct Cyc_Absyn_VarType_Absyn_Type_struct*_T4;struct Cyc_List_List*_T5;void*_T6;struct Cyc_List_List*_T7;struct Cyc_List_List*_T8;struct Cyc_List_List*_T9;
# 102
struct Cyc_List_List*inst=0;
_TL21: if(tvs0!=0)goto _TL1F;else{goto _TL20;}
_TL1F:{struct Cyc_List_List*_TA=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple16*_TB=_cycalloc(sizeof(struct _tuple16));_T2=_check_null(tvs1);_T3=_T2->hd;_TB->f0=(struct Cyc_Absyn_Tvar*)_T3;{struct Cyc_Absyn_VarType_Absyn_Type_struct*_TC=_cycalloc(sizeof(struct Cyc_Absyn_VarType_Absyn_Type_struct));_TC->tag=2;_T5=tvs0;_T6=_T5->hd;_TC->f1=(struct Cyc_Absyn_Tvar*)_T6;_T4=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_TC;}_TB->f1=(void*)_T4;_T1=(struct _tuple16*)_TB;}_TA->hd=_T1;_TA->tl=inst;_T0=(struct Cyc_List_List*)_TA;}inst=_T0;_T7=tvs0;
# 103
...
# 159
struct Cyc_Absyn_Aggrdecl*d2;{struct _tuple17 _TB0;_T24=d0;
# 161
_TB0.f0=_T24->impl;_T25=d1;_TB0.f1=_T25->impl;_T23=_TB0;}{struct _tuple17 _TB0=_T23;struct Cyc_List_List*_TB1;int _TB2;struct Cyc_List_List*_TB3;struct Cyc_List_List*_TB4;struct Cyc_List_List*_TB5;struct Cyc_List_List*_TB6;int _TB7;struct Cyc_List_List*_TB8;struct Cyc_List_List*_TB9;struct Cyc_List_List*_TBA;_T26=_TB0.f1;if(_T26!=0)goto _TL38;
...
# 295
_TL77: _T35=typs0;_T36=_T35->hd;_T37=(struct _tuple18*)_T36;_T38=*_T37;_T39=_T38.f0;_T3A=typs1;_T3B=_T3A->hd;_T3C=(struct _tuple18*)_T3B;_T3D=*_T3C;_T3E=_T3D.f0;_T3F=Cyc_Absyn_equal_tqual(_T39,_T3E);if(_T3F)goto _TL7B;else{goto _TL7D;}
...
res=0;goto _TL7C;_TL7B: _TL7C: _T47=inst;_T48=typs1;_T49=_T48->hd;_T4A=(struct _tuple18*)_T49;_T4B=*_T4A;_T4C=_T4B.f1;{
# 299
void*subst_t1=Cyc_Tcutil_substitute(_T47,_T4C);_T4D=loc;_T4E=typs0;_T4F=_T4E->hd;_T50=(struct _tuple18*)_T4F;_T51=*_T50;_T52=_T51.f1;_T53=subst_t1;_T54=
# 301
...
return _T6F;}}}}}}}}
# 316
static struct _tuple18*Cyc_Tcdecl_substitute_datatypefield_f2(struct Cyc_List_List*inst,struct _tuple18*x){struct _tuple18*_T0;struct _tuple18*_T1;void*_T2;struct Cyc_Absyn_Tqual _T3;_T0=x;{struct _tuple18 _T4=*_T0;_T3=_T4.f0;_T2=_T4.f1;}{struct Cyc_Absyn_Tqual tq=_T3;void*t=_T2;{struct _tuple18*_T4=_cycalloc(sizeof(struct _tuple18));
# 320
_T4->f0=tq;_T4->f1=Cyc_Tcutil_substitute(inst,t);_T1=(struct _tuple18*)_T4;}return _T1;}}
# 325
static struct Cyc_Absyn_Datatypefield*Cyc_Tcdecl_substitute_datatypefield(struct Cyc_List_List*inst1,struct Cyc_Absyn_Datatypefield*f1){struct Cyc_Absyn_Datatypefield*_T0;struct Cyc_Absyn_Datatypefield*_T1;struct Cyc_Absyn_Datatypefield*_T2;struct Cyc_List_List*(*_T3)(struct _tuple18*(*)(struct Cyc_List_List*,struct _tuple18*),struct Cyc_List_List*,struct Cyc_List_List*);struct Cyc_List_List*(*_T4)(void*(*)(void*,void*),void*,struct Cyc_List_List*);struct Cyc_List_List*_T5;struct Cyc_Absyn_Datatypefield*_T6;struct Cyc_List_List*_T7;struct Cyc_Absyn_Datatypefield*_T8;
# 327
...
struct Cyc_List_List*(*_T9)(struct _tuple18*(*)(struct Cyc_List_List*,struct _tuple18*),struct Cyc_List_List*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple18*(*)(struct Cyc_List_List*,struct _tuple18*),struct Cyc_List_List*,struct Cyc_List_List*))_T4;_T3=_T9;}_T5=inst1;_T6=f1;_T7=_T6->typs;_T2->typs=_T3(Cyc_Tcdecl_substitute_datatypefield_f2,_T5,_T7);_T8=f0;
# 330
return _T8;}
# 337
...
# 385
return _T34;}}struct _tuple19{struct Cyc_List_List*f0;struct Cyc_List_List*f1;};
# 388
static struct _tuple19 Cyc_Tcdecl_split(struct Cyc_List_List*f){struct _tuple19 _T0;struct Cyc_List_List*_T1;struct Cyc_List_List*_T2;struct _tuple19 _T3;struct Cyc_List_List*_T4;struct Cyc_List_List*_T5;struct Cyc_List_List*_T6;struct _tuple19 _T7;struct Cyc_List_List*_T8;struct Cyc_List_List*_T9;struct Cyc_List_List*_TA;struct Cyc_List_List*_TB;struct Cyc_List_List*_TC;struct Cyc_List_List*_TD;
if(f!=0)goto _TL99;{struct _tuple19 _TE;_TE.f0=0;_TE.f1=0;_T0=_TE;}return _T0;_TL99: _T1=f;_T2=_T1->tl;
if(_T2!=0)goto _TL9B;{struct _tuple19 _TE;_TE.f0=f;_TE.f1=0;_T3=_TE;}return _T3;_TL9B: _T4=f;_T5=_T4->tl;_T6=_T5->tl;{
struct _tuple19 _TE=Cyc_Tcdecl_split(_T6);struct Cyc_List_List*_TF;struct Cyc_List_List*_T10;_T10=_TE.f0;_TF=_TE.f1;{struct Cyc_List_List*f1=_T10;struct Cyc_List_List*f2=_TF;{struct _tuple19 _T11;{struct Cyc_List_List*_T12=_cycalloc(sizeof(struct Cyc_List_List));_T9=f;
...
# 400
struct _tuple19 _TE=Cyc_Tcdecl_split(f);struct Cyc_List_List*_TF;struct Cyc_List_List*_T10;_T10=_TE.f0;_TF=_TE.f1;{struct Cyc_List_List*f1=_T10;struct Cyc_List_List*f2=_TF;
...
# 429
struct _tuple14 _T78=Cyc_Tcdecl_merge_scope(_T1D,_T1F,_T20,_T21,_T22,_T23,0);int _T79;enum Cyc_Absyn_Scope _T7A;_T7A=_T78.f0;_T79=_T78.f1;{enum Cyc_Absyn_Scope new_scope=_T7A;int res_scope=_T79;_T24=res_scope;
if(_T24)goto _TLA6;else{goto _TLA8;}_TLA8: res=0;goto _TLA7;_TLA6: _TLA7: {
# 432
struct Cyc_Absyn_Datatypedecl*d2;{struct _tuple20 _T7B;_T26=d0;
# 435
_T7B.f0=_T26->fields;_T27=d1;_T7B.f1=_T27->fields;_T25=_T7B;}{struct _tuple20 _T7B=_T25;struct Cyc_List_List*_T7C;struct Cyc_List_List*_T7D;_T28=_T7B.f1;if(_T28!=0)goto _TLA9;
...
return _T77;}}}}}
# 491
struct Cyc_Absyn_Enumdecl*Cyc_Tcdecl_merge_enumdecl(struct Cyc_Absyn_Enumdecl*d0,struct Cyc_Absyn_Enumdecl*d1,unsigned loc,struct _fat_ptr*msg){struct Cyc_Absyn_Enumdecl*_T0;struct _tuple0*_T1;struct Cyc_Absyn_Enumdecl*_T2;enum Cyc_Absyn_Scope _T3;struct Cyc_Absyn_Enumdecl*_T4;enum Cyc_Absyn_Scope _T5;struct _fat_ptr _T6;struct _fat_ptr _T7;unsigned _T8;struct _fat_ptr*_T9;int _TA;struct _tuple20 _TB;struct Cyc_Absyn_Enumdecl*_TC;struct Cyc_Absyn_Enumdecl*_TD;struct Cyc_Core_Opt*_TE;struct Cyc_Core_Opt*_TF;struct Cyc_Core_Opt*_T10;void*_T11;struct Cyc_Core_Opt*_T12;void*_T13;struct Cyc_List_List*_T14;void*_T15;struct _tuple0*_T16;struct Cyc_List_List*_T17;void*_T18;struct _tuple0*_T19;int _T1A;struct Cyc_String_pa_PrintArg_struct _T1B;struct Cyc_String_pa_PrintArg_struct _T1C;struct _fat_ptr*_T1D;struct Cyc_String_pa_PrintArg_struct _T1E;struct _fat_ptr*_T1F;unsigned _T20;struct _fat_ptr*_T21;struct _fat_ptr _T22;struct _fat_ptr _T23;struct Cyc_Absyn_Exp*_T24;unsigned _T25;struct Cyc_Absyn_Exp*_T26;unsigned _T27;struct Cyc_String_pa_PrintArg_struct _T28;struct Cyc_String_pa_PrintArg_struct _T29;struct _fat_ptr*_T2A;unsigned _T2B;struct _fat_ptr*_T2C;struct _fat_ptr _T2D;struct _fat_ptr _T2E;struct Cyc_List_List*_T2F;struct Cyc_List_List*_T30;struct Cyc_String_pa_PrintArg_struct _T31;unsigned _T32;struct _fat_ptr*_T33;struct _fat_ptr _T34;struct _fat_ptr _T35;int _T36;struct Cyc_Absyn_Enumdecl*_T37;enum Cyc_Absyn_Scope _T38;int _T39;enum Cyc_Absyn_Scope _T3A;int _T3B;struct Cyc_Absyn_Enumdecl*_T3C;struct Cyc_Absyn_Enumdecl*_T3D;struct Cyc_Absyn_Enumdecl*_T3E;struct Cyc_Absyn_Enumdecl*_T3F;struct Cyc_Absyn_Enumdecl*_T40;_T0=d0;_T1=_T0->name;{
# 493
struct _fat_ptr v=Cyc_Absynpp_qvar2string(_T1);
int res=1;_T2=d0;_T3=_T2->sc;_T4=d1;_T5=_T4->sc;_T6=
# 497
_tag_fat("enum",sizeof(char),5U);_T7=v;_T8=loc;_T9=msg;{struct _tuple14 _T41=Cyc_Tcdecl_merge_scope(_T3,_T5,_T6,_T7,_T8,_T9,1);int _T42;enum Cyc_Absyn_Scope _T43;_T43=_T41.f0;_T42=_T41.f1;{enum Cyc_Absyn_Scope new_scope=_T43;int res_scope=_T42;_TA=res_scope;
if(_TA)goto _TLBF;else{goto _TLC1;}_TLC1: res=0;goto _TLC0;_TLBF: _TLC0: {
# 500
struct Cyc_Absyn_Enumdecl*d2;{struct _tuple20 _T44;_TC=d0;
# 503
_T44.f0=_TC->fields;_TD=d1;_T44.f1=_TD->fields;_TB=_T44;}{struct _tuple20 _T44=_TB;struct Cyc_List_List*_T45;struct Cyc_List_List*_T46;_TE=_T44.f1;if(_TE!=0)goto _TLC2;
...
res=0;goto _TLE4;_TLE3: _TLE4:{struct _tuple14 _T45;
# 580
...
# 632
struct _tuple14 _T54=Cyc_Tcdecl_check_var_or_fn_decl(_T10,_T12,_T14,_T16,_T18,_T1B,_T1C,_T1F,_T20,_T23,_T24,_T25);int _T55;_T55=_T54.f1;{int res=_T55;_T26=res;
# 636
...
# 643
struct _tuple14 _T54=Cyc_Tcdecl_check_var_or_fn_decl(_T37,_T3A,_T3B,_T3E,_T40,_T42,_T44,_T46,_T47,_T4A,_T4B,_T4C);int _T55;_T55=_T54.f1;{int res=_T55;_T4D=res;
# 647
