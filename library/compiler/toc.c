...
# 196 "../../library/std/core.h"
void Cyc_Core_ufree(void*);
# 212 "../../library/std/core.h"
...
int(*_T6)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Stmt*)=(int(*)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Stmt*))_T1;_T0=_T6;}_T2=_check_null(Cyc_Toc_fn_pop_table);_T3=*_T2;_T4=s;_T5=_T0(_T3,_T4);return _T5;}struct Cyc_Toc_TocState{struct Cyc_List_List**tuple_types;struct Cyc_List_List**anon_aggr_types;struct Cyc_Dict_Dict*aggrs_so_far;struct Cyc_List_List**abs_struct_types;struct Cyc_Set_Set**datatypes_so_far;struct Cyc_Dict_Dict*xdatatypes_so_far;struct Cyc_Dict_Dict*qvar_tags;struct Cyc_Xarray_Xarray*temp_labels;};struct _tuple17{struct _tuple1*f0;struct _tuple1*f1;};
# 119
static int Cyc_Toc_qvar_tag_cmp(struct _tuple17*x,struct _tuple17*y){struct _tuple17*_T0;struct _tuple17 _T1;struct _tuple1*_T2;struct _tuple17*_T3;struct _tuple17 _T4;struct _tuple1*_T5;int _T6;struct _tuple17*_T7;struct _tuple17 _T8;struct _tuple1*_T9;struct _tuple17*_TA;struct _tuple17 _TB;struct _tuple1*_TC;int _TD;_T0=x;_T1=*_T0;_T2=_T1.f0;_T3=y;_T4=*_T3;_T5=_T4.f0;{
...
struct Cyc_Dict_Dict(*_T21)(struct _RegionHandle*,int(*)(struct _tuple17*,struct _tuple17*))=(struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*)(struct _tuple17*,struct _tuple17*)))_T1D;_T1C=_T21;}_T1E=d;*_T20=_T1C(_T1E,Cyc_Toc_qvar_tag_cmp);_T1A=(struct Cyc_Dict_Dict*)_T20;}_T1F->qvar_tags=_T1A;
...
# 146
static struct Cyc_Toc_TocStateWrap*Cyc_Toc_toc_state=0;struct _tuple18{struct Cyc_Toc_TocState*f0;void*f1;};
# 152
static void*Cyc_Toc_use_toc_state(void*arg,void*(*f)(struct _RegionHandle*,struct _tuple18*)){struct Cyc_Toc_TocStateWrap*_T0;struct Cyc_Core_DynamicRegion*_T1;struct _fat_ptr _T2;struct Cyc_Toc_TocStateWrap*_T3;struct Cyc_Toc_TocStateWrap _T4;struct _fat_ptr _T5;unsigned char*_T6;unsigned char*_T7;struct Cyc_Core_DynamicRegion*_T8;struct _tuple18 _T9;struct _RegionHandle*_TA;struct _tuple18*_TB;struct _fat_ptr _TC;unsigned char*_TD;struct Cyc_Core_DynamicRegion*_TE;void*_TF;
# 155
...
void*res;_T5=_check_fat_at_base(dyn2);_T6=_untag_fat_ptr_check_bound(_T5,sizeof(struct Cyc_Core_DynamicRegion),1U);_T7=_check_null(_T6);_T8=(struct Cyc_Core_DynamicRegion*)_T7;{struct _RegionHandle*h=& _T8->h;{struct _tuple18 _T13;
# 163
_T13.f0=s;_T13.f1=arg;_T9=_T13;}{struct _tuple18 env=_T9;_TA=h;_TB=& env;
...
return _TF;}}}}}struct _tuple19{struct _tuple1*f0;void*(*f1)(struct _tuple1*);};struct _tuple20{struct Cyc_Toc_TocState*f0;struct _tuple19*f1;};struct _tuple21{struct Cyc_Absyn_Aggrdecl*f0;void*f1;};
# 170
static void*Cyc_Toc_aggrdecl_type_body(struct _RegionHandle*d,struct _tuple20*env){struct _tuple20*_T0;struct _tuple19*_T1;struct _tuple21**(*_T2)(struct Cyc_Dict_Dict,struct _tuple1*);void**(*_T3)(struct Cyc_Dict_Dict,void*);struct Cyc_Toc_TocState*_T4;struct Cyc_Dict_Dict*_T5;struct Cyc_Dict_Dict _T6;struct _tuple1*_T7;void*_T8;struct _tuple21**_T9;struct _tuple21*_TA;struct _tuple21 _TB;_T0=env;{
# 173
struct _tuple20 _TC=*_T0;void*(*_TD)(struct _tuple1*);struct _tuple1*_TE;struct Cyc_Toc_TocState*_TF;_TF=_TC.f0;_T1=_TC.f1;{struct _tuple19 _T10=*_T1;_TE=_T10.f0;_TD=_T10.f1;}{struct Cyc_Toc_TocState*s=_TF;struct _tuple1*q=_TE;void*(*type_maker)(struct _tuple1*)=_TD;_T3=Cyc_Dict_lookup_opt;{
struct _tuple21**(*_T10)(struct Cyc_Dict_Dict,struct _tuple1*)=(struct _tuple21**(*)(struct Cyc_Dict_Dict,struct _tuple1*))_T3;_T2=_T10;}_T4=s;_T5=_T4->aggrs_so_far;_T6=*_T5;_T7=q;{struct _tuple21**v=_T2(_T6,_T7);
if(v!=0)goto _TL8;_T8=type_maker(q);goto _TL9;_TL8: _T9=v;_TA=*_T9;_TB=*_TA;_T8=_TB.f1;_TL9: return _T8;}}}}
# 178
static void*Cyc_Toc_aggrdecl_type(struct _tuple1*q,void*(*type_maker)(struct _tuple1*)){struct _tuple19 _T0;void*(*_T1)(struct _tuple19*,void*(*)(struct _RegionHandle*,struct _tuple20*));struct _tuple19*_T2;void*_T3;{struct _tuple19 _T4;
_T4.f0=q;_T4.f1=type_maker;_T0=_T4;}{struct _tuple19 env=_T0;{
void*(*_T4)(struct _tuple19*,void*(*)(struct _RegionHandle*,struct _tuple20*))=(void*(*)(struct _tuple19*,void*(*)(struct _RegionHandle*,struct _tuple20*)))Cyc_Toc_use_toc_state;_T1=_T4;}_T2=& env;_T3=_T1(_T2,Cyc_Toc_aggrdecl_type_body);return _T3;}}struct _tuple22{struct _fat_ptr*f0;struct _fat_ptr*f1;void*f2;};
# 185
static void*Cyc_Toc_tagged_union_field_struct(void*t,struct _fat_ptr*f){int*_T0;int _T1;struct Cyc_Absyn_AppType_Absyn_Type_struct*_T2;void*_T3;int*_T4;int _T5;struct Cyc_Absyn_AppType_Absyn_Type_struct*_T6;void*_T7;struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_T8;union Cyc_Absyn_AggrInfo _T9;struct _union_AggrInfo_KnownAggr _TA;unsigned _TB;void*_TC;union Cyc_Absyn_AggrInfo _TD;struct _union_AggrInfo_KnownAggr _TE;struct Cyc_Absyn_Aggrdecl**_TF;struct Cyc_Absyn_Aggrdecl*_T10;void*_T11;union Cyc_Absyn_AggrInfo _T12;struct _union_AggrInfo_UnknownAggr _T13;struct _tuple3 _T14;struct _tuple1*_T15;struct Cyc_List_List*_T16;void*_T17;int _T18;int _T19;void*_T1A;struct Cyc_List_List*_T1B;struct _fat_ptr _T1C;struct Cyc_String_pa_PrintArg_struct _T1D;struct _fat_ptr*_T1E;struct Cyc_String_pa_PrintArg_struct _T1F;struct _fat_ptr*_T20;struct _fat_ptr _T21;struct _fat_ptr _T22;struct _fat_ptr*_T23;struct Cyc_List_List*_T24;struct _tuple22*_T25;void*_T26;struct Cyc_Warn_String_Warn_Warg_struct _T27;int(*_T28)(struct _fat_ptr ap);struct _fat_ptr _T29;
# 187
...
_TL11: _T16=c;_T17=_T16->hd;{struct _tuple22*_T2E=(struct _tuple22*)_T17;void*_T2F;struct _fat_ptr*_T30;struct _fat_ptr*_T31;{struct _tuple22 _T32=*_T2E;_T31=_T32.f0;_T30=_T32.f1;_T2F=_T32.f2;}{struct _fat_ptr*n2=_T31;struct _fat_ptr*f2=_T30;void*t=_T2F;_T18=
...
*_T2E=str;_T23=(struct _fat_ptr*)_T2E;}t=Cyc_Absyn_strct(_T23);{struct Cyc_List_List*_T2E=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple22*_T2F=_cycalloc(sizeof(struct _tuple22));
_T2F->f0=n;_T2F->f1=f;_T2F->f2=t;_T25=(struct _tuple22*)_T2F;}_T2E->hd=_T25;_T2E->tl=cache;_T24=(struct Cyc_List_List*)_T2E;}cache=_T24;_T26=t;
...
Cyc_Absyn_skip_stmt(0U);return _T0;}struct _tuple23{struct Cyc_List_List*f0;struct Cyc_Absyn_Exp*f1;};
# 318
static struct _tuple23*Cyc_Toc_make_field(struct _fat_ptr*name,struct Cyc_Absyn_Exp*e){struct _tuple23*_T0;struct Cyc_List_List*_T1;struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_T2;{struct _tuple23*_T3=_cycalloc(sizeof(struct _tuple23));{struct Cyc_List_List*_T4=_cycalloc(sizeof(struct Cyc_List_List));{struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_T5=_cycalloc(sizeof(struct Cyc_Absyn_FieldName_Absyn_Designator_struct));_T5->tag=1;
_T5->f1=name;_T2=(struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_T5;}_T4->hd=(void*)_T2;_T4->tl=0;_T1=(struct Cyc_List_List*)_T4;}_T3->f0=_T1;_T3->f1=e;_T0=(struct _tuple23*)_T3;}return _T0;}
# 322
...
_TL2C: _T8=dles;_T9=_T8->hd;_TA=(struct _tuple23*)_T9;_TB=*_TA;_TC=_TB.f1;_TD=Cyc_Toc_is_zero(_TC);if(_TD)goto _TL2F;else{goto _TL31;}_TL31: return 0;_TL2F: _TE=dles;
# 427
...
# 447
_T20.f1=*_T13;_T12=_T20;}{struct Cyc_String_pa_PrintArg_struct _T20=_T12;{struct Cyc_String_pa_PrintArg_struct _T21;_T21.tag=0;_T15=r;_T16=vs;_T17=_tag_fat("_",sizeof(char),2U);_T21.f1=Cyc_rstr_sepstr(_T15,_T16,_T17);_T14=_T21;}{struct Cyc_String_pa_PrintArg_struct _T21=_T14;{struct Cyc_String_pa_PrintArg_struct _T22;_T22.tag=0;_T19=v;_T22.f1=*_T19;_T18=_T22;}{struct Cyc_String_pa_PrintArg_struct _T22=_T18;void*_T23[3];_T23[0]=& _T20;_T23[1]=& _T21;_T23[2]=& _T22;_T1A=_tag_fat("%s_%s_%s_struct",sizeof(char),16U);_T1B=_tag_fat(_T23,sizeof(void*),3);_T11=Cyc_aprintf(_T1A,_T1B);}}}{struct _fat_ptr _T20=_T11;_npop_handler(0);return _T20;}_pop_region();}}};}}struct _tuple24{struct Cyc_Toc_TocState*f0;struct _tuple17*f1;};
# 457
static struct _tuple1*Cyc_Toc_collapse_qvars_body(struct _RegionHandle*d,struct _tuple24*env){struct _tuple24*_T0;struct Cyc_Toc_TocState*_T1;struct _tuple17*_T2;struct _handler_cons*_T3;int _T4;struct _tuple1*(*_T5)(struct Cyc_Dict_Dict,int(*)(struct _tuple17*,struct _tuple17*),struct _tuple17*);void*(*_T6)(struct Cyc_Dict_Dict,int(*)(void*,void*),void*);struct Cyc_Dict_Dict*_T7;struct Cyc_Dict_Dict _T8;struct _tuple17*_T9;void*_TA;struct Cyc_Dict_Absent_exn_struct*_TB;char*_TC;char*_TD;struct _RegionHandle*_TE;struct _tuple17*_TF;struct _tuple17*_T10;struct _tuple1*_T11;struct _tuple1*_T12;struct _tuple1*_T13;struct _fat_ptr*_T14;struct Cyc_Dict_Dict*_T15;struct Cyc_Dict_Dict(*_T16)(struct Cyc_Dict_Dict,struct _tuple17*,struct _tuple1*);struct Cyc_Dict_Dict(*_T17)(struct Cyc_Dict_Dict,void*,void*);struct Cyc_Dict_Dict*_T18;struct Cyc_Dict_Dict _T19;struct _tuple17*_T1A;struct _tuple1*_T1B;struct _tuple1*_T1C;_T0=env;{
# 460
struct _tuple24 _T1D=*_T0;struct _tuple17*_T1E;struct Cyc_Dict_Dict*_T1F;_T1=_T1D.f0;{struct Cyc_Toc_TocState _T20=*_T1;_T1F=_T20.qvar_tags;}_T1E=_T1D.f1;{struct Cyc_Dict_Dict*qvs=_T1F;struct _tuple17*pair=_T1E;_T2=pair;{
struct _tuple17 _T20=*_T2;struct _tuple1*_T21;struct _tuple1*_T22;_T22=_T20.f0;_T21=_T20.f1;{struct _tuple1*fieldname=_T22;struct _tuple1*dtname=_T21;struct _handler_cons _T23;_T3=& _T23;_push_handler(_T3);{int _T24=0;_T4=setjmp(_T23.handler);if(!_T4)goto _TL35;_T24=1;goto _TL36;_TL35: _TL36: if(_T24)goto _TL37;else{goto _TL39;}_TL39: _T6=Cyc_Dict_lookup_other;{
struct _tuple1*(*_T25)(struct Cyc_Dict_Dict,int(*)(struct _tuple17*,struct _tuple17*),struct _tuple17*)=(struct _tuple1*(*)(struct Cyc_Dict_Dict,int(*)(struct _tuple17*,struct _tuple17*),struct _tuple17*))_T6;_T5=_T25;}_T7=qvs;_T8=*_T7;_T9=pair;{struct _tuple1*_T25=_T5(_T8,Cyc_Toc_qvar_tag_cmp,_T9);_npop_handler(0);return _T25;}_pop_handler();goto _TL38;_TL37: _TA=Cyc_Core_get_exn_thrown();{void*_T25=(void*)_TA;void*_T26;_TB=(struct Cyc_Dict_Absent_exn_struct*)_T25;_TC=_TB->tag;_TD=Cyc_Dict_Absent;if(_TC!=_TD)goto _TL3A;{
# 464
struct _tuple17*new_pair;_TE=d;new_pair=_region_malloc(_TE,0U,sizeof(struct _tuple17));_TF=new_pair;_TF->f0=fieldname;_T10=new_pair;_T10->f1=dtname;{struct _fat_ptr*_T27;union Cyc_Absyn_Nmspace _T28;_T11=fieldname;{struct _tuple1 _T29=*_T11;_T28=_T29.f0;_T27=_T29.f1;}{union Cyc_Absyn_Nmspace nmspace=_T28;struct _fat_ptr*fieldvar=_T27;
# 466
...
struct Cyc_Dict_Dict(*_T29)(struct Cyc_Dict_Dict,struct _tuple17*,struct _tuple1*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple17*,struct _tuple1*))_T17;_T16=_T29;}_T18=qvs;_T19=*_T18;_T1A=new_pair;_T1B=res;*_T15=_T16(_T19,_T1A,_T1B);_T1C=res;
return _T1C;}}}_TL3A: _T26=_T25;{void*exn=_T26;_rethrow(exn);};}_TL38:;}}}}}}
# 472
static struct _tuple1*Cyc_Toc_collapse_qvars(struct _tuple1*fieldname,struct _tuple1*dtname){struct _tuple17 _T0;struct _tuple1*(*_T1)(struct _tuple17*,struct _tuple1*(*)(struct _RegionHandle*,struct _tuple24*));struct _tuple17*_T2;struct _tuple1*_T3;{struct _tuple17 _T4;
_T4.f0=fieldname;_T4.f1=dtname;_T0=_T4;}{struct _tuple17 env=_T0;{
struct _tuple1*(*_T4)(struct _tuple17*,struct _tuple1*(*)(struct _RegionHandle*,struct _tuple24*))=(struct _tuple1*(*)(struct _tuple17*,struct _tuple1*(*)(struct _RegionHandle*,struct _tuple24*)))Cyc_Toc_use_toc_state;_T1=_T4;}_T2=& env;_T3=_T1(_T2,Cyc_Toc_collapse_qvars_body);return _T3;}}
# 479
...
# 480
return _T0;}struct _tuple25{struct Cyc_Toc_TocState*f0;struct Cyc_List_List*f1;};struct _tuple26{void*f0;struct Cyc_List_List*f1;};struct _tuple27{struct Cyc_Absyn_Tqual f0;void*f1;};
# 488
static void*Cyc_Toc_add_tuple_type_body(struct _RegionHandle*d,struct _tuple25*env){struct _tuple25*_T0;struct Cyc_Toc_TocState*_T1;struct Cyc_List_List**_T2;struct Cyc_List_List*_T3;void*_T4;struct Cyc_List_List*_T5;void*_T6;struct _tuple27*_T7;struct _tuple27 _T8;void*_T9;struct Cyc_List_List*_TA;void*_TB;int _TC;struct Cyc_List_List*_TD;struct Cyc_List_List*_TE;void*_TF;struct Cyc_List_List*_T10;struct _fat_ptr*_T11;struct _fat_ptr _T12;struct Cyc_Int_pa_PrintArg_struct _T13;int _T14;int _T15;struct _fat_ptr _T16;struct _fat_ptr _T17;struct Cyc_List_List*_T18;void*_T19;struct _tuple27*_T1A;struct _tuple27 _T1B;struct Cyc_List_List*_T1C;struct Cyc_Absyn_Aggrfield*_T1D;struct Cyc_List_List*_T1E;struct _RegionHandle*_T1F;struct Cyc_List_List*_T20;struct Cyc_Absyn_Aggrdecl**_T21;union Cyc_Absyn_AggrInfo _T22;struct Cyc_List_List*_T23;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_T24;void*_T25;struct Cyc_List_List**_T26;struct Cyc_List_List*_T27;struct _RegionHandle*_T28;struct _tuple26*_T29;struct _RegionHandle*_T2A;struct Cyc_List_List**_T2B;void*_T2C;_T0=env;{
# 491
struct _tuple25 _T2D=*_T0;struct Cyc_List_List*_T2E;struct Cyc_List_List**_T2F;_T1=_T2D.f0;{struct Cyc_Toc_TocState _T30=*_T1;_T2F=_T30.tuple_types;}_T2E=_T2D.f1;{struct Cyc_List_List**tuple_types=_T2F;struct Cyc_List_List*tqs0=_T2E;_T2=tuple_types;{
# 493
struct Cyc_List_List*tts=*_T2;_TL3F: if(tts!=0)goto _TL3D;else{goto _TL3E;}
_TL3D: _T3=tts;_T4=_T3->hd;{struct _tuple26*_T30=(struct _tuple26*)_T4;struct Cyc_List_List*_T31;void*_T32;{struct _tuple26 _T33=*_T30;_T32=_T33.f0;_T31=_T33.f1;}{void*x=_T32;struct Cyc_List_List*ts=_T31;
struct Cyc_List_List*tqs=tqs0;
_TL43: if(tqs!=0)goto _TL44;else{goto _TL42;}_TL44: if(ts!=0)goto _TL41;else{goto _TL42;}
_TL41: _T5=tqs;_T6=_T5->hd;_T7=(struct _tuple27*)_T6;_T8=*_T7;_T9=_T8.f1;_TA=ts;_TB=_TA->hd;_TC=Cyc_Unify_unify(_T9,_TB);if(_TC)goto _TL45;else{goto _TL47;}
...
_TL4B: _T18=tqs0;_T19=_T18->hd;_T1A=(struct _tuple27*)_T19;_T1B=*_T1A;{void*t=_T1B.f1;{struct Cyc_List_List*_T30=_cycalloc(sizeof(struct Cyc_List_List));{struct Cyc_Absyn_Aggrfield*_T31=_cycalloc(sizeof(struct Cyc_Absyn_Aggrfield));
...
_T31->f1=sd;_T24=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_T31;}_T25=(void*)_T24;_T30->hd=Cyc_Absyn_new_decl(_T25,0U);_T30->tl=Cyc_Toc_result_decls;_T23=(struct Cyc_List_List*)_T30;}Cyc_Toc_result_decls=_T23;_T26=tuple_types;_T28=d;{struct Cyc_List_List*_T30=_region_malloc(_T28,0U,sizeof(struct Cyc_List_List));_T2A=d;{struct _tuple26*_T31=_region_malloc(_T2A,0U,sizeof(struct _tuple26));
_T31->f0=ans;_T31->f1=ts;_T29=(struct _tuple26*)_T31;}_T30->hd=_T29;_T2B=tuple_types;_T30->tl=*_T2B;_T27=(struct Cyc_List_List*)_T30;}*_T26=_T27;_T2C=ans;
return _T2C;}}}}}}}
# 520
static void*Cyc_Toc_add_tuple_type(struct Cyc_List_List*tqs0){void*(*_T0)(struct Cyc_List_List*,void*(*)(struct _RegionHandle*,struct _tuple25*));void*_T1;{
void*(*_T2)(struct Cyc_List_List*,void*(*)(struct _RegionHandle*,struct _tuple25*))=(void*(*)(struct Cyc_List_List*,void*(*)(struct _RegionHandle*,struct _tuple25*)))Cyc_Toc_use_toc_state;_T0=_T2;}_T1=_T0(tqs0,Cyc_Toc_add_tuple_type_body);return _T1;}struct _tuple28{enum Cyc_Absyn_AggrKind f0;struct Cyc_List_List*f1;};struct _tuple29{struct Cyc_Toc_TocState*f0;struct _tuple28*f1;};struct _tuple30{void*f0;enum Cyc_Absyn_AggrKind f1;struct Cyc_List_List*f2;};
# 525
static void*Cyc_Toc_add_anon_aggr_type_body(struct _RegionHandle*d,struct _tuple29*env){struct _tuple29*_T0;struct Cyc_Toc_TocState*_T1;struct _tuple28*_T2;struct Cyc_List_List**_T3;struct Cyc_List_List*_T4;void*_T5;enum Cyc_Absyn_AggrKind _T6;int _T7;enum Cyc_Absyn_AggrKind _T8;int _T9;int(*_TA)(int(*)(struct Cyc_Absyn_Aggrfield*,struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*,struct Cyc_List_List*);int(*_TB)(int(*)(void*,void*),struct Cyc_List_List*,struct Cyc_List_List*);int(*_TC)(struct Cyc_Absyn_Aggrfield*,struct Cyc_Absyn_Aggrfield*);struct Cyc_List_List*_TD;struct Cyc_List_List*_TE;int _TF;void*_T10;struct Cyc_List_List*_T11;struct _fat_ptr*_T12;struct _fat_ptr _T13;struct Cyc_Int_pa_PrintArg_struct _T14;int _T15;int _T16;struct _fat_ptr _T17;struct _fat_ptr _T18;struct Cyc_Absyn_Aggrdecl*_T19;struct Cyc_Absyn_Aggrdecl**_T1A;union Cyc_Absyn_AggrInfo _T1B;struct Cyc_List_List*_T1C;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_T1D;void*_T1E;struct Cyc_List_List**_T1F;struct Cyc_List_List*_T20;struct _RegionHandle*_T21;struct _tuple30*_T22;struct _RegionHandle*_T23;struct Cyc_List_List**_T24;void*_T25;struct Cyc_List_List*_T26;enum Cyc_Absyn_AggrKind _T27;struct Cyc_List_List**_T28;_T0=env;{struct _tuple29 _T29=*_T0;_T1=_T29.f0;{struct Cyc_Toc_TocState _T2A=*_T1;_T28=_T2A.anon_aggr_types;}_T2=_T29.f1;{struct _tuple28 _T2A=*_T2;_T27=_T2A.f0;_T26=_T2A.f1;}}{struct Cyc_List_List**anon_aggr_types=_T28;enum Cyc_Absyn_AggrKind ak=_T27;struct Cyc_List_List*fs=_T26;_T3=anon_aggr_types;{
# 530
struct Cyc_List_List*ts=*_T3;_TL51: if(ts!=0)goto _TL4F;else{goto _TL50;}
_TL4F: _T4=ts;_T5=_T4->hd;{struct _tuple30*_T29=(struct _tuple30*)_T5;struct Cyc_List_List*_T2A;enum Cyc_Absyn_AggrKind _T2B;void*_T2C;{struct _tuple30 _T2D=*_T29;_T2C=_T2D.f0;_T2B=_T2D.f1;_T2A=_T2D.f2;}{void*x=_T2C;enum Cyc_Absyn_AggrKind ak2=_T2B;struct Cyc_List_List*fs2=_T2A;_T6=ak;_T7=(int)_T6;_T8=ak2;_T9=(int)_T8;
...
_T2A->f1=sd;_T1D=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_T2A;}_T1E=(void*)_T1D;_T29->hd=Cyc_Absyn_new_decl(_T1E,0U);_T29->tl=Cyc_Toc_result_decls;_T1C=(struct Cyc_List_List*)_T29;}Cyc_Toc_result_decls=_T1C;_T1F=anon_aggr_types;_T21=d;{struct Cyc_List_List*_T29=_region_malloc(_T21,0U,sizeof(struct Cyc_List_List));_T23=d;{struct _tuple30*_T2A=_region_malloc(_T23,0U,sizeof(struct _tuple30));
_T2A->f0=ans;_T2A->f1=ak;_T2A->f2=fs;_T22=(struct _tuple30*)_T2A;}_T29->hd=_T22;_T24=anon_aggr_types;_T29->tl=*_T24;_T20=(struct Cyc_List_List*)_T29;}*_T1F=_T20;_T25=ans;
return _T25;}}}}}
# 545
static void*Cyc_Toc_add_anon_aggr_type(enum Cyc_Absyn_AggrKind ak,struct Cyc_List_List*fs){void*(*_T0)(struct _tuple28*,void*(*)(struct _RegionHandle*,struct _tuple29*));struct _tuple28*_T1;void*_T2;{
void*(*_T3)(struct _tuple28*,void*(*)(struct _RegionHandle*,struct _tuple29*))=(void*(*)(struct _tuple28*,void*(*)(struct _RegionHandle*,struct _tuple29*)))Cyc_Toc_use_toc_state;_T0=_T3;}{struct _tuple28*_T3=_cycalloc(sizeof(struct _tuple28));_T3->f0=ak;_T3->f1=fs;_T1=(struct _tuple28*)_T3;}_T2=_T0(_T1,Cyc_Toc_add_anon_aggr_type_body);return _T2;}struct _tuple31{struct _tuple1*f0;struct Cyc_List_List*f1;struct Cyc_List_List*f2;struct Cyc_List_List*f3;};struct _tuple32{struct Cyc_Toc_TocState*f0;struct _tuple31*f1;};struct _tuple33{struct _tuple1*f0;struct Cyc_List_List*f1;void*f2;};
# 554
static void*Cyc_Toc_add_struct_type_body(struct _RegionHandle*d,struct _tuple32*env){struct _tuple32*_T0;struct Cyc_Toc_TocState*_T1;struct _tuple31*_T2;struct Cyc_List_List**_T3;struct Cyc_List_List*_T4;void*_T5;int _T6;int _T7;int _T8;struct Cyc_List_List*_T9;struct Cyc_List_List*_TA;struct Cyc_Absyn_Kind*_TB;enum Cyc_Absyn_KindQual _TC;int _TD;void*_TE;void*_TF;int _T10;struct Cyc_List_List*_T11;struct Cyc_List_List*_T12;int _T13;void*_T14;struct Cyc_List_List*_T15;struct _fat_ptr*_T16;struct _fat_ptr _T17;struct Cyc_Int_pa_PrintArg_struct _T18;int _T19;int _T1A;struct _fat_ptr _T1B;struct _fat_ptr _T1C;struct Cyc_List_List**_T1D;struct Cyc_List_List*_T1E;struct _RegionHandle*_T1F;struct _tuple33*_T20;struct _RegionHandle*_T21;struct Cyc_List_List**_T22;struct Cyc_List_List*_T23;void*_T24;struct Cyc_Absyn_Aggrfield*_T25;struct Cyc_Absyn_Aggrfield*_T26;struct Cyc_List_List*_T27;struct Cyc_List_List*_T28;struct Cyc_Absyn_Kind*_T29;struct Cyc_Absyn_Kind*_T2A;struct Cyc_Absyn_Kind*_T2B;int _T2C;int _T2D;struct Cyc_List_List*_T2E;struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_T2F;void*_T30;int _T31;struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_T32;struct Cyc_Absyn_Exp*_T33;void*_T34;struct Cyc_List_List*_T35;struct Cyc_Absyn_Aggrfield*_T36;struct Cyc_Absyn_Aggrfield*_T37;struct Cyc_Absyn_Aggrfield*_T38;struct Cyc_List_List*_T39;struct Cyc_List_List*_T3A;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_T3B;void*_T3C;_T0=env;{
# 563
struct _tuple32 _T3D=*_T0;struct Cyc_List_List*_T3E;struct Cyc_List_List*_T3F;struct Cyc_List_List*_T40;struct _tuple1*_T41;struct Cyc_List_List**_T42;_T1=_T3D.f0;{struct Cyc_Toc_TocState _T43=*_T1;_T42=_T43.abs_struct_types;}_T2=_T3D.f1;{struct _tuple31 _T43=*_T2;_T41=_T43.f0;_T40=_T43.f1;_T3F=_T43.f2;_T3E=_T43.f3;}{struct Cyc_List_List**abs_struct_types=_T42;struct _tuple1*struct_name=_T41;struct Cyc_List_List*type_vars=_T40;struct Cyc_List_List*type_args=_T3F;struct Cyc_List_List*fields=_T3E;_T3=abs_struct_types;{
# 567
struct Cyc_List_List*tts=*_T3;_TL58: if(tts!=0)goto _TL56;else{goto _TL57;}
_TL56: _T4=tts;_T5=_T4->hd;{struct _tuple33*_T43=(struct _tuple33*)_T5;void*_T44;struct Cyc_List_List*_T45;struct _tuple1*_T46;{struct _tuple33 _T47=*_T43;_T46=_T47.f0;_T45=_T47.f1;_T44=_T47.f2;}{struct _tuple1*x=_T46;struct Cyc_List_List*ts2=_T45;void*t=_T44;_T6=
...
struct Cyc_List_List*fs=0;_T1D=abs_struct_types;_T1F=d;{struct Cyc_List_List*_T43=_region_malloc(_T1F,0U,sizeof(struct Cyc_List_List));_T21=d;{struct _tuple33*_T44=_region_malloc(_T21,0U,sizeof(struct _tuple33));
# 597
_T44->f0=struct_name;_T44->f1=type_args;_T44->f2=x;_T20=(struct _tuple33*)_T44;}_T43->hd=_T20;_T22=abs_struct_types;
...
# 629
static void*Cyc_Toc_add_struct_type(struct _tuple1*struct_name,struct Cyc_List_List*type_vars,struct Cyc_List_List*type_args,struct Cyc_List_List*fields){struct _tuple31 _T0;void*(*_T1)(struct _tuple31*,void*(*)(struct _RegionHandle*,struct _tuple32*));struct _tuple31*_T2;void*_T3;{struct _tuple31 _T4;
# 633
_T4.f0=struct_name;_T4.f1=type_vars;_T4.f2=type_args;_T4.f3=fields;_T0=_T4;}{struct _tuple31 env=_T0;{
void*(*_T4)(struct _tuple31*,void*(*)(struct _RegionHandle*,struct _tuple32*))=(void*(*)(struct _tuple31*,void*(*)(struct _RegionHandle*,struct _tuple32*)))Cyc_Toc_use_toc_state;_T1=_T4;}_T2=& env;_T3=_T1(_T2,Cyc_Toc_add_struct_type_body);return _T3;}}
# 641
...
return _T15;}}}}}
# 661
static struct _fat_ptr*Cyc_Toc_fresh_label (void){struct _fat_ptr*(*_T0)(int,struct _fat_ptr*(*)(struct _RegionHandle*,struct _tuple35*));struct _fat_ptr*_T1;{
struct _fat_ptr*(*_T2)(int,struct _fat_ptr*(*)(struct _RegionHandle*,struct _tuple35*))=(struct _fat_ptr*(*)(int,struct _fat_ptr*(*)(struct _RegionHandle*,struct _tuple35*)))Cyc_Toc_use_toc_state;_T0=_T2;}_T1=_T0(0,Cyc_Toc_fresh_label_body);return _T1;}
# 667
...
_TLC5: _T21=tqs;_T22=_T21->hd;_T23=(struct _tuple27*)_T22;_T24=*_T23;_T25=_T24.f1;_T26=Cyc_Toc_atomic_type(_T25);if(_T26)goto _TLC8;else{goto _TLCA;}_TLCA: return 0;_TLC8: _T27=tqs;
# 903
...
# 1019
Cyc_Toc_void_star_type();_T13=Cyc_Toc_deep_copy(e);_T14=sz;_T15=Cyc_Absyn_add_exp(_T13,_T14,0U);xplussz=Cyc_Toc_cast_it(_T12,_T15);goto _LL0;_TLE5: _LL0:;}{struct _tuple23*_T1C[3];{struct _tuple23*_T1D=_cycalloc(sizeof(struct _tuple23));
# 1022
_T1D->f0=0;_T1D->f1=xexp;_T17=(struct _tuple23*)_T1D;}_T1C[0]=_T17;{struct _tuple23*_T1D=_cycalloc(sizeof(struct _tuple23));
_T1D->f0=0;_T1D->f1=Cyc_Toc_deep_copy(xexp);_T18=(struct _tuple23*)_T1D;}_T1C[1]=_T18;{struct _tuple23*_T1D=_cycalloc(sizeof(struct _tuple23));
_T1D->f0=0;_T1D->f1=xplussz;_T19=(struct _tuple23*)_T1D;}_T1C[2]=_T19;_T1A=_tag_fat(_T1C,sizeof(struct _tuple23*),3);_T16=Cyc_List_list(_T1A);}_T1B=
# 1022
...
static void Cyc_Toc_fndecl_to_c(struct Cyc_Toc_Env*,struct Cyc_Absyn_Fndecl*,int);struct _tuple36{struct _fat_ptr f0;struct Cyc_Absyn_Exp*f1;};
# 1125
static void Cyc_Toc_asm_iolist_types_toc(struct Cyc_List_List*l){struct Cyc_List_List*_T0;void*_T1;struct _tuple36*_T2;struct _tuple36 _T3;struct Cyc_Absyn_Exp*_T4;struct Cyc_List_List*_T5;
_TLEA: if(l!=0)goto _TLE8;else{goto _TLE9;}
_TLE8: _T0=l;_T1=_T0->hd;_T2=(struct _tuple36*)_T1;_T3=*_T2;_T4=_T3.f1;Cyc_Toc_exptypes_to_c(_T4);_T5=l;
# 1126
...
# 1215
struct _tuple16 _T9D=Cyc_Evexp_eval_const_uint_exp(bd);int _T9E;unsigned _T9F;_T9F=_T9D.f0;_T9E=_T9D.f1;{unsigned i=_T9F;int valid=_T9E;_T55=valid;
...
return _T6;}
# 1275
static struct _tuple27*Cyc_Toc_tup_to_c(struct Cyc_Absyn_Exp*e){struct _tuple27*_T0;struct Cyc_Absyn_Exp*_T1;void*_T2;void*_T3;{struct _tuple27*_T4=_cycalloc(sizeof(struct _tuple27));
_T4->f0=Cyc_Toc_mt_tq;_T1=e;_T2=_T1->topt;_T3=_check_null(_T2);_T4->f1=Cyc_Toc_typ_to_c(_T3);_T0=(struct _tuple27*)_T4;}return _T0;}
# 1280
static struct Cyc_Absyn_Exp*Cyc_Toc_array_length_exp(struct Cyc_Absyn_Exp*e){struct Cyc_Absyn_Exp*_T0;int*_T1;unsigned _T2;struct Cyc_List_List*_T3;void*_T4;struct _tuple23*_T5;struct _tuple23 _T6;struct Cyc_List_List*_T7;int(*_T8)(struct _fat_ptr);struct _fat_ptr _T9;struct Cyc_List_List*_TA;int _TB;struct Cyc_Absyn_Exp*_TC;void*_TD;struct Cyc_Absyn_Exp*_TE;int _TF;struct Cyc_Absyn_Exp*_T10;struct Cyc_Absyn_Exp*_T11;void*_T12;struct Cyc_Absyn_Exp*_T13;struct Cyc_Absyn_Exp*_T14;void*_T15;_T0=e;{
...
_TL122: _T3=dles2;_T4=_T3->hd;_T5=(struct _tuple23*)_T4;_T6=*_T5;_T7=_T6.f0;if(_T7==0)goto _TL125;{
...
_TL13C: _T22=dles;_T23=_T22->hd;{struct _tuple23*_T43=(struct _tuple23*)_T23;struct Cyc_Absyn_Exp*_T44;struct Cyc_List_List*_T45;{struct _tuple23 _T46=*_T43;_T45=_T46.f0;_T44=_T46.f1;}{struct Cyc_List_List*ds=_T45;struct Cyc_Absyn_Exp*e2=_T44;
...
struct _tuple34 _T3C=Cyc_Toc_temp_var_and_exp();struct Cyc_Absyn_Exp*_T3D;struct _tuple1*_T3E;_T3E=_T3C.f0;_T3D=_T3C.f1;{struct _tuple1*temp=_T3E;struct Cyc_Absyn_Exp*temp_exp=_T3D;_TC=
...
# 1662
struct _tuple34 _T12=Cyc_Toc_temp_var_and_exp();struct Cyc_Absyn_Exp*_T13;struct _tuple1*_T14;_T14=_T12.f0;_T13=_T12.f1;{struct _tuple1*temp=_T14;struct Cyc_Absyn_Exp*temp_exp=_T13;_T0=temp_exp;_T1=
...
# 1773
_check_null(old_types);_T8F=_T8E->hd;{void*_T601=Cyc_Absyn_compress(_T8F);void*_T602;void*_T603;void*_T604;_T90=(int*)_T601;_T91=*_T90;if(_T91!=4)goto _TL197;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T605=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T601;_T92=_T605->f1;_T604=_T92.elt_type;_T93=_T605->f1;_T94=_T93.ptr_atts;_T603=_T94.bounds;_T95=_T605->f1;_T96=_T95.ptr_atts;_T602=_T96.zero_term;}{void*elt_type=_T604;void*b=_T603;void*zt=_T602;_T97=
# 1776
Cyc_Toc_is_toplevel(nv);if(!_T97)goto _TL199;{
int(*_T605)(struct _fat_ptr)=(int(*)(struct _fat_ptr))Cyc_Toc_unimp;_T98=_T605;}_T99=_tag_fat("can't do pointer arithmetic at top-level",sizeof(char),41U);_T98(_T99);goto _TL19A;_TL199: _TL19A: _T9A=
...
_TL1DD:{void(*_T601)(struct Cyc_Absyn_Exp*,struct Cyc_List_List*,struct Cyc_Absyn_Exp*(*)(struct Cyc_Absyn_Exp*,struct _tuple37*),struct _tuple37*)=(void(*)(struct Cyc_Absyn_Exp*,struct Cyc_List_List*,struct Cyc_Absyn_Exp*(*)(struct Cyc_Absyn_Exp*,struct _tuple37*),struct _tuple37*))Cyc_Toc_lvalue_assign;_T1B3=_T601;}_T1B4=e1;{struct _tuple37*_T601=_cycalloc(sizeof(struct _tuple37));_T601->f0=popt;_T601->f1=e2;_T1B5=(struct _tuple37*)_T601;}_T1B3(_T1B4,0,Cyc_Toc_assignop_lvalue,_T1B5);_T1B6=e;_T1B7=e1;
...
# 2055 "toc.cyc"
struct _tuple34 _T602=Cyc_Toc_temp_var_and_exp();struct Cyc_Absyn_Exp*_T603;struct _tuple1*_T604;_T604=_T602.f0;_T603=_T602.f1;{struct _tuple1*argv=_T604;struct Cyc_Absyn_Exp*argvexp=_T603;_T1C6=
...
_T607.f1=_tag_fat("unknown datatype in vararg with inject",sizeof(char),39U);_T201=_T607;}{struct Cyc_Warn_String_Warn_Warg_struct _T607=_T201;void*_T608[1];_T608[0]=& _T607;{int(*_T609)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_T202=_T609;}_T203=_tag_fat(_T608,sizeof(void*),1);_T202(_T203);}_LLA1:;}_T205=num_varargs;{unsigned _T605=(unsigned)_T205;_T207=r;_T208=_check_times(_T605,sizeof(struct _tuple38));{struct _tuple38*_T606=_region_malloc(_T207,0U,_T208);{unsigned _T607=_T605;unsigned i;i=0;_TL1F7: if(i < _T607)goto _TL1F5;else{goto _TL1F6;}_TL1F5: _T209=i;
# 2098
_T606[_T209].f0=Cyc_Toc_temp_var();_T20A=i;_T606[_T20A].f1=0;i=i + 1;goto _TL1F7;_TL1F6:;}_T206=(struct _tuple38*)_T606;}_T204=_tag_fat(_T206,sizeof(struct _tuple38),_T605);}{struct _fat_ptr vs=_T204;
# 2100
...
void*arg_type=_check_null(_T20F);_T210=vs;_T211=i;_T212=_check_fat_subscript(_T210,sizeof(struct _tuple38),_T211);_T213=(struct _tuple38*)_T212;_T214=*_T213;{
...
_TL1FD: _T225=vs;_T226=_T225.curr;_T227=(struct _tuple38*)_T226;_T228=i;{struct _tuple38 _T605=_T227[_T228];void*_T606;struct _tuple1*_T607;_T607=_T605.f0;_T606=_T605.f1;{struct _tuple1*v=_T607;void*t=_T606;_T229=
...
void*arg_type=_check_null(_T238);_T239=vs;_T23A=i;_T23B=_check_fat_subscript(_T239,sizeof(struct _tuple38),_T23A);_T23C=(struct _tuple38*)_T23B;_T23D=*_T23C;{
struct _tuple1*var=_T23D.f0;_T23E=vs;_T23F=_T23E.curr;_T240=(struct _tuple38*)_T23F;_T241=i;_T242=_T240[_T241];_T243=_T242.f1;{
...
# 2138
struct _tuple1*tdn=Cyc_Toc_collapse_qvars(_T247,_T249);{struct _tuple23*_T608[2];_T24B=Cyc_Toc_tag_sp;_T24C=
Cyc_Toc_datatype_tag(tud,qv);_T608[0]=Cyc_Toc_make_field(_T24B,_T24C);_T24D=
Cyc_Absyn_fieldname(1);_T24E=arg;_T608[1]=Cyc_Toc_make_field(_T24D,_T24E);_T24F=_tag_fat(_T608,sizeof(struct _tuple23*),2);_T24A=Cyc_List_list(_T24F);}{
# 2139
...
# 2194 "toc.cyc"
struct _tuple34 _T601=Cyc_Toc_temp_var_and_exp();struct Cyc_Absyn_Exp*_T602;struct _tuple1*_T603;_T603=_T601.f0;_T602=_T601.f1;{struct _tuple1*temp=_T603;struct Cyc_Absyn_Exp*temp_exp=_T602;_T277=e;_T278=temp;_T279=tc;_T27A=
...
*_T287=new_typ_c;
Cyc_Toc_exp_to_c(nv,e1);{struct _tuple39 _T601;
# 2207
_T601.f0=Cyc_Absyn_compress(old_t2);_T601.f1=Cyc_Absyn_compress(new_typ);_T288=_T601;}{struct _tuple39 _T601=_T288;struct Cyc_Absyn_PtrInfo _T602;struct Cyc_Absyn_PtrInfo _T603;_T289=_T601.f0;_T28A=(int*)_T289;_T28B=*_T28A;if(_T28B!=4)goto _TL20E;_T28C=_T601.f1;_T28D=(int*)_T28C;_T28E=*_T28D;switch(_T28E){case 4: _T28F=_T601.f0;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T604=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T28F;_T603=_T604->f1;}_T290=_T601.f1;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T604=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T290;_T602=_T604->f1;}{struct Cyc_Absyn_PtrInfo p1=_T603;struct Cyc_Absyn_PtrInfo p2=_T602;_T291=
# 2209
...
int zt2=Cyc_Tcutil_force_type2bool(0,_T29E);{struct _tuple40 _T604;
_T604.f0=b1;_T604.f1=b2;_T29F=_T604;}{struct _tuple40 _T604=_T29F;_T2A0=_T604.f0;if(_T2A0==0)goto _TL211;_T2A1=_T604.f1;if(_T2A1==0)goto _TL213;
# 2216
...
struct _tuple16 _T605=Cyc_Evexp_eval_const_uint_exp(e2);int _T606;unsigned _T607;_T607=_T605.f0;_T606=_T605.f1;{unsigned i=_T607;int valid=_T606;_T2AA=
...
# 2242
struct _tuple34 _T608=Cyc_Toc_temp_var_and_exp();struct Cyc_Absyn_Exp*_T609;struct _tuple1*_T60A;_T60A=_T608.f0;_T609=_T608.f1;{struct _tuple1*x=_T60A;struct Cyc_Absyn_Exp*x_exp=_T609;_T2BB=x_exp;_T2BC=
...
_TL283: _T405=nv;_T406=dles;_T407=_T406->hd;_T408=(struct _tuple23*)_T407;_T409=*_T408;_T40A=_T409.f1;Cyc_Toc_exp_to_c(_T405,_T40A);_T40B=dles;
# 2524
...
struct _tuple16 _T601=Cyc_Evexp_eval_const_uint_exp(e1);int _T602;unsigned _T603;_T603=_T601.f0;_T602=_T601.f1;{unsigned sz=_T603;int known=_T602;_T40F=e2;_T410=_T40F->topt;_T411=
...
_TL291:{struct Cyc_List_List*_T604=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple23*_T605=_cycalloc(sizeof(struct _tuple23));_T605->f0=0;_T605->f1=e2;_T419=(struct _tuple23*)_T605;}_T604->hd=_T419;_T604->tl=es;_T418=(struct Cyc_List_List*)_T604;}es=_T418;
# 2542
i=i + 1;goto _TL293;_TL292:;}_T41A=iszeroterm;
# 2545
if(!_T41A)goto _TL294;_T41B=elt_typ;_T41C=
Cyc_Absyn_uint_exp(0U,0U);_T41D=Cyc_Absyn_uint_type;_T41E=Cyc_Absyn_set_type(_T41C,_T41D);{struct Cyc_Absyn_Exp*ezero=Cyc_Toc_cast_it(_T41B,_T41E);_T41F=es;{struct Cyc_List_List*_T604=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple23*_T605=_cycalloc(sizeof(struct _tuple23));
_T605->f0=0;_T605->f1=ezero;_T421=(struct _tuple23*)_T605;}_T604->hd=_T421;_T604->tl=0;_T420=(struct Cyc_List_List*)_T604;}es=Cyc_List_imp_append(_T41F,_T420);}goto _TL295;_TL294: _TL295: goto _TL28B;_TL28A: _TL28B: _T422=e;
# 2550
...
_TL299: _T427=nv;_T428=dles2;_T429=_T428->hd;_T42A=(struct _tuple23*)_T429;_T42B=*_T42A;_T42C=_T42B.f1;Cyc_Toc_exp_to_c(_T427,_T42C);_T42D=dles2;
# 2566
...
_TL2BA: _T46D=fields2;_T46E=_T46D->hd;{struct _tuple41*_T604=(struct _tuple41*)_T46E;struct Cyc_Absyn_Exp*_T605;struct Cyc_Absyn_Aggrfield*_T606;{struct _tuple41 _T607=*_T604;_T606=_T607.f0;_T605=_T607.f1;}{struct Cyc_Absyn_Aggrfield*aggrfield=_T606;struct Cyc_Absyn_Exp*fieldexp=_T605;_T46F=fieldexp;{
...
struct _tuple23*tag_dle=Cyc_Toc_make_field(Cyc_Toc_tag_sp,tag_exp);
struct _tuple23*val_dle=Cyc_Toc_make_field(Cyc_Toc_val_sp,fieldexp);
...
# 2630
_T607->f1=s;_T607->f2=0;{struct _tuple23*_T608[2];_T608[0]=tag_dle;_T608[1]=val_dle;_T496=_tag_fat(_T608,sizeof(struct _tuple23*),2);_T495=Cyc_List_list(_T496);}_T607->f3=_T495;_T607->f4=0;_T494=(struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_T607;}_T497=(void*)_T494;{struct Cyc_Absyn_Exp*aggr_exp=Cyc_Absyn_new_exp(_T497,0U);_T498=aggr_exp;_T499=
Cyc_Toc_tagged_union_field_struct(old_typ,n);Cyc_Absyn_set_type(_T498,_T499);{
struct _tuple23*u_dle=Cyc_Toc_make_field(n,aggr_exp);_T49A=e;{struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_T607=_cycalloc(sizeof(struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct));_T607->tag=28;_T49C=tdn;
_T607->f1=*_T49C;_T607->f2=0;{struct _tuple23*_T608[1];_T608[0]=u_dle;_T49E=_tag_fat(_T608,sizeof(struct _tuple23*),1);_T49D=Cyc_List_list(_T49E);}_T607->f3=_T49D;_T607->f4=sd;_T49B=(struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_T607;}_T49A->r=(void*)_T49B;}}}}goto _TL2C1;_TL2C0: _TL2C1: _T49F=
# 2639
...
# 2703
_check_null(fields);_T4F5=_T4F4->hd;{struct _tuple41*_T601=(struct _tuple41*)_T4F5;struct Cyc_Absyn_Exp*_T602;struct Cyc_Absyn_Aggrfield*_T603;{struct _tuple41 _T604=*_T601;_T603=_T604.f0;_T602=_T604.f1;}{struct Cyc_Absyn_Aggrfield*field=_T603;struct Cyc_Absyn_Exp*fieldexp=_T602;_T4F6=fieldexp;_T4F7=_T4F6->topt;{
...
Cyc_Absyn_signed_int_exp(i,0U);_T502=Cyc_Absyn_sint_type;{struct Cyc_Absyn_Exp*field_tag_exp=Cyc_Absyn_set_type(_T501,_T502);{struct _tuple23*_T604[2];{struct _tuple23*_T605=_cycalloc(sizeof(struct _tuple23));
_T605->f0=0;_T605->f1=field_tag_exp;_T504=(struct _tuple23*)_T605;}_T604[0]=_T504;{struct _tuple23*_T605=_cycalloc(sizeof(struct _tuple23));_T605->f0=0;_T605->f1=fieldexp;_T505=(struct _tuple23*)_T605;}_T604[1]=_T505;_T506=_tag_fat(_T604,sizeof(struct _tuple23*),2);_T503=Cyc_List_list(_T506);}{struct Cyc_List_List*newdles=_T503;
struct Cyc_Absyn_Exp*umem=Cyc_Absyn_unresolvedmem_exp(0,newdles,0U);_T507=e;{struct _tuple23*_T604[1];_T509=field;_T50A=_T509->name;_T50B=umem;_T604[0]=
Cyc_Toc_make_field(_T50A,_T50B);_T50C=_tag_fat(_T604,sizeof(struct _tuple23*),1);_T508=Cyc_List_list(_T50C);}_T507->r=Cyc_Toc_unresolvedmem_exp_r(0,_T508);}}}}}}}goto _TL2D9;
# 2719
...
_TL2E2: _T50F=fields2;_T510=_T50F->hd;_T511=(struct _tuple41*)_T510;_T512=*_T511;_T513=_T512.f0;_T514=sdfields;_T515=_T514->hd;_T516=(struct Cyc_Absyn_Aggrfield*)_T515;if(_T513!=_T516)goto _TL2E5;_T517=fields2;_T518=_T517->hd;{
struct _tuple41*_T601=(struct _tuple41*)_T518;struct Cyc_Absyn_Exp*_T602;struct Cyc_Absyn_Aggrfield*_T603;{struct _tuple41 _T604=*_T601;_T603=_T604.f0;_T602=_T604.f1;}{struct Cyc_Absyn_Aggrfield*field=_T603;struct Cyc_Absyn_Exp*fieldexp=_T602;_T519=field;_T51A=_T519->type;{
...
# 2736
_TL2ED: _T522=fieldtyp;_T523=Cyc_Toc_deep_copy(fieldexp);fieldexp=Cyc_Toc_cast_it(_T522,_T523);goto _TL2EC;_TL2EB: _TL2EC: goto _TL2E8;_TL2E7: _TL2E8:{struct Cyc_List_List*_T604=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple23*_T605=_cycalloc(sizeof(struct _tuple23));
_T605->f0=0;_T605->f1=fieldexp;_T525=(struct _tuple23*)_T605;}_T604->hd=_T525;_T604->tl=newdles;_T524=(struct Cyc_List_List*)_T604;}newdles=_T524;goto _TL2E3;}}}}_TL2E5: _T526=fields2;
# 2722
...
_check_null(tqts);_T530=_T52F->hd;_T531=(struct _tuple27*)_T530;_T532=*_T531;_T533=_T532.f1;{void*field_typ=Cyc_Toc_typ_to_c(_T533);
...
# 2771
struct _tuple23*tag_dle=Cyc_Toc_make_field(Cyc_Toc_tag_sp,tag_exp);_T54D=e;{struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_T601=_cycalloc(sizeof(struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct));_T601->tag=28;_T54F=tuf;_T550=_T54F->name;_T551=tud;_T552=_T551->name;
...
_TL300:{struct Cyc_List_List*_T601=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple23*_T602=_cycalloc(sizeof(struct _tuple23));_T602->f0=0;_T556=es;_T557=_T556->hd;_T602->f1=(struct Cyc_Absyn_Exp*)_T557;_T555=(struct _tuple23*)_T602;}_T601->hd=_T555;_T601->tl=dles;_T554=(struct Cyc_List_List*)_T601;}dles=_T554;_T558=es;
# 2778
es=_T558->tl;goto _TL302;_TL301: _T559=e;{struct Cyc_List_List*_T601=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple23*_T602=_cycalloc(sizeof(struct _tuple23));
# 2780
_T602->f0=0;_T602->f1=tag_exp;_T55B=(struct _tuple23*)_T602;}_T601->hd=_T55B;
...
_TL331:{struct Cyc_Warn_String_Warn_Warg_struct _T5EC;_T5EC.tag=0;_T5EC.f1=_tag_fat("Toc did not examine an inserted check: ",sizeof(char),40U);_T5E5=_T5EC;}{struct Cyc_Warn_String_Warn_Warg_struct _T5EC=_T5E5;{struct Cyc_Warn_Exp_Warn_Warg_struct _T5ED;_T5ED.tag=4;_T5ED.f1=e;_T5E6=_T5ED;}{struct Cyc_Warn_Exp_Warn_Warg_struct _T5ED=_T5E6;void*_T5EE[2];_T5EE[0]=& _T5EC;_T5EE[1]=& _T5ED;_T5E8=Cyc_Warn_impos_loc2;{int(*_T5EF)(unsigned,struct _fat_ptr)=(int(*)(unsigned,struct _fat_ptr))_T5E8;_T5E7=_T5EF;}_T5E9=e;_T5EA=_T5E9->loc;_T5EB=_tag_fat(_T5EE,sizeof(void*),2);_T5E7(_T5EA,_T5EB);}}goto _TL330;_TL32F: _TL330:;}}}struct _tuple42{int f0;struct _fat_ptr*f1;struct _fat_ptr*f2;struct Cyc_Absyn_Switch_clause*f3;};
# 2930 "toc.cyc"
static struct _tuple42*Cyc_Toc_gen_labels(struct _RegionHandle*r,struct Cyc_Absyn_Switch_clause*sc){struct _tuple42*_T0;struct _RegionHandle*_T1;_T1=r;{struct _tuple42*_T2=_region_malloc(_T1,0U,sizeof(struct _tuple42));
# 2932
_T2->f0=0;_T2->f1=Cyc_Toc_fresh_label();_T2->f2=Cyc_Toc_fresh_label();_T2->f3=sc;_T0=(struct _tuple42*)_T2;}return _T0;}
# 2938
...
struct Cyc_Toc_DatatypeTagTest_Toc_TestKind_struct Cyc_Toc_DatatypeTagTest_val={1};struct _tuple43{int f0;void*f1;};
# 3066
static struct _tuple43 Cyc_Toc_admits_switch(struct Cyc_List_List*ss){struct Cyc_Toc_OtherTest_Toc_TestKind_struct*_T0;struct Cyc_Toc_OtherTest_Toc_TestKind_struct*_T1;struct Cyc_List_List*_T2;void*_T3;struct _tuple39*_T4;void*_T5;int*_T6;unsigned _T7;void*_T8;void*_T9;void*_TA;struct Cyc_Toc_OtherTest_Toc_TestKind_struct*_TB;struct Cyc_Toc_OtherTest_Toc_TestKind_struct*_TC;void*_TD;struct Cyc_Toc_TaggedUnionTest_Toc_TestKind_struct*_TE;struct Cyc_Toc_DatatypeTagTest_Toc_TestKind_struct*_TF;struct Cyc_Toc_DatatypeTagTest_Toc_TestKind_struct*_T10;void*_T11;struct Cyc_Absyn_Exp*_T12;struct Cyc_Toc_WhereTest_Toc_TestKind_struct*_T13;struct _tuple43 _T14;struct _tuple43 _T15;struct Cyc_List_List*_T16;struct _tuple43 _T17;
# 3068
...
# 3083
_T1D->f1=e;_T13=(struct Cyc_Toc_WhereTest_Toc_TestKind_struct*)_T1D;}k=(void*)_T13;{struct _tuple43 _T1D;_T1D.f0=0;_T1D.f1=k;_T14=_T1D;}return _T14;}_TL34F: goto _LL13;case 1: _LL13: goto _LL15;case 2: _LL15: goto _LL17;case 5: _LL17: goto _LL19;default: _LL19:{struct _tuple43 _T1D;
# 3088
_T1D.f0=0;_T1D.f1=k;_T15=_T1D;}return _T15;};}}_TL348: _T16=ss;
# 3070
ss=_T16->tl;c=c + 1;goto _TL34B;_TL34A:{struct _tuple43 _T18;
# 3091
...
Cyc_Absyn_seq_stmt(s1,s2,0U);return _T2;}struct _tuple44{struct Cyc_Absyn_Vardecl*f0;struct Cyc_Absyn_Vardecl*f1;void*f2;int f3;};
# 3122
int Cyc_Toc_vd_in_use(struct Cyc_Absyn_Vardecl*other_vd,struct Cyc_List_List**newdecls){struct Cyc_List_List**_T0;struct Cyc_Absyn_Vardecl*_T1;struct Cyc_List_List*_T2;void*_T3;struct _tuple44*_T4;struct _tuple44 _T5;struct Cyc_Absyn_Vardecl*_T6;struct Cyc_List_List*_T7;_T0=newdecls;{
struct Cyc_List_List*ds=*_T0;_TL359: if(ds!=0)goto _TL357;else{goto _TL358;}
# 3126
_TL357: _T1=other_vd;_T2=ds;_T3=_T2->hd;_T4=(struct _tuple44*)_T3;_T5=*_T4;_T6=_T5.f1;if(_T1!=_T6)goto _TL35A;return 1;_TL35A: _T7=ds;
# 3123
...
_TL364: _TD=pds;_TE=_TD->hd;_TF=(struct _tuple45*)_TE;{struct _tuple45 _T161=*_TF;struct Cyc_Absyn_Vardecl*_T162;_T162=_T161.f1;{struct Cyc_Absyn_Vardecl*other_vd=_T162;_T10=ctype;_T11=other_vd;_T12=_T11->type;_T13=
# 3170
...
# 3172
_TL369: _T15=newdecls;_T17=rgn;{struct Cyc_List_List*_T163=_region_malloc(_T17,0U,sizeof(struct Cyc_List_List));_T19=rgn;{struct _tuple44*_T164=_region_malloc(_T19,0U,sizeof(struct _tuple44));_T164->f0=vd;_T164->f1=other_vd;_T164->f2=ctype;_T164->f3=0;_T18=(struct _tuple44*)_T164;}_T163->hd=_T18;_T1A=newdecls;
...
Cyc_Toc_temp_var();_T2D=ctype;new_vd=Cyc_Absyn_new_vardecl(0U,_T2C,_T2D,0,0);_T2E=newdecls;_T30=rgn;{struct Cyc_List_List*_T161=_region_malloc(_T30,0U,sizeof(struct Cyc_List_List));_T32=rgn;{struct _tuple44*_T162=_region_malloc(_T32,0U,sizeof(struct _tuple44));
_T162->f0=vd;_T162->f1=new_vd;_T162->f2=ctype;_T162->f3=0;_T31=(struct _tuple44*)_T162;}_T161->hd=_T31;_T33=newdecls;
...
_TL36B: _T48=pds;_T49=_T48->hd;_T4A=(struct _tuple45*)_T49;{struct _tuple45 _T161=*_T4A;struct Cyc_Absyn_Vardecl*_T162;_T162=_T161.f1;{struct Cyc_Absyn_Vardecl*other_vd=_T162;_T4B=ctype;_T4C=other_vd;_T4D=_T4C->type;_T4E=
# 3201
...
# 3203
_TL370: _T50=newdecls;_T52=rgn;{struct Cyc_List_List*_T163=_region_malloc(_T52,0U,sizeof(struct Cyc_List_List));_T54=rgn;{struct _tuple44*_T164=_region_malloc(_T54,0U,sizeof(struct _tuple44));_T164->f0=vd;_T164->f1=other_vd;_T164->f2=ctype;_T164->f3=0;_T53=(struct _tuple44*)_T164;}_T163->hd=_T53;_T55=newdecls;
...
Cyc_Toc_temp_var();_T61=Cyc_Toc_void_star_type();new_vd=Cyc_Absyn_new_vardecl(0U,_T60,_T61,0,0);_T62=newdecls;_T64=rgn;{struct Cyc_List_List*_T161=_region_malloc(_T64,0U,sizeof(struct Cyc_List_List));_T66=rgn;{struct _tuple44*_T162=_region_malloc(_T66,0U,sizeof(struct _tuple44));
_T162->f0=vd;_T162->f1=new_vd;_T162->f2=ctype;_T162->f3=1;_T65=(struct _tuple44*)_T162;}_T161->hd=_T65;_T67=newdecls;
_T161->tl=*_T67;_T63=(struct Cyc_List_List*)_T161;}
# 3214
*_T62=_T63;goto _TL372;
# 3217
_TL371: _T68=Cyc_Toc_temp_var();_T69=ctype;new_vd=Cyc_Absyn_new_vardecl(0U,_T68,_T69,0,0);_T6A=newdecls;_T6C=rgn;{struct Cyc_List_List*_T161=_region_malloc(_T6C,0U,sizeof(struct Cyc_List_List));_T6E=rgn;{struct _tuple44*_T162=_region_malloc(_T6E,0U,sizeof(struct _tuple44));
_T162->f0=vd;_T162->f1=new_vd;_T162->f2=ctype;_T162->f3=0;_T6D=(struct _tuple44*)_T162;}_T161->hd=_T6D;_T6F=newdecls;
...
_TL374: _T7C=pds;_T7D=_T7C->hd;_T7E=(struct _tuple45*)_T7D;{struct _tuple45 _T161=*_T7E;struct Cyc_Absyn_Vardecl*_T162;_T162=_T161.f1;{struct Cyc_Absyn_Vardecl*other_vd=_T162;_T7F=ctype;_T80=other_vd;_T81=_T80->type;_T82=
# 3234
...
# 3236
_TL379: _T84=newdecls;_T86=rgn;{struct Cyc_List_List*_T163=_region_malloc(_T86,0U,sizeof(struct Cyc_List_List));_T88=rgn;{struct _tuple44*_T164=_region_malloc(_T88,0U,sizeof(struct _tuple44));_T164->f0=vd;_T164->f1=other_vd;_T164->f2=ctype;_T164->f3=0;_T87=(struct _tuple44*)_T164;}_T163->hd=_T87;_T89=newdecls;
...
Cyc_Toc_temp_var();_T9C=Cyc_Toc_void_star_type();new_vd=Cyc_Absyn_new_vardecl(0U,_T9B,_T9C,0,0);_T9D=newdecls;_T9F=rgn;{struct Cyc_List_List*_T161=_region_malloc(_T9F,0U,sizeof(struct Cyc_List_List));_TA1=rgn;{struct _tuple44*_T162=_region_malloc(_TA1,0U,sizeof(struct _tuple44));
_T162->f0=vd;_T162->f1=new_vd;_T162->f2=ctype;_T162->f3=1;_TA0=(struct _tuple44*)_T162;}_T161->hd=_TA0;_TA2=newdecls;
_T161->tl=*_TA2;_T9E=(struct Cyc_List_List*)_T161;}
# 3253
*_T9D=_T9E;goto _TL37B;
# 3256
_TL37A: _TA3=Cyc_Toc_temp_var();_TA4=ctype;new_vd=Cyc_Absyn_new_vardecl(0U,_TA3,_TA4,0,0);_TA5=newdecls;_TA7=rgn;{struct Cyc_List_List*_T161=_region_malloc(_TA7,0U,sizeof(struct Cyc_List_List));_TA9=rgn;{struct _tuple44*_T162=_region_malloc(_TA9,0U,sizeof(struct _tuple44));
_T162->f0=vd;_T162->f1=new_vd;_T162->f2=ctype;_T162->f3=0;_TA8=(struct _tuple44*)_T162;}_T161->hd=_TA8;_TAA=newdecls;
...
_check_null(tuf_tqts);_TD8=_TD7->hd;_TD9=(struct _tuple27*)_TD8;_TDA=*_TD9;{void*tuf_typ=_TDA.f1;_TDB=p2;_TDC=_TDB->topt;{
...
_TL398: _T129=dlps;_T12A=_T129->hd;{struct _tuple46*tup=(struct _tuple46*)_T12A;_T12B=tup;_T12C=*_T12B;{
...
_TL3B0: _T20=env;_T21=dles;_T22=_T21->hd;_T23=(struct _tuple23*)_T22;_T24=*_T23;_T25=_T24.f1;Cyc_Toc_subst_pattern_vars(_T20,_T25);_T26=dles;
# 3445
...
_TL3B7: _T6=lscs;_T7=_T6->hd;{struct _tuple42*_TC1=(struct _tuple42*)_T7;struct Cyc_Absyn_Switch_clause*_TC2;struct _fat_ptr*_TC3;struct _fat_ptr*_TC4;void*_TC5;{struct _tuple42 _TC6=*_TC1;_T8=& _TC1->f0;_TC5=(int*)_T8;_TC4=_TC6.f1;_TC3=_TC6.f2;_TC2=_TC6.f3;}{int*already_emitted=(int*)_TC5;struct _fat_ptr*init_lab=_TC4;struct _fat_ptr*code_lab=_TC3;struct Cyc_Absyn_Switch_clause*sc=_TC2;_T9=sc;{
...
_TL3BF: _T1A=ds;_T1B=_T1A->hd;_T1C=(struct _tuple44*)_T1B;{struct _tuple44 _TC6=*_T1C;int _TC7;void*_TC8;struct Cyc_Absyn_Vardecl*_TC9;struct Cyc_Absyn_Vardecl*_TCA;_TCA=_TC6.f0;_TC9=_TC6.f1;_TC8=_TC6.f2;_TC7=_TC6.f3;{struct Cyc_Absyn_Vardecl*oldv=_TCA;struct Cyc_Absyn_Vardecl*newv=_TC9;void*oldvt=_TC8;int cast=_TC7;_T1D=decls;_T1F=rgn;{struct Cyc_List_List*_TCB=_region_malloc(_T1F,0U,sizeof(struct Cyc_List_List));_T21=rgn;{struct _tuple45*_TCC=_region_malloc(_T21,0U,sizeof(struct _tuple45));
_TCC->f0=oldv;_TCC->f1=newv;_T20=(struct _tuple45*)_TCC;}_TCB->hd=_T20;_T22=decls;_TCB->tl=*_T22;_T1E=(struct Cyc_List_List*)_TCB;}*_T1D=_T1E;_T23=cast;
...
res=Cyc_Absyn_seq_stmt(init_opt,res,0U);goto _TL3C5;_TL3C4: _TL3C5:
 res=Cyc_Absyn_label_stmt(init_lab,res,0U);_T3A=bodies;_T3C=rgn;{struct Cyc_List_List*_TC6=_region_malloc(_T3C,0U,sizeof(struct Cyc_List_List));_T3E=rgn;{struct _tuple47*_TC7=_region_malloc(_T3E,0U,sizeof(struct _tuple47));
_TC7->f0=nv;_TC7->f1=code_lab;_TC7->f2=body;_T3D=(struct _tuple47*)_TC7;}_TC6->hd=_T3D;_T3F=bodies;_TC6->tl=*_T3F;_T3B=(struct Cyc_List_List*)_TC6;}*_T3A=_T3B;_T40=res;
...
# 3521
struct _tuple43 _TC1=Cyc_Toc_admits_switch(ss);void*_TC2;int _TC3;_TC3=_TC1.f0;_TC2=_TC1.f1;{int allows_switch=_TC3;void*test_kind=_TC2;
...
_TL3C9: _T4F=ss;_T50=_T4F->hd;_T51=(struct _tuple39*)_T50;{struct _tuple39 _TC4=*_T51;void*_TC5;void*_TC6;_TC6=_TC4.f0;_TC5=_TC4.f1;{void*pat_test=_TC6;void*dec_tree=_TC5;
# 3531
...
# 3564
_TL3C6:{struct Cyc_Absyn_Exp*_TC4;_T68=test_kind;_T69=(int*)_T68;_T6A=*_T69;if(_T6A!=2)goto _TL3CE;_T6B=test_kind;{struct Cyc_Toc_WhereTest_Toc_TestKind_struct*_TC5=(struct Cyc_Toc_WhereTest_Toc_TestKind_struct*)_T6B;_TC4=_TC5->f1;}{struct Cyc_Absyn_Exp*e=_TC4;struct Cyc_Tcpat_Rhs*_TC5;void*_TC6;if(ss==0)goto _TL3D0;_T6C=ss;_T6D=(struct Cyc_List_List*)_T6C;_T6E=_T6D->hd;_T6F=(struct _tuple39*)_T6E;_T70=_T6F->f1;_T71=(int*)_T70;_T72=*_T71;if(_T72!=1)goto _TL3D2;_T73=ss;_T74=(struct Cyc_List_List*)_T73;_T75=_T74->tl;if(_T75!=0)goto _TL3D4;_T76=ss;{struct Cyc_List_List _TC7=*_T76;_T77=_TC7.hd;_T78=(struct _tuple39*)_T77;{struct _tuple39 _TC8=*_T78;_TC6=_TC8.f0;_T79=_TC8.f1;{struct Cyc_Tcpat_Success_Tcpat_Decision_struct*_TC9=(struct Cyc_Tcpat_Success_Tcpat_Decision_struct*)_T79;_TC5=_TC9->f1;}}}{void*pat_test=_TC6;struct Cyc_Tcpat_Rhs*rhs=_TC5;
# 3572
_TL3D9: if(lscs!=0)goto _TL3D7;else{goto _TL3D8;}
_TL3D7: _T7A=lscs;_T7B=_T7A->hd;{struct _tuple42*_TC7=(struct _tuple42*)_T7B;struct Cyc_Absyn_Switch_clause*_TC8;struct _fat_ptr*_TC9;struct _fat_ptr*_TCA;void*_TCB;{struct _tuple42 _TCC=*_TC7;_T7C=& _TC7->f0;_TCB=(int*)_T7C;_TCA=_TCC.f1;_TC9=_TCC.f2;_TC8=_TCC.f3;}{int*already_emitted=(int*)_TCB;struct _fat_ptr*init_lab=_TCA;struct _fat_ptr*code_lab=_TC9;struct Cyc_Absyn_Switch_clause*sc=_TC8;_T7D=sc;{
...
_TL3DF: _T8E=ds;_T8F=_T8E->hd;_T90=(struct _tuple44*)_T8F;{struct _tuple44 _TCC=*_T90;int _TCD;void*_TCE;struct Cyc_Absyn_Vardecl*_TCF;struct Cyc_Absyn_Vardecl*_TD0;_TD0=_TCC.f0;_TCF=_TCC.f1;_TCE=_TCC.f2;_TCD=_TCC.f3;{struct Cyc_Absyn_Vardecl*oldv=_TD0;struct Cyc_Absyn_Vardecl*newv=_TCF;void*oldvt=_TCE;int cast=_TCD;_T91=decls;_T93=rgn;{struct Cyc_List_List*_TD1=_region_malloc(_T93,0U,sizeof(struct Cyc_List_List));_T95=rgn;{struct _tuple45*_TD2=_region_malloc(_T95,0U,sizeof(struct _tuple45));
_TD2->f0=oldv;_TD2->f1=newv;_T94=(struct _tuple45*)_TD2;}_TD1->hd=_T94;_T96=decls;_TD1->tl=*_T96;_T92=(struct Cyc_List_List*)_TD1;}*_T91=_T92;_T97=cast;
...
r=Cyc_Absyn_seq_stmt(init_opt,r,0U);goto _TL3E5;_TL3E4: _TL3E5:
 r=Cyc_Absyn_label_stmt(init_lab,r,0U);_TAB=bodies;_TAD=rgn;{struct Cyc_List_List*_TCC=_region_malloc(_TAD,0U,sizeof(struct Cyc_List_List));_TAF=rgn;{struct _tuple47*_TCD=_region_malloc(_TAF,0U,sizeof(struct _tuple47));
_TCD->f0=nv;_TCD->f1=code_lab;_TCD->f2=body;_TAE=(struct _tuple47*)_TCD;}_TCC->hd=_TAE;_TB0=bodies;_TCC->tl=*_TB0;_TAC=(struct Cyc_List_List*)_TCC;}*_TAB=_TAC;_TB1=r;
...
_TL3E7: _TB9=ss;_TBA=_TB9->hd;_TBB=(struct _tuple39*)_TBA;{struct _tuple39 _TC5=*_TBB;void*_TC6;void*_TC7;_TC7=_TC5.f0;_TC6=_TC5.f1;{void*pat_test=_TC7;void*dec_tree=_TC6;
...
_TL3EB: _T0=bodies;_T1=_T0->hd;{struct _tuple47*_T5=(struct _tuple47*)_T1;struct Cyc_Absyn_Stmt*_T6;void*_T7;{struct _tuple47 _T8=*_T5;_T2=& _T5->f0;_T7=(struct Cyc_Toc_Env**)_T2;_T6=_T8.f2;}{struct Cyc_Toc_Env**nv=(struct Cyc_Toc_Env**)_T7;struct Cyc_Absyn_Stmt*s2=_T6;
...
_TL3F3: _T1A=lscs2;_T1B=_T1A->hd;{struct _tuple42*_T56=(struct _tuple42*)_T1B;struct Cyc_Absyn_Switch_clause*_T57;struct _fat_ptr*_T58;{struct _tuple42 _T59=*_T56;_T58=_T59.f2;_T57=_T59.f3;}{struct _fat_ptr*body_lab=_T58;struct Cyc_Absyn_Switch_clause*body_sc=_T57;_T1C=body_sc;{
...
struct _tuple42*_T59=(struct _tuple42*)_T22;struct Cyc_Absyn_Switch_clause*_T5A;struct _fat_ptr*_T5B;{struct _tuple42 _T5C=*_T59;_T5B=_T5C.f2;_T5A=_T5C.f3;}{struct _fat_ptr*fallthru_lab=_T5B;struct Cyc_Absyn_Switch_clause*next_sc=_T5A;_T23=mybodies;_T24=next_sc;_T25=_T24->body;{
# 3693
...
_TL3FF: _T3F=mydecls;_T40=_T3F->hd;_T41=(struct _tuple45*)_T40;{struct _tuple45 _T56=*_T41;struct Cyc_Absyn_Vardecl*_T57;_T57=_T56.f1;{struct Cyc_Absyn_Vardecl*vd=_T57;{
...
struct _tuple34 _T11A=Cyc_Toc_temp_var_and_exp();struct Cyc_Absyn_Exp*_T11B;struct _tuple1*_T11C;_T11C=_T11A.f0;_T11B=_T11A.f1;{struct _tuple1*rh_var=_T11C;struct Cyc_Absyn_Exp*rh_exp=_T11B;
...
# 3933 "toc.cyc"
struct _tuple34 _T112=Cyc_Toc_temp_var_and_exp();struct Cyc_Absyn_Exp*_T113;struct _tuple1*_T114;_T114=_T112.f0;_T113=_T112.f1;{struct _tuple1*h_var=_T114;struct Cyc_Absyn_Exp*h_exp=_T113;
struct _tuple34 _T115=Cyc_Toc_temp_var_and_exp();struct Cyc_Absyn_Exp*_T116;struct _tuple1*_T117;_T117=_T115.f0;_T116=_T115.f1;{struct _tuple1*e_var=_T117;struct Cyc_Absyn_Exp*e_exp=_T116;
struct _tuple34 _T118=Cyc_Toc_temp_var_and_exp();struct Cyc_Absyn_Exp*_T119;struct _tuple1*_T11A;_T11A=_T118.f0;_T119=_T118.f1;{struct _tuple1*was_thrown_var=_T11A;struct Cyc_Absyn_Exp*was_thrown_exp=_T119;
...
struct _tuple21**(*_T8B)(struct Cyc_Dict_Dict,struct _tuple1*)=(struct _tuple21**(*)(struct Cyc_Dict_Dict,struct _tuple1*))_T5;_T4=_T8B;}_T6=aggrs_so_far;_T7=*_T6;_T8=n;{struct _tuple21**dopt=_T4(_T7,_T8);
if(dopt!=0)goto _TL43E;
seen_defn_before=0;{
struct _tuple21*v;_T9=d;v=_region_malloc(_T9,0U,sizeof(struct _tuple21));_TA=v;
...
struct Cyc_Dict_Dict(*_T8B)(struct Cyc_Dict_Dict,struct _tuple1*,struct _tuple21*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple1*,struct _tuple21*))_T12;_T11=_T8B;}_T13=aggrs_so_far;_T14=*_T13;_T15=n;_T16=v;*_T10=_T11(_T14,_T15,_T16);}goto _TL43F;
# 4049
_TL43E: _T17=dopt;{struct _tuple21*_T8B=*_T17;void*_T8C;struct Cyc_Absyn_Aggrdecl*_T8D;{struct _tuple21 _T8E=*_T8B;_T8D=_T8E.f0;_T8C=_T8E.f1;}{struct Cyc_Absyn_Aggrdecl*ad2=_T8D;void*t=_T8C;_T18=ad2;_T19=_T18->impl;
if(_T19!=0)goto _TL442;_T1A=aggrs_so_far;_T1C=Cyc_Dict_insert;{
struct Cyc_Dict_Dict(*_T8E)(struct Cyc_Dict_Dict,struct _tuple1*,struct _tuple21*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple1*,struct _tuple21*))_T1C;_T1B=_T8E;}_T1D=aggrs_so_far;_T1E=*_T1D;_T1F=n;_T21=d;{struct _tuple21*_T8E=_region_malloc(_T21,0U,sizeof(struct _tuple21));_T8E->f0=ad;_T8E->f1=t;_T20=(struct _tuple21*)_T8E;}*_T1A=_T1B(_T1E,_T1F,_T20);
...
_TL456:{struct Cyc_List_List*_T8B=_cycalloc(sizeof(struct Cyc_List_List));{struct Cyc_Absyn_Decl*_T8C=_cycalloc(sizeof(struct Cyc_Absyn_Decl));{struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_T8D=_cycalloc(sizeof(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct));_T8D->tag=5;_T8D->f1=new_ad;_T85=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_T8D;}_T8C->r=(void*)_T85;_T8C->loc=0U;_T84=(struct Cyc_Absyn_Decl*)_T8C;}_T8B->hd=_T84;_T8B->tl=Cyc_Toc_result_decls;_T83=(struct Cyc_List_List*)_T8B;}Cyc_Toc_result_decls=_T83;goto _TL455;_TL454: _TL455:
 return 0;}}}}}}}}
# 4131
static void Cyc_Toc_aggrdecl_to_c(struct Cyc_Absyn_Aggrdecl*ad){int(*_T0)(struct Cyc_Absyn_Aggrdecl**,int(*)(struct _RegionHandle*,struct _tuple48*));struct Cyc_Absyn_Aggrdecl**_T1;{
int(*_T2)(struct Cyc_Absyn_Aggrdecl**,int(*)(struct _RegionHandle*,struct _tuple48*))=(int(*)(struct Cyc_Absyn_Aggrdecl**,int(*)(struct _RegionHandle*,struct _tuple48*)))Cyc_Toc_use_toc_state;_T0=_T2;}_T1=& ad;_T0(_T1,Cyc_Toc_aggrdecl_to_c_body);}struct _tuple49{struct Cyc_Toc_TocState*f0;struct Cyc_Absyn_Datatypedecl*f1;};
# 4159 "toc.cyc"
static int Cyc_Toc_datatypedecl_to_c_body(struct _RegionHandle*d,struct _tuple49*env){struct _tuple49*_T0;struct Cyc_Toc_TocState*_T1;struct Cyc_Absyn_Datatypedecl*_T2;struct Cyc_Absyn_Datatypedecl*_T3;struct Cyc_Core_Opt*_T4;int(*_T5)(struct Cyc_Set_Set*,struct _tuple1*);int(*_T6)(struct Cyc_Set_Set*,void*);struct Cyc_Set_Set**_T7;struct Cyc_Set_Set*_T8;struct _tuple1*_T9;int _TA;struct Cyc_Set_Set**_TB;struct Cyc_Set_Set*(*_TC)(struct _RegionHandle*,struct Cyc_Set_Set*,struct _tuple1*);struct Cyc_Set_Set*(*_TD)(struct _RegionHandle*,struct Cyc_Set_Set*,void*);struct _RegionHandle*_TE;struct Cyc_Set_Set**_TF;struct Cyc_Set_Set*_T10;struct _tuple1*_T11;struct Cyc_Absyn_Datatypedecl*_T12;struct Cyc_Core_Opt*_T13;struct Cyc_Core_Opt*_T14;void*_T15;struct Cyc_List_List*_T16;void*_T17;struct Cyc_Absyn_Datatypefield*_T18;struct Cyc_Absyn_Aggrfield*_T19;struct Cyc_Absyn_Aggrfield*_T1A;struct Cyc_List_List*_T1B;void*_T1C;struct _tuple27*_T1D;struct _tuple27 _T1E;struct Cyc_Absyn_Aggrfield*_T1F;struct Cyc_List_List*_T20;void*_T21;struct _tuple27*_T22;struct _tuple27 _T23;void*_T24;struct Cyc_Absyn_Aggrfield*_T25;struct Cyc_Absyn_Aggrfield*_T26;struct Cyc_Absyn_Aggrfield*_T27;struct Cyc_List_List*_T28;struct Cyc_List_List*_T29;struct Cyc_List_List*_T2A;struct Cyc_Absyn_Aggrfield*_T2B;struct _fat_ptr*_T2C;struct Cyc_List_List*_T2D;struct Cyc_Absyn_Aggrdecl*_T2E;struct Cyc_Absyn_Datatypefield*_T2F;struct _tuple1*_T30;struct Cyc_Absyn_Datatypedecl*_T31;struct _tuple1*_T32;struct Cyc_List_List*_T33;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_T34;void*_T35;struct Cyc_List_List*_T36;_T0=env;{
# 4162
struct _tuple49 _T37=*_T0;struct Cyc_Absyn_Datatypedecl*_T38;struct Cyc_Set_Set**_T39;_T1=_T37.f0;{struct Cyc_Toc_TocState _T3A=*_T1;_T39=_T3A.datatypes_so_far;}_T38=_T37.f1;{struct Cyc_Set_Set**datatypes_so_far=_T39;struct Cyc_Absyn_Datatypedecl*tud=_T38;_T2=tud;{
...
_TL460:{struct Cyc_Absyn_Aggrfield*f;f=_cycalloc(sizeof(struct Cyc_Absyn_Aggrfield));_T19=f;_T19->name=Cyc_Absyn_fieldname(i);_T1A=f;_T1B=ts;_T1C=_T1B->hd;_T1D=(struct _tuple27*)_T1C;_T1E=*_T1D;_T1A->tq=_T1E.f0;_T1F=f;_T20=ts;_T21=_T20->hd;_T22=(struct _tuple27*)_T21;_T23=*_T22;_T24=_T23.f1;
...
struct Cyc_Absyn_Aggrfield*newf;newf=_cycalloc(sizeof(struct Cyc_Absyn_Aggrfield));_T32=newf;_T32->name=field_n;_T33=newf;_T34=tqts;_T35=_T34->hd;_T36=(struct _tuple27*)_T35;_T37=*_T36;_T33->tq=_T37.f0;_T38=newf;_T39=tqts;_T3A=_T39->hd;_T3B=(struct _tuple27*)_T3A;_T3C=*_T3B;_T3D=_T3C.f1;
...
return 0;}}}}}}
# 4259
static void Cyc_Toc_xdatatypedecl_to_c(struct Cyc_Absyn_Datatypedecl*xd){int(*_T0)(struct Cyc_Absyn_Datatypedecl*,int(*)(struct _RegionHandle*,struct _tuple49*));{
int(*_T1)(struct Cyc_Absyn_Datatypedecl*,int(*)(struct _RegionHandle*,struct _tuple49*))=(int(*)(struct Cyc_Absyn_Datatypedecl*,int(*)(struct _RegionHandle*,struct _tuple49*)))Cyc_Toc_use_toc_state;_T0=_T1;}_T0(xd,Cyc_Toc_xdatatypedecl_to_c_body);}
# 4263
...
_TL485: _TF=sws;_T10=_TF->hd;{struct _tuple39*_T1B=(struct _tuple39*)_T10;void*_T1C;{struct _tuple39 _T1D=*_T1B;_T11=& _T1B->f1;_T1C=(void**)_T11;}{void**d2=(void**)_T1C;_T12=d2;_T13=d2;_T14=*_T13;_T15=success;
...
struct _tuple47*_T34=(struct _tuple47*)_T25;struct Cyc_Absyn_Stmt*_T35;struct Cyc_Toc_Env*_T36;{struct _tuple47 _T37=*_T34;_T36=_T37.f0;_T35=_T37.f2;}{struct Cyc_Toc_Env*env=_T36;struct Cyc_Absyn_Stmt*st=_T35;
...
_TL495: _T27=mydecls;_T28=_T27->hd;{struct _tuple45*_T34=(struct _tuple45*)_T28;struct Cyc_Absyn_Vardecl*_T35;{struct _tuple45 _T36=*_T34;_T35=_T36.f1;}{struct Cyc_Absyn_Vardecl*vd=_T35;{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_T36=_cycalloc(sizeof(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct));_T36->tag=0;
