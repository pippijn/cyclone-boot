...
void Cyc_CurRgn_subst_inst(struct Cyc_List_List * inst,struct Cyc_Absyn_Tvar * tv,
  ...
  _TL3: _T0 = inst;
  _T1 = _T0->hd;
  { struct _tuple14 * _TA = (struct _tuple14 *)_T1;
    void * _TB;
    void * _TC;
    { struct _tuple14 _TD = *_TA;
      _T2 = &_TA->f0;
...
void * Cyc_CurRgn_instantiate(void * fntype,void * currgn) {
  ...
  { struct Cyc_Absyn_FnType_Absyn_Type_struct * _T25 = (struct Cyc_Absyn_FnType_Absyn_Type_struct *)_T3;
	...
	_T11 = inst;
	{ struct _tuple14 * _T25 = _cycalloc(sizeof(struct _tuple14));
	  _T25->f0 = _check_null(Cyc_CurRgn_curr_tvar);
	  _T25->f1 = currgn;
	  _T12 = (struct _tuple14 *)_T25;
	}_T11->hd = _T12;
	_T13 = inst;
	_T13->tl = 0;
...
static void Cyc_CurRgn_rgnsubtype(unsigned int loc,struct Cyc_CurRgn_rgnsubenv env,
  ...
  default: 
	...
	_T23 = _T34;
      ...
      _T26 = _tag_fat("currgn.cyc",sizeof(char),11U);
      _T23(_T25,_T26,243U);
      _TL25: _T27 = td;
      { void * _T34 = _T27->r;
...
static void Cyc_CurRgn_rgnsubexp(struct Cyc_CurRgn_rgnsubenv env,struct Cyc_Absyn_Exp * e) {
  ...
  { void * _TA4 = _T0->r;
	...
	*_T7B = Cyc_Tcutil_substitute_nofun(_T7D,_T80);
	...
	_T8A = _tag_fat("currgn.cyc",sizeof(char),11U);
	_T87(_T89,_T8A,416U);
...
static void Cyc_CurRgn_rgnsubpat(struct Cyc_CurRgn_rgnsubenv env,struct Cyc_Absyn_Pat * p) {
  ...
  _T5 = _tag_fat("currgn.cyc",sizeof(char),11U);
  _T2(_T4,_T5,458U);
  _TL66: _T6 = p;
  { void * _T45 = _T6->r;
    struct Cyc_Absyn_Exp * _T46;
...
static void Cyc_CurRgn_rgnsubdtdecl(unsigned int loc,struct Cyc_CurRgn_rgnsubenv env,
  ...
  { struct Cyc_List_List * fs = (struct Cyc_List_List *)_T7;
    ...
    { struct Cyc_List_List * ts = _TA->typs;
      ...
      _TL8D: _TB = ts;
      _TC = _TB->hd;
      { struct _tuple17 * _T14 = (struct _tuple17 *)_TC;
	void * _T15;
	{ struct _tuple17 _T16 = *_T14;
	  _TD = &_T14->f1;
	  _T15 = (void * *)_TD;
	}{ void * * typ = (void * *)_T15;
	  _TE = loc;
...
static void Cyc_CurRgn_rgnsubdecl(struct Cyc_CurRgn_rgnsubenv env,struct Cyc_Absyn_Decl * d) {
  ...
  { void * _T57 = _T0->r;
	...
	_T1C = _tag_fat("currgn.cyc",sizeof(char),11U);
	_T19(_T1B,_T1C,608U);
	_TL94: _T1D = d;
	_T1E = _T1D->loc;
	_T1F = td;
	...
	_T2D = _tag_fat("currgn.cyc",sizeof(char),11U);
	_T2A(_T2C,_T2D,615U);
	_TL98: _T2E = d;
	_T2F = _T2E->loc;
	_T30 = env;
	...
	_T37 = _tag_fat("currgn.cyc",sizeof(char),11U);
	_T34(_T36,_T37,620U);
	_TL9A: _T38 = d;
	_T39 = _T38->loc;
	_T3A = env;
	...
	_T41 = _tag_fat("currgn.cyc",sizeof(char),11U);
	_T3E(_T40,_T41,647U);
