...
void Cyc_Absyn_visit_exp(int(*)(void*,struct Cyc_Absyn_Exp*),int(*)(void*,struct Cyc_Absyn_Stmt*),void*,struct Cyc_Absyn_Exp*);struct Cyc_String_pa_PrintArg_struct{int tag;struct _fat_ptr f1;};
# 157 "../../library/std/cycboot.h"
extern int Cyc_printf(struct _fat_ptr,struct _fat_ptr);
# 38 "bansheeif.h"
void Cyc_BansheeIf_register_toplevel_cvar(void*);struct Cyc_Dict_T;struct Cyc_Dict_Dict{int(*rel)(void*,void*);struct _RegionHandle*r;const struct Cyc_Dict_T*t;};extern char Cyc_Dict_Absent[7U];struct Cyc_Dict_Absent_exn_struct{char*tag;};
...
_TL7D:{struct Cyc_List_List*_TBF=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple14*_TC0=_cycalloc(sizeof(struct _tuple14));_TC0->f0=0;_T4B=es;_T4C=_T4B->hd;_TC0->f1=(struct Cyc_Absyn_Exp*)_T4C;_T4A=(struct _tuple14*)_TC0;}_TBF->hd=_T4A;_TBF->tl=dles;_T49=(struct Cyc_List_List*)_TBF;}dles=_T49;_T4D=es;
# 554
...
# 956
struct Cyc_Dict_Dict(*_T177)(struct Cyc_Dict_Dict,struct _fat_ptr*,void*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _fat_ptr*,void*))_TCD;_TCC=_T177;}_TCE=decl_ns_data;_TCF=_TCE->ordinaries;_TD0=f;_TD1=_TD0->name;_TD2=*_TD1;_TD3=_TD2.f1;{struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*_T177=_cycalloc(sizeof(struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct));_T177->tag=4;
# 958
_T177->f1=t;_T177->f2=f;_TD4=(struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_T177;}_TD5=(void*)_TD4;
# 955
_TCB->ordinaries=
_TCC(_TCF,_TD3,_TD5);}_TD6=fs;
# 950
...
struct Cyc_Dict_Dict(*_T177)(struct Cyc_Dict_Dict,struct _fat_ptr*,void*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _fat_ptr*,void*))_T165;_T164=_T177;}_T166=env;_T167=_T166->local_vars;_T168=*_T167;_T169=vd;_T16A=_T169->name;_T16B=_T16A->f1;{struct Cyc_Binding_VarRes_Binding_Resolved_struct*_T177=_cycalloc(sizeof(struct Cyc_Binding_VarRes_Binding_Resolved_struct));_T177->tag=0;{struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_T178=_cycalloc(sizeof(struct Cyc_Absyn_Param_b_Absyn_Binding_struct));_T178->tag=3;
# 1022
_T178->f1=vd;_T16D=(struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)_T178;}_T177->f1=(void*)_T16D;_T16C=(struct Cyc_Binding_VarRes_Binding_Resolved_struct*)_T177;}_T16E=(void*)_T16C;
# 1019
*_T163=
...
_TL13A:{struct Cyc_List_List*_T85=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple15*_T86=_cycalloc(sizeof(struct _tuple15));_T86->f0=0;_T28=ps;_T29=_T28->hd;_T86->f1=(struct Cyc_Absyn_Pat*)_T29;_T27=(struct _tuple15*)_T86;}_T85->hd=_T27;_T85->tl=new_ps;_T26=(struct Cyc_List_List*)_T85;}new_ps=_T26;_T2A=ps;
# 1081
...
_TL14F: _T6C=env;_T6D=dps;_T6E=_T6D->hd;_T6F=(struct _tuple15*)_T6E;_T70=*_T6F;_T71=_T70.f1;Cyc_Binding_resolve_pat(_T6C,_T71);_T72=dps;
# 1160
...
# 1174
static void Cyc_Binding_resolve_rgnpo(unsigned loc,struct Cyc_Binding_Env*env,struct Cyc_List_List*po){unsigned _T0;struct Cyc_Binding_Env*_T1;struct Cyc_List_List*_T2;void*_T3;struct _tuple16*_T4;struct _tuple16 _T5;void*_T6;unsigned _T7;struct Cyc_Binding_Env*_T8;struct Cyc_List_List*_T9;void*_TA;struct _tuple16*_TB;struct _tuple16 _TC;void*_TD;struct Cyc_List_List*_TE;
# 1177
_TL159: if(po!=0)goto _TL157;else{goto _TL158;}
# 1179
_TL157: _T0=loc;_T1=env;_T2=po;_T3=_T2->hd;_T4=(struct _tuple16*)_T3;_T5=*_T4;_T6=_T5.f0;Cyc_Binding_resolve_type(_T0,_T1,_T6);_T7=loc;_T8=env;_T9=po;_TA=_T9->hd;_TB=(struct _tuple16*)_TA;_TC=*_TB;_TD=_TC.f1;
...
struct _tuple17*ex_sym;ex_sym=_cycalloc(sizeof(struct _tuple17));_TF=ex_sym;_TF->f0=wcloc;_T10=ex_sym;_T10->f1=qv;_T11=ex_sym;_T11->f2=0;_T12=exlist_ptr;{struct Cyc_List_List*_T3B=_cycalloc(sizeof(struct Cyc_List_List));
...
_TL1C3: _T156=loc;_T157=env;_T158=tqts;_T159=_T158->hd;_T15A=(struct _tuple18*)_T159;_T15B=*_T15A;_T15C=_T15B.f1;Cyc_Binding_resolve_type(_T156,_T157,_T15C);_T15D=tqts;
# 1483
...
# 1533
_TL1CC: _T19F=exs;_T1A0=_T19F->hd;{struct _tuple17*_T1EB=(struct _tuple17*)_T1A0;struct _tuple0*_T1EC;unsigned _T1ED;{struct _tuple17 _T1EE=*_T1EB;_T1ED=_T1EE.f0;_T1EC=_T1EE.f1;}{unsigned loc=_T1ED;struct _tuple0*qv=_T1EC;
...
# 1567
_TL1D7: _T1C6=exs;_T1C7=_T1C6->hd;{struct _tuple17*_T1EB=(struct _tuple17*)_T1C7;struct _fat_ptr*_T1EC;unsigned _T1ED;{struct _tuple17 _T1EE=*_T1EB;_T1ED=_T1EE.f0;_T1C8=_T1EE.f1;{struct _tuple0 _T1EF=*_T1C8;_T1EC=_T1EF.f1;}}{unsigned loc=_T1ED;struct _fat_ptr*v=_T1EC;_T1CA=Cyc_Dict_member;{
