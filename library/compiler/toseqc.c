...
# 32 "toseqc.cyc"
enum Cyc_Toseqc_SideEffect{Cyc_Toseqc_Const =0U,Cyc_Toseqc_NoEffect =1U,Cyc_Toseqc_ExnEffect =2U,Cyc_Toseqc_AnyEffect =3U};struct _tuple15{enum Cyc_Toseqc_SideEffect f0;enum Cyc_Toseqc_SideEffect f1;};
# 34
static enum Cyc_Toseqc_SideEffect Cyc_Toseqc_join_side_effect(enum Cyc_Toseqc_SideEffect e1,enum Cyc_Toseqc_SideEffect e2){struct _tuple15 _T0;enum Cyc_Toseqc_SideEffect _T1;enum Cyc_Toseqc_SideEffect _T2;enum Cyc_Toseqc_SideEffect _T3;enum Cyc_Toseqc_SideEffect _T4;enum Cyc_Toseqc_SideEffect _T5;enum Cyc_Toseqc_SideEffect _T6;enum Cyc_Toseqc_SideEffect _T7;enum Cyc_Toseqc_SideEffect _T8;enum Cyc_Toseqc_SideEffect _T9;struct Cyc_Warn_String_Warn_Warg_struct _TA;int(*_TB)(struct _fat_ptr);void*(*_TC)(struct _fat_ptr);struct _fat_ptr _TD;{struct _tuple15 _TE;
_TE.f0=e1;_TE.f1=e2;_T0=_TE;}{struct _tuple15 _TE=_T0;_T1=_TE.f0;if(_T1!=Cyc_Toseqc_AnyEffect)goto _TL0;goto _LL4;_TL0: _T2=_TE.f1;if(_T2!=Cyc_Toseqc_AnyEffect)goto _TL2;_LL4:
# 37
...
# 140
struct Cyc_List_List*(*_T29)(struct Cyc_Absyn_Exp*(*)(struct _tuple16*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*)(struct _tuple16*),struct Cyc_List_List*))_T15;_T14=_T29;}_T17=Cyc_Core_snd;{struct Cyc_Absyn_Exp*(*_T29)(struct _tuple16*)=(struct Cyc_Absyn_Exp*(*)(struct _tuple16*))_T17;_T16=_T29;}_T18=dles;_T27=_T14(_T16,_T18);goto _LL18;}case 3:{struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_T29=(struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_T23;_T27=_T29->f2;}_LL18: {struct Cyc_List_List*es=_T27;_T19=
...
# 321
struct Cyc_List_List*(*_T1C)(struct Cyc_Absyn_Exp*(*)(struct _tuple16*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*)(struct _tuple16*),struct Cyc_List_List*))_TF;_TE=_T1C;}_T11=Cyc_Core_snd;{struct Cyc_Absyn_Exp*(*_T1C)(struct _tuple16*)=(struct Cyc_Absyn_Exp*(*)(struct _tuple16*))_T11;_T10=_T1C;}_T12=dles;_T13=_TE(_T10,_T12);Cyc_Toseqc_exps_to_seqc(_TD,_T13);return;}case 36:{struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*_T1C=(struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_T15;_T16=_T1C->f1;}{struct Cyc_Absyn_Stmt*s=_T16;
# 323
...
# 398 "toseqc.cyc"
struct Cyc_List_List*(*_T4B)(struct Cyc_Absyn_Exp*(*)(struct _tuple16*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*)(struct _tuple16*),struct Cyc_List_List*))_T18;_T17=_T4B;}_T1A=Cyc_Core_snd;{struct Cyc_Absyn_Exp*(*_T4B)(struct _tuple16*)=(struct Cyc_Absyn_Exp*(*)(struct _tuple16*))_T1A;_T19=_T4B;}_T1B=dles;_T1C=_T17(_T19,_T1B);{
# 397
