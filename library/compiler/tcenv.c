...
void * Cyc_Tcenv_env_err(struct _fat_ptr msg) {
 ...
 struct Cyc_Tcenv_Fenv {
  ...
  const struct _tuple14 * ctrl_env;
  void * capability;
  void * curr_rgn;
  void * curr_lifo_rgn;
...
void * Cyc_Tcenv_lookup_ordinary_global(struct Cyc_Tcenv_Tenv * te,unsigned int loc,
  ...
  struct _tuple15 * (* _T0)(struct Cyc_Dict_Dict,struct _tuple0 *);
  ...
  void * _TA;
  _T1 = Cyc_Dict_lookup;
  { struct _tuple15 * (* _TB)(struct Cyc_Dict_Dict,struct _tuple0 *) = (struct _tuple15 * (*)(struct Cyc_Dict_Dict,
											      struct _tuple0 *))_T1;
    _T0 = _TB;
  }_T2 = te;
  _T3 = _T2->ae;
  _T4 = _T3->ordinaries;
  _T5 = q;
  { struct _tuple15 * ans = _T0(_T4,_T5);
    _T6 = is_use;
    if (! _T6) { goto _TL0;
    }
    _T7 = ans;
...
const struct _tuple14 *const  Cyc_Tcenv_process_fallthru(struct Cyc_Tcenv_Tenv * te,
  ...
  const struct _tuple14 * _T5;
  struct _tuple14 _T6;
  const struct _tuple14 * _T7;
  _T0 = te;
  _T1 = _tag_fat("process_fallthru",sizeof(char),17U);
  _T2 = Cyc_Tcenv_get_fenv(_T0,_T1);
  { const struct _tuple14 * ans = _T2->ctrl_env;
    if (ans == 0) { goto _TL22;
    }
    _T3 = clauseopt;
...
struct Cyc_Tcenv_Tenv * Cyc_Tcenv_set_fallthru(struct Cyc_Tcenv_Tenv * te,
  ...
  vds = _T4->tl;
  goto _TL27;
  _TL26: { struct _tuple14 * new_ctrl_env;
    new_ctrl_env = _cycalloc(sizeof(struct _tuple14));
    _T5 = new_ctrl_env;
    _T5->f0 = clause;
    _T6 = new_ctrl_env;
    _T6->f1 = new_tvs;
...
static void Cyc_Tcenv_print_aquals_bound(struct Cyc_List_List * aqb) {
  ...
  _TL46: _T0 = i;
  _T1 = _T0->hd;
  { struct _tuple16 * _T8 = (struct _tuple16 *)_T1;
    void * _T9;
    void * _TA;
    { struct _tuple16 _TB = *_T8;
      _TA = _TB.f0;
      _T9 = _TB.f1;
    }{ void * tv = _TA;
      void * b = _T9;
...
void Cyc_Tcenv_check_effect_accessible(struct Cyc_Tcenv_Tenv * te,unsigned int loc,
  ...
  { struct Cyc_Tcenv_Fenv * _TA = Cyc_Tcenv_get_fenv(_T2,_T3);
	...
	{ struct _tuple17 * _TF = _cycalloc(sizeof(struct _tuple17));
	  _TF->f0 = capability;
	  _TF->f1 = eff;
	  _TF->f2 = effc;
	  _TF->f3 = loc;
	  _T8 = (struct _tuple17 *)_TF;
	}_TE->hd = _T8;
	_T9 = shared;
...
void Cyc_Tcenv_check_delayed_effects(struct Cyc_Tcenv_Tenv * te) {
  ...
  { struct Cyc_List_List * checks = _T3->delayed_effect_checks;
    ...
    _TL61: _T4 = checks;
    _T5 = _T4->hd;
    { struct _tuple17 * _TF = (struct _tuple17 *)_T5;
      unsigned int _T10;
      struct Cyc_List_List * _T11;
      void * _T12;
      void * _T13;
      { struct _tuple17 _T14 = *_TF;
	_T13 = _T14.f0;
	_T12 = _T14.f1;
	_T11 = _T14.f2;
	_T10 = _T14.f3;
...
void Cyc_Tcenv_check_effect_constraints(struct Cyc_Tcenv_Tenv * te,unsigned int loc,
  ...
  { struct Cyc_Tcenv_Fenv _TD = *_T7;
	...
	{ struct _tuple18 * _T11 = _cycalloc(sizeof(struct _tuple18));
	  _T11->f0 = ec;
	  _T11->f1 = env_ec;
	  _T11->f2 = loc;
	  _TB = (struct _tuple18 *)_T11;
	}_T10->hd = _TB;
	_TC = shared;
...
void Cyc_Tcenv_check_delayed_constraints(struct Cyc_Tcenv_Tenv * te) {
  ...
  { struct Cyc_List_List * checks = _T3->delayed_constraint_checks;
    ...
    _TL71: _T4 = checks;
    _T5 = _T4->hd;
    { struct _tuple18 * _TB = (struct _tuple18 *)_T5;
      unsigned int _TC;
      struct Cyc_List_List * _TD;
      struct Cyc_List_List * _TE;
      { struct _tuple18 _TF = *_TB;
	_TE = _TF.f0;
	_TD = _TF.f1;
	_TC = _TF.f2;
...
struct Cyc_Tcenv_Fenv * Cyc_Tcenv_new_fenv(unsigned int loc,struct Cyc_Absyn_Fndecl * fd) {
  ...
  struct Cyc_Absyn_VarargInfo * _T27;
  ...
  _T0 = rgn0;
  { struct _fat_ptr * _T3E = _cycalloc(sizeof(struct _fat_ptr));
    { struct Cyc_String_pa_PrintArg_struct _T3F;
      ...
      _T3F.f1 = *_T7;
      _T3 = _T3F;
    }{ struct Cyc_String_pa_PrintArg_struct _T3F = _T3;
      void * _T40[1];
      _T40[0] = &_T3F;
      _T8 = _tag_fat("`%s",sizeof(char),4U);
      _T9 = _tag_fat(_T40,sizeof(void *),1);
      _T2 = Cyc_aprintf(_T8,_T9);
    }*_T3E = _T2;
    _T1 = (struct _fat_ptr *)_T3E;
  }_T0->name = _T1;
  _TA = rgn0;
  ...
  { struct _tuple19 _T3E;
    { struct Cyc_List_List * _T3F = _cycalloc(sizeof(struct Cyc_List_List));
      _T3F->hd = Cyc_CurRgn_curr_rgn_tvar();
      _T11 = fd;
      _T12 = _T11->i;
      _T3F->tl = _T12.tvars;
      _T10 = (struct Cyc_List_List *)_T3F;
    }_T3E.f0 = _T10;
    { struct Cyc_List_List * _T3F = _cycalloc(sizeof(struct Cyc_List_List));
      _T3F->hd = Cyc_CurRgn_curr_rgn_type();
      { struct Cyc_List_List * _T40 = _cycalloc(sizeof(struct Cyc_List_List));
	_T15 = fd;
	_T16 = _T15->i;
	_T17 = _T16.effect;
	_T40->hd = _check_null(_T17);
	_T40->tl = 0;
	_T14 = (struct Cyc_List_List *)_T40;
      }_T3F->tl = _T14;
      _T13 = (struct Cyc_List_List *)_T3F;
    }_T3E.f1 = Cyc_Absyn_join_eff(_T13);
    _T18 = fd;
    _T19 = _T18->i;
    _T3E.f2 = _T19.ret_type;
    _TF = _T3E;
  }{ struct _tuple19 _T3E = _TF;
    void * _T3F;
    void * _T40;
    ...
    _T40 = _T3E.f1;
    _T3F = _T3E.f2;
    { struct Cyc_List_List * tvs1 = _T41;
      void * cap = _T40;
      void * ret_t = _T3F;
      struct Cyc_List_List * tvs;
      ...
      { void * init_store_constraint = Cyc_Tcenv_make_init_store_constraint(tvs,
									    0);
	{ struct Cyc_Absyn_VarType_Absyn_Type_struct * _T42 = _cycalloc(sizeof(struct Cyc_Absyn_VarType_Absyn_Type_struct));
	  _T42->tag = 2;
	  _T42->f1 = rgn0;
	  _T1C = (struct Cyc_Absyn_VarType_Absyn_Type_struct *)_T42;
	}{ void * param_rgn = (void *)_T1C;
	  _T1D = fd;
	  _T1E = _T1D->param_vardecls;
	  _T1F = _check_null(_T1E);
	  _T20 = _T1F->v;
	  { struct Cyc_List_List * vds = (struct Cyc_List_List *)_T20;
	    _TL8A: if (vds != 0) { goto _TL88;
	    }else { goto _TL89;
	    }
	    _TL88: _T21 = vds;
	    _T22 = _T21->hd;
	    _T23 = (struct Cyc_Absyn_Vardecl *)_T22;
	    _T23->rgn = param_rgn;
	    _T24 = vds;
	    vds = _T24->tl;
	    goto _TL8A;
	  ...
	  _T26 = _T25->i;
	  _T27 = _T26.cyc_varargs;
	  if (_T27 == 0) { goto _TL8B;
	  }
	  _T28 = fd;
	  _T29 = _T28->i;
	  _T2A = _T29.cyc_varargs;
	  { struct Cyc_Absyn_VarargInfo _T42 = *_T2A;
	    long _T43;
	    void * _T44;
	    struct Cyc_Absyn_Tqual _T45;
	    struct _fat_ptr * _T46;
	    _T46 = _T42.name;
	    _T45 = _T42.tq;
	    _T44 = _T42.type;
	    _T43 = _T42.inject;
	    { struct _fat_ptr * n = _T46;
	      struct Cyc_Absyn_Tqual tq = _T45;
	      void * t = _T44;
	      long i = _T43;
	      _T2B = fd;
	      _T2C = _T2B->param_vardecls;
	      _T2D = _check_null(_T2C);
	      _T2E = _T2D->v;
	      { struct Cyc_List_List * vds = (struct Cyc_List_List *)_T2E;
		_TL90: if (vds != 0) { goto _TL8E;
		}else { goto _TL8F;
		}
		_TL8E: _T2F = vds;
		_T30 = _T2F->hd;
		{ struct Cyc_Absyn_Vardecl * vd = (struct Cyc_Absyn_Vardecl *)_T30;
		  _T31 = vd;
		  _T32 = _T31->name;
		  _T33 = *_T32;
		  _T34 = _T33.f1;
		  _T35 = _check_null(n);
		  _T36 = Cyc_strptrcmp(_T34,_T35);
		  if (_T36 != 0) { goto _TL91;
		  }
		  _T37 = vd;
		  _T37->type = Cyc_Absyn_fatptr_type(t,param_rgn,Cyc_Absyn_al_qual_type,
	  ...
	  _TL8B: _TL8C: { struct Cyc_Tcenv_Fenv * _T42 = _cycalloc(sizeof(struct Cyc_Tcenv_Fenv));
		...
		_T44->hd = cap;
		_T44->tl = 0;
		_T3B = (struct Cyc_List_List *)_T44;
	      }_T43->tl = _T3B;
	    ...
	    (_T42->flags).in_new = 0U;
	    (_T42->flags).in_notreadctxt = 0;
	    (_T42->flags).in_lhs = 0;
	    (_T42->flags).abstract_ok = 0;
	    (_T42->flags).in_stmt_exp = 0;
	    _T42->lastconstraint = init_store_constraint;
	    _T3C = fd;
	    _T3D = _T3C->i;
	    _T42->effconstr = _T3D.effconstr;
	    _T39 = (struct Cyc_Tcenv_Fenv *)_T42;
	  }return _T39;
	}
      }
    }
...
void Cyc_Tcenv_print_delayed_checks(struct Cyc_List_List * dcc) {
  ...
  _TLA0: _T0 = c;
  _T1 = _T0->hd;
  { struct _tuple18 * _T8 = (struct _tuple18 *)_T1;
    struct Cyc_List_List * _T9;
    struct Cyc_List_List * _TA;
    { struct _tuple18 _TB = *_T8;
      _TA = _TB.f0;
      _T9 = _TB.f1;
