...
# 127
poll(_TB,_TC,_T11);return _T12;}}union Cyc_pthread_attr_t{char __size[36U];long __align;};struct _tuple5{void*(*f0)(void*);void*f1;};
# 140 "cycstubs.cyc"
...
# 184
int  __attribute__((cdecl )) Cyc_sigaction(int sig,const struct Cyc_sigaction*act,struct Cyc_sigaction*oact){int _T0;
# 188
...
# 271
extern int fgetpos(struct __abstractFILE*,struct _tuple20*);
# 273
int Cyc_fgetpos(struct Cyc___cycFILE*f,struct _tuple20*x){struct Cyc___cycFILE*_T0;struct __abstractFILE*_T1;struct __abstractFILE*_T2;struct _tuple20*_T3;int _T4;_T0=f;_T1=_T0->file;_T2=
...
# 382
extern int fsetpos(struct __abstractFILE*,const struct _tuple20*);
# 384
int Cyc_fsetpos(struct Cyc___cycFILE*f,const struct _tuple20*b){struct Cyc___cycFILE*_T0;struct __abstractFILE*_T1;struct __abstractFILE*_T2;const struct _tuple20*_T3;int _T4;_T0=f;_T1=_T0->file;_T2=
...
# 668
extern int select(int,struct _tuple23*,struct _tuple23*,struct _tuple23*,struct Cyc_timeval*);
# 671 "cycstubs.cyc"
extern int Cyc_select(int a,struct _tuple23*b,struct _tuple23*c,struct _tuple23*d,struct Cyc_timeval*e){int*_T0;int*_T1;int _T2;int _T3;
# 674
...
# 682
extern void __stub_FD_CLR(int,struct _tuple23*);
extern int __stub_FD_ISSET(int,struct _tuple23*);
extern void __stub_FD_SET(int,struct _tuple23*);
extern void __stub_FD_ZERO(struct _tuple23*);
# 687
void Cyc_FD_CLR(int a,struct _tuple23*b){
...
# 691
int Cyc_FD_ISSET(int a,struct _tuple23*b){int _T0;
...
# 695
void Cyc_FD_SET(int a,struct _tuple23*b){
...
# 699
void Cyc_FD_ZERO(struct _tuple23*a){
...
# 712
extern int accept_in(int,const struct Cyc_sockaddr_in*,unsigned*);struct _tuple25{void*f0;void*f1;};
# 714
int Cyc_accept(int fd,struct _fat_ptr ap){struct _fat_ptr _T0;unsigned _T1;struct Cyc_SocketError_exn_struct*_T2;struct Cyc_SocketError_exn_struct*_T3;struct _tuple25 _T4;struct _fat_ptr _T5;unsigned char*_T6;void**_T7;void**_T8;struct _fat_ptr _T9;unsigned char*_TA;void**_TB;void*_TC;int*_TD;int _TE;void*_TF;int*_T10;int _T11;void*_T12;void*_T13;int _T14;struct Cyc_SocketError_exn_struct*_T15;struct Cyc_SocketError_exn_struct*_T16;_T0=ap;_T1=
_get_fat_size(_T0,sizeof(void*));if(_T1==2U)goto _TL6D;_T2=& Cyc_SocketError_val;_T3=(struct Cyc_SocketError_exn_struct*)_T2;_throw(_T3);goto _TL6E;_TL6D: _TL6E:{struct _tuple25 _T17;_T5=ap;_T6=_T5.curr;_T7=(void**)_T6;_T8=
_check_null(_T7);_T17.f0=_T8[0];_T9=ap;_TA=_T9.curr;_TB=(void**)_TA;_T17.f1=_TB[1];_T4=_T17;}{struct _tuple25 _T17=_T4;unsigned*_T18;struct Cyc_sockaddr_in*_T19;_TC=_T17.f0;_TD=(int*)_TC;_TE=*_TD;if(_TE!=0)goto _TL6F;_TF=_T17.f1;_T10=(int*)_TF;_T11=*_T10;if(_T11!=1)goto _TL71;_T12=_T17.f0;{struct Cyc_SA_sockaddr_in_SockAddr_struct*_T1A=(struct Cyc_SA_sockaddr_in_SockAddr_struct*)_T12;_T19=_T1A->f1;}_T13=_T17.f1;{struct Cyc_SA_socklenptr_SockAddr_struct*_T1A=(struct Cyc_SA_socklenptr_SockAddr_struct*)_T13;_T18=_T1A->f1;}{struct Cyc_sockaddr_in*x=_T19;unsigned*y=_T18;_T14=
# 718
...
_get_fat_size(_T0,sizeof(void*));if(_T1==2U)goto _TL73;_T2=& Cyc_SocketError_val;_T3=(struct Cyc_SocketError_exn_struct*)_T2;_throw(_T3);goto _TL74;_TL73: _TL74:{struct _tuple25 _T17;_T5=ap;_T6=_T5.curr;_T7=(void**)_T6;_T8=
_check_null(_T7);_T17.f0=_T8[0];_T9=ap;_TA=_T9.curr;_TB=(void**)_TA;_T17.f1=_TB[1];_T4=_T17;}{struct _tuple25 _T17=_T4;unsigned _T18;struct Cyc_sockaddr_in*_T19;_TC=_T17.f0;_TD=(int*)_TC;_TE=*_TD;if(_TE!=0)goto _TL75;_TF=_T17.f1;_T10=(int*)_TF;_T11=*_T10;if(_T11!=2)goto _TL77;_T12=_T17.f0;{struct Cyc_SA_sockaddr_in_SockAddr_struct*_T1A=(struct Cyc_SA_sockaddr_in_SockAddr_struct*)_T12;_T19=_T1A->f1;}_T13=_T17.f1;{struct Cyc_SA_socklen_SockAddr_struct*_T1A=(struct Cyc_SA_socklen_SockAddr_struct*)_T13;_T18=_T1A->f1;}{struct Cyc_sockaddr_in*x=_T19;unsigned y=_T18;_T14=
# 730
...
_get_fat_size(_T0,sizeof(void*));if(_T1==2U)goto _TL79;_T2=& Cyc_SocketError_val;_T3=(struct Cyc_SocketError_exn_struct*)_T2;_throw(_T3);goto _TL7A;_TL79: _TL7A:{struct _tuple25 _T17;_T5=ap;_T6=_T5.curr;_T7=(void**)_T6;_T8=
_check_null(_T7);_T17.f0=_T8[0];_T9=ap;_TA=_T9.curr;_TB=(void**)_TA;_T17.f1=_TB[1];_T4=_T17;}{struct _tuple25 _T17=_T4;unsigned _T18;struct Cyc_sockaddr_in*_T19;_TC=_T17.f0;_TD=(int*)_TC;_TE=*_TD;if(_TE!=0)goto _TL7B;_TF=_T17.f1;_T10=(int*)_TF;_T11=*_T10;if(_T11!=2)goto _TL7D;_T12=_T17.f0;{struct Cyc_SA_sockaddr_in_SockAddr_struct*_T1A=(struct Cyc_SA_sockaddr_in_SockAddr_struct*)_T12;_T19=_T1A->f1;}_T13=_T17.f1;{struct Cyc_SA_socklen_SockAddr_struct*_T1A=(struct Cyc_SA_socklen_SockAddr_struct*)_T13;_T18=_T1A->f1;}{struct Cyc_sockaddr_in*x=_T19;unsigned y=_T18;_T14=
# 742
...
_get_fat_size(_T0,sizeof(void*));if(_T1==2U)goto _TL7F;_T2=& Cyc_SocketError_val;_T3=(struct Cyc_SocketError_exn_struct*)_T2;_throw(_T3);goto _TL80;_TL7F: _TL80:{struct _tuple25 _T17;_T5=ap;_T6=_T5.curr;_T7=(void**)_T6;_T8=
_check_null(_T7);_T17.f0=_T8[0];_T9=ap;_TA=_T9.curr;_TB=(void**)_TA;_T17.f1=_TB[1];_T4=_T17;}{struct _tuple25 _T17=_T4;unsigned*_T18;struct Cyc_sockaddr_in*_T19;_TC=_T17.f0;_TD=(int*)_TC;_TE=*_TD;if(_TE!=0)goto _TL81;_TF=_T17.f1;_T10=(int*)_TF;_T11=*_T10;if(_T11!=1)goto _TL83;_T12=_T17.f0;{struct Cyc_SA_sockaddr_in_SockAddr_struct*_T1A=(struct Cyc_SA_sockaddr_in_SockAddr_struct*)_T12;_T19=_T1A->f1;}_T13=_T17.f1;{struct Cyc_SA_socklenptr_SockAddr_struct*_T1A=(struct Cyc_SA_socklenptr_SockAddr_struct*)_T13;_T18=_T1A->f1;}{struct Cyc_sockaddr_in*x=_T19;unsigned*y=_T18;_T14=
# 754
...
_get_fat_size(_T0,sizeof(void*));if(_T1==2U)goto _TL85;_T2=& Cyc_SocketError_val;_T3=(struct Cyc_SocketError_exn_struct*)_T2;_throw(_T3);goto _TL86;_TL85: _TL86:{struct _tuple25 _T17;_T5=ap;_T6=_T5.curr;_T7=(void**)_T6;_T8=
_check_null(_T7);_T17.f0=_T8[0];_T9=ap;_TA=_T9.curr;_TB=(void**)_TA;_T17.f1=_TB[1];_T4=_T17;}{struct _tuple25 _T17=_T4;unsigned*_T18;struct Cyc_sockaddr_in*_T19;_TC=_T17.f0;_TD=(int*)_TC;_TE=*_TD;if(_TE!=0)goto _TL87;_TF=_T17.f1;_T10=(int*)_TF;_T11=*_T10;if(_T11!=1)goto _TL89;_T12=_T17.f0;{struct Cyc_SA_sockaddr_in_SockAddr_struct*_T1A=(struct Cyc_SA_sockaddr_in_SockAddr_struct*)_T12;_T19=_T1A->f1;}_T13=_T17.f1;{struct Cyc_SA_socklenptr_SockAddr_struct*_T1A=(struct Cyc_SA_socklenptr_SockAddr_struct*)_T13;_T18=_T1A->f1;}{struct Cyc_sockaddr_in*x=_T19;unsigned*y=_T18;_T14=
# 766
...
# 775
int Cyc_getsockopt(int fd,int level,int optname,struct _fat_ptr ap){struct _fat_ptr _T0;unsigned _T1;struct Cyc_SocketError_exn_struct*_T2;struct Cyc_SocketError_exn_struct*_T3;struct _tuple25 _T4;struct _fat_ptr _T5;unsigned char*_T6;void**_T7;void**_T8;struct _fat_ptr _T9;unsigned char*_TA;void**_TB;void*_TC;int*_TD;unsigned _TE;void*_TF;int*_T10;unsigned _T11;void*_T12;void*_T13;int _T14;void*_T15;void*_T16;int _T17;int _T18;int _T19;int*_T1A;int*_T1B;unsigned*_T1C;int _T1D;void*_T1E;int*_T1F;unsigned _T20;void*_T21;void*_T22;int _T23;void*_T24;void*_T25;int _T26;int _T27;int _T28;struct Cyc_timeval*_T29;int*_T2A;unsigned*_T2B;int _T2C;struct Cyc_SocketError_exn_struct*_T2D;struct Cyc_SocketError_exn_struct*_T2E;_T0=ap;_T1=
_get_fat_size(_T0,sizeof(void*));if(_T1==2U)goto _TL8B;_T2=& Cyc_SocketError_val;_T3=(struct Cyc_SocketError_exn_struct*)_T2;_throw(_T3);goto _TL8C;_TL8B: _TL8C:{struct _tuple25 _T2F;_T5=ap;_T6=_T5.curr;_T7=(void**)_T6;_T8=
_check_null(_T7);_T2F.f0=_T8[0];_T9=ap;_TA=_T9.curr;_TB=(void**)_TA;_T2F.f1=_TB[1];_T4=_T2F;}{struct _tuple25 _T2F=_T4;struct Cyc_timeval*_T30;int*_T31;unsigned*_T32;int*_T33;_TC=_T2F.f0;_TD=(int*)_TC;_TE=*_TD;switch(_TE){case 0: _TF=_T2F.f1;_T10=(int*)_TF;_T11=*_T10;switch(_T11){case 3: _T12=_T2F.f0;{struct Cyc_SO_int_SockOpt_struct*_T34=(struct Cyc_SO_int_SockOpt_struct*)_T12;_T33=_T34->f1;}_T13=_T2F.f1;{struct Cyc_SO_socklenptr_SockOpt_struct*_T34=(struct Cyc_SO_socklenptr_SockOpt_struct*)_T13;_T32=_T34->f1;}{int*x=_T33;unsigned*y=_T32;_T14=
# 779
...
# 805
_get_fat_size(_T0,sizeof(void*));if(_T1==2U)goto _TL90;_T2=& Cyc_SocketError_val;_T3=(struct Cyc_SocketError_exn_struct*)_T2;_throw(_T3);goto _TL91;_TL90: _TL91:{struct _tuple25 _T17;_T5=ap;_T6=_T5.curr;_T7=(void**)_T6;_T8=
_check_null(_T7);_T17.f0=_T8[0];_T9=ap;_TA=_T9.curr;_TB=(void**)_TA;_T17.f1=_TB[1];_T4=_T17;}{struct _tuple25 _T17=_T4;unsigned*_T18;struct Cyc_sockaddr_in*_T19;_TC=_T17.f0;_TD=(int*)_TC;_TE=*_TD;if(_TE!=0)goto _TL92;_TF=_T17.f1;_T10=(int*)_TF;_T11=*_T10;if(_T11!=1)goto _TL94;_T12=_T17.f0;{struct Cyc_SA_sockaddr_in_SockAddr_struct*_T1A=(struct Cyc_SA_sockaddr_in_SockAddr_struct*)_T12;_T19=_T1A->f1;}_T13=_T17.f1;{struct Cyc_SA_socklenptr_SockAddr_struct*_T1A=(struct Cyc_SA_socklenptr_SockAddr_struct*)_T13;_T18=_T1A->f1;}{struct Cyc_sockaddr_in*x=_T19;unsigned*y=_T18;_T14=
# 808
...
# 826
_get_fat_size(_T0,sizeof(void*));if(_T1==2U)goto _TL96;_T2=& Cyc_SocketError_val;_T3=(struct Cyc_SocketError_exn_struct*)_T2;_throw(_T3);goto _TL97;_TL96: _TL97:{struct _tuple25 _T17;_T5=ap;_T6=_T5.curr;_T7=(void**)_T6;_T8=
_check_null(_T7);_T17.f0=_T8[0];_T9=ap;_TA=_T9.curr;_TB=(void**)_TA;_T17.f1=_TB[1];_T4=_T17;}{struct _tuple25 _T17=_T4;unsigned _T18;struct Cyc_sockaddr_in*_T19;_TC=_T17.f0;_TD=(int*)_TC;_TE=*_TD;if(_TE!=0)goto _TL98;_TF=_T17.f1;_T10=(int*)_TF;_T11=*_T10;if(_T11!=2)goto _TL9A;_T12=_T17.f0;{struct Cyc_SA_sockaddr_in_SockAddr_struct*_T1A=(struct Cyc_SA_sockaddr_in_SockAddr_struct*)_T12;_T19=_T1A->f1;}_T13=_T17.f1;{struct Cyc_SA_socklen_SockAddr_struct*_T1A=(struct Cyc_SA_socklen_SockAddr_struct*)_T13;_T18=_T1A->f1;}{struct Cyc_sockaddr_in*x=_T19;unsigned y=_T18;_T14=
# 829
