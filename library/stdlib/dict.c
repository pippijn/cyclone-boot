...
_get_fat_size(_T1D,sizeof(const struct Cyc_Dict_T*));{unsigned _T48=_T1E * 2U;_T20=temp;_T21=_check_times(_T48,sizeof(const struct Cyc_Dict_T*));{const struct Cyc_Dict_T**_T49=_region_malloc(_T20,0U,_T21);{unsigned _T4A=_T48;unsigned i;i=0;_TLF9: if(i < _T4A)goto _TLF7;else{goto _TLF8;}_TLF7: _T22=i;_T23=queue;_T24=
...
_TF->f0=stack;_TC=t;_TD=(unsigned)_TC;if(!_TD)goto _TL119;_TF->f1=0;goto _TL11A;_TL119: _TF->f1=- 1;_TL11A: _TA=(struct _tuple10*)_TF;}_TE.env=_TA;
