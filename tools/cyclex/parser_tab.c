...
static struct _tuple5 * Cyc_yyget_Entrypoint_tok(union Cyc_YYSTYPE * yy1) {
  union Cyc_YYSTYPE * _T0;
  union Cyc_YYSTYPE * _T1;
  ...
  { union Cyc_YYSTYPE _T8 = *_T4;
    ...
    _T7 = _T5.val;
  }{ struct _tuple5 * yy = _T7;
    _T6 = yy;
    return _T6;
  }_TL1B: Cyc_yythrowfail(s);
  ;
}
static union Cyc_YYSTYPE Cyc_Entrypoint_tok(struct _tuple5 * yy1) {
  union Cyc_YYSTYPE _T0;
  { union Cyc_YYSTYPE _T1;
...
static struct _tuple3 * Cyc_yyget_Acase_tok(union Cyc_YYSTYPE * yy1) {
  union Cyc_YYSTYPE * _T0;
  union Cyc_YYSTYPE * _T1;
  ...
  { union Cyc_YYSTYPE _T8 = *_T4;
    _T5 = _T8.Acase_tok;
    _T7 = _T5.val;
  }{ struct _tuple3 * yy = _T7;
    _T6 = yy;
    return _T6;
  }_TL1F: Cyc_yythrowfail(s);
  ;
}
static union Cyc_YYSTYPE Cyc_Acase_tok(struct _tuple3 * yy1) {
  union Cyc_YYSTYPE _T0;
  { union Cyc_YYSTYPE _T1;
...
int Cyc_yyparse() {
  ...
  { int yystate;
	...
	*_TB = (short)_TC;
	...
	_T4F = yyvsp_offset;
	_T50 = _check_fat_subscript(_T4E,sizeof(struct Cyc_Yystacktype),_T4F);
	_T51 = (struct Cyc_Yystacktype *)_T50;
	...
	case 7: 
	  ...
	  goto _LL0;
	case 8: 
	  { struct _tuple5 * _T18C = _cycalloc(sizeof(struct _tuple5));
	    _T92 = yyyvsp;
	    _T93 = &(_T92[0]).v;
	...
	case 10: 
	  { struct _tuple5 * _T18C = _cycalloc(sizeof(struct _tuple5));
	    ...
	    { struct _tuple4 * _T18D = _cycalloc(sizeof(struct _tuple4));
	      _TAB = yyyvsp;
	      _TAC = &(_TAB[2]).v;
	...
	case 14: 
	  ...
	  goto _LL0;
	case 15: 
	  { struct _tuple3 * _T18C = _cycalloc(sizeof(struct _tuple3));
	    _TC9 = yyyvsp;
	    _TCA = &(_TC9[0]).v;
