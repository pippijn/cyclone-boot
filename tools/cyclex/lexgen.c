...
static int Cyc_Lexgen_get_state(struct Cyc_Set_Set * st) {
  ...
  { int _T17 = 0;
    ...
    { void * _T18 = (void *)_T7;
      ...
      _TB = _check_null(Cyc_Lexgen_state_map);
      _TD = Cyc_Dict_insert;
...
static void * Cyc_Lexgen_translate_state(struct _fat_ptr chars,struct _fat_ptr follow,
  ...
  int _T5;
  int _T6;
  struct Cyc_Lexgen_No_remember_Lexgen_Automata_trans_struct * _T7;
  struct Cyc_Lexgen_No_remember_Lexgen_Automata_trans_struct * _T8;
  struct Cyc_Lexgen_Remember_Lexgen_Automata_trans_struct * _T9;
  void * _TA;
  struct _tuple7 * _TB = Cyc_Lexgen_split_trans_set(state);
  struct Cyc_List_List * _TC;
  int _TD;
  _T0 = (struct _tuple7 *)_TB;
  _T1 = _T0->f1;
  if (_T1 != 0) { goto _TL46;
  }
  { struct _tuple7 _TE = *_TB;
    _TD = _TE.f0;
  }{ int n = _TD;
    { struct Cyc_Lexgen_Perform_Lexgen_Automata_struct * _TE = _cycalloc(sizeof(struct Cyc_Lexgen_Perform_Lexgen_Automata_struct));
      _TE->tag = 0;
      _TE->f1 = n;
      _T2 = (struct Cyc_Lexgen_Perform_Lexgen_Automata_struct *)_TE;
    }_T3 = (void *)_T2;
    return _T3;
  }_TL46: { struct _tuple7 _TE = *_TB;
    _TD = _TE.f0;
    _TC = _TE.f1;
  }{ int n = _TD;
    struct Cyc_List_List * ps = _TC;
    { struct Cyc_Lexgen_Shift_Lexgen_Automata_struct * _TE = _cycalloc(sizeof(struct Cyc_Lexgen_Shift_Lexgen_Automata_struct));
      _TE->tag = 1;
      _T5 = n;
      _T6 = 1 << 29;
      if (_T5 != _T6) { goto _TL48;
      }
      _T7 = &Cyc_Lexgen_No_remember_val;
      _T8 = (struct Cyc_Lexgen_No_remember_Lexgen_Automata_trans_struct *)_T7;
      _TE->f1 = (void *)_T8;
      goto _TL49;
      _TL48: { struct Cyc_Lexgen_Remember_Lexgen_Automata_trans_struct * _TF = _cycalloc(sizeof(struct Cyc_Lexgen_Remember_Lexgen_Automata_trans_struct));
	_TF->tag = 1;
	_TF->f1 = n;
	_T9 = (struct Cyc_Lexgen_Remember_Lexgen_Automata_trans_struct *)_TF;
      }_TE->f1 = (void *)_T9;
      _TL49: _TE->f2 = Cyc_Lexgen_transition_from(chars,follow,ps);
      _T4 = (struct Cyc_Lexgen_Shift_Lexgen_Automata_struct *)_TE;
    }_TA = (void *)_T4;
    return _TA;
  };
}
