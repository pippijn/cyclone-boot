...
# 36
void Cyc_Output_output_array(struct Cyc___cycFILE*oc,struct _fat_ptr v){struct Cyc___cycFILE*_T0;struct _fat_ptr _T1;struct _fat_ptr _T2;int _T3;unsigned _T4;struct _fat_ptr _T5;unsigned _T6;unsigned _T7;struct Cyc_Int_pa_PrintArg_struct _T8;struct _fat_ptr _T9;int _TA;unsigned char*_TB;int*_TC;int _TD;struct Cyc___cycFILE*_TE;struct _fat_ptr _TF;struct _fat_ptr _T10;struct Cyc_Int_pa_PrintArg_struct _T11;struct _fat_ptr _T12;struct _fat_ptr _T13;unsigned _T14;unsigned _T15;int _T16;unsigned char*_T17;int*_T18;int _T19;struct Cyc___cycFILE*_T1A;struct _fat_ptr _T1B;struct _fat_ptr _T1C;_T0=oc;_T1=
...
_TLD:{struct Cyc_Int_pa_PrintArg_struct _T1D;_T1D.tag=1;_T9=v;_TA=i;_TB=_check_fat_subscript(_T9,sizeof(int),_TA);_TC=(int*)_TB;_TD=*_TC;_T1D.f1=(unsigned long)_TD;_T8=_T1D;}{struct Cyc_Int_pa_PrintArg_struct _T1D=_T8;void*_T1E[1];_T1E[0]=& _T1D;_TE=oc;_TF=_tag_fat("%d,",sizeof(char),4U);_T10=_tag_fat(_T1E,sizeof(void*),1);Cyc_fprintf(_TE,_TF,_T10);}
# 38
i=i + 1;goto _TLF;_TLE:;}{struct Cyc_Int_pa_PrintArg_struct _T1D;_T1D.tag=1;_T12=v;_T13=v;_T14=
# 40
_get_fat_size(_T13,sizeof(int));_T15=_T14 - 1U;_T16=(int)_T15;_T17=_check_fat_subscript(_T12,sizeof(int),_T16);_T18=(int*)_T17;_T19=*_T18;_T1D.f1=(unsigned long)_T19;_T11=_T1D;}{struct Cyc_Int_pa_PrintArg_struct _T1D=_T11;void*_T1E[1];_T1E[0]=& _T1D;_T1A=oc;_T1B=_tag_fat("%d}",sizeof(char),4U);_T1C=_tag_fat(_T1E,sizeof(void*),1);Cyc_fprintf(_T1A,_T1B,_T1C);}}
# 43
