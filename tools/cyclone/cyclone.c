...
# 643
struct Cyc_List_List*Cyc_do_print(struct _tuple15*env,struct Cyc_List_List*tds){struct _tuple15*_T0;struct Cyc_Absynpp_Params _T1;enum Cyc_Flags_Cyclone_Passes _T2;int _T3;enum Cyc_Flags_Cyclone_Passes _T4;int _T5;int _T6;int _T7;struct Cyc___cycFILE*_T8;struct _fat_ptr _T9;struct _fat_ptr _TA;struct Cyc___cycFILE*_TB;struct _fat_ptr _TC;struct _fat_ptr _TD;struct Cyc___cycFILE*_TE;struct _fat_ptr _TF;struct _fat_ptr _T10;int _T11;struct Cyc_Absynpp_Params*_T12;struct Cyc_Absynpp_Params*_T13;struct Cyc_Absynpp_Params*_T14;struct Cyc_Absynpp_Params*_T15;struct Cyc_List_List*_T16;struct _fat_ptr _T17;struct Cyc___cycFILE*_T18;_T0=env;{struct _tuple15 _T19=*_T0;_T18=_T19.f0;_T17=_T19.f1;}{struct Cyc___cycFILE*out_file=_T18;struct _fat_ptr cfile=_T17;_T2=Cyc_Flags_stop_after_pass;_T3=(int)_T2;
# 646
...
# 657
if(_T5 <= 6)goto _TL75;_T6=Cyc_nocyc_setjmp_r;
if(_T6)goto _TL77;else{goto _TL79;}
_TL79: _T7=Cyc_Flags_compile_for_boot;if(!_T7)goto _TL7A;_T8=out_file;_T9=
_tag_fat("#include <setjmp.h>\n",sizeof(char),21U);_TA=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T8,_T9,_TA);goto _TL7B;
# 662
_TL7A: _TB=out_file;_TC=_tag_fat("#include <cyc_setjmp.h>\n",sizeof(char),25U);_TD=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_TB,_TC,_TD);_TL7B: goto _TL78;_TL77: _TL78: _TE=out_file;_TF=
# 664
_tag_fat("#include <cyc_include.h>\n",sizeof(char),26U);_T10=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_TE,_TF,_T10);goto _TL76;_TL75: _TL76: _T11=Cyc_pp_r;
# 666
if(!_T11)goto _TL7C;_T12=& params_r;_T13=(struct Cyc_Absynpp_Params*)_T12;
Cyc_Absynpp_set_params(_T13);
Cyc_Absynpp_decllist2file(tds,out_file);goto _TL7D;
# 670
_TL7C: _T14=& params_r;_T15=(struct Cyc_Absynpp_Params*)_T14;Cyc_Absyndump_set_params(_T15);
Cyc_Absyndump_dumpdecllist2file(tds,out_file);_TL7D:
# 673
 Cyc_fflush(out_file);_T16=tds;
return _T16;}}}
# 678
...
if(_T2!=0)goto _TL7E;return 0;_TL7E: {
struct Cyc_List_List*result=0;
unsigned long len=Cyc_strlen(s);
# 683
_TL80: if(len > 0U)goto _TL81;else{goto _TL82;}
_TL81:{struct _fat_ptr end=Cyc_strchr(s,c);_T3=end;_T4=_T3.curr;_T5=(char*)_T4;
if(_T5!=0)goto _TL83;{struct Cyc_List_List*_T1E=_cycalloc(sizeof(struct Cyc_List_List));{struct _fat_ptr*_T1F=_cycalloc(sizeof(struct _fat_ptr));
*_T1F=s;_T7=(struct _fat_ptr*)_T1F;}_T1E->hd=_T7;_T1E->tl=result;_T6=(struct Cyc_List_List*)_T1E;}result=_T6;goto _TL82;
# 689
_TL83:{struct Cyc_List_List*_T1E=_cycalloc(sizeof(struct Cyc_List_List));{struct _fat_ptr*_T1F=_cycalloc(sizeof(struct _fat_ptr));_TA=s;_TB=end;_TC=_TB;_TD=_TC.curr;_TE=s;_TF=_TE.curr;_T10=_TD - _TF;_T11=_T10 / sizeof(char);_T12=(unsigned long)_T11;_T13=Cyc_substring(_TA,0,_T12);*_T1F=_T13;_T9=(struct _fat_ptr*)_T1F;}_T1E->hd=_T9;_T1E->tl=result;_T8=(struct Cyc_List_List*)_T1E;}result=_T8;_T14=end;_T15=_T14;_T16=_T15.curr;_T17=s;_T18=_T17.curr;_T19=_T16 - _T18;_T1A=_T19 / sizeof(char);_T1B=(unsigned long)_T1A;
len=len - _T1B;_T1C=end;
s=_fat_ptr_plus(_T1C,sizeof(char),1);;}goto _TL80;_TL82: _T1D=
# 694
...
_TL88: if(dirs!=0)goto _TL86;else{goto _TL87;}
_TL86:{struct Cyc_List_List*_TA=_cycalloc(sizeof(struct Cyc_List_List));{struct _fat_ptr*_TB=_cycalloc(sizeof(struct _fat_ptr));_T2=dirs;_T3=_T2->hd;_T4=(struct _fat_ptr*)_T3;_T5=*_T4;_T6=subdir;_T7=Cyc_Filename_concat(_T5,_T6);*_TB=_T7;_T1=(struct _fat_ptr*)_TB;}_TA->hd=_T1;_TA->tl=l;_T0=(struct Cyc_List_List*)_TA;}l=_T0;_T8=dirs;
# 702
dirs=_T8->tl;goto _TL88;_TL87:
# 704
...
int single_quotes=0;
int other_special=0;{
int i=0;_TL8D: _T0=i;_T1=(unsigned long)_T0;_T2=len;if(_T1 < _T2)goto _TL8B;else{goto _TL8C;}
_TL8B: _T3=s;_T4=_T3.curr;_T5=(const char*)_T4;_T6=_check_null(_T5);_T7=i;{char c=_T6[_T7];_T8=c;_T9=(int)_T8;
if(_T9!=39)goto _TL8E;single_quotes=single_quotes + 1;goto _TL8F;
_TL8E: _TA=Cyc_is_other_special(c);if(!_TA)goto _TL90;other_special=other_special + 1;goto _TL91;_TL90: _TL91: _TL8F:;}
# 737
i=i + 1;goto _TL8D;_TL8C:;}
# 744
if(single_quotes!=0)goto _TL92;if(other_special!=0)goto _TL92;_TB=s;
return _TB;_TL92:
# 748
 if(single_quotes!=0)goto _TL94;{struct _fat_ptr*_T3A[3];{struct _fat_ptr*_T3B=_cycalloc(sizeof(struct _fat_ptr));
*_T3B=_tag_fat("'",sizeof(char),2U);_TD=(struct _fat_ptr*)_T3B;}_T3A[0]=_TD;{struct _fat_ptr*_T3B=_cycalloc(sizeof(struct _fat_ptr));_TF=s;*_T3B=_TF;_TE=(struct _fat_ptr*)_T3B;}_T3A[1]=_TE;{struct _fat_ptr*_T3B=_cycalloc(sizeof(struct _fat_ptr));*_T3B=_tag_fat("'",sizeof(char),2U);_T10=(struct _fat_ptr*)_T3B;}_T3A[2]=_T10;_T11=_tag_fat(_T3A,sizeof(struct _fat_ptr*),3);_TC=Cyc_List_list(_T11);}_T12=Cyc_strconcat_l(_TC);return _T12;_TL94: _T13=len;_T14=single_quotes;_T15=(unsigned long)_T14;_T16=_T13 + _T15;_T17=other_special;_T18=(unsigned long)_T17;{
# 752
unsigned long len2=_T16 + _T18;_T1A=len2 + 1U;{unsigned _T3A=_T1A + 1U;_T1C=_check_times(_T3A,sizeof(char));{char*_T3B=_cycalloc_atomic(_T1C);{unsigned _T3C=_T3A;unsigned i;i=0;_TL99: if(i < _T3C)goto _TL97;else{goto _TL98;}_TL97: _T1D=i;
_T3B[_T1D]='\000';i=i + 1;goto _TL99;_TL98: _T3B[_T3C]=0;}_T1B=(char*)_T3B;}_T19=_tag_fat(_T1B,sizeof(char),_T3A);}{struct _fat_ptr s2=_T19;
int i=0;
int j=0;
_TL9D: _T1E=i;_T1F=(unsigned long)_T1E;_T20=len;if(_T1F < _T20)goto _TL9B;else{goto _TL9C;}
_TL9B: _T21=s;_T22=_T21.curr;_T23=(const char*)_T22;_T24=_check_null(_T23);_T25=i;{char c=_T24[_T25];_T26=c;_T27=(int)_T26;
if(_T27==39)goto _TLA0;else{goto _TLA1;}_TLA1: _T28=Cyc_is_other_special(c);if(_T28)goto _TLA0;else{goto _TL9E;}
_TLA0: _T29=s2;_T2A=j;j=_T2A + 1;_T2B=_T2A;{struct _fat_ptr _T3A=_fat_ptr_plus(_T29,sizeof(char),_T2B);_T2C=_check_fat_subscript(_T3A,sizeof(char),0U);_T2D=(char*)_T2C;{char _T3B=*_T2D;char _T3C='\\';_T2E=_get_fat_size(_T3A,sizeof(char));if(_T2E!=1U)goto _TLA2;if(_T3B!=0)goto _TLA2;if(_T3C==0)goto _TLA2;_throw_arraybounds();goto _TLA3;_TLA2: _TLA3: _T2F=_T3A.curr;_T30=(char*)_T2F;*_T30=_T3C;}}goto _TL9F;_TL9E: _TL9F: _T31=s2;_T32=j;
j=_T32 + 1;_T33=_T32;{struct _fat_ptr _T3A=_fat_ptr_plus(_T31,sizeof(char),_T33);_T34=_check_fat_subscript(_T3A,sizeof(char),0U);_T35=(char*)_T34;{char _T3B=*_T35;char _T3C=c;_T36=_get_fat_size(_T3A,sizeof(char));if(_T36!=1U)goto _TLA4;if(_T3B!=0)goto _TLA4;if(_T3C==0)goto _TLA4;_throw_arraybounds();goto _TLA5;_TLA4: _TLA5: _T37=_T3A.curr;_T38=(char*)_T37;*_T38=_T3C;}}}
# 756
i=i + 1;goto _TL9D;_TL9C: _T39=s2;
# 762
return _T39;}}}
# 764
...
if(_T2!=0)goto _TLA6;{struct Cyc_List_List*_TB=_cycalloc(sizeof(struct Cyc_List_List));{struct _fat_ptr*_TC=_cycalloc(sizeof(struct _fat_ptr));_T5=
# 771
...
# 770
cppargs_string=
Cyc_str_sepstr(_T3,_T9);goto _TLA7;_TLA6: _TLA7: _TA=cppargs_string;
# 774
return _TA;}
# 777
...
# 785
if(!_T3)goto _TLA8;{struct Cyc_String_pa_PrintArg_struct _T58;_T58.tag=0;_T58.f1=filename;_T4=_T58;}{struct Cyc_String_pa_PrintArg_struct _T58=_T4;void*_T59[1];_T59[0]=& _T58;_T5=Cyc_stderr;_T6=_tag_fat("Compiling %s\n",sizeof(char),14U);_T7=_tag_fat(_T59,sizeof(void*),1);Cyc_fprintf(_T5,_T6,_T7);}goto _TLA9;_TLA8: _TLA9: _T8=filename;_T9=
# 788
...
if(_TB)goto _TLAC;else{goto _TLAD;}_TLAD: _TC=f0;_TD=(unsigned)_TC;if(_TD)goto _TLAA;else{goto _TLAC;}
_TLAC: return 0;_TLAA:
 Cyc_fclose(f0);{
# 796
...
Cyc_strlen(Cyc_def_inc_path);if(_T10 <= 0U)goto _TLAE;{struct Cyc_List_List*_T58=_cycalloc(sizeof(struct Cyc_List_List));{struct _fat_ptr*_T59=_cycalloc(sizeof(struct _fat_ptr));
*_T59=Cyc_def_inc_path;_T12=(struct _fat_ptr*)_T59;}_T58->hd=_T12;_T58->tl=stdinc_dirs;_T11=(struct Cyc_List_List*)_T58;}stdinc_dirs=_T11;goto _TLAF;_TLAE: _TLAF: {
char*cyclone_include_path=getenv("CYCLONE_INCLUDE_PATH");
if(cyclone_include_path==0)goto _TLB0;{char*_T58=cyclone_include_path;_T14=(void*)_T58;_T15=(void*)_T58;_T16=_get_zero_arr_size_char(_T15,1U);_T13=_tag_fat(_T14,sizeof(char),_T16);}_T17=
Cyc_split_by_char(_T13,':');_T18=stdinc_dirs;stdinc_dirs=Cyc_List_append(_T17,_T18);goto _TLB1;_TLB0: _TLB1:{struct Cyc_List_List*_T58=_cycalloc(sizeof(struct Cyc_List_List));{struct _fat_ptr*_T59=_cycalloc(sizeof(struct _fat_ptr));_T1B=
# 812
...
if(_T21 > 0)goto _TLB2;
if(Cyc_output_file!=0)goto _TLB4;_T22=_tag_fat("",sizeof(char),1U);goto _TLB5;_TLB4:{struct Cyc_String_pa_PrintArg_struct _T58;_T58.tag=0;_T25=Cyc_output_file;_T58.f1=*_T25;_T24=_T58;}{struct Cyc_String_pa_PrintArg_struct _T58=_T24;void*_T59[1];_T59[0]=& _T58;_T26=_tag_fat(" > %s",sizeof(char),6U);_T27=_tag_fat(_T59,sizeof(void*),1);_T23=Cyc_aprintf(_T26,_T27);}_T22=_T23;_TLB5: ofile_string=_T22;goto _TLB3;
# 819
_TLB2:{struct Cyc_String_pa_PrintArg_struct _T58;_T58.tag=0;_T58.f1=Cyc_sh_escape_string(preprocfile);_T29=_T58;}{struct Cyc_String_pa_PrintArg_struct _T58=_T29;void*_T59[1];_T59[0]=& _T58;_T2A=_tag_fat(" > %s",sizeof(char),6U);_T2B=_tag_fat(_T59,sizeof(void*),1);_T28=Cyc_aprintf(_T2A,_T2B);}ofile_string=_T28;_TLB3: {
# 821
struct _fat_ptr fixup_string;_T2C=Cyc_produce_dependencies;
if(!_T2C)goto _TLB6;
# 825
if(Cyc_dependencies_target!=0)goto _TLB8;
# 829
fixup_string=_tag_fat(" | sed 's/^\\(.*\\)\\.cyc\\.o:/\\1.o:/'",sizeof(char),35U);goto _TLB9;
# 834
_TLB8:{struct Cyc_String_pa_PrintArg_struct _T58;_T58.tag=0;_T2F=Cyc_dependencies_target;
_T58.f1=*_T2F;_T2E=_T58;}{struct Cyc_String_pa_PrintArg_struct _T58=_T2E;void*_T59[1];_T59[0]=& _T58;_T30=
# 834
_tag_fat(" | sed 's/^.*\\.cyc\\.o:/%s:/'",sizeof(char),29U);_T31=_tag_fat(_T59,sizeof(void*),1);_T2D=Cyc_aprintf(_T30,_T31);}fixup_string=_T2D;_TLB9: goto _TLB7;
# 837
_TLB6: fixup_string=_tag_fat("",sizeof(char),1U);_TLB7:{struct Cyc_String_pa_PrintArg_struct _T58;_T58.tag=0;
# 840
...
# 843
if(!_T3B)goto _TLBA;{struct Cyc_String_pa_PrintArg_struct _T58;_T58.tag=0;_T58.f1=cmd;_T3C=_T58;}{struct Cyc_String_pa_PrintArg_struct _T58=_T3C;void*_T59[1];_T59[0]=& _T58;_T3D=Cyc_stderr;_T3E=_tag_fat("%s\n",sizeof(char),4U);_T3F=_tag_fat(_T59,sizeof(void*),1);Cyc_fprintf(_T3D,_T3E,_T3F);}goto _TLBB;_TLBA: _TLBB: _T40=cmd;_T41=_untag_fat_ptr_check_bound(_T40,sizeof(char),1U);_T42=_check_null(_T41);_T43=(const char*)_T42;_T44=
system(_T43);if(_T44==0)goto _TLBC;
...
if(_T49 <= 0)goto _TLBE;Cyc_remove_file(preprocfile);goto _TLBF;_TLBE: _TLBF:
 return 0;_TLBC: _T4A=Cyc_Flags_stop_after_pass;_T4B=(int)_T4A;
# 850
if(_T4B > 0)goto _TLC0;return 0;_TLC0:
# 853
...
if(_T5==0)goto _TLC5;_T2=Cyc_specified_interface;goto _TLC6;_TLC5: _T6=basename;_T7=
_tag_fat(".cyci",sizeof(char),6U);_T2=Cyc_strconcat(_T6,_T7);_TLC6: {
# 867
...
# 874
if(_TC)goto _TLC7;else{goto _TLC9;}_TLC9: _TD=Cyc_Flags_tags;if(!_TD)goto _TLC7;
Cyc_Interproc_dump_tags(filename,tds);
Cyc_remove_file(preprocfile);
return;_TLC7: _TE=Cyc_compile_failure;
# 881
if(_TE)goto _TLCA;else{goto _TLCC;}_TLCC: _TF=Cyc_Flags_porting_c_code;if(!_TF)goto _TLCA;
Cyc_Port_port(tds);
Cyc_remove_file(preprocfile);
return;_TLCA: _T10=Cyc_compile_failure;
# 889
if(_T10)goto _TLCD;else{goto _TLCF;}_TLCF: _T11=Cyc_Flags_stop_after_pass;_T12=(int)_T11;if(_T12 < 2)goto _TLCD;_T13=Cyc_Flags_interproc;
if(!_T13)goto _TLD0;{
struct Cyc_List_List*(*_TD4)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(struct _fat_ptr*,struct Cyc_List_List*),struct _fat_ptr*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(struct _fat_ptr*,struct Cyc_List_List*),struct _fat_ptr*,struct Cyc_List_List*))Cyc_do_stage;_T14=_TD4;}_T15=_tag_fat("interproc_binding",sizeof(char),18U);_T16=tds;_T17=& filename;_T18=(struct _fat_ptr*)_T17;tds=_T14(_T15,_T16,Cyc_do_interproc_binding,_T18,0);goto _TLD1;
# 893
_TLD0: _T19=Cyc_Flags_resolve;if(!_T19)goto _TLD2;{
struct Cyc_List_List*(*_TD4)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*))Cyc_do_stage;_T1A=_TD4;}_T1B=_tag_fat("interproc_resolution",sizeof(char),21U);_T1C=tds;tds=_T1A(_T1B,_T1C,Cyc_do_interproc_resolution,1,0);goto _TLD3;
# 897
_TLD2:{int(*_TD4)(struct _fat_ptr,struct Cyc_List_List*,int(*)(int,struct Cyc_List_List*),int,int)=(int(*)(struct _fat_ptr,struct Cyc_List_List*,int(*)(int,struct Cyc_List_List*),int,int))Cyc_do_stage;_T1D=_TD4;}_T1E=_tag_fat("binding",sizeof(char),8U);_T1F=tds;_T1D(_T1E,_T1F,Cyc_do_binding,1,1);_TLD3: _TLD1: goto _TLCE;_TLCD: _TLCE: {
# 901
...
# 931
_TLE6: _T50=& Cyc_Absynpp_cyci_params_r;_T51=(struct Cyc_Absynpp_Params*)_T50;Cyc_Absyndump_set_params(_T51);
...
Cyc_Absynpp_set_params(_T53);_TLE7: _T54=Cyc_compile_failure;
# 938
if(_T54)goto _TLE8;else{goto _TLEA;}_TLEA: _T55=Cyc_ic_r;if(!_T55)goto _TLE8;_T56=interfacefile;_T57=_untag_fat_ptr(_T56,sizeof(char),1U);_T58=(const char*)_T57;{
...
if(inter_objfile!=0)goto _TLEB;
Cyc_compile_failure=1;goto _TLEC;
# 944
_TLEB: Cyc_Warn_reset(interfacefile);{struct _tuple14 _TD4;
...
if(inter_file==0)goto _TLED;
Cyc_file_close(inter_file);goto _TLEE;_TLED: _TLEE:
 Cyc_file_close(inter_objfile);}_TLEC:;}}goto _TLE9;_TLE8: _TLE9:;}goto _TLE4;_TLE3: _TLE4: _T62=Cyc_Flags_interproc;
# 953
if(_T62)goto _TLF1;else{goto _TLF2;}_TLF2: _T63=Cyc_Flags_resolve;if(_T63)goto _TLF1;else{goto _TLEF;}
_TLF1: Cyc_BansheeIf_discharge_implications();_T64=
Cyc_Warn_error_p();if(!_T64)goto _TLF3;
Cyc_compile_failure=1;_T65=Cyc_stderr;_T66=
_tag_fat("\nCOMPILATION FAILED!\n",sizeof(char),22U);_T67=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T65,_T66,_T67);
Cyc_fflush(Cyc_stderr);goto _TLF4;_TLF3: _TLF4: goto _TLF0;_TLEF: _TLF0: _T68=Cyc_compile_failure;
# 963
if(_T68)goto _TLF5;else{goto _TLF7;}_TLF7: _T69=Cyc_Flags_stop_after_pass;_T6A=(int)_T69;if(_T6A < 9)goto _TLF5;{
struct Cyc_List_List*(*_TD4)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(struct Cyc_Hashtable_Table*,struct Cyc_List_List*),struct Cyc_Hashtable_Table*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(struct Cyc_Hashtable_Table*,struct Cyc_List_List*),struct Cyc_Hashtable_Table*,struct Cyc_List_List*))Cyc_do_stage;_T6B=_TD4;}_T6C=_tag_fat("translation to C",sizeof(char),17U);_T6D=tds;_T6E=_check_null(jump_tables);_T6F=_T6E->pop_tables;_T70=tds;tds=_T6B(_T6C,_T6D,Cyc_do_translate,_T6F,_T70);goto _TLF6;_TLF5: _TLF6: _T71=Cyc_compile_failure;
# 967
if(_T71)goto _TLF8;else{goto _TLFA;}_TLFA: _T72=Cyc_Flags_stop_after_pass;_T73=(int)_T72;if(_T73 < 10)goto _TLF8;{
struct Cyc_List_List*(*_TD4)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*))Cyc_do_stage;_T74=_TD4;}_T75=_tag_fat("aggregate removal",sizeof(char),18U);_T76=tds;_T77=tds;tds=_T74(_T75,_T76,Cyc_do_removeaggrs,1,_T77);goto _TLF9;_TLF8: _TLF9: _T78=Cyc_compile_failure;
# 971
if(_T78)goto _TLFB;else{goto _TLFD;}_TLFD: _T79=Cyc_nolower_r;if(_T79)goto _TLFB;else{goto _TLFE;}_TLFE: _T7A=Cyc_Flags_stop_after_pass;_T7B=(int)_T7A;if(_T7B < 10)goto _TLFB;{
struct Cyc_List_List*(*_TD4)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*))Cyc_do_stage;_T7C=_TD4;}_T7D=_tag_fat("lowering C code",sizeof(char),16U);_T7E=tds;_T7F=tds;tds=_T7C(_T7D,_T7E,Cyc_do_lower,1,_T7F);goto _TLFC;_TLFB: _TLFC: _T80=Cyc_compile_failure;
# 975
if(_T80)goto _TLFF;else{goto _TL101;}_TL101: _T81=Cyc_Flags_stop_after_pass;_T82=(int)_T81;if(_T82 < 11)goto _TLFF;{
struct Cyc_List_List*(*_TD4)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*))Cyc_do_stage;_T83=_TD4;}_T84=_tag_fat("unused label removal",sizeof(char),21U);_T85=tds;_T86=tds;tds=_T83(_T84,_T85,Cyc_do_removelabs,1,_T86);goto _TL100;_TLFF: _TL100: _T87=Cyc_compile_failure;
# 981
if(_T87)goto _TL102;else{goto _TL104;}_TL104: _T88=Cyc_Flags_stop_after_pass;_T89=(int)_T88;if(_T89 < 9)goto _TL102;
Cyc_Toc_finish();goto _TL103;_TL102: _TL103: _T8A=Cyc_compile_failure;
# 984
if(_T8A)goto _TL105;else{goto _TL107;}_TL107: _T8B=Cyc_Flags_stop_after_pass;_T8C=(int)_T8B;if(_T8C < 14)goto _TL105;{
struct Cyc_List_List*(*_TD4)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*))Cyc_do_stage;_T8D=_TD4;}_T8E=_tag_fat("low treeshaking",sizeof(char),16U);_T8F=tds;_T90=tds;tds=_T8D(_T8E,_T8F,Cyc_do_lowtreeshake,1,_T90);goto _TL106;_TL105: _TL106: _T91=Cyc_compile_failure;
# 987
if(_T91)goto _TL108;else{goto _TL10A;}_TL10A: _T92=Cyc_Flags_stop_after_pass;_T93=(int)_T92;if(_T93 < 12)goto _TL108;{
struct Cyc_List_List*(*_TD4)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*))Cyc_do_stage;_T94=_TD4;}_T95=_tag_fat("renaming temporaries",sizeof(char),21U);_T96=tds;_T97=tds;tds=_T94(_T95,_T96,Cyc_do_temprename,1,_T97);goto _TL109;_TL108: _TL109: _T98=Cyc_compile_failure;
# 990
if(_T98)goto _TL10B;else{goto _TL10D;}_TL10D: _T99=Cyc_Flags_stop_after_pass;_T9A=(int)_T99;if(_T9A < 13)goto _TL10B;{
struct Cyc_List_List*(*_TD4)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _fat_ptr,struct Cyc_List_List*,struct Cyc_List_List*(*)(int,struct Cyc_List_List*),int,struct Cyc_List_List*))Cyc_do_stage;_T9B=_TD4;}_T9C=_tag_fat("removing casts",sizeof(char),15U);_T9D=tds;_T9E=tds;tds=_T9B(_T9C,_T9D,Cyc_do_castremove,1,_T9E);goto _TL10C;_TL10B: _TL10C: _T9F=Cyc_compile_failure;
# 996
if(_T9F)goto _TL10E;else{goto _TL110;}_TL110: _TA0=Cyc_Flags_interproc;if(!_TA0)goto _TL10E;_TA1=Cyc_Flags_no_merge;if(!_TA1)goto _TL10E;
# 999
Cyc_Interproc_emit_decls(filename,tds);goto _TL10F;_TL10E: _TL10F: _TA2=Cyc_compile_failure;
# 1001
if(_TA2)goto _TL111;else{goto _TL113;}
_TL113: Cyc_Warn_flush_warnings();goto _TL112;_TL111: _TL112: _TA3=Cyc_Flags_stop_after_pass;_TA4=(int)_TA3;
if(_TA4 <= 0)goto _TL114;
Cyc_remove_file(preprocfile);goto _TL115;_TL114: _TL115:
 if(Cyc_uncaught_exn==0)goto _TL116;{
...
# 1009
Cyc_fflush(Cyc_stderr);
return;}}_TL116: _TB4=Cyc_Flags_interproc;
# 1013
if(!_TB4)goto _TL118;_TB5=Cyc_Flags_resolve;if(_TB5)goto _TL118;else{goto _TL11A;}
_TL11A: return;_TL118: {
# 1016
struct Cyc___cycFILE*out_file;_TB6=Cyc_Flags_stop_after_pass;_TB7=(int)_TB6;
if(_TB7 > 0)goto _TL11B;
return;_TL11B: _TB8=Cyc_Flags_stop_after_pass;_TB9=(int)_TB8;
# 1020
if(_TB9 > 6)goto _TL11D;
if(Cyc_output_file==0)goto _TL11F;_TBA=Cyc_output_file;_TBB=*_TBA;_TBC=
_tag_fat("w",sizeof(char),2U);_TBD=_tag_fat("output file",sizeof(char),12U);out_file=Cyc_try_file_open(_TBB,_TBC,_TBD);goto _TL120;
# 1024
_TL11F: out_file=Cyc_stdout;_TL120: goto _TL11E;
_TL11D: _TBE=Cyc_Flags_stop_after_pass;_TBF=(int)_TBE;if(_TBF >= 15)goto _TL121;if(Cyc_output_file==0)goto _TL121;_TC0=Cyc_output_file;_TC1=*_TC0;_TC2=
_tag_fat("w",sizeof(char),2U);_TC3=_tag_fat("output file",sizeof(char),12U);out_file=Cyc_try_file_open(_TC1,_TC2,_TC3);goto _TL122;
# 1028
_TL121: _TC4=cfile;_TC5=_tag_fat("w",sizeof(char),2U);_TC6=_tag_fat("output file",sizeof(char),12U);out_file=Cyc_try_file_open(_TC4,_TC5,_TC6);_TL122: _TL11E: _TC7=Cyc_compile_failure;
# 1030
if(_TC7)goto _TL125;else{goto _TL126;}_TL126: _TC8=out_file;_TC9=(unsigned)_TC8;if(_TC9)goto _TL123;else{goto _TL125;}_TL125: return;_TL123: _TCA=Cyc_noprint_r;
# 1032
if(_TCA)goto _TL127;else{goto _TL129;}
_TL129:{struct _tuple15*env;env=_cycalloc(sizeof(struct _tuple15));_TCB=env;_TCB->f0=out_file;_TCC=env;_TCC->f1=cfile;{
...
*_TD5=Cyc_strdup(cfile);_TD3=(struct _fat_ptr*)_TD5;}_TD4->hd=_TD3;_TD4->tl=Cyc_cfiles;_TD2=(struct Cyc_List_List*)_TD4;}Cyc_cfiles=_TD2;}goto _TL128;_TL127: _TL128:;}}}}}}}static char _TmpGC[8U]="<final>";
# 1040
...
if(n!=Cyc_final_strptr)goto _TL12A;_T0=
Cyc_Interface_final();return _T0;_TL12A: {
struct _fat_ptr basename;{struct _handler_cons _T10;_T1=& _T10;_push_handler(_T1);{int _T11=0;_T2=setjmp(_T10.handler);if(!_T2)goto _TL12C;_T11=1;goto _TL12D;_TL12C: _TL12D: if(_T11)goto _TL12E;else{goto _TL130;}_TL130: _T3=n;_T4=*_T3;
basename=Cyc_Filename_chop_extension(_T4);_pop_handler();goto _TL12F;_TL12E: _T5=Cyc_Core_get_exn_thrown();{void*_T12=(void*)_T5;void*_T13;_T6=(struct Cyc_Core_Invalid_argument_exn_struct*)_T12;_T7=_T6->tag;_T8=Cyc_Core_Invalid_argument;if(_T7!=_T8)goto _TL131;_T9=n;
basename=*_T9;goto _LL0;_TL131: _T13=_T12;{void*exn=_T13;_rethrow(exn);}_LL0:;}_TL12F:;}}_TA=basename;_TB=
# 1050
...
Cyc_compile_failure=1;
Cyc_remove_cfiles();
exit(1);goto _TL134;_TL133: _TL134:
# 1057
 Cyc_Warn_reset(nf);{
...
# 1400
int i=1;_TL138: _T0=i;_T1=(unsigned)_T0;if(_T1 < 94U)goto _TL136;else{goto _TL137;}
_TL136: _T2=Cyc_global_options;_T3=i - 1;_T4=_check_known_subscript_notnull(_T2,94U,sizeof(struct Cyc_List_List*),_T3);_T5=(struct Cyc_List_List**)_T4;_T6=*_T5;_T7=Cyc_global_options;_T8=i;_T6->tl=_T7[_T8];
# 1400
i=i + 1;goto _TL138;_TL137:;}_T9=Cyc_global_options;{
# 1402
...
if(!_TE)goto _TL139;{struct Cyc_String_pa_PrintArg_struct _TDD;_TDD.tag=0;_TDD.f1=specs_file;_TF=_TDD;}{struct Cyc_String_pa_PrintArg_struct _TDD=_TF;void*_TDE[1];_TDE[0]=& _TDD;_T10=Cyc_stderr;_T11=_tag_fat("Reading from specs file %s\n",sizeof(char),28U);_T12=_tag_fat(_TDE,sizeof(void*),1);Cyc_fprintf(_T10,_T11,_T12);}goto _TL13A;_TL139: _TL13A: {
...
if(_T18==0)goto _TL13B;
Cyc_Arg_current=0;_T19=options;_T1A=optstring;_T1B=args_from_specs_file;
Cyc_Arg_parse(_T19,Cyc_add_other,Cyc_add_other_flag,_T1A,_T1B);goto _TL13C;_TL13B: _TL13C: _T1C=specs;_T1D=
# 1419
...
if(_T22)goto _TL13D;else{goto _TL13F;}_TL13F: cyclone_cc=_tag_fat("gcc",sizeof(char),4U);goto _TL13E;_TL13D: _TL13E: _T23=specs;_T24=
...
return 0;_TL140: _T29=Cyc_cpp;_T2A=
# 1433
_tag_fat("",sizeof(char),1U);_T2B=Cyc_strcmp(_T29,_T2A);if(_T2B!=0)goto _TL142;_T2D=Cyc_produce_dependencies;
# 1449 "cyclone.cyc"
if(!_T2D)goto _TL144;_T2C="";goto _TL145;_TL144: _T2C=" -E";_TL145:{const char*dash_E=_T2C;{struct Cyc_String_pa_PrintArg_struct _TDD;_TDD.tag=0;
# 1451
...
# 1450
_tag_fat("%s %s -w -x c%s -specs %s",sizeof(char),26U);_T38=_tag_fat(_TE1,sizeof(void*),4);_T2E=Cyc_aprintf(_T37,_T38);}}}}Cyc_set_cpp(_T2E);}goto _TL143;_TL142: _TL143:
# 1453
 if(Cyc_cyclone_files!=0)goto _TL146;if(Cyc_ccargs!=0)goto _TL146;_T39=Cyc_stderr;_T3A=
_tag_fat("missing file\n",sizeof(char),14U);_T3B=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T39,_T3A,_T3B);
exit(1);goto _TL147;_TL146: _TL147: _T3C=Cyc_Flags_stop_after_pass;_T3D=(int)_T3C;
# 1462
if(_T3D <= 0)goto _TL148;_T3E=Cyc_nocyc_setjmp_r;if(_T3E)goto _TL148;else{goto _TL14A;}
_TL14A: _T3F=_tag_fat("cyc_setjmp.h",sizeof(char),13U);Cyc_cyc_setjmp=Cyc_find_in_arch_path(_T3F);goto _TL149;_TL148: _TL149: _T40=Cyc_Flags_stop_after_pass;_T41=(int)_T40;
if(_T41 <= 0)goto _TL14B;_T42=Cyc_strlen(Cyc_cyc_include);if(_T42!=0U)goto _TL14B;_T43=
_tag_fat("cyc_include.h",sizeof(char),14U);Cyc_cyc_include=Cyc_find_in_exec_path(_T43);goto _TL14C;_TL14B: _TL14C:{struct _handler_cons _TDD;_T44=& _TDD;_push_handler(_T44);{int _TDE=0;_T45=setjmp(_TDD.handler);if(!_T45)goto _TL14D;_TDE=1;goto _TL14E;_TL14D: _TL14E: if(_TDE)goto _TL14F;else{goto _TL151;}_TL151:{
# 1469
struct Cyc_List_List*l=Cyc_List_rev(Cyc_cyclone_files);_TL155: if(l!=0)goto _TL153;else{goto _TL154;}
_TL153: _T46=l;_T47=_T46->hd;_T48=(struct _fat_ptr*)_T47;_T49=*_T48;Cyc_process_file(_T49);_T4A=Cyc_compile_failure;
if(!_T4A)goto _TL156;{int _TDF=1;_npop_handler(0);return _TDF;}_TL156: _T4B=l;
# 1469
l=_T4B->tl;goto _TL155;_TL154:;}_pop_handler();goto _TL150;_TL14F: _T4C=Cyc_Core_get_exn_thrown();{void*_TDF=(void*)_T4C;void*_TE0;_TE0=_TDF;{void*x=_TE0;_T4D=Cyc_compile_failure;
# 1474
if(!_T4D)goto _TL158;return 1;_TL158:
 Cyc_Core_rethrow(x);};}_TL150:;}}_T4E=Cyc_Flags_tags;
# 1477
if(!_T4E)goto _TL15A;
Cyc_Interproc_close_tags_file();goto _TL15B;_TL15A: _TL15B: _T4F=Cyc_Flags_stop_after_pass;_T50=(int)_T4F;
# 1481
if(_T50 >= 15)goto _TL15C;return 0;_TL15C:
# 1487
 if(Cyc_ccargs!=0)goto _TL15E;return 0;_TL15E: _T51=Cyc_Specsfile_target_arch;_T52=_T51.curr;_T53=(unsigned)_T52;
# 1490
if(!_T53)goto _TL160;_T54=Cyc_Specsfile_cyclone_exec_path;_T55=(unsigned)_T54;if(!_T55)goto _TL160;{struct Cyc_List_List*_TDD=_cycalloc(sizeof(struct Cyc_List_List));{struct _fat_ptr*_TDE=_cycalloc(sizeof(struct _fat_ptr));
...
# 1491
Cyc_str_sepstr(_T56,_T58);Cyc_add_ccarg(_T59);goto _TL161;_TL160: _TL161: _T5A=
# 1494
...
# 1504
if(_T69)goto _TL164;else{goto _TL166;}_TL166: _T6A=Cyc_stop_after_objectfile_r;if(_T6A)goto _TL164;else{goto _TL165;}_TL165: if(Cyc_output_file!=0)goto _TL167;else{goto _TL162;}_TL167: _T6B=Cyc_output_file;_T6C=*_T6B;_T6D=
# 1506
_tag_fat(".a",sizeof(char),3U);_T6E=Cyc_Filename_check_suffix(_T6C,_T6D);
# 1504
if(_T6E)goto _TL164;else{goto _TL162;}_TL164: _T68=1;goto _TL163;_TL162:
# 1507
 if(Cyc_output_file==0)goto _TL168;_T70=Cyc_output_file;_T71=*_T70;_T72=_tag_fat(".lib",sizeof(char),5U);_T6F=Cyc_Filename_check_suffix(_T71,_T72);goto _TL169;_TL168: _T6F=0;_TL169: _T68=_T6F;_TL163: {
# 1503
int is_not_executable=_T68;_T73=is_not_executable;
# 1508
if(!_T73)goto _TL16A;
stdlib=0;_T74=
_tag_fat("",sizeof(char),1U);stdlib_string=_T74;goto _TL16B;
# 1513
_TL16A:{struct _fat_ptr libcyc_flag;
...
runtime_filename=_tag_fat("runtime_cyc_a.a",sizeof(char),16U);goto _TL16D;
_TL16C: _T76=Cyc_nocheck_r;if(!_T76)goto _TL16E;
libcyc_flag=_tag_fat("-lcyc_nocheck",sizeof(char),14U);
nogc_filename=_tag_fat("nogc.a",sizeof(char),7U);
runtime_filename=_tag_fat("runtime_cyc.a",sizeof(char),14U);goto _TL16F;
_TL16E: _T77=Cyc_pg_r;if(!_T77)goto _TL170;
libcyc_flag=_tag_fat("-lcyc_pg",sizeof(char),9U);
runtime_filename=_tag_fat("runtime_cyc_pg.a",sizeof(char),17U);
nogc_filename=_tag_fat("nogc_pg.a",sizeof(char),10U);goto _TL171;
_TL170: _T78=Cyc_Flags_compile_for_boot;if(!_T78)goto _TL172;
# 1531
libcyc_flag=_tag_fat("-lcycboot",sizeof(char),10U);
nogc_filename=_tag_fat("nogc.a",sizeof(char),7U);
runtime_filename=_tag_fat("runtime_cyc.a",sizeof(char),14U);goto _TL173;
_TL172: _T79=Cyc_pthread_r;if(!_T79)goto _TL174;
libcyc_flag=_tag_fat("-lcyc",sizeof(char),6U);
nogc_filename=_tag_fat("nogc_pthread.a",sizeof(char),15U);
runtime_filename=_tag_fat("runtime_cyc_pthread.a",sizeof(char),22U);goto _TL175;
# 1539
_TL174: libcyc_flag=_tag_fat("-lcyc",sizeof(char),6U);
nogc_filename=_tag_fat("nogc.a",sizeof(char),7U);
runtime_filename=_tag_fat("runtime_cyc.a",sizeof(char),14U);_TL175: _TL173: _TL171: _TL16F: _TL16D: _T7A=Cyc_pthread_r;
# 1543
if(_T7A)goto _TL176;else{goto _TL178;}
_TL178: gc_filename=_tag_fat("gc.a",sizeof(char),5U);goto _TL177;
# 1546
_TL176: gc_filename=_tag_fat("gc_pthread.a",sizeof(char),13U);_TL177: _T7C=Cyc_nogc_r;
# 1548
if(!_T7C)goto _TL179;_T7B=Cyc_find_in_arch_path(nogc_filename);goto _TL17A;_TL179: _T7B=Cyc_find_in_arch_path(gc_filename);_TL17A: {struct _fat_ptr gc=_T7B;
struct _fat_ptr runtime=Cyc_find_in_arch_path(runtime_filename);
# 1551
stdlib=0;_T7D=Cyc_nogc_r;
if(!_T7D)goto _TL17B;{struct Cyc_String_pa_PrintArg_struct _TDD;_TDD.tag=0;
_TDD.f1=libcyc_flag;_T7F=_TDD;}{struct Cyc_String_pa_PrintArg_struct _TDD=_T7F;{struct Cyc_String_pa_PrintArg_struct _TDE;_TDE.tag=0;_TDE.f1=runtime;_T80=_TDE;}{struct Cyc_String_pa_PrintArg_struct _TDE=_T80;{struct Cyc_String_pa_PrintArg_struct _TDF;_TDF.tag=0;_TDF.f1=gc;_T81=_TDF;}{struct Cyc_String_pa_PrintArg_struct _TDF=_T81;void*_TE0[3];_TE0[0]=& _TDD;_TE0[1]=& _TDE;_TE0[2]=& _TDF;_T82=_tag_fat(" %s %s %s ",sizeof(char),11U);_T83=_tag_fat(_TE0,sizeof(void*),3);_T7E=Cyc_aprintf(_T82,_T83);}}}stdlib_string=_T7E;goto _TL17C;
# 1555
_TL17B:{struct Cyc_String_pa_PrintArg_struct _TDD;_TDD.tag=0;_TDD.f1=libcyc_flag;_T85=_TDD;}{struct Cyc_String_pa_PrintArg_struct _TDD=_T85;{struct Cyc_String_pa_PrintArg_struct _TDE;_TDE.tag=0;_TDE.f1=runtime;_T86=_TDE;}{struct Cyc_String_pa_PrintArg_struct _TDE=_T86;{struct Cyc_String_pa_PrintArg_struct _TDF;_TDF.tag=0;_TDF.f1=gc;_T87=_TDF;}{struct Cyc_String_pa_PrintArg_struct _TDF=_T87;void*_TE0[3];_TE0[0]=& _TDD;_TE0[1]=& _TDE;_TE0[2]=& _TDF;_T88=_tag_fat(" %s %s %s -DCYC_GC_PTHREAD_REDIRECTS ",sizeof(char),38U);_T89=_tag_fat(_TE0,sizeof(void*),3);_T84=Cyc_aprintf(_T88,_T89);}}}stdlib_string=_T84;_TL17C:;}}_TL16B: _T8A=Cyc_ic_r;
# 1558
if(!_T8A)goto _TL17D;{struct _handler_cons _TDD;_T8B=& _TDD;_push_handler(_T8B);{int _TDE=0;_T8C=setjmp(_TDD.handler);if(!_T8C)goto _TL17F;_TDE=1;goto _TL180;_TL17F: _TL180: if(_TDE)goto _TL181;else{goto _TL183;}_TL183: _T8E=Cyc_List_filter;{
...
if(_T95)goto _TL184;else{goto _TL186;}
_TL186:{struct Cyc_List_List*_TDF=_cycalloc(sizeof(struct Cyc_List_List));_TDF->hd=Cyc_final_strptr;_TDF->tl=lf;_T96=(struct Cyc_List_List*)_TDF;}lf=_T96;goto _TL185;_TL184: _TL185: _T98=Cyc_Interface_get_and_merge_list;{
# 1565
...
if(i!=0)goto _TL187;_T9B=Cyc_stderr;_T9C=
_tag_fat("Error: interfaces incompatible\n",sizeof(char),32U);_T9D=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T9B,_T9C,_T9D);
Cyc_compile_failure=1;
Cyc_remove_cfiles();{int _TDF=1;_npop_handler(0);return _TDF;}_TL187: _T9E=is_not_executable;
# 1572
if(!_T9E)goto _TL189;
if(Cyc_output_file==0)goto _TL18B;{struct Cyc_String_pa_PrintArg_struct _TDF;_TDF.tag=0;_TA1=Cyc_output_file;_TA2=*_TA1;
...
if(f!=0)goto _TL18D;
Cyc_compile_failure=1;
Cyc_remove_cfiles();{int _TDF=1;_npop_handler(0);return _TDF;}_TL18D:
# 1581
 Cyc_Interface_save(i,f);
Cyc_file_close(f);}}goto _TL18C;_TL18B: _TL18C: goto _TL18A;
# 1585
_TL189: _TA8=Cyc_Interface_empty();_TA9=i;{struct _tuple11*_TDF=_cycalloc(sizeof(struct _tuple11));
...
# 1585
Cyc_Interface_is_subinterface(_TA8,_TA9,_TAA);if(_TAB)goto _TL18F;else{goto _TL191;}
# 1587
_TL191: _TAC=Cyc_stderr;_TAD=_tag_fat("Error: some objects are still undefined\n",sizeof(char),41U);_TAE=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_TAC,_TAD,_TAE);
Cyc_compile_failure=1;
Cyc_remove_cfiles();{int _TDF=1;_npop_handler(0);return _TDF;}_TL18F: _TL18A:;}}_pop_handler();goto _TL182;_TL181: _TAF=Cyc_Core_get_exn_thrown();{void*_TDF=(void*)_TAF;void*_TE0;_TE0=_TDF;{void*e=_TE0;{struct Cyc_String_pa_PrintArg_struct _TE1;_TE1.tag=0;{const char*_TE2=
# 1595
...
Cyc_compile_failure=1;
Cyc_remove_cfiles();
return 1;};}_TL182:;}}goto _TL17E;_TL17D: _TL17E: {
# 1601
struct _fat_ptr outfile_str=_tag_fat("",sizeof(char),1U);
if(Cyc_output_file==0)goto _TL192;{struct Cyc_String_pa_PrintArg_struct _TDD;_TDD.tag=0;_TC1=Cyc_output_file;_TC2=*_TC1;
_TDD.f1=Cyc_sh_escape_string(_TC2);_TC0=_TDD;}{struct Cyc_String_pa_PrintArg_struct _TDD=_TC0;void*_TDE[1];_TDE[0]=& _TDD;_TC3=_tag_fat(" -o %s",sizeof(char),7U);_TC4=_tag_fat(_TDE,sizeof(void*),1);_TBF=Cyc_aprintf(_TC3,_TC4);}outfile_str=_TBF;goto _TL193;_TL192: _TL193:{struct Cyc_String_pa_PrintArg_struct _TDD;_TDD.tag=0;
# 1607
...
# 1610
if(!_TCE)goto _TL194;{struct Cyc_String_pa_PrintArg_struct _TDD;_TDD.tag=0;_TDD.f1=cccmd;_TCF=_TDD;}{struct Cyc_String_pa_PrintArg_struct _TDD=_TCF;void*_TDE[1];_TDE[0]=& _TDD;_TD0=Cyc_stderr;_TD1=_tag_fat("%s\n",sizeof(char),4U);_TD2=_tag_fat(_TDE,sizeof(void*),1);Cyc_fprintf(_TD0,_TD1,_TD2);}Cyc_fflush(Cyc_stderr);goto _TL195;_TL194: _TL195: _TD3=cccmd;_TD4=_untag_fat_ptr_check_bound(_TD3,sizeof(char),1U);_TD5=_check_null(_TD4);_TD6=(const char*)_TD5;_TD7=
system(_TD6);if(_TD7==0)goto _TL196;_TD8=Cyc_stderr;_TD9=
...
# 1619
if(!_TDC)goto _TL198;_TDB=1;goto _TL199;_TL198: _TDB=0;_TL199: return _TDB;}}}}}}}}}}}}}}
