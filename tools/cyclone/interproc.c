...
# 25 "cyclone.h"
struct Cyc_List_List*Cyc_Cyclone_parse_file(struct _fat_ptr);struct Cyc___cycFILE;
...
# 119
static void Cyc_Interproc_print_filedecls(struct Cyc_List_List*fd){struct Cyc_List_List*_T0;unsigned _T1;struct Cyc_String_pa_PrintArg_struct _T2;struct Cyc_List_List*_T3;void*_T4;struct _tuple14*_T5;struct Cyc___cycFILE*_T6;struct _fat_ptr _T7;struct _fat_ptr _T8;struct Cyc_List_List*_T9;
_TL1D: _T0=fd;_T1=(unsigned)_T0;if(_T1)goto _TL1B;else{goto _TL1C;}
_TL1B:{struct Cyc_String_pa_PrintArg_struct _TA;_TA.tag=0;_T3=fd;_T4=_T3->hd;_T5=(struct _tuple14*)_T4;_TA.f1=_T5->f0;_T2=_TA;}{struct Cyc_String_pa_PrintArg_struct _TA=_T2;void*_TB[1];_TB[0]=& _TA;_T6=Cyc_stderr;_T7=_tag_fat("Decls for file %s::\n",sizeof(char),21U);_T8=_tag_fat(_TB,sizeof(void*),1);Cyc_fprintf(_T6,_T7,_T8);}_T9=fd;
# 120
...
# 181
 return 1;}
# 185
static int Cyc_Interproc_init_tagmap(struct Cyc_List_List*ftds){struct Cyc_Hashtable_Table*_T0;unsigned _T1;struct _fat_ptr _T2;struct _fat_ptr _T3;struct _fat_ptr _T4;struct Cyc___cycFILE*_T5;unsigned _T6;struct Cyc_List_List*_T7;unsigned _T8;struct Cyc_Hashtable_Table*(*_T9)(int,int(*)(struct _fat_ptr*,struct _fat_ptr*),int(*)(struct _fat_ptr*));struct Cyc_Hashtable_Table*(*_TA)(int,int(*)(void*,void*),int(*)(void*));struct _fat_ptr*_TB;struct _fat_ptr _TC;struct Cyc_String_pa_PrintArg_struct _TD;struct Cyc_List_List*_TE;void*_TF;struct _tuple14*_T10;struct _fat_ptr _T11;struct _fat_ptr _T12;struct Cyc_List_List*_T13;void*_T14;struct _tuple14*_T15;struct Cyc_List_List*_T16;int _T17;struct Cyc_Hashtable_Table*(*_T18)(int,int(*)(struct _fat_ptr*,struct _fat_ptr*),int(*)(struct _fat_ptr*));struct Cyc_Hashtable_Table*(*_T19)(int,int(*)(void*,void*),int(*)(void*));struct _fat_ptr _T1A;unsigned char*_T1B;unsigned _T1C;struct _fat_ptr _T1D;unsigned char*_T1E;char*_T1F;char _T20;int _T21;struct _fat_ptr*_T22;struct _fat_ptr _T23;struct Cyc_String_pa_PrintArg_struct _T24;struct _fat_ptr _T25;struct _fat_ptr _T26;struct _fat_ptr _T27;struct _fat_ptr _T28;struct _fat_ptr*_T29;struct _fat_ptr _T2A;struct Cyc_String_pa_PrintArg_struct _T2B;struct _fat_ptr _T2C;struct _fat_ptr _T2D;struct _fat_ptr _T2E;struct _fat_ptr _T2F;struct _fat_ptr _T30;struct _fat_ptr _T31;struct _fat_ptr _T32;struct _fat_ptr _T33;int _T34;void(*_T35)(struct Cyc_Hashtable_Table*,struct _fat_ptr*,struct _fat_ptr*);void(*_T36)(struct Cyc_Hashtable_Table*,void*,void*);struct Cyc_Hashtable_Table*_T37;struct _fat_ptr*_T38;struct _fat_ptr*_T39;_T0=Cyc_Interproc_tagmap;_T1=(unsigned)_T0;
if(!_T1)goto _TL33;
return 1;_TL33: _T2=
...
struct _fat_ptr*(*_T10)(struct Cyc_Hashtable_Table*,struct _fat_ptr*)=(struct _fat_ptr*(*)(struct Cyc_Hashtable_Table*,struct _fat_ptr*))_TB;_TA=_T10;}_TC=_check_null(Cyc_Interproc_tagmap);_TD=qvname;_TE=_TA(_TC,_TD);_TF=*_TE;return _TF;}}struct _tuple15{struct _fat_ptr f0;void*f1;};
# 226
static int Cyc_Interproc_cmp_filenames(struct _fat_ptr*fname,struct _tuple15*ftd){struct _fat_ptr*_T0;struct _fat_ptr _T1;struct _tuple15*_T2;struct _fat_ptr _T3;int _T4;int _T5;_T0=fname;_T1=*_T0;_T2=ftd;_T3=_T2->f0;_T4=
Cyc_strcmp(_T1,_T3);_T5=!_T4;return _T5;}struct _tuple16{int f0;struct Cyc_List_List*f1;};
# 233
static struct _tuple16 Cyc_Interproc_add_filedecls(struct _fat_ptr filename,struct Cyc_List_List*ftds){int(*_T0)(int(*)(struct _fat_ptr*,struct _tuple14*),struct _fat_ptr*,struct Cyc_List_List*);int(*_T1)(int(*)(void*,void*),void*,struct Cyc_List_List*);int(*_T2)(struct _fat_ptr*,struct _tuple14*);struct _fat_ptr*_T3;struct _fat_ptr*_T4;struct Cyc_List_List*_T5;int _T6;struct _tuple16 _T7;struct Cyc_List_List*_T8;unsigned _T9;struct _tuple16 _TA;struct Cyc_List_List*_TB;struct _tuple14*_TC;struct Cyc_List_List*_TD;struct _tuple16 _TE;_T1=Cyc_List_exists_c;{
int(*_TF)(int(*)(struct _fat_ptr*,struct _tuple14*),struct _fat_ptr*,struct Cyc_List_List*)=(int(*)(int(*)(struct _fat_ptr*,struct _tuple14*),struct _fat_ptr*,struct Cyc_List_List*))_T1;_T0=_TF;}{int(*_TF)(struct _fat_ptr*,struct _tuple14*)=(int(*)(struct _fat_ptr*,struct _tuple14*))Cyc_Interproc_cmp_filenames;_T2=_TF;}_T3=& filename;_T4=(struct _fat_ptr*)_T3;_T5=ftds;_T6=_T0(_T2,_T4,_T5);if(!_T6)goto _TL47;{struct _tuple16 _TF;
...
_TL4B:{struct _tuple16 _TF;_TF.f0=0;_TF.f1=0;_TA=_TF;}return _TA;_TL49: {
# 240
struct Cyc_List_List*newl;newl=_cycalloc(sizeof(struct Cyc_List_List));_TB=newl;{struct _tuple14*_TF=_cycalloc(sizeof(struct _tuple14));_TF->f0=filename;_TF->f1=decls;_TC=(struct _tuple14*)_TF;}_TB->hd=_TC;_TD=newl;_TD->tl=0;
Cyc_List_imp_append(ftds,newl);{struct _tuple16 _TF;
# 245
_TF.f0=1;_TF.f1=newl;_TE=_TF;}return _TE;}}}struct _tuple17{int f0;struct Cyc_List_List*f1;struct Cyc_List_List*f2;};
# 256 "interproc.cyc"
static struct _tuple17 Cyc_Interproc_locate_externs(struct Cyc_List_List*es,struct Cyc_List_List*ftds){struct Cyc_List_List*_T0;void*_T1;struct Cyc_Absyn_Exp*_T2;int*_T3;int _T4;void*_T5;void*_T6;int*_T7;unsigned _T8;void*_T9;int _TA;struct Cyc_Interproc_Unresolved_sym_exn_struct*_TB;struct Cyc_List_List*_TC;void*_TD;void*_TE;struct _handler_cons*_TF;int _T10;struct Cyc_List_List*_T11;struct Cyc_List_List*_T12;void*_T13;void*_T14;struct Cyc_Core_Not_found_exn_struct*_T15;char*_T16;char*_T17;struct Cyc_Interproc_Unresolved_sym_exn_struct*_T18;struct Cyc_List_List*_T19;void*_T1A;void*_T1B;void*_T1C;struct _handler_cons*_T1D;int _T1E;struct Cyc_Absyn_Vardecl*_T1F;struct _tuple0*_T20;struct Cyc_List_List*_T21;int _T22;struct _fat_ptr _T23;struct Cyc_List_List*_T24;void*_T25;struct _tuple14*_T26;struct _fat_ptr _T27;int _T28;struct Cyc_List_List*_T29;struct Cyc_List_List*_T2A;void*_T2B;struct Cyc_Absyn_Vardecl*_T2C;void*_T2D;struct Cyc_List_List*_T2E;struct Cyc_List_List*_T2F;void*_T30;void*_T31;struct Cyc_Core_Not_found_exn_struct*_T32;char*_T33;char*_T34;struct Cyc_Warn_String_Warn_Warg_struct _T35;struct Cyc_Warn_Exp_Warn_Warg_struct _T36;struct Cyc_List_List*_T37;void*_T38;int(*_T39)(struct _fat_ptr);void*(*_T3A)(struct _fat_ptr);struct _fat_ptr _T3B;struct Cyc_Warn_String_Warn_Warg_struct _T3C;struct Cyc_Warn_Exp_Warn_Warg_struct _T3D;struct Cyc_List_List*_T3E;void*_T3F;int(*_T40)(struct _fat_ptr);void*(*_T41)(struct _fat_ptr);struct _fat_ptr _T42;struct _fat_ptr _T43;unsigned char*_T44;unsigned _T45;int _T46;int(*_T47)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T48)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T49;struct _fat_ptr _T4A;int _T4B;struct _tuple17 _T4C;struct Cyc_List_List*_T4D;unsigned _T4E;struct Cyc_List_List*_T4F;struct _tuple17 _T50;
...
_check_null(ftds);_T25=_T24->hd;_T26=(struct _tuple14*)_T25;_T27=_T26->f0;_T28=Cyc_strcmp(_T23,_T27);if(_T28)goto _TL63;else{goto _TL65;}
# 280
...
struct _tuple16 _T51=Cyc_Interproc_add_filedecls(filename,ftds);struct Cyc_List_List*_T52;int _T53;_T53=_T51.f0;_T52=_T51.f1;{int b=_T53;struct Cyc_List_List*newl=_T52;_T4B=b;
if(_T4B)goto _TL6B;else{goto _TL6D;}
_TL6D:{struct _tuple17 _T54;_T54.f0=0;_T54.f1=0;_T54.f2=0;_T4C=_T54;}return _T4C;_TL6B: _T4D=newdecls;_T4E=(unsigned)_T4D;
if(_T4E)goto _TL6E;else{goto _TL70;}
_TL70: newdecls=newl;goto _TL6F;_TL6E: _TL6F:;}}}_TL4C: _T4F=es;
# 259
es=_T4F->tl;goto _TL4F;_TL4E:{struct _tuple17 _T51;
# 319
...
void(*_T3)(struct Cyc_Hashtable_Table*,void(*)(struct _fat_ptr*),void(*)(void*))=(void(*)(struct Cyc_Hashtable_Table*,void(*)(struct _fat_ptr*),void(*)(void*)))_T1;_T0=_T3;}_T2=cvmap;_T0(_T2,Cyc_Interproc_print_strptr,Cyc_Interproc_print_type);}struct _tuple19{struct Cyc_Absyn_Tqual f0;void*f1;};
# 489
...
_TLE7: _T94=ft;_T95=_T94->hd;{struct _tuple19*_T20C=(struct _tuple19*)_T95;void*_T20D;{struct _tuple19 _T20E=*_T20C;_T20D=_T20E.f1;}{void*t=_T20D;_T96=Cyc_Interproc__prefix;_T97=
...
# 666
static int Cyc_Interproc_cvars_in_local_decl(struct _tuple20*env,struct Cyc_Absyn_Stmt*s){struct _tuple20*_T0;struct _tuple20*_T1;int*_T2;void*_T3;struct Cyc_Absyn_Stmt*_T4;int*_T5;int _T6;struct Cyc_Absyn_Decl*_T7;int*_T8;unsigned _T9;struct Cyc_Absyn_Vardecl*_TA;struct _tuple0*_TB;char*_TC;unsigned _TD;struct _fat_ptr _TE;struct _fat_ptr _TF;struct _fat_ptr _T10;struct Cyc_Int_pa_PrintArg_struct _T11;struct Cyc_String_pa_PrintArg_struct _T12;struct Cyc_Int_pa_PrintArg_struct _T13;struct Cyc_String_pa_PrintArg_struct _T14;struct Cyc_Int_pa_PrintArg_struct _T15;int*_T16;int _T17;int _T18;struct _fat_ptr _T19;struct Cyc_Absyn_Vardecl*_T1A;void*_T1B;char*_T1C;struct _fat_ptr _T1D;unsigned long _T1E;int _T1F;struct Cyc_Absyn_Pat*_T20;int*_T21;int _T22;struct Cyc_Absyn_Vardecl*_T23;struct _tuple0*_T24;char*_T25;unsigned _T26;struct _fat_ptr _T27;struct _fat_ptr _T28;struct _fat_ptr _T29;struct Cyc_Int_pa_PrintArg_struct _T2A;struct Cyc_String_pa_PrintArg_struct _T2B;struct Cyc_Int_pa_PrintArg_struct _T2C;struct Cyc_String_pa_PrintArg_struct _T2D;struct Cyc_Int_pa_PrintArg_struct _T2E;int*_T2F;int _T30;int _T31;struct _fat_ptr _T32;struct Cyc_Absyn_Vardecl*_T33;void*_T34;char*_T35;struct _fat_ptr _T36;unsigned long _T37;int _T38;void*_T39;void(*_T3A)(struct Cyc_List_List*,void*);void*_T3B;struct _fat_ptr _T3C;_T0=env;{struct _tuple20 _T3D=*_T0;_T3C=_T3D.f0;_T1=env;_T2=& _T1->f1;_T3B=(int*)_T2;_T3A=_T3D.f2;_T3=_T3D.f3;_T39=(void*)_T3;}{struct _fat_ptr pfx=_T3C;int*count=(int*)_T3B;void(*fn)(struct Cyc_List_List*,void*)=_T3A;void*inner_env=_T39;_T4=s;{
# 668
...
# 747
struct _tuple21*env;env=_cycalloc(sizeof(struct _tuple21));_T3E=env;_T3E->f0=fdname;_T3F=env;_T3F->f1=0;_T40=env;_T40->f2=Cyc_Interproc_remove_local_constraints;_T41=env;_T41->f3=0;_T43=Cyc_Absyn_visit_stmt;{
void(*_T66)(int(*)(struct _tuple21*,struct Cyc_Absyn_Exp*),int(*)(struct _tuple21*,struct Cyc_Absyn_Stmt*),struct _tuple21*,struct Cyc_Absyn_Stmt*)=(void(*)(int(*)(struct _tuple21*,struct Cyc_Absyn_Exp*),int(*)(struct _tuple21*,struct Cyc_Absyn_Stmt*),struct _tuple21*,struct Cyc_Absyn_Stmt*))_T43;_T42=_T66;}{int(*_T66)(struct _tuple21*,struct Cyc_Absyn_Exp*)=(int(*)(struct _tuple21*,struct Cyc_Absyn_Exp*))Cyc_Interproc_exp_noop;_T44=_T66;}{int(*_T66)(struct _tuple21*,struct Cyc_Absyn_Stmt*)=(int(*)(struct _tuple21*,struct Cyc_Absyn_Stmt*))Cyc_Interproc_cvars_in_local_decl;_T45=_T66;}_T46=env;_T47=fd;_T48=_T47->body;_T42(_T44,_T45,_T46,_T48);goto _LL0;}}}case 5:{struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_T66=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_T5F;_T62=_T66->f1;}{struct Cyc_Absyn_Aggrdecl*ad=_T62;{struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_T66=_cycalloc(sizeof(struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct));_T66->tag=24;{struct Cyc_Absyn_Aggrdecl**_T67=_cycalloc(sizeof(struct Cyc_Absyn_Aggrdecl*));
# 751
...
return _T9;}struct _tuple22{const char*f0;const char*f1;};
# 853
int Cyc_Interproc_cmp_stats(struct _tuple22*a,struct _tuple22*b){struct _fat_ptr _T0;struct _tuple22*_T1;void*_T2;void*_T3;unsigned _T4;struct _fat_ptr _T5;struct _tuple22*_T6;void*_T7;void*_T8;unsigned _T9;int _TA;_T1=a;{const char*_TB=_T1->f1;_T2=(void*)_TB;_T3=(void*)_TB;_T4=_get_zero_arr_size_char(_T3,1U);_T0=_tag_fat(_T2,sizeof(char),_T4);}_T6=b;{const char*_TB=_T6->f1;_T7=(void*)_TB;_T8=(void*)_TB;_T9=_get_zero_arr_size_char(_T8,1U);_T5=_tag_fat(_T7,sizeof(char),_T9);}_TA=
Cyc_strcmp(_T0,_T5);return _TA;}
# 858
struct Cyc_List_List*Cyc_Interproc_resolve_all(struct _fat_ptr filename,struct Cyc_List_List*tds){struct Cyc_List_List*_T0;struct _tuple14*_T1;struct Cyc_List_List*_T2;unsigned _T3;struct Cyc_List_List*_T4;void*_T5;struct _tuple14*_T6;struct Cyc_List_List*_T7;struct Cyc_List_List*_T8;unsigned _T9;struct _handler_cons*_TA;int _TB;int _TC;struct Cyc_List_List*_TD;unsigned _TE;void*_TF;struct Cyc_Interproc_Unresolved_sym_exn_struct*_T10;char*_T11;char*_T12;struct Cyc_Warn_String_Warn_Warg_struct _T13;struct Cyc_Warn_Exp_Warn_Warg_struct _T14;struct Cyc_Absyn_Exp*_T15;unsigned _T16;struct _fat_ptr _T17;struct Cyc_List_List*_T18;unsigned _T19;struct Cyc_List_List*_T1A;void*_T1B;struct _tuple14*_T1C;struct Cyc_List_List*_T1D;struct Cyc_List_List*_T1E;unsigned _T1F;struct Cyc_List_List*_T20;struct Cyc_List_List*_T21;void*_T22;struct _tuple14*_T23;struct Cyc_List_List*_T24;struct Cyc_List_List*_T25;struct Cyc_List_List*_T26;
struct Cyc_List_List*orig=tds;
struct Cyc_List_List*first=0;struct Cyc_List_List*worklist=0;{struct Cyc_List_List*_T27=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple14*_T28=_cycalloc(sizeof(struct _tuple14));
_T28->f0=filename;_T28->f1=tds;_T1=(struct _tuple14*)_T28;}_T27->hd=_T1;_T27->tl=0;_T0=(struct Cyc_List_List*)_T27;}first=_T0;{
struct Cyc_List_List*all_located_fnsyms=0;
# 864
_TL157: _T2=worklist;_T3=(unsigned)_T2;if(!_T3)goto _TL159;_T4=worklist;_T5=_T4->hd;_T6=(struct _tuple14*)_T5;
...
# 871
struct _tuple17 _T29=Cyc_Interproc_locate_externs(externs,first);struct Cyc_List_List*_T2A;struct Cyc_List_List*_T2B;int _T2C;_T2C=_T29.f0;_T2B=_T29.f1;_T2A=_T29.f2;{int b=_T2C;struct Cyc_List_List*nd=_T2B;struct Cyc_List_List*rext=_T2A;_TC=b;
...
# 863
if(_T19)goto _TL157;else{goto _TL158;}_TL158: _T1A=first;_T1B=_T1A->hd;_T1C=(struct _tuple14*)_T1B;{
# 885
...
_TL16B: _T20=all_decls;_T21=it;_T22=_T21->hd;_T23=(struct _tuple14*)_T22;_T24=_T23->f1;all_decls=Cyc_List_imp_append(_T20,_T24);_T25=it;
# 887
it=_T25->tl;goto _TL16D;_TL16C:;}
# 893
Cyc_Interproc_bind_cvars(all_decls);_T26=all_decls;
return _T26;}}}struct _tuple23{void*f0;struct Cyc_List_List*f1;};struct _tuple24{const char*f0;const char*f1;int f2;int f3;};
# 897
void Cyc_Interproc_inference_statistics (void){struct Cyc___cycFILE*_T0;struct _fat_ptr _T1;struct _fat_ptr _T2;int _T3;struct Cyc___cycFILE*_T4;struct _fat_ptr _T5;struct _fat_ptr _T6;struct Cyc_List_List*_T7;unsigned _T8;struct Cyc_List_List*_T9;void*_TA;void*_TB;int*_TC;int _TD;void*_TE;int*_TF;unsigned _T10;struct Cyc_Absyn_AppType_Absyn_Type_struct*_T11;void*_T12;int*_T13;unsigned _T14;struct Cyc_List_List*_T15;struct _tuple24*_T16;struct Cyc_List_List*_T17;struct _tuple24*_T18;struct Cyc_List_List*_T19;struct Cyc_Int_pa_PrintArg_struct _T1A;int _T1B;struct Cyc___cycFILE*_T1C;struct _fat_ptr _T1D;struct _fat_ptr _T1E;struct Cyc_List_List*(*_T1F)(int(*)(struct _tuple24*,struct _tuple24*),struct Cyc_List_List*);struct Cyc_List_List*(*_T20)(int(*)(void*,void*),struct Cyc_List_List*);int(*_T21)(struct _tuple24*,struct _tuple24*);struct Cyc_List_List*_T22;struct Cyc_String_pa_PrintArg_struct _T23;struct Cyc_String_pa_PrintArg_struct _T24;struct Cyc_String_pa_PrintArg_struct _T25;struct Cyc_String_pa_PrintArg_struct _T26;struct Cyc___cycFILE*_T27;struct _fat_ptr _T28;struct _fat_ptr _T29;struct Cyc___cycFILE*_T2A;struct _fat_ptr _T2B;struct _fat_ptr _T2C;struct Cyc_List_List*_T2D;unsigned _T2E;const char*_T2F;struct Cyc_List_List*_T30;void*_T31;struct _tuple24*_T32;int _T33;const char*_T34;struct Cyc_List_List*_T35;void*_T36;struct _tuple24*_T37;int _T38;struct Cyc_String_pa_PrintArg_struct _T39;struct _fat_ptr _T3A;struct Cyc_List_List*_T3B;void*_T3C;struct _tuple24*_T3D;void*_T3E;void*_T3F;unsigned _T40;struct Cyc_String_pa_PrintArg_struct _T41;struct _fat_ptr _T42;struct Cyc_List_List*_T43;void*_T44;struct _tuple24*_T45;void*_T46;void*_T47;unsigned _T48;struct Cyc_String_pa_PrintArg_struct _T49;struct _fat_ptr _T4A;void*_T4B;void*_T4C;unsigned _T4D;struct Cyc_String_pa_PrintArg_struct _T4E;struct _fat_ptr _T4F;void*_T50;void*_T51;unsigned _T52;struct Cyc___cycFILE*_T53;struct _fat_ptr _T54;struct _fat_ptr _T55;struct Cyc_List_List*_T56;struct Cyc___cycFILE*_T57;struct _fat_ptr _T58;struct _fat_ptr _T59;struct Cyc___cycFILE*_T5A;struct _fat_ptr _T5B;struct _fat_ptr _T5C;_T0=Cyc_stderr;_T1=
...
_TL171: _T9=graph;_TA=_T9->hd;{struct _tuple23*_T5D=(struct _tuple23*)_TA;void*_T5E;{struct _tuple23 _T5F=*_T5D;_T5E=_T5F.f0;}{void*t=_T5E;int _T5F;const char*_T60;const char*_T61;_TB=t;_TC=(int*)_TB;_TD=*_TC;if(_TD!=3)goto _TL174;_TE=t;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T62=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_TE;_T61=_T62->f5;_T60=_T62->f6;_T5F=_T62->f7;}{const char*name=_T61;const char*loc=_T60;int origfat=_T5F;{
# 912
void*_T62=Cyc_Absyn_compress(t);_TF=(int*)_T62;_T10=*_TF;switch(_T10){case 3: goto _LLC;case 0: _T11=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T62;_T12=_T11->f1;_T13=(int*)_T12;_T14=*_T13;switch(_T14){case 13: _LLC:{struct Cyc_List_List*_T63=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple24*_T64=_cycalloc(sizeof(struct _tuple24));
# 915
_T64->f0=name;_T64->f1=loc;_T64->f2=0;_T64->f3=origfat;_T16=(struct _tuple24*)_T64;}_T63->hd=_T16;_T63->tl=ips;_T15=(struct Cyc_List_List*)_T63;}ips=_T15;
nips=nips + 1;goto _LL8;case 14:{struct Cyc_List_List*_T63=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple24*_T64=_cycalloc(sizeof(struct _tuple24));
# 919
_T64->f0=name;_T64->f1=loc;_T64->f2=1;_T64->f3=origfat;_T18=(struct _tuple24*)_T64;}_T63->hd=_T18;_T63->tl=ips;_T17=(struct Cyc_List_List*)_T63;}ips=_T17;
...
# 933
struct Cyc_List_List*(*_T5D)(int(*)(struct _tuple24*,struct _tuple24*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(int(*)(struct _tuple24*,struct _tuple24*),struct Cyc_List_List*))_T20;_T1F=_T5D;}_T21=(int(*)(struct _tuple24*,struct _tuple24*))Cyc_Interproc_cmp_stats;_T22=ips;ips=_T1F(_T21,_T22);{struct Cyc_String_pa_PrintArg_struct _T5D;_T5D.tag=0;
