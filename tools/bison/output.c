...
j=1;goto _TL84;
# 587
_TL83: j=j + 1;_TL84:{struct Cyc_Int_pa_PrintArg_struct _TE9;_TE9.tag=1;_TC8=Cyc_rrhs;_TC9=i + 1;_TCA=_check_fat_subscript(_TC8,sizeof(short),_TC9);_TCB=(short*)_TCA;_TCC=*_TCB;_TCD=(int)_TCC;_TCE=Cyc_rrhs;_TCF=_TCE.curr;_TD0=(short*)_TCF;_TD1=i;_TD2=_TD0[_TD1];_TD3=(int)_TD2;_TD4=_TCD - _TD3;_TD5=_TD4 - 1;
# 590
