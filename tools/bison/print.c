...
Cyc_strlen(buffer);_T166=_T164 + _T165;if(_T166 <= 50U)goto _TLA8;{struct Cyc_String_pa_PrintArg_struct _T19E;_T19E.tag=0;_T19E.f1=buffer;_T167=_T19E;}{struct Cyc_String_pa_PrintArg_struct _T19E=_T167;void*_T19F[1];_T19F[0]=& _T19E;_T168=_check_null(Cyc_foutput);_T169=_tag_fat("%s\n   ",sizeof(char),7U);_T16A=_tag_fat(_T19F,sizeof(void*),1);Cyc_fprintf(_T168,_T169,_T16A);}column=3;_T16B=buffer;{struct _fat_ptr _T19E=_fat_ptr_plus(_T16B,sizeof(char),0);_T16C=_check_fat_subscript(_T19E,sizeof(char),0U);_T16D=(char*)_T16C;{char _T19F=*_T16D;char _T1A0='\000';_T16E=_get_fat_size(_T19E,sizeof(char));if(_T16E!=1U)goto _TLAA;if(_T19F!=0)goto _TLAA;if(_T1A0==0)goto _TLAA;_throw_arraybounds();goto _TLAB;_TLAA: _TLAB: _T16F=_T19E.curr;_T170=(char*)_T16F;*_T170=_T1A0;}}goto _TLA9;_TLA8: _TLA9: _T171=buffer;_T172=
# 381
_tag_fat(" on right:",sizeof(char),11U);buffer=Cyc_strconcat(_T171,_T172);
j=1;_TLAF: if(j <= Cyc_nrules)goto _TLAD;else{goto _TLAE;}
# 385
_TLAD: _T173=Cyc_ritem;_T174=Cyc_rrhs;_T175=j;_T176=_check_fat_subscript(_T174,sizeof(short),_T175);_T177=(short*)_T176;_T178=*_T177;_T179=(int)_T178;rule=_fat_ptr_plus(_T173,sizeof(short),_T179);_TLB3: _T17A=rule;_T17B=_check_fat_subscript(_T17A,sizeof(short),0U);_T17C=(short*)_T17B;_T17D=*_T17C;_T17E=(int)_T17D;if(_T17E > 0)goto _TLB1;else{goto _TLB2;}
...
# 388
Cyc_strlen(buffer);_T188=_T186 + _T187;if(_T188 <= 65U)goto _TLB6;{struct Cyc_String_pa_PrintArg_struct _T19E;_T19E.tag=0;_T19E.f1=buffer;_T189=_T19E;}{struct Cyc_String_pa_PrintArg_struct _T19E=_T189;void*_T19F[1];_T19F[0]=& _T19E;_T18A=_check_null(Cyc_foutput);_T18B=_tag_fat("%s\n   ",sizeof(char),7U);_T18C=_tag_fat(_T19F,sizeof(void*),1);Cyc_fprintf(_T18A,_T18B,_T18C);}column=3;_T18D=buffer;{struct _fat_ptr _T19E=_fat_ptr_plus(_T18D,sizeof(char),0);_T18E=_check_fat_subscript(_T19E,sizeof(char),0U);_T18F=(char*)_T18E;{char _T19F=*_T18F;char _T1A0='\000';_T190=_get_fat_size(_T19E,sizeof(char));if(_T190!=1U)goto _TLB8;if(_T19F!=0)goto _TLB8;if(_T1A0==0)goto _TLB8;_throw_arraybounds();goto _TLB9;_TLB8: _TLB9: _T191=_T19E.curr;_T192=(char*)_T191;*_T192=_T1A0;}}goto _TLB7;_TLB6: _TLB7: _T193=buffer;{struct Cyc_Int_pa_PrintArg_struct _T19E;_T19E.tag=1;_T196=j;
# 390
