...
void Cyc_output_token_defines(struct Cyc___cycFILE * file) {
  ...
  int _T23;
  struct Cyc_String_pa_PrintArg_struct _T24;
  struct Cyc_Int_pa_PrintArg_struct _T25;
  short _T26;
  int _T27;
  int _T28;
  struct Cyc_bucket * _T29;
  ...
  _T5 = (int)_T4;
  _T6 = Cyc_ntokens;
  if (_T5 < _T6) { goto _TL2CE;
  }
  goto _TL2CA;
  _TL2CE: _T7 = bp;
  _T8 = _T7->user_token_number;
  _T9 = (int)_T8;
  _TA = - 9991;
  if (_T9 != _TA) { goto _TL2D0;
  }
  goto _TL2CA;
  _TL2D0: _TB = symbol;
  _TC = _check_fat_subscript(_TB,sizeof(char),0U);
  ...
  _TL2DA: _T1A = &cp;
  _T1B = _fat_ptr_inplace_plus_post(_T1A,sizeof(char),1);
  _T1C = _check_fat_subscript(_T1B,sizeof(char),0U);
  _T1D = (char *)_T1C;
  c = *_T1D;
  _T1E = c;
  _T1F = (int)_T1E;
  if (_T1F != 0) { goto _TL2DD;
  }else { goto _TL2DC;
  }
  _TL2DD: _T20 = c;
  _T21 = (int)_T20;
  if (_T21 != 46) { goto _TL2DB;
  }else { goto _TL2DC;
  }
  _TL2DB: goto _TL2DA;
  _TL2DC: _T22 = c;
  _T23 = (int)_T22;
  if (_T23 == 0) { goto _TL2DE;
  }
  goto _TL2CA;
  _TL2DE: { struct Cyc_String_pa_PrintArg_struct _T39;
    _T39.tag = 0;
    _T39.f1 = symbol;
    _T24 = _T39;
  }{ struct Cyc_String_pa_PrintArg_struct _T39 = _T24;
    { struct Cyc_Int_pa_PrintArg_struct _T3A;
      _T3A.tag = 1;
      _T27 = Cyc_translations;
      if (! _T27) { goto _TL2E0;
      }
      _T28 = Cyc_rawtoknumflag;
      if (_T28) { goto _TL2E0;
      }else { goto _TL2E2;
      }
      _TL2E2: _T29 = bp;
      _T26 = _T29->user_token_number;
      goto _TL2E1;
      _TL2E0: _T2A = bp;
      _T26 = _T2A->value;
      _TL2E1: _T2B = (int)_T26;
      _T3A.f1 = (unsigned long)_T2B;
      _T25 = _T3A;
    }{ struct Cyc_Int_pa_PrintArg_struct _T3A = _T25;
      void * _T3B[2];
      _T3B[0] = &_T39;
      _T3B[1] = &_T3A;
      _T2C = file;
      _T2D = _tag_fat("#define\t%s\t%d\n",sizeof(char),15U);
      _T2E = _tag_fat(_T3B,sizeof(void *),2);
      Cyc_fprintf(_T2C,_T2D,_T2E);
    }
  }_T2F = Cyc_semantic_parser;
  if (! _T2F) { goto _TL2E3;
  }
  { struct Cyc_String_pa_PrintArg_struct _T39;
    _T39.tag = 0;
    _T39.f1 = symbol;
    _T30 = _T39;
  }{ struct Cyc_String_pa_PrintArg_struct _T39 = _T30;
    { struct Cyc_Int_pa_PrintArg_struct _T3A;
      _T3A.tag = 1;
      _T32 = bp;
      _T33 = _T32->value;
      _T34 = (int)_T33;
      _T3A.f1 = (unsigned long)_T34;
      _T31 = _T3A;
    }{ struct Cyc_Int_pa_PrintArg_struct _T3A = _T31;
      void * _T3B[2];
      _T3B[0] = &_T39;
      _T3B[1] = &_T3A;
      _T35 = file;
      _T36 = _tag_fat("#define\tT%s\t%d\n",sizeof(char),16U);
      _T37 = _tag_fat(_T3B,sizeof(void *),2);
      Cyc_fprintf(_T35,_T36,_T37);
    }
  }goto _TL2E4;
  _TL2E3: _TL2E4: _TL2CA: _T38 = bp;
  bp = _T38->next;
  goto _TL2CD;
  _TL2CC: Cyc_putc(10,file);
}
void Cyc_packgram() {
  struct _fat_ptr _T0;
  int _T1;
  ...
  { unsigned int _T74 = (unsigned int)_T1;
	...
	unsigned int _new2_cyclone;
	_new2_cyclone = 0;
	_TL2E8: if (_new2_cyclone < _T76) { goto _TL2E6;
	}else { goto _TL2E7;
	}
	_TL2E6: _T4 = _new2_cyclone;
	_T75[_T4] = 0;
	_new2_cyclone = _new2_cyclone + 1;
	goto _TL2E8;
	_TL2E7: ;
  ...
  { unsigned int _T74 = (unsigned int)_T6;
	...
	unsigned int _new2_cyclone;
	_new2_cyclone = 0;
	_TL2EC: if (_new2_cyclone < _T76) { goto _TL2EA;
	}else { goto _TL2EB;
	}
  ...
  { unsigned int _T74 = (unsigned int)_TD;
	...
	unsigned int _new2_cyclone;
	_new2_cyclone = 0;
	_TL2F0: if (_new2_cyclone < _T76) { goto _TL2EE;
	}else { goto _TL2EF;
	}
	_TL2EE: _T10 = _new2_cyclone;
	_T75[_T10] = 0;
	_new2_cyclone = _new2_cyclone + 1;
	goto _TL2F0;
	_TL2EF: ;
  ...
  { unsigned int _T74 = (unsigned int)_T14;
	...
	unsigned int _new2_cyclone;
	_new2_cyclone = 0;
	_TL2F4: if (_new2_cyclone < _T76) { goto _TL2F2;
	}else { goto _TL2F3;
	}
	_TL2F2: _T17 = _new2_cyclone;
	_T75[_T17] = 0;
	_new2_cyclone = _new2_cyclone + 1;
	goto _TL2F4;
	_TL2F3: ;
  ...
  { unsigned int _T74 = (unsigned int)_T1B;
	...
	unsigned int _new2_cyclone;
	_new2_cyclone = 0;
	_TL2F8: if (_new2_cyclone < _T76) { goto _TL2F6;
	}else { goto _TL2F7;
	}
	_TL2F6: _T1E = _new2_cyclone;
	_T75[_T1E] = 0;
	_new2_cyclone = _new2_cyclone + 1;
	goto _TL2F8;
	_TL2F7: ;
  ...
  { unsigned int _T74 = (unsigned int)_T22;
	...
	unsigned int _new2_cyclone;
	_new2_cyclone = 0;
	_TL2FC: if (_new2_cyclone < _T76) { goto _TL2FA;
	}else { goto _TL2FB;
	}
	_TL2FA: _T25 = _new2_cyclone;
	_T75[_T25] = 0;
	_new2_cyclone = _new2_cyclone + 1;
	goto _TL2FC;
	_TL2FB: ;
  ...
  *_T34 = (short)_T35;
  ...
  _TL303: _T3A = p;
  _T3B = _T3A->sym;
  if (_T3B != 0) { goto _TL301;
  }else { goto _TL302;
  }
  _TL301: _T3C = Cyc_ritem;
  _T3D = itemno;
  itemno = _T3D + 1;
  _T3E = _T3D;
  ...
  *_T50 = _T52->assoc;
  ...
  p = _T55->next;
  goto _TL307;
  _TL306: _TL307: goto _TL300;
  _TL302: _T56 = ruleprec;
  ...
  *_T6B = (short)_T6C;
  ...
  p = _T6F->next;
  goto _TL30B;
  _TL30A: _TL30B: goto _TL2FD;
  _TL2FF: _T70 = Cyc_ritem;
  _T71 = itemno;
